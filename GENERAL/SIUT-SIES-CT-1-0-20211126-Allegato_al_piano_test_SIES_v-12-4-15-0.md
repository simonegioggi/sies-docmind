---
uniqueName: siut-sies-ct-1-0-20211126-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20211126 Allegato al piano test SIES v 12 4 15 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20211126-Allegato_al_piano_test_SIES_v.12.4.15.0

> **File originale:** `RILASCIO_12.4.15.0/SIUT-SIES-CT-1.0-20211126-Allegato_al_piano_test_SIES_v.12.4.15.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20211126-Allegato-al-piano-test_SIES_v.12.4.15.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20211126-Piano_dei_Test_SIES_v.12.4.15.0.docx |
|  | Versione | 1.0 |
|  | Data | 44526.0 |
|  | Intervento | SIES v.12.4.15.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.15.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20211126-Allegato-al-piano-test_SIES_v.12.4.15.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20211014013.0 |  |  | 20211014013.0 | SIGE EMISSIONE ORDINANZA CON PIù SENTENZE / DECRETI COME ALTRI TITOLI ESECUTIVI |  | SIGE | SIGE - SIGE EMISSIONE ORDINANZA CON PIù SENTENZE / DECRETI COME ALTRI TITOLI ESECUTIVI | TF001.SIGE | Verifica presenza in stampa Ordinanza dei Titoli Esecutivi |  |  |  | Verifica: verificare che la stampa  SIGE_OR_MODGENERICO.rtfriporti tutti i titoli esecutivi associati al procedimento SIGE oltre al primo. | 1.0 |  |  |  |  |
| SIUT | SIES | 20211019014.0 |  |  | 20211019014.0 | Misure sicurezza – errore trasferimento procedimento |  | SIEP | SIEP - Misure sicurezza – errore trasferimento procedimento | TF002.SIEP | Verifica presa in carico fascicolo da altro distretto |  |  |  | Verifica: verificare che la presa in carico di un fascicolo proveniente da un altro distretto e senza informazioni di tipo altra causa avvenga correttamente. | 1.0 |  |  |  |  |
| SIUT | SIES | 20211022013.0 |  |  | 20211022013.0 | correzione template 656 comma 1 c.p.p. detenuto Stessa causa |  | SIEP | SIEP - correzione template 656 comma 1 c.p.p. detenuto Stessa causa | TF003.SIEP | Verifica correzione template |  |  |  | Verifica: verificare che il template SIEP_CUMULO_OE_656_DET.rtf riporti le correzioni indicate nel ticket | 1.0 |  |  |  |  |
| SIUT | SIES | 20211102019.0 |  |  | 20211102019.0 | SIES - Rif. TT 20211102011  Estrazione Archiviati nella statistica  proc. Pendenti di Conversione P.P. |  | SIEP | SIEP - SIES - Rif. TT 20211102011  Estrazione Archiviati nella statistica  proc. Pendenti di Conversione P.P. | TF004.SIEP | Verifica corrispondenza procedimenti di C.P.P. riportati nel foglio Archiviati delle estrazione statistica con quelli riportati nella ricerca avanzata |  |  |  | Verifica: verificare che l'elenco dei proc. Riiportati nel foglio excel Archiviati  includa tutti quelli riportati nell'elenco di ricerca avanzata in stato di archiviazione | 1.0 |  |  |  |  |
| SIUT | SIES | 202111150114.0 |  |  | 202111150114.0 | Dichiarazione estinzione liberta' controllata |  | SIEP | SIEP - Dichiarazione estinzione liberta' controllata | TF005.SIEP | Verifica corretta visualizzazione Decreto |  |  |  | Verifica: verificare che il sistema visualizzi il Decreto estinzione della sanzione sostitutiva | 1.0 |  |  |  |  |
| SIUT | SIES | 20211116019.0 |  |  | 20211116019.0 | Funzione RICERCA PROCEDIMENTO SIGE PER ESTREMI ATTO |  | SIGE | SIGE - Funzione RICERCA PROCEDIMENTO SIGE PER ESTREMI ATTO | TF006.SIGE | Verifica corretta estrazione statistica |  |  |  | Verifica: verificare che l'estrazione della statistica per la funzionalità di ricerca procedimento SIGE per estremi Atto non vada in errore. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.15.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20211126-Allegato-al-piano-test_SIES_v.12.4.15.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIGE | 01 | Verifica presenza in stampa Ordinanza dei Titoli Esecutivi |  | Verifica: verificare che la stampa  SIGE_OR_MODGENERICO.rtfriporti tutti i titoli esecutivi associati al procedimento SIGE oltre al primo. |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Ricercare un procedimento SIGE nello stato Iscritto. |  | Visualizzazione pagina Dettaglio Procedimento SIGE |  |  |  |  |
|  | 2 | Azione | Nel caso il procedimento ricercato ha un solo titolo esecutivo assegnarne altri tramite la funzione Assegnazione Titolo Esecutivo presente nella combo delle funzionalità del Dettaglio Procedimento SIGE |  | Visualizzazione pagina Ricerca Titolo Esecutivo da assegnare a Procedimento SIGE |  |  |  |  |
|  | 3 | Azione | Cliccare sul link Oggetti presente nella pagina Dettaglio Procedimento SIGE |  | Visualizzazione pagina Gestione Oggetti Relativi alla Richiesta/Atto |  |  |  |  |
|  | 4 | Azione | Inserire/Aggiornare l'oggetto con i seguenti dati:
Contenuto: Revoca altri provvedimenti (art. 674 cpp. -  art. 168 cp)
Oggetto: Revoca sospensione condizionale della pena (art. 163 cp)
Titolo Esecutivo: selezionare Tutti
Cliccare su Conferma. |  | Visualizzazione pagina Gestione Oggetti Relativi alla Richiesta/Atto |  |  |  |  |
|  | 5 | Navigazione | Ordinanze/Deposito/Notifiche » Emissione Ordinanza |  | Visualizzazione pagina Emissione Ordinanza |  |  |  |  |
|  | 6 | Azione | Inserire i dati obbligatori nella pagina e cliccare su Conferma |  | Visualizzazione pagina  Dettaglio Ordinanza |  |  |  |  |
|  | 7 | Azione | Cliccare sull'icona di stampa. |  | Generazione documento SIGE_OR_MODGENERICO.rtf |  |  |  |  |
|  | V | Verifica | Verificare che la stampa prodotta riporti tutti i titoli esecutivi associati al procedimento SIGE |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica presa in carico fascicolo da altro distretto |  | Verifica: verificare che la presa in carico di un fascicolo proveniente da un altro distretto e senza informazioni di tipo altra causa avvenga correttamente. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Iscrivere un procedimento di classe qualsiasi |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Nella pagina di dettaglio, tramite la combo contenente varie funzionalità, selezionare le seguenti voci :
Difensore,
Reati, 
Posizione Giuridica, 
Pena Complessiva, 
Assegnazione procedimento al Magistrato.
Per ognuna di queste voci inserire le informazioni obbligatorie. In particolare la Posizione Giuridica deve essere "Libero - Detenuto per altra causa". |  | Visualizzazione pagine delle singole voci selezionate |  |  |  |  |
...
|  | 5 | Navigazione | Decisioni della Sorveglianza |  | Visualizzazione pagina  Decisioni Sorveglianza |  |  |  |  |
|  | 6 | Azione | Selezionare Affidamento in Prova al Servizio sociale |  | Visualizazzione pagina Affidamento in Prova |  |  |  |  |
|  | 7 | Azione | Selezionare Concessione/Ratifica |  | Visualizzazione pagina Concessione Affidamento In Prova |  |  |  |  |
|  | 8 | Azione | Completare i dati e validare. |  | Visualizzazione pagina Dettaglio Concessione Affidamento In Prova |  |  |  |  |
|  | 9 | Navigazione | Decisioni della Sorveglianza |  | Visualizzazione pagina  Decisioni Sorveglianza |  |  |  |  |
|  | 10 | Azione | Selezionare Registrazione Data Inizio Misura |  | Visualizazzione pagina Registrazione Data Inizio Misura |  |  |  |  |
|  | 11 | Azione | Completare i dati delle varie schermate ed infine validare. |  | Visualizzazione pagina Dettaglio Concessione Affidamento In Prova |  |  |  |  |
|  | 12 | Azione | Selezionare Elenco Provvedimenti del PM |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | 13 | Azione | Annullare tramite l'apposita icona presente nella colonna Azioni il Verbale  sottoscrizione obblighi |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | 14 | Azione | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario di un altro distretto | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 15 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 16 | Navigazione | Ricerche |  | Visualizzazione pagina Ricerche |  |  |  |  |
|  | 17 | Azione | Selezionare Procedimento |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 18 | Azione | Ricercare il fascicolo del distretto dello step 1 |  | Visualizzazione pagina Dettaglio Ricerca altre BDI |  |  |  |  |
|  | 19 | Azione | Procedere alla presa in carico. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la presa in carico del Fascicolo avvenga senza errori applicativi. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica correzione template |  | Verifica: verificare che il template SIEP_CUMULO_OE_656_DET.rtf riporti le correzioni indicate nel ticket |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare una istruttoria cumulo aperta, selezionando l'icona IC dalla pagina principale. |  | Visualizzazione pagina Ricerca Istruttoria Cumulo |  |  |  |  |
|  | 2 | Azione | Cliccare sull'icona  Gestione cumulo |  | Visualizzazione pagina  Gestione Cumulo |  |  |  |  |
|  | 3 | Azione | In Gestione Cumulo cliccare su Dati Finali Cumulo |  | Visualizzazione pagina Dati Finali Cumulo |  |  |  |  |
|  | 4 | Azione | Se non presente inserire Data Emissione e cliccare su Conferma |  | Visualizzazione pagina Dati Finali Cumulo con i vari TAB |  |  |  |  |
|  | 5 | Azione | Inserire nei vari tab la pena rideterminata che deve contenere reclusione e arresto,la Posizione giuridica Espiazione Pena in Regime Carcerario, procedere al calcolo pena ed infine emettere il provvedimento di unificazione di pene concorrenti con Tipologia "Ordine di esecuzione per la carcerazione ex art. 656 Comma 1 CPP" e validare. |  | Visualizzazione pagina Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 6 | Azione | Cliccare sull'icona di stampa. |  | Generazione documento  SIEP_CUMULO_OE_656_DET.rtf |  |  |  |  |
|  | V | Verifica | Verificare che la stampa riporti le correzioni richieste dall'utente nel ticket |  |  |  |  |  |  |
| TF004.SIEP | 01 | Verifica corrispondenza procedimenti di C.P.P. riportati nel foglio Archiviati delle estrazione statistica con quelli riportati nella ricerca avanzata |  | Verifica: verificare che l'elenco dei proc. Riiportati nel foglio excel Archiviati  includa tutti quelli riportati nell'elenco di ricerca avanzata in stato di archiviazione |  | 1,0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Statistiche/Monitoraggio |  | Visualizzazione menu con  Ricerca Fogli Complemetari - Statistiche Estrazione Dati |  |  |  |  |
|  | 2 | Azione | selezionare Statistiche Estrazione Dati |  | Visualizzazione pagina  in cui sono riportate le tipologie di classi dei procedimenti SIEP |  |  |  |  |
|  | 3 | Azione | selezionare Classe VII, Riepilogo Procedimenti Pendenti e Conferma |  | Visualizzazione pagina  in cui impostare il periodo di inizio e fine estrazione |  |  |  |  |
|  | 4 | Azione | Impostare periodo di inizio e fine iscrizione dei procedimenti SIEP di classe IV e Confermare |  | Visualizzazione pagina  in cui sono riportati i periodi precedentemente impostati |  |  |  |  |
|  | 5 | Azione | selezionare Conferma |  | Attendere che il sistema richieda di Aprire o Salvare il file excel, contenente il risultato dell'estrazione |  |  |  |  |
|  | 6 | Azione | selezionare Aprire documento.xls |  | Verificare che il numero riportato nella riga  Totale Procedimenti Definiti corrisponda con il numero riportato in Totale Generale del foglio  Archiviazioni |  |  |  |  |
|  | V | Verifica | Verificare che il numero riportato nella riga  Totale Procedimenti Definiti corrisponda con il numero riportato in Totale Generale del foglio  Archiviazioni |  |  |  |  |  |  |
|  | 7 | Navigazione | selezionare Ricerca Procedimento Avanzata |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 8 | Azione | Selezionare ricerca per Date Iscrizioni, impostare le stesso periodo della statistica, selezionare Classe IV e avviare Ricerca |  | Visualizzazione pagina Elenco procedimenti impaginato |  |  |  |  |
|  | V | Verifica | Per ciascun procedimento dell'elenco in stato di Archiviazione |  | Verificarne la presenza nel foglio excel Archiviati della Statistica |  |  |  |  |
| TF005.SIEP | 01 | Verifica corretta visualizzazione Decreto |  | Verifica: verificare che il sistema visualizzi il Decreto estinzione della sanzione sostitutiva |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento SIEP di Conversione Pene Pecuniarie, su cui sia stato già scaricato provvedimento della Sorveglianza di Conversione della pena pecuniaria in libertà controllata. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | L'utente effettua l'accesso al sistema SIUS come Ufficio di Sorveglianza | Exxxxx (Ufficio di Sorveglianza) |  |  |  |  |  |
...
|  | 5 | Azione | Ricercare il procedimento di Esecuzione Sanzione Sostitutiva - Libertà controllata, collegato al procedimento dello step 1 oppure inserirlo. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 6 | Azione | Dal dettaglio del procedimento, cliccare su anno e numero del Numero Procedimento E.S.S. |  | Visualizzazione pagina Elenco dei Procedimenti relativi all' Esecuzione della Sanzione Sostitutiva |  |  |  |  |
|  | 7 | Azione | Cliccare su icona di inserimento (foglio bianco). |  | Visualizzazione pagina Iscrizione Procedimento da Soggetto |  |  |  |  |
|  | 8 | Azione | Nella pagina visualizzata selezionare come
Tipo Atto: Richiesta
Contenuto ed Oggetto: Dichiarazione di estinzione libertà controllata.
Confermare |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 9 | Navigazione | Decreti » Emissione Decreto |  | Visualizazzione pagina Emissione Decreto |  |  |  |  |
|  | 10 | Azione | Sul procedimento appena iscritto Emettere e depositare il decreto con esito "Dichiara Estinta" e validarlo. |  | Visualizzazione pagina Dettaglio Decreto Declaratoria Estinzione Sanzioni Sostitutive |  |  |  |  |
|  | 11 | Azione | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 12 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 13 | Navigazione | Gestione Altre Sanzioni |  | Visualizazzione pagina  Gestione Altre Sanzioni |  |  |  |  |
|  | 14 | Azione | Selezionare Conversione Pene Pecuniarie |  | Visualizzazione pagina  Gestione Conversione Pene Pecuniarie |  |  |  |  |
|  | 15 | Azione | Selezionare Definizione Procedimento |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 16 | Azione | Ricercare il Procedimento dello step 1 |  | Visualizzazione pagina Definizione Procedimento - Provvedimento Sorveglianza |  |  |  |  |
|  | 17 | Azione | Selezionare il link Seleziona provvedimenti dalla lista |  | Visualizzazione popup |  |  |  |  |
|  | V | Verifica | Verificare che nella popup sia presente il provvedimento dello step 8 ed importarlo nella form principale. |  |  |  |  |  |  |
|  | 18 | Azione | Confermare |  |  |  |  |  |  |
|  | V | Verifica | Verificare correttezza dei dati nella pagina di dettaglio. |  |  |  |  |  |  |
| TF006.SIGE | 01 | Verifica corretta estrazione statistica |  | Verifica: verificare che l'estrazione della statistica per la funzionalità di ricerca procedimento SIGE per estremi Atto non vada in errore. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Nella sezione "Stato Procedimento:" scegliere la voce "Solo Definiti" e riempire i campi "Intervallo Date Definizione"; selezionare un "Magistrato" nella sezione "Estremi dell'Atto"; effettuare la ricerca premendo il tasto "Statistica". |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non visualizzi una pagina di errore. |  |  |  |  |  |  |
