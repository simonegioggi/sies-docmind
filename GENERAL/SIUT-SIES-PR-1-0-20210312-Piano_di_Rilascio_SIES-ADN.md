---
uniqueName: siut-sies-pr-1-0-20210312-pianodirilasciosies-adn
displayName: "SIUT SIES PR 1 0 20210312 Piano di Rilascio SIES ADN"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20210312-Piano_di_Rilascio_SIES-ADN

> **File originale:** `MEV/Integrazione SIES-ADN/DOCS/SIUT-SIES-PR-1.0-20210312-Piano_di_Rilascio_SIES-ADN.docx`  
> **Tipo:** DOCX
...
6.	Installazione	10
6.1	Prerequisiti	10
6.2	Attività di configurazione	10
6.3	Attività di preinstallazione	10
6.4	Attività di installazione	10
6.4.1	Installazione lato DB	10
6.4.1.1	Esecuzione script	10
6.4.2	Installazione applicazione	11
6.4.2.1	Deploy Applicazione	11
...
Gli interventi in oggetto sono rilasciati nell’ambito della release SIES-ADN di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio del software relativo alla Mev Integrazione SIES-ADN (pre-golive), contenente l’integrazione della suddetta MEV nella versione SIES 12.4.7.0.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 07 - MEV > 2019_002_Casellario_Sostituzione IGI > Verifica Conformità > 02_SIES > pre-golive |  |  |
| Note-osservazioni |  |  |  |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20210312-Piano_di_Rilascio_SIES-ADN.docx
SIUT-SIE-PV-1.0-20210312-Piano delle verifiche_SIES-ADN.pdf
SIUT-SIE-MU-1.0-20210312-Manuale_Utente_SIES-ADN.pdf
SIGI_PNL_ML_20210312_1.5_Modello dei Dati_SIES.pdf
SIUT-SIES-PT-1.0-20210312-Piano_dei_Test_SIES-ADN.pdf
SIUT-SIES-CT-1.0-20210312-Allegato_al_piano_test_SIES-ADN.xlsx |
| Note-osservazioni |  |  |
...
Creare sul server DB una cartella MEV_MISA sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/ MEV_MISA/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella MEV_MISA tramite il comando:
chmod 777 MEV_MISA
...
Nella cartella appena creata (MEV_MISA), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/MEV_MISA/log/ in cui si può constatare l’esito dell’esecuzione.
