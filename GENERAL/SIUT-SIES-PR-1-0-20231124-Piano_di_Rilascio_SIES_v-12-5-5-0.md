---
uniqueName: siut-sies-pr-1-0-20231124-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20231124 Piano di Rilascio SIES v 12 5 5 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20231124-Piano_di_Rilascio_SIES_v.12.5.5.0

> **File originale:** `RILASCIO_12.5.5.0/SIUT-SIES-PR-1.0-20231124-Piano_di_Rilascio_SIES_v.12.5.5.0.docx`  
> **Tipo:** DOCX
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.5.5.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.5.5.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.5.5.0 2023-11-24 | 12.5.5.0 | 24/11/2023 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20231124-Piano_di_Rilascio_SIES_v.12.5.5.0.docx
SIUT-SIES-PT-1.0-20231124-Piano_dei_Test_SIES_v.12.5.5.0.docx
SIUT-SIES-CT-1.0-20231124-Allegato_al_piano_test_SIES_v.12.5.5.0.xls |
...
Creare sul server DB una cartella V_12_5_5_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_5_5_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_5_5_0 tramite il comando:
chmod 777 V_12_5_5_0
...
Nella cartella appena creata (V_12_5_5_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_5_5_0/log/ in cui si può constatare l’esito dell’esecuzione.
