---
uniqueName: siut-sies-pr-1-0-20251024-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20251024 Piano di Rilascio SIES v 12 8 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20251024-Piano_di_Rilascio_SIES_v.12.8.3.0

> **File originale:** `RILASCIO_12.8.3.0/SIUT-SIES-PR-1.0-20251024-Piano_di_Rilascio_SIES_v.12.8.3.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 24/10/2025 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.8.3.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.8.3.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.8.3.0 2025-10-24 | 12.8.3.0 | 24/10/2025 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 202510090125 | Procura della Repubblica presso il Tribunale di Torino | L’ufficio segnala la Correzione template -SIEP_PP_PR_AVVPAGAM_PP | Per la risoluzione della problematica sono stati modificati i template relativi all'avvenuto pagamento della pena pecuniaria | Il problema era legato al fatto che il significato di alcune frasi non era corretto.
Template modificati:
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20251024-Piano_di_Rilascio_SIES_v.12.8.3.0.docx
SIUT-SIES-PT-1.0-20251024-Piano_dei_Test_SIES_v.12.8.3.0.docx
SIUT-SIES-CT-1.0-20251024-Allegato_al_piano_test_SIES_v.12.8.3.0.xlsx |
...
siep/pp/SIEP_PP_PR_AVVPAGAM_PP.rtf |
| Note-osservazioni |  |  |

# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.8.2.0.
...
Creare sul server DB una cartella V_12_8_3_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_8_3_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_8_3_0 tramite il comando:
chmod 777 V_12_8_3_0
...
Nella cartella appena creata (V_12_8_3_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_8_3_0/log/ in cui si può constatare l’esito dell’esecuzione.
