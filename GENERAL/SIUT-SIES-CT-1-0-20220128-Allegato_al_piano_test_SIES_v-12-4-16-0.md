---
uniqueName: siut-sies-ct-1-0-20220128-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220128 Allegato al piano test SIES v 12 4 16 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220128-Allegato_al_piano_test_SIES_v.12.4.16.0

> **File originale:** `RILASCIO_12.4.16.0/SIUT-SIES-CT-1.0-20220128-Allegato_al_piano_test_SIES_v.12.4.16.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220128-Allegato-al-piano-test_SIES_v.12.4.16.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220128-Piano_dei_Test_SIES_v.12.4.16.0.docx |
|  | Versione | 1.0 |
|  | Data | 44589.0 |
|  | Intervento | SIES v.12.4.16.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.16.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220128-Allegato-al-piano-test_SIES_v.12.4.16.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20211129018.0 |  |  | 20211129018.0 | Rinvio udienza Sige |  | SIGE | SIGE - Rinvio udienza Sige | TF001.SIGE | Emissione Provvedimento di Rinvio Udienza da Verbale in caso di presenza provvedimento definitorio |  |  |  | Verifica: in caso di esistenza di Provvedimento Definitorio, si può emettere un altro provvedimento (rinvio udienza o rinvio udienza da verbale) se lo stato del fascicolo è:
   Opposizione - Accoglie (fissa l'udienza) = 14
   Ricorso convertito in opposizione = 16
   Decreto Fissazione Udienza = 20
   Ricorso convertito in opposizione (Fissa Udienza) = 21 | 1.0 |  |  |  |  |
| SIUT | SIES | 20211202015.0 |  |  | 20211202015.0 | CUMULO - COMUNICAZIONI ALLE PROCURE E UFFICI DI SORVEGLIANZA |  | SIEP | SIEP - CUMULO - COMUNICAZIONI ALLE PROCURE E UFFICI DI SORVEGLIANZA | TF002.SIEP | Comunicazioni alle Procure ed agli uffici di sorveglianza in presenza di cumulo |  |  |  | Verifica: verificare che in assenza di uffici di esecuzione tra i destinatari della comunicazione del cumulo il sistema visualizza un messaggio di controllo bloccante | 1.0 |  |  |  |  |
| SIUT | SIES | 20211216018.0 |  |  | 20211216018.0 | cumulo - Provvedimenti di Comunicazione Emessi |  | SIEP | SIEP - cumulo - Provvedimenti di Comunicazione Emessi | TF003.SIEP | Gestione provvedimento di cumulo emesso da altro ufficio dello stesso distretto |  |  |  | Verifica: verificare che nel caso un fascicolo di cumulo non è di competenza dell'ufficio siano inibite le funzioni segnalate nel ticket | 1.0 |  |  |  |  |
| SIUT | SIES | 20211220019.0 |  |  | 20211220019.0 | Riepilogo ispettivo - posizione errata procedimenti - Procedimenti in attesa di emissione provvedimenti del PM - attesa per istruttoria cumulo |  | SIEP | SIEP - Riepilogo ispettivo - posizione errata procedimenti - Procedimenti in attesa di emissione provvedimenti del PM - attesa per istruttoria cumulo | TF004.SIEP | Gestione casisitica per codice motivo dell'ultimo evento uguale a 0340 nel Riepilogo Ispettivo |  |  |  | Verifica: verificare che nell'eleborazione del riepilogo ispettivo vengano considerati correttamente i procedimenti aventi codice motivo dell'ultimo evento uguale a 0340 | 1.0 |  |  |  |  |
| SIUT | SIES | 20220110012.0 |  |  | 20220110012.0 | anomali stampa ordine di esecuzione |  | SIEP | SIEP - anomali stampa ordine di esecuzione | TF005.SIEP | Modifica template per gestire posizione giuridica 05 |  |  |  | Verifica: verificare che il template SIEP_LS_ODARI.rtf gestisca correttamente la posizione giuridica 04 oltre la 02. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220111018.0 |  |  | 20220111018.0 | Sies - Cancellazione atti ricevuti per competenza |  | SIEP | SIEP - Sies - Cancellazione atti ricevuti per competenza | TF006.SIEP | Inserimento paginazione nella mappa di ricerca atti ricevuti da altre procure |  |  |  | Verifica: verificare che in presenza di molte occorrenze la funzione segnalata abbia nella ricerca dei dati tempi di risposta accettabili | 1.0 |  |  |  |  |
| SIUT | SIES | 20220111017.0 |  |  | 20220111017.0 | SIES - Statistiche Classe VII |  | SIEP | SIEP - SIES - Statistiche Classe VII | TF007.SIEP | Elaborazione statistica classe VII con occorrenze aventi stessa data scadenza |  |  |  | Verifica: verificare che l'eleborazione della statistica classe VII avvenga correttamente nel caso siano presenti più occorrenze con stessa data scadenza | 1.0 |  |  |  |  |
| SIUT | SIES | 20220124013.0 |  |  | 20220124013.0 | Nel provvedimento di cumulo - nota accompagnamento autorità destinatarie mancanti |  | SIEP | SIEP - Nel provvedimento di cumulo - nota accompagnamento autorità destinatarie mancanti | TF008.SIEP | Nota accompagnamento autorità destinatarie |  |  |  | Verifica: verificare che nel template NoteDiTrasmissione.rtf siano riportati correttamente le autorità destinatarie | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.16.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220128-Allegato-al-piano-test_SIES_v.12.4.16.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIGE | 01 | Emissione Provvedimento di Rinvio Udienza da Verbale in caso di presenza provvedimento definitorio |  | Verifica: in caso di esistenza di Provvedimento Definitorio, si può emettere un altro provvedimento (rinvio udienza o rinvio udienza da verbale) se lo stato del fascicolo è:
   Opposizione - Accoglie (fissa l'udienza) = 14
   Ricorso convertito in opposizione = 16
   Decreto Fissazione Udienza = 20
   Ricorso convertito in opposizione (Fissa Udienza) = 21 |  | 1.0 |  |  | OK |
...
|  | 1.0 | Azione | Ricercare un procedimento SIGE nello stato "Ricorso convertito in opposizione (Fissa Udienza)" |  | Visualizzazione pagina Dettaglio Procedimento SIGE |  |  |  |  |
|  | 2.0 | Navigazione | Udienze/Fissazione/Rinvio/Ruolo » Rinvio Udienza da Verbale |  | Visualizzazione pagina Rinvio Udienza da Verbale |  |  |  |  |
|  | 3.0 | Azione | Inserire i dati obbligatori nella pagina e cliccare su Conferma |  | Visualizzazione pagina Inserimento Ordinanza Rinvio Udienza da Verbale |  |  |  |  |
|  | V | Verifica | Verificare che non venga visualizzato più il messaggio bloccante: "Per il procedimento indicato è già stato emesso un provvedimento. Non è consentito emettere un nuovo provvedimento" |  |  |  |  |  |  |
| TF002.SIEP | 01 | Comunicazioni alle Procure ed agli uffici di sorveglianza in presenza di cumulo |  | Verifica: verificare che in assenza di uffici di esecuzione tra i destinatari della comunicazione del cumulo il sistema visualizza un messaggio di controllo bloccante |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Azione | Selezionare un fascicolo SIEP |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2.0 | Navigazione | Cliccare sull'icona  Gestione cumulo |  | Visualizzazione pagina  Gestione Cumulo |  |  |  |  |
|  | 3.0 | Azione | Aprire una Istruttoria di Cumulo |  | Visualizzazione pagina  Gestione Cumulo |  |  |  |  |
|  | 4.0 | Azione | Senza aggiungere ulteriori titoli procedere a chiudere il cumulo cliccando su Dati finali Cumulo, valorizzando Data Emissione e cliccando su Conferma. |  | Visualizzazione pagina Dati Finali Cumulo |  |  |  |  |
|  | 5.0 | Azione | Valorizzare "Pene rideterminate" - "posizione giuridica" - "calcolo pena". |  | Visualizzazione pagina Dati Finali Cumulo - Emissione Provvedimento |  |  |  |  |
|  | 6.0 | Azione | In fase di emissione del provvedimento indicare tra i destinatari Ufficio e Tribunale di Sorveglianza. Confermare |  | Visualizzazione pagina  Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 7.0 | Azione | Stampare e validare. |  | Visualizzazione pagina  Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 8.0 | Azione | Sul dettaglio del provvedimento validato in basso a sinistra selezionare "Comunicazioni - Uffici Esecuzione Penale/Sorveglianza". |  | Visualizzazione pagina Comunicazioni alle Procure e Uffici di Sorveglianza |  |  |  |  |
|  | 9.0 | Azione | Selezionare solo ufficio della Sorveglianza. Confermare. |  | Visualizzazione pagina  DETTAGLIO COMUNICAZIONI DI CUMULO ALLE PROCURE E UFFICI DI SORVEGLIANZA |  |  |  |  |
|  | 10.0 | Azione | Procedere alla stampa e validazione. |  | Visualizzazione pagina DETTAGLIO COMUNICAZIONI DI CUMULO ALLE PROCURE E UFFICI DI SORVEGLIANZA |  |  |  |  |
|  | 11.0 | Azione | Selezionare l'icona di trasmissione. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il messaggio visualizzato contenga la seguente frase: Il risultato atteso è il messaggio: "La trasmissione telematica è prevista solo verso gli Uffici di Esecuzione. Nessun Ufficio di Esecuzione è stato selezionato. Trasmissione non effettuata." |  |  |  |  |  |  |
| TF003.SIEP | 01 | Gestione provvedimento di cumulo emesso da altro ufficio dello stesso distretto |  | Verifica: verificare che nel caso un fascicolo di cumulo non è di competenza dell'ufficio siano inibite le funzioni segnalate nel ticket |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1.0 | Azione | Selezionare un fascicolo non archiviato. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2.0 | Navigazione | Cliccare sull'icona  Gestione cumulo |  | Visualizzazione pagina  Gestione Cumulo |  |  |  |  |
|  | 3.0 | Azione | Aprire una Istruttoria di Cumulo in cui sia presente almeno un fascicolo/titolo di altro ufficio (in assenza inserirne uno manualmente). |  | Visualizzazione pagina  Gestione Cumulo |  |  |  |  |
|  | 4.0 | Azione | Valorizzare "Pene rideterminate" - "posizione giuridica" - "calcolo pena". |  | Visualizzazione pagina Dati Finali Cumulo - Emissione Provvedimento |  |  |  |  |
|  | 5.0 | Azione | In fase di emissione del provvedimento indicare tra i destinatari Magistrato di Sorveglianza e Tribunale di Sorveglianza. Confermare |  | Visualizzazione pagina  Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 6.0 | Azione | Stampare e validare. |  | Visualizzazione pagina  Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 7.0 | Azione | Sul dettaglio selezionare  in basso a sinistra il tasto Comunicazioni-Uffici esecuzioni Penali/Sorveglianza.  Dettaglio Provvedimento Determinazione Pene Concorrenti |  | Visualizzazione pagina Comunicazioni alle Procure e Uffici di Sorveglianza |  |  |  |  |
|  | 8.0 | Azione | La form ottenuta riporta i seguenti elementi "attivi": campo Data Emissione Comunicazione, checkbox in corrispondenza dei destinatari Procura e Uffici di sorveglianza, tasto Conferma. |  |  |  |  |  |  |
|  | 9.0 | Azione | Collegarsi adesso come utente di altro ufficio dello stesso distretto | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 10.0 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 11.0 | Navigazione | Ricerche -> Procedimento |  | Visualizzazione pagina  Ricerca Procedimento |  |  |  |  |
|  | 12.0 | Azione | Ricercare il fascicolo precedentemente lavorato |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 13.0 | Azione | Selezionare elenco provvedimenti del PM e quindi il dettaglio in corrispondenza del provvedimento di cumulo. |  | Visualizzazione pagina  Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 14.0 | Azione | Selezionare nuovamente il tasto Comunicazioni-Uffici esecuzioni Penali/Sorveglianza. |  | Visualizzazione pagina  Comunicazioni alle Procure e Uffici di Sorveglianza |  |  |  |  |
|  | V | Verifica | Verificare che che nella form di dettaglio non compaia il tasto Conferma, non compaiano i campi relativi alla Data Emissione Comunicazione, non compaiano i checkbox in corrispondenza dei destinatari per i quali l'invio della comunicazione non è stato ancora effettuato. |  |  |  |  |  |  |
| TF004.SIEP | 01 | Gestione casisitica per codice motivo dell'ultimo evento uguale a 0340 nel Riepilogo Ispettivo |  | Verifica: verificare che nell'eleborazione del riepilogo ispettivo vengano considerati correttamente i procedimenti aventi codice motivo dell'ultimo evento uguale a 0340 |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1.0 | Azione | Iscrivere un procedimento di classe I (Difensore, Posizione Giuridica, Reati, Pena Complessiva, Assegnazione al Magistrato). |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2.0 | Azione | Validare il Procedimento |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3.0 | Azione | Cliccare sull'icona di Gestione Cumulo |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 4.0 | Azione | Aprire un'istruttoria di Cumulo |  | Visualizzazione pagina Apertura Istruttoria Cumulo |  |  |  |  |
|  | 5.0 | Azione | Effettuare una richiesta Atti tramite la funzione "Richiesta Trasmissione Atti" presente nella griglia delle funzioni del cumulo. |  | Visualizzazione pagina  Dettaglio Richiesta Trasmissione Atti Per Competenza |  |  |  |  |
|  | 6.0 | Azione | Validare |  | Visualizzazione pagina  Dettaglio Richiesta Trasmissione Atti Per Competenza |  |  |  |  |
|  | 7.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati |  | Visualizzazione pagina STATISTICHE - ESTRAZIONE DATI |  |  |  |  |
|  | 8.0 | Azione | Selezionare Classe I - Riepilogo Ispettivo. Confermare |  | Visualizzazione pagina STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI |  |  |  |  |
|  | 9.0 | Azione | Selezionare Tutti e Confermare. |  | Generazione file Excel |  |  |  |  |
|  | V | Verifica | Verificare che sulla scheda "Dettagli" il fascicolo sia classificato come "Procedimenti in attesa di emissione provvedimenti del PM - Attesa per Istruttoria Cumulo". |  |  |  |  |  |  |
| TF005.SIEP | 01 | Modifica template per gestire posizione giuridica 05 |  | Verifica: verificare che il template SIEP_LS_ODARI.rtf gestisca correttamente la posizione giuridica 04 oltre la 02. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Azione | Iscrivere un NUOVO fascicolo indicando come posizione giuridica "Espiazione Pena in Altro Luogo - Custodia Cautelare per questa causa in regime di Arresti Domiciliari". |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2.0 | Azione | Inserire la Pena Complessiva, il Magistrato, il Reato, il Difensore |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3.0 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 4.0 | Azione | Validare il Procedimento. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 5.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  |  |  |  |  |  |
|  | 6.0 | Azione | Eseguire il calcolo della pena |  | Visualizzazione pagina Ordine di Esecuzione con sospensione (LEGGE 165/98) |  |  |  |  |
|  | 7.0 | Azione | Emettere ordine di Esecuzione con Sospensione |  | Visualizzazione pagina Dettaglio Legge 165/98 |  |  |  |  |
|  | 8.0 | Azione | Stampare e Validare |  | Generazione stampa SIEP_LS_ODARI.rtf |  |  |  |  |
|  | V | Verifica | Il sistema modifica la posizione giuridica in PROSECUZIONE DELLA DETENZIONE IN REGIME DI ARRESTI DOMICILIARI  (ex art. 656 comma 10 c.p.p.). |  |  |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere gli step da 5 ad 8 |  | Generazione stampa SIEP_LS_ODARI.rtf |  |  |  |  |
|  | V | Verifica | Verificare che il template prodotto sia completo nelle 3 sezioni segnalate: intestazione, paragrafo "Rilevato che.. ", sezione "DISPONE ALTRESI'". |  |  |  |  |  |  |
| TF006.SIEP | 01 | Inserimento paginazione nella mappa di ricerca atti ricevuti da altre procure |  | Verifica: verificare che in presenza di molte occorrenze la funzione segnalata abbia nella ricerca dei dati tempi di risposta accettabili |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Gestione Misure Sicurezza |  | Visualizzazione pagina Misure Sicurezza |  |  |  |  |
|  | 2.0 | Azione | Selezionare Ricerca Atti Ricevuti per Competenza |  |  |  |  |  |  |
|  | V | Verifica | Verificare che si attivi la pagina di attesa e che i tempi di risposta siano "accettabili" |  |  |  |  |  |  |
| TF007.SIEP | 01 | Elaborazione statistica classe VII con occorrenze aventi stessa data scadenza |  | Verifica: verificare che l'eleborazione della statistica classe VII avvenga correttamente nel caso siano presenti più occorrenze con stessa data scadenza |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati |  | Visualizzazione pagina STATISTICHE - ESTRAZIONE DATI |  |  |  |  |
|  | 2.0 | Azione | Selezionare classe VII e il radio "Riepilogo Procedimenti Pendenti". Confermare. |  | Visualizzazione pagina RICERCA PROCEDIMENTI CLASSE VII |  |  |  |  |
|  | 3.0 | Azione | Indicare il periodo 01-01-2022 / 20-01-2022 e confermare. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non produca errore. |  |  |  |  |  |  |
| TF008.SIEP | 01 | Nota accompagnamento autorità destinatarie |  | Verifica: verificare che nel template NoteDiTrasmissione.rtf siano riportati correttamente le autorità destinatarie |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Azione | Ricercare una istruttoria cumulo aperta, selezionando l'icona IC dalla pagina principale. |  | Visualizzazione pagina Ricerca Istruttoria Cumulo |  |  |  |  |
|  | 2.0 | Azione | Verificare che tra i titoli assorbiti ve ne sia almeno uno di un ufficio esecuzione differente da quello con cui si è collegati. |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 3.0 | Azione | Cliccare sull'icona  Gestione cumulo |  | Visualizzazione pagina  Gestione Cumulo |  |  |  |  |
|  | 4.0 | Azione | In Gestione Cumulo cliccare su Dati Finali Cumulo |  | Visualizzazione pagina Dati Finali Cumulo |  |  |  |  |
|  | 5.0 | Azione | Se non presente inserire Data Emissione e cliccare su Conferma |  | Visualizzazione pagina Dati Finali Cumulo con i vari TAB |  |  |  |  |
|  | 6.0 | Azione | Inserire nei vari tab la pena rideterminata,la Posizione giuridica , procedere al calcolo pena ed infine emettere il provvedimento di unificazione di pene concorrenti. |  | Visualizzazione pagina Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 7.0 | Azione | Cliccare sull'icona di stampa. |  | Generazione stampa |  |  |  |  |
|  | V | Verifica | Verificare che sull'ultima pagina del template (NoteDiTrasmissione.rtf) vengano riportati tra i destinatari solo gli uffici (PM PGCAT) differenti da quello che sta emettendo il cumulo. |  |  |  |  |  |  |
