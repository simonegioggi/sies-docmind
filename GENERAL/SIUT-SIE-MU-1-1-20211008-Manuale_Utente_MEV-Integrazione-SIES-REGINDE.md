---
uniqueName: siut-sie-mu-1-1-20211008-manualeutentemev-integraz
displayName: "SIUT SIE MU 1 1 20211008 Manuale Utente MEV Integrazione SIES REGINDE"
category: "GENERAL"
tags: []
---

# SIUT-SIE-MU-1.1-20211008-Manuale_Utente_MEV-Integrazione SIES-REGINDE

> **File originale:** `MEV/SCHEDA_021/Docs/consegna docx/ORIGINALS/SIUT-SIE-MU-1.1-20211008-Manuale_Utente_MEV-Integrazione SIES-REGINDE.docx`  
> **Tipo:** DOCX
...
3.1.2.	Sostituzione Difensore	30
3.1.3.	Iscrizione Istanza	35
3.2.	Sottosistema SIUS	45
3.2.1.	Assegnazione Difensore	45
3.2.2.	Sostituzione Difensore	59
3.3.	Sottosistema SIGE	64
3.3.1.	Assegnazione Difensore	64
3.3.2.	Sostituzione Difensore	77
3.3.3.	Gestione Difensore su Parti Civili/Offese	82
4.	Gestione DIFENSORI in Funzioni Amministrative	89
4.1.	Eliminazione funzione Inserimento Difensore	89
4.2.	Eliminazione funzione Modifica Difensore	89
5.	Gestione Luogo Nascita Soggetto	92
5.1.	Sottosistema SIEP	92
5.2.	Sottosistema SIUS	100
5.3.	Sottosistema SIGE	101
...
| Foro | Comune Sede | Tipo di attività eseguita |
| --- | --- | --- |
...
## Iscrizione Istanza
Le funzioni di Iscrizione Istanza, selezionabili da Istanze >> Iscrizione Istanza



sono state modificate per modificare l’attuale selezione dell’avvocato dalla tabella AVVOCATO SIES alla ricerca dell’Avvocato da ReGIndE.

Di seguito si riporta la form di Iscrizione Istanza per Procedimento SIEP modificata
...
in cui, come già descritto al par. 3.1.1, è possibile effettuare la Ricerca su ReGIndE oppure, in caso di risultato nullo, effettuare la Ricerca sugli Avvocati certificati già presenti in SIES
...
da cui è possibile selezionare la funzione di Modifica


Figura 40 – Form Modifica Istanza

che è stata anch’essa modificata per consentire la nuova gestione dell’avvocato.

Nel caso che nella Maschera di Iscrizione Istanza si imposti il radio button presente su Dati Istanza su Depositata la form presenta la sezione relativa all’avvocato depositante, modificata in maniera simile a quella dell’avvocato, per consentire la ricerca dello stesso su ReGIndE, con le modalità già descritte per quest’ultimo. La form si presenta come di seguito:


Figura 41 – Form Iscrizione Istanza da Numero SIEP con istanza Depositata

Le stesse modifiche, descritte per l’iscrizione istanza da Numero SIEP, sono state apportate anche all’Iscrizione Istanza per Soggetto


Figura 42 – Form Iscrizione Istanza da Soggetto con istanza Presentata



Figura 43 – Form Iscrizione Istanza da Soggetto con istanza Depositata
...
e all’Iscrizione Istanza per Titolo Esecutivo


Figura 44 – Form Iscrizione Istanza da Titolo Esecutivo con istanza Presentata





Figura 45 – Form Iscrizione Istanza da Titolo Esecutivo con istanza Depositata
Per queste due funzionalità le modalità di ricerca del Difensore e di gestione dello stesso in fase di aggiornamento della base dati sono le stesse descritte in precedenza per l’Iscrizione Istanza da Numero SIEP.
## Sottosistema SIUS
## Assegnazione Difensore
...
Figura 46 – Form Assegnazione / Inserimento Difensore SIUS
...
Figura 47 – Popup Ricerca Difensore su ReGIndE
in cui è possibile compilare:
...
Figura 48 – Popup Ricerca Difensore su ReGIndE
Per ciascun avvocato della lista saranno riportati: Cognome, Nome, Codice Fiscale, Foro, Luogo e Data nascita, Indirizzo dello Studio, Stato. Inoltre cliccando sull’icona , presente accanto a Cognome e Nome, il sistema mostra i seguenti dati aggiuntivi (pec, telefono, fax e-mail)
...
Figura 49 – Form Assegnazione/Inserimento Avvocato SIUS
...
Figura 50 – Form Dettaglio Avvocato SIUS
...
Figura 51 – Popup Ricerca Difensore su ReGIndE con tasto per ricerca su SIES
...
Figura 52 – Form Assegnazione/Inserimento Avvocato SIUS
...
Figura 53 – Form Inserimento Avvocato SIUS non certificato ReGIndE
L’utente compila i campi della form


Figura 54 – Form Inserimento Avvocato SIUS non certificato ReGIndE compilata manualmente
...
Figura 55 – Form Dettaglio  Avvocato SIUS non certificato ReGIndE compilata manualmente
...
Figura 56 – Popup Elenco  Avvocati certificati collegati al procedimento SIEP
...
Figura 57 – Popup ricerca Avvocato su  ReGIndE in caso di SearchLimitException
...
Figura 58 – Form iniziale di Sostituzione Difensore
...
Figura 60 – Form Sostituzione Difensore SIUS compilata a seguito selezione da ricerca
...
Figura 61 – Form Dettaglio Difensore SIUS a seguito sostituzione
...
Figura 62 – Form Sostituzione per Inserimento manuale difensore non certificato
Dopo la compilazione dei campi della form, l’utente  clicca il tasto Inserimento .
...
Figura 63 – Form Assegnazione / Inserimento Difensore SIGE

infatti nella form nessun campo è digitabile, ad esclusione della combo ‘Tipo Difensore’, è possibile solo selezionare il link , che apre la popup di ricerca, o il link  . Nel primo caso si apre la popup di ricerca


Figura 64 – Popup Ricerca Difensore su ReGIndE
in cui è possibile compilare:
...
Figura 65 – Popup Ricerca Difensore su ReGIndE
Per ciascun avvocato della lista saranno riportati: Cognome, Nome, Codice Fiscale, Foro, Luogo e Data nascita, Indirizzo dello Studio, Stato. Inoltre cliccando sull’icona , presente accanto a Cognome e Nome, il sistema mostra i seguenti dati aggiuntivi (pec, telefono, fax e-mail)
...
Figura 66 – Form Assegnazione/Inserimento Avvocato SIGE
...
Figura 67 – Form Dettaglio Avvocato SIGE
...
Figura 68 – Popup Ricerca Difensore su ReGIndE con tasto per ricerca su SIES
...
Figura 69 – Form Assegnazione/Inserimento Avvocato SIGE
...
Figura 70 – Form Inserimento Avvocato SIGE non certificato ReGIndE
L’utente compila i campi della form


Figura 71 – Form Inserimento Avvocato SIGE non certificato ReGIndE compilata manualmente
...
Figura 72 – Form Dettaglio  Avvocato SIGE non certificato ReGIndE compilata manualmente
...
Figura 73 – Popup Elenco  Avvocati certificati collegati al procedimento SIEP
...
Figura 74 – Popup ricerca Avvocato su  ReGIndE in caso di SearchLimitException
...
Figura 75 – Form iniziale di Sostituzione Difensore

nella form nessun campo è digitabile, ad esclusione della combo ‘Tipo Difensore’, è possibile solo
selezionare il link , che apre la popup di ricerca


Figura 76 – Popup Ricerca Difensore su ReGIndE
...
Figura 77 – Form Sostituzione Difensore SIGE compilata a seguito selezione da ricerca
L’utente dopo aver selezionato il Tipo Difensore dalla relativa combo box , procede alla Conferma, il sistema effettua l’aggiornamento della base dati osservando le stesse regole descritte al par. 3.3.1 relativamente alla gestione dell’Avvocato, l’unica differenza è relativa all’associazione al procedimento corrente che sarà eseguita dopo che il sistema imposta la data fine validità sul record di associazione precedente.
Al termine dell’aggiornamento della base dati il sistema invierà la form di Dettaglio


Figura 78 – Form Dettaglio Difensore SIGE a seguito sostituzione

Nel caso di ricerca nulla su ReGIndE e su SIES, anche per la sostituzione è prevista la possibilità di
procedere all’inserimento manuale del Difensore, utilizzando la form


Figura 79 – Form Sostituzione per Inserimento manuale difensore non certificato
Dopo la compilazione dei campi della form, l’utente  clicca il tasto Inserimento .
...
Figura 80 – Form Modifica Difensore e Convocazione Parte Fisica
...
Figura 81 – Form Assegnazione Difensore su Parte Civile/Offesa
...
Figura 82 – Form Assegnazione Difensore su Parte Civile/Offesa a seguito ricerca su ReGIndE/SIES
...
Figura 83 – Form Dettaglio  Difensore su Parte Civile/Offesa

In caso di ricerca nulla sia su ReGIndE sia su SIES, si può procedere con l’iscrizione manuale dell’avvocato


Figura 84 – Form Inserimento Manuale  Difensore su Parte Civile/Offesa
...
Figura 85 – Menu Gestione Difensori
...
Figura 86 – Form Elenco Avvocati
...
Figura 87 – Form Dettaglio Avvocato
...
Figura 88 – Form Iscrizione Soggetto
...
Figura 89 – Popup Ricerca Comuni per Provincia
...
Figura 90 – Popup Ricerca Comune
