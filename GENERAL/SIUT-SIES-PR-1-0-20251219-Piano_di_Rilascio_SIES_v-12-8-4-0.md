---
uniqueName: siut-sies-pr-1-0-20251219-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20251219 Piano di Rilascio SIES v 12 8 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20251219-Piano_di_Rilascio_SIES_v.12.8.4.0

> **File originale:** `RILASCIO_12.8.4.0/SIUT-SIES-PR-1.0-20251219-Piano_di_Rilascio_SIES_v.12.8.4.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 19/12/2025 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.8.4.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.8.4.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- | --- | --- |
| 202511270115 | Procura della Repubblica presso il Tribunale di Torino | L’ufficio segnala che molti uffici segnalano che dopo l'ultimo aggiornamento sui template si verifica una errata compilazione delle note di accompagnamento e associazione  di note relative ai  fogli complementari non previsti. Note errate anche su alcuni procedimenti ordini di esecuzione che riportano note relative agli ordini di ingiunzione Cartabia | Per la risoluzione della problematica è stato modificato il template relativo alla Notifica agli Avvocati | Il problema era legato al fatto che mancava un controllo sul codice motivo dell'evento legato al fascicolo.
Template modificato:
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20251219-Piano_di_Rilascio_SIES_v.12.8.4.0.docx
SIUT-SIES-PT-1.0-20251219-Piano_dei_Test_SIES_v.12.8.4.0.docx
SIUT-SIES-CT-1.0-20251219-Allegato_al_piano_test_SIES_v.12.8.4.0.xlsx |
...
Alterazione in tabella “SEDE_GIUDIZIARIA”
Aggiornamento in tabella “SEDE_GIUDIZIARIA”
Aggiornamento in tabella “DETTAGLIO_PROVVEDIMENTO”
Aggiornamento in tabella “FUNZIONE_PROFILO” |
| sorgenti.zip | Sorgenti | Sorgenti software |
| template.zip | Template | import/NotificaAvvocati.rtf
...
# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.8.3.1.
...
Creare sul server DB una cartella V_12_8_4_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_8_4_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_8_4_0 tramite il comando:
chmod 777 V_12_8_4_0
...
Nella cartella appena creata (V_12_8_4_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_8_4_0/log/ in cui si può constatare l’esito dell’esecuzione.
...
Copiare i files contenuti nella cartella siep\altri
