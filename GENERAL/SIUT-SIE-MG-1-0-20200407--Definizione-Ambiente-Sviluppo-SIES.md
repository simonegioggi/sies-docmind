---
uniqueName: siut-sie-mg-1-0-20200407-definizione-ambiente-svil
displayName: "SIUT SIE MG 1 0 20200407  Definizione Ambiente Sviluppo SIES"
category: "GENERAL"
tags: []
---

# SIUT-SIE-MG-1.0-20200407- Definizione Ambiente Sviluppo SIES

> **File originale:** `Docs_CMDBuild_SIES+SIUS_Avvocati/SIUT-SIE-MG-1.0-20200407- Definizione Ambiente Sviluppo SIES.docx`  
> **Tipo:** DOCX
...
| Nominativo | Nominativo | Organizzazione | Ufficio | Funzione | Funzione |
| --- | --- | --- | --- | --- | --- |
| Ing. Giovanni Malesci | Ing. Giovanni Malesci | Amministrazione |  | Responsabile Unico Procedimento | Responsabile Unico Procedimento |
| Dr.ssa Annamaria Palmieri | Dr.ssa Annamaria Palmieri | Amministrazione |  | Direttore Esecutivo Contratto | Direttore Esecutivo Contratto |
| Paolo Ceccanti | Paolo Ceccanti | RTI |  | Responsabile Unico Fornitura | Responsabile Unico Fornitura |
| Pasquale Lamattina | Pasquale Lamattina | RTI |  | Referente Tecnico | Referente Tecnico |
| Vito Bufi | Vito Bufi | RTI |  | Responsabile Manutenzione Sistemi attuali | Responsabile Manutenzione Sistemi attuali |
| Fabio Mazzocchi | Fabio Mazzocchi | RTI |  | Responsabile Manutenzione Correttiva | Responsabile Manutenzione Correttiva |
| Andrea Salvaggio | Andrea Salvaggio | RTI |  | Responsabile Progetto Sistema Unitario | Responsabile Progetto Sistema Unitario |
| Antonio Iacobelli | Antonio Iacobelli | RTI |  | Responsabile Supporto Specialistico | Responsabile Supporto Specialistico |
| Antonella Damiani | Antonella Damiani | RTI |  | Responsabile Centro di Competenza | Responsabile Centro di Competenza |
| Fabio Gattamorta | Fabio Gattamorta | RTI |  | Responsabile PMO | Responsabile PMO |
| Alessandro Falleni | Alessandro Falleni | RTI |  | Referente sicurezza | Referente sicurezza |
| Edoardo Lamuraglia | Edoardo Lamuraglia | RTI |  | Referente qualità | Referente qualità |
| Francesco Rosati | Francesco Rosati | RTI |  | Referente qualità | Referente qualità |
| Andrea Castorino | Andrea Castorino | RTI |  | Referente Applicativo Gestore Fascicolo Documentale | Referente Applicativo Gestore Fascicolo Documentale |
...
2.	Software ambiente di sviluppo	7
2.1.	Eclipse Java EE IDE	7
2.1.1.	Configurazione del progetto siesWeb	7
2.1.2.	Configurazione del progetto siesEsecuzione	9
2.1.3.	Configurazione JDK	10
2.1.4.	Configurazione Runtime Environment	11
2.1.5.	Configurazione USER LIBRARIES	13
2.1.6.	Configurazione strumenti di delivery (es. ANT, JENKINS, MAVEN, GRADLE, etc.)	14
2.1.7.	Configurazione generale	16
2.2.	Application Server	18
2.2.1.	Configurazione librerie	18
2.2.2.	Configurazione Datasource	18
2.2.3.	Installazione report	19
2.2.4.	Configurazione applicativa	19
2.2.5.	Configurazione specifica	20
2.3.	Controllo del software	21
2.3.1.	Repository remoto	21
2.3.2.	Repository locale	21
2.3.3.	Repository Git in Eclipse	21
2.3.4.	Strumenti di lavoro	21
2.3.5.	Struttura repository	22
2.3.6.	Standard di nomenclatura e regole generali	22
3.	Compilatore e struttura di progetto	24
3.1.	Struttura del progetto	24
3.2.	Requisiti ambiente hardware di sviluppo	24
4.	Standard adottati	25
...
Il progetto siesWeb è scaricabile dal repository git come riferito nel par. 4.1 Repository remoto.
...
spostarsi nell'albero di navigazione sulla sinistra e selezionare il ramo "Project Facets";
cliccare sul link "Convert to faceted form";
...
Il progetto siesEsecuzione è scaricabile dal repository git come riferito nel par. 4.1 Repository remoto. Il progetto siesEsecuzione è un progetto Maven come riferito ne paragrafo 2.6 Configurazione strumenti di delivery (es. ANT, JENKINS, MAVEN, GRADLE, etc.).
...
selezionare nell'albero di navigazione sulla sinistra il ramo "Targeted Runtimes";
...
La cartella oracle contiene la libreria ojdbc6.jar che costituisce il driver JDBC lato client di Oracle compatibile con Java 6 e successive:
...
<datasources>
<datasource jta="true" jndi-name="java:jboss/jdbc/oracleds" pool-name="oracleds" enabled="true" use-java-context="true" use-ccm="false">
...
Nel file standalone.xml del server sono state aggiunte proprietà di sistema aggiuntive rispetto all’originale nativo del server:
...
Inoltre nella sezione “urn:jboss:domain:web:2.2” è stata aggiunta la configurazione per il connettore https, necessario per installare e configurare il supporto SSL (Secure Sockets Layer) per JBoss.
...
Se il repository locale corrisponde al workspace di Eclipse, nella prospettiva Git (selezionabile e attivabile dal menu "Window > Perspective > Open Perspective > Other…") dal pannello Git Repositories risulterà già censito il repository locale, come nell’immagine seguente:
...
master	contiene l’ultima release consegnata;
develop	contiene l’ultima release consegnata ed è il punto di partenza per gli sviluppi
...
mac-otrs-numero	per lo sviluppo delle mac, es. mac-otrs-20200220016;
MEV_numero		per lo sviluppo delle mev, es. MEV_20;
major.minor.patch	per i rilasci, es. release_12.2.1.

Il repository presenta un tag per ogni consegna effettuata, nel formato:
major.minor.patch	es. VERSIONE_SIES_12.0.0.
