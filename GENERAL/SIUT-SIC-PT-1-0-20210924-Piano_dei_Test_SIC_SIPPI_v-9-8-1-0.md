---
uniqueName: siut-sic-pt-1-0-20210924-pianodeitestsicsippiv-9-8
displayName: "SIUT SIC PT 1 0 20210924 Piano dei Test SIC SIPPI v 9 8 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIC-PT-1.0-20210924-Piano_dei_Test_SIC_SIPPI_v.9.8.1.0

> **File originale:** `RILASCIO_9.8.1.0_SIPPI/SIUT-SIC-PT-1.0-20210924-Piano_dei_Test_SIC_SIPPI_v.9.8.1.0.docx`  
> **Tipo:** DOCX
...
# Introduzione
## Scopo del documento
Il presente documento descrive il piano dei test per la verifica della risoluzione dei ticket indicati nel piano di rilascio: SIUT-SIC-PR-1.0-20210924-Piano_di_Rilascio_SIC_SIPPI_v.9.8.1.0.docx
## Riferimenti
| Riferimento | Nome Documento | Descrizione Documento |
| --- | --- | --- |
| RIF1 | SIUT-SIC-PR-1.0-20210924-Piano_di_Rilascio_SIC_SIPPI_v.9.8.1.0.docx | Il documento riporta l’elenco delle funzionalità modificate con gli interventi eseguiti dal servizio di manutenzione forniti con il presente rilascio.
Riporta inoltre le modalità di installazione degli aggiornamenti in ambiente di esercizio. |
| RIF2 | SIUT-SIC-CT-1.0-20210924-Allegato_al_piano_test_SIC_SIPPI_v.9.8.1.0.xls | Il documento riporta l'elenco dei test eseguiti per la verifica della risoluzione delle anomalie |
...
## Entità da testare
L'entità oggetto di verifica è la componente SIPPI (di SIC/NSC) relativamente alle funzionalità oggetto dei ticket indicati nel piano di rilascio SIUT-SIC-PR-1.0-20210924-Piano_di_Rilascio_SIC_SIPPI_v.9.8.1.0.docx. In particolare, per il ticket 20210831011 è propedeutico aver eseguito anche il piano di rilascio SIUT-SIES-PR-1.0-20210924-Piano_di_Rilascio_SIES_v.12.4.13.0.docx.
...
I test sono eseguiti secondo quanto descritto nella relativa scheda contenuta nel documento SIUT-SIC-CT-1.0-20210924-Allegato_al_piano_test_SIC_SIPPI_v.9.8.1.0.xls. In particolare, è stata compilata la colonna ‘Esito’ per indicare l'esito del test.
...
La descrizione di dettaglio di ciascun caso di test è contenuta nel documento SIUT-SIC-CT-1.0-20210924-Allegato_al_piano_test_SIC_SIPPI_v.9.8.1.0.xls  a complemento del presente piano dei test.
In particolare:
