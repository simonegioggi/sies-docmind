---
uniqueName: siut-sies-pr-1-0-20201127-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20201127 Piano di Rilascio SIES v 12 4 5 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20201127-Piano_di_Rilascio_SIES_v.12.4.5.0

> **File originale:** `RILASCIO_12.4.5.0/SIUT-SIES-PR-1.0-20201127-Piano_di_Rilascio_SIES_v.12.4.5.0.doc`  
> **Tipo:** DOC
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.4.5.0 di SIES.
...
Il presente documento descrive il piano di rilascio di SIES 12.4.5.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
L’utente segnala la presenza di carattere non standard nel template allegato (“SIEP_RINVIO_PROV_DET_SCARC.rtf”)

Per la risoluzione della problematica si è intervenuti con la sostituzione del carattere “Calibri” con quello “Times New Roman” nel template “SIEP_RINVIO_PROV_DET_SCARC.rtf”

Aggiornato il template SIEP_RINVIO_PROV_DET_SCARC.rtf



20201106019 (collegato al 202011180111)

Ufficio di Sorveglianza di Frosinone

L’utente segnala il malfunzionamento per il procedimento di tribunale di sorveglianza in cui, pur in assenza di altri titoli esecutivi assegnati al numero sius oltre a quello su cui si è incardinato il procedimento, al momento della trasmissione telematica dell’ordinanza depositata, risultano due procure/procure generali - con i rispettivi siep - a cui poter trasmettere (già flaggati), di cui uno solo corretto e l’altro riguardante, alla verifica, un nominativo completamente diverso da quello del procedimento in corso

L’anomalia è determinata dal fatto che quando si modificava il fascicolo sius, in talune casistiche, veniva aggiornato l’anno del generale procedimento con l’anno corrente (nel database: GENERALE_PROCEDIMENTO.ANNO_S1)

La correzione ha coinvolto la classe: “siap.sius.fascicolo.action.ActModificaFascicolo” in cui quando si modificava il fascicolo SIUS con uno stato diverso da ‘01’ - Archiviato/Definito, ‘05’ - Unificato o ‘07’ - Emesso Provvedimento, il sistema aggiornava erroneamente l'anno del generale procedimento con l’anno corrente
...
L’utente segnala che nel cumulo le note riportano una data errata e casellario locale errato

Per la risoluzione della problematica si è intervenuti sulla rettifica del template “NoteDiTrasmissione.rtf”

Aggiornato il template “NoteDiTrasmissione.rtf” che aveva come casellario di riferimento, il valore fisso del casellario di Roma e come data di riferimento, la data di emissione



202011180111 (collegato al 20201106019)

Ufficio di Sorveglianza di Frosinone

L’utente segnala un malfunzionamento su  fascicolo sius che aggancia al momento del deposito ordinanza un altro titolo legato ad un Siep di altra sede che non ha nulla a che vedere con esso
...
SIEP_RINVIO_PROV_DET_SCARC.rtf

documentazione.zip

Documentazione

SIUT-SIES-PR-1.0-20201127-Piano_di_Rilascio_SIES_v.12.4.5.0.doc

SIUT-SIES-PT-1.0-20201127-Piano_dei_Test_SIES_v.12.4.5.0.doc

SIUT-SIES-CT-1.0-20201127-Allegato_al_piano_test_SIES_v.12.4.5.0.xls
...
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.4.4.0.
...
Creare sul server DB una cartella V_12_4_5_0 sotto la directory /home/oracle/;

Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_4_5_0/;

Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_4_5_0 tramite il comando:

chmod 777 V_12_4_5_0
...
Nella cartella appena creata (V_12_4_5_0), lanciare il comando:

./aggiorna_db.sh

Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_4_5_0/log/ in cui si può constatare l’esito dell’esecuzione.
...
Copiare i file contenuti nella cartella template\siep\rinvio

nella cartella “/var/SIES/template/siep/rinvio” sovrascrivendo quelli precedenti;
