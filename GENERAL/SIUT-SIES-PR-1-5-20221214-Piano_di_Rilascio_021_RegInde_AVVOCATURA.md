---
uniqueName: siut-sies-pr-1-5-20221214-pianodirilascio021regind
displayName: "SIUT SIES PR 1 5 20221214 Piano di Rilascio 021 RegInde AVVOCATURA"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.5-20221214-Piano_di_Rilascio_021_RegInde_AVVOCATURA

> **File originale:** `MEV/SCHEDA_021/Docs/SIUT-SIES-PR-1.5-20221214-Piano_di_Rilascio_021_RegInde_AVVOCATURA.docx`  
> **Tipo:** DOCX
...
| 1.3 | 26/10/2022 | Quarta Emissione | Rivista intera struttura del documento |
| 1.4 | 25/11/2022 | Quinta Emissione | Rivista intera struttura del documento |
| 1.5 | 14/12/2022 | Sesta Emissione | Aggiunto par. 6.1.1 e modificato par. 6.4.1 |
...
6.	Installazione	10
6.1	Prerequisiti	10
6.1.1	Attività di preinstallazione	10
6.2	Procedura di Aggiornamento Tabella SIUS-Avvocati da Tabella fissa DGSIA	10
6.2.1	Attività di installazione ed esecuzione procedura batch Aggiornamento Tabella SIUS-Avvocati da Tabella fissa DGSIA	10
...
Modifica Strutturale delle Tabelle “COMUNI” e “STATI”
Creazione e popolamento della Tabella “COMUNE_TF”
Aggiornamento Tabella “COMUNI” e “STATI”
Procedura di salvataggio delle tabelle “COMUNI”, “STATI” |
| documentazione_AVVOCATURA.zip | Documentazione | SIUT-SIES-PR-1.5-20221214-Piano_di_Rilascio_021_RegInde_AVVOCATURA.pdf
...
Le attività descritte indicano i passi necessari all’allineamento delle tabelle SIES-AVVOCATURA COMUNI ed STATI, e sono preliminari alle attività di installazione del software relativo alla MEV 021_2019 RegInde di SIES.
...
## Attività di installazione ed esecuzione procedura batch Aggiornamento Tabella SIUS-Avvocati da Tabella fissa DGSIA
...
Copiare il contenuto della cartella aggiorna_db_AVVOCATURA nella cartella /home/oracle/MEV-2019_21_AVVOCATURA/.
...
Nome ....................: avvsies
==================================================
SID Oracle ........................: avvsiessid
Utente_AVVSIES .............: avvsiesuser
Password_ AVVSIES .........: avvsiespwd
...
Di seguito le attività da eseguire per l’aggiornamento delle tabelle COMUNI e STATI alle tabelle fisse COMUNE e STATO-NAZIONE fornite dalla DGSIA.
## STEP 1
...
Dettaglio del file:
XAT_SALVA_TABELLE_AVVOCATURA.prc = Crea e compila la procedure XAT_SALVA_TABELLE_ AVVOCATURA, che esegue una copia di backup delle tabelle COMUNI e STATI nelle tabelle COMUNI_SXALLTF e STATI_SXALLTF.
ALTER_COMUNI_STATI_AVVOCATURA.sql = lo script .sql aggiunge all’attuale struttura della tabella COMUNI le nuove colonne COD_CATASTALE_COMUNE, DATA_AGGIORNAMENTO_COMUNE e DATA_FINE_VALIDITA_COMUNE; aggiunge all’attuale struttura della tabella STATI le nuove colonne COD_STATO_ISO, COD_ISTAT_STATO, COD_CATASTALE e DATA_FINE_VALIDITA.
CREA_COMUNE_TF.sql = lo script crea la tabella COMUNE_TF che conterrà i Comuni importati dalla tabella COMUNE di Tabelle Fisse, operazione già effettuata per l’aggiornamento di SIES.
INSERT_COMUNE_TF.sql = lo script carica la tabella COMUNE_TF con i records estratti dalla omonima tabella di SIES.
AGGIORNA_COMUNI_AVVOCATURA.prc = La procedure effettua l’aggiornamento della tabella COMUNI in base al contenuto della tabella COMUNE_TF, aggiornando  i preesistenti records e inserendo quelli inesistenti.
AGGIORNA_STATI_AVVOCATURA.sql = Lo script cancella i records dalla tabella STATI e la ricarica con quelli estratti dal dominio NAZIONE di SIES.
...
Attenzione!! Prima di avviare il server jboss assicurarsi di aver cancellato gli elementi già esistenti seguendo le istruzioni ai punti 2.b e 2.d. All’avvio, infatti, tali cartelle verranno ricreate.
