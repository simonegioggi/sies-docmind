---
uniqueName: siut-sies-ct-1-0-20201012-allegato-al-piano-testsi
displayName: "SIUT SIES CT 1 0 20201012 Allegato al piano test SIES v 12 4 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0

> **File originale:** `RILASCIO_12.4.3.0/SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20201012-Piano_dei_Test_SIES_v.12.4.3.0.docx |
|  | Versione | 1.0 |
|  | Data | 44116.0 |
|  | Intervento | SIES v.12.4.3.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.3.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20200902016.0 |  |  | 20200902016.0 | Richiesta accertamento pericolosità |  | SIEP | SIEP - Richiesta accertamento pericolosità | TF001.SIEP | Verifica assenza obbligatorietà avvocato in caso di trasmissione richiesta per Accertamento di Pericolosità Sociale |  |  |  | Verifica: verificare che nel caso di trasmissione di una richiesta per Accertamento Pericolosità Sociale,  il sistema non imponga l'obbligatorietà dell'inserimento del difensore | 1.0 |  |  |  |  |
| SIUT | SIES | 20200915015.0 |  |  | 20200915015.0 | Impossibilità di trasferire Procedimenti SIEP sul DB SIUS |  | SIEP | SIEP - Impossibilità di trasferire Procedimenti SIEP sul DB SIUS | TF002.SIEP | Verifica che un fascicolo di classe 7 con fascicolo origine in classe 1 venga correttamente trasferito da un distretto ad un altro. |  |  |  | Verifica: Verificare che che un fascicolo di classe 7 con fascicolo origine in classe 1 venga correttamente trasferito da un distretto ad un altro e che il distretto destinatario riesca a prendere correttamente in carico il fascicolo. | 1.0 |  |  |  |  |
| SIUT | SIES | 20200915014.0 |  |  | 20200915014.0 | Procura |  | SIES | SIES - Procura | TF003.SIES | Verifica trasferimento tra due Distretti di un fascicolo relativo a soggetto con posizione giuridica 'Altra Causa'. |  |  |  | Verifica: Verificare che  il Trasferimento tra due Distretti di un fascicolo  relativo a soggetto con posizione giuridica 'Altra Causa' avvenga correttamente. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.3.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica assenza obbligatorietà avvocato in caso di trasmissione richiesta per Accertamento di Pericolosità Sociale |  | Verifica: verificare che nel caso di trasmissione di una richiesta per Accertamento Pericolosità Sociale,  il sistema non imponga l'obbligatorietà dell'inserimento del difensore |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Iscrivere un procedimento di classe IV in cui non è presente il difensore ma la Posizione Giuridica - Libero e la Misura di sicurezza (es: non detentiva - Espulsione) |  |  |  |  |  |  |
|  | 2 | Azione | Nella pagina di dettaglio, nel menù orizzontale a tendina, selezionare la voce Assegnazione Procedimento al Magistrato, assegnare e successivamente validare il procedimento stesso |  | Visualizzazione pagina Dettaglio Procedimento con stato procedimento a Validato |  |  |  |  |
|  | 3 | Navigazione | Gestione Misure di sicurezza |  | Visualizzazione pagina Misure Sicurezza |  |  |  |  |
|  | 4 | Azione | Cliccare su Richiesta Accertamento Pericolosità Sociale |  | Visualizzazione pagina Richiesta Accertamento Pericolosità Sociale |  |  |  |  |
|  | 5 | Azione | Completare i campi indicando come destinatari un Magistrato di sorveglianza dello stesso distretto e procedere a stampa e validazione del provvedimento. |  | Visualizzazione pagina Dettaglio Richiesta Accertamento Pericolosità Sociale |  |  |  |  |
|  | 6 | Azione | Selezionare l'icona di trasmissione. |  | Visualizzazione pagina  Trasferimento Richiesta Accertamento pericolosità Sociale |  |  |  |  |
|  | 7 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina Conferma Trasmissione Richiesta Accertamento pericolosita sociale |  |  |  |  |
|  | 8 | Azione | Selezionare il tasto 'Conferma Trasmissione' |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non prospetti più il messaggio bloccante 'Nessun avvocato associato al fascicolo' ma il messaggio 'Trasmissione Provvedimento sottomessa al Sistema!' |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica che un fascicolo di classe 7 con fascicolo origine in classe 1 venga correttamente trasferito da un distretto ad un altro. |  | Verifica: Verificare che che un fascicolo di classe 7 con fascicolo origine in classe 1 venga correttamente trasferito da un distretto ad un altro e che il distretto destinatario riesca a prendere correttamente in carico il fascicolo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
Per ognuna di queste voci inserire le informazioni obbligatorie. In particolare nella Pena complessiva indicare un importo sulla multa. |  | Visualizzazione pagine delle singole voci selezionate |  |  |  |  |
...
|  | 5 | Navigazione | Assegnazioni - Calcolo Pena |  | Visualizzazione pagina  Calcolo Pena |  |  |  |  |
|  | 6 | Navigazione | Gestione Altre sanzioni -> Conversione Pene Pecuniarie -> Iscrizione Procedimento |  | Visualizazione pagina Iscrizione Richiesta Conversione |  |  |  |  |
|  | 7 | Azione | Compilare i dati in maschera e confermare |  | Visualizazzione pagina Dettaglio Richiesta Conversione |  |  |  |  |
|  | 8 | Azione | Verrà creato un fascicolo di classe 7. Annotare il numero. |  |  |  |  |  |  |
|  | 9 | Azione | Collegarsi come utente Ufficio di Sorveglianza di un ufficio di altro distretto | Exxxxx (Tribunale di Sorveglianza ) |  |  |  |  |  |
|  | 10 | Navigazione | Ricerche Altre BDI -> Ricerca fascicolo SIEP altre BDI |  | Visualizzazione pagina  Ricerca Procedimento |  |  |  |  |
|  | 11 | Azione | Digitare gli estremi del Fascicolo di classe 7 precedentemente creato e confermare. |  | Visualizzazione messaggio "Richiesta di ricerca Procedimento sottomessa al Sistema!" |  |  |  |  |
|  | 12 | Azione | Premere OK |  | Visualizzazione pagina Dettaglio Procedimento da Trasferire |  |  |  |  |
|  | 13 | Azione | Selezionare il pulsante Conferma Trasferimento Procedimento |  |  |  |  |  |  |
|  | V | Verifica | Verificare  che il sistema confermi la corretta acquisizione del fascicolo di classe 7. |  |  |  |  |  |  |
| TF003.SIES | 01 | Verifica trasferimento tra due Distretti di un fascicolo relativo a soggetto con posizione giuridica 'Altra Causa'. |  | Verifica: Verificare che  il Trasferimento tra due Distretti di un fascicolo  relativo a soggetto con posizione giuridica 'Altra Causa' avvenga correttamente. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
Pena Complessiva, 
Assegnazione al magistrato.
Per ognuna di queste voci inserire le informazioni obbligatorie. In particolare nella voce Posizione Giuridica indicare Libero Detenuto altra causa. |  | Visualizzazione pagine delle singole voci selezionate |  |  |  |  |
|  | 3 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 4 | Azione | Indicare il procedimento da validare e cliccare su Conferma |  | Visualizzazione pagina Dettaglio Procedimento con stato procedimento a Validato |  |  |  |  |
|  | 5 | Navigazione | Assegnazioni - Calcolo Pena |  | Visualizzazione pagina Calcolo Pena |  |  |  |  |
|  | 6 | Azione | Collegarsi come utente di Procura di altro distretto | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 7 | Navigazione | Ricerche - Procedimento |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 8 | Azione | Effettuare la ricerca del procedimento inserito dall'altro distretto |  | Visualizazione messaggio Richiesta di ricerca Procedimento sottomessa al Sistema! |  |  |  |  |
|  | 9 | Azione | Cliccare su OK |  | Visualizzazione pagina Dettaglio Procedimento da Trasferire |  |  |  |  |
|  | 10 | Azione | Selezionare il pulsante Conferma Trasferimento Procedimento |  | Il sistema acquaisisce correttamente il procedimento. |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere i passi da 7 a 10 |  |  |  |  |  |  |
|  | V | Verifica | Verificare che Il sistema riesca ad acquisire nuovamente il procedimento senza andare in errore. |  |  |  |  |  |  |
