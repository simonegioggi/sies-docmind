---
uniqueName: siut-sies-ct-1-0-20220422-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220422 Allegato al piano test SIES v 12 4 19 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220422-Allegato_al_piano_test_SIES_v.12.4.19.0

> **File originale:** `RILASCIO_12.4.19.0/SIUT-SIES-CT-1.0-20220422-Allegato_al_piano_test_SIES_v.12.4.19.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220422-Allegato_al_piano_test_SIES_v.12.4.19.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220422-Piano_dei_Test_SIES_v.12.4.19.0.docx |
|  | Versione | 1.0 |
|  | Data | 44673.0 |
|  | Intervento | SIES v.12.4.19.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.19.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220422-Allegato_al_piano_test_SIES_v.12.4.19.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220323018.0 |  |  | 20220323018.0 | correzione template - SIEP_LS_ODARI |  | SIEP | SIEP - correzione template - SIEP_LS_ODARI | TF001.SIEP | Mancato calcolo residuo della pena nel template. |  |  |  | Verifica: verificare che nel template "SIEP_LS_ODARI" sia correttamente effettuato il calcolo della pena residua. | 1.0 |  |  |  |  |
| SIUT | SIES | 202203250112.0 |  |  | 202203250112.0 | Impossibilità deposito ordinanza |  | SIUS | SIUS - Impossibilità deposito ordinanza | TF001.SIUS | Mancato deposito dell'ordinanza. |  |  |  | Verifica: verificare che il sistema consenta di validare e depositare l'ordinanza di Programma di Trattamento. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220329015.0 |  |  | 20220329015.0 | SIUS |  | SIUS | SIUS - SIUS | TF002.SIUS | Mancato trasferimento del foglio complementare. |  |  |  | Verifica: verificare che il sistema consenta il trasferimento verso il Casellario dei fogli complementari relativi ai procedimenti di riduzione pena da espiare, ovvero risarcimento danni ex art. 35 ter O.P. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220331017.0 |  |  | 20220331017.0 | SIUS - Sorveglianza Minorenni Milano - Presa in carico atti pervenuti --> Ricerca per Atti - SIUS |  | SIUS | SIUS - SIUS - Sorveglianza Minorenni Milano - Presa in carico atti pervenuti --> Ricerca per Atti - SIUS | TF003.SIUS | Errore nella presa in carico di un procedimento da altra BDI. |  |  |  | Verifica: verificare che il sistema consenta di prendere in carico il procedimento dalla base dati mittente a quella destinataria. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220404012.0 |  |  | 20220404012.0 | Misure sicurezza mancata visualizzazione provvedimento sorveglianza |  | SIEP | SIEP - Misure sicurezza mancata visualizzazione provvedimento sorveglianza | TF002.SIEP | Mancata visualizzazione nel provvedimento della sorveglianza delle Misure di sicurezza. |  |  |  | Verifica: verificare che le misure di sicurezza siano visualizzate nel provvedimento della sorveglianza. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.19.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220422-Allegato_al_piano_test_SIES_v.12.4.19.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Mancato calcolo residuo della pena nel template. |  | Verifica: verificare che nel template "SIEP_LS_ODARI" sia correttamente effettuato il calcolo della pena residua. |  | 1.0 |  |  | OK |
...
|  | 1.0 | Navigazione | Iscrizione » Soggetto |  | Visualizzazione pagina "Inserimento Soggetto" |  |  |  |  |
|  | 2.0 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina "Inserimento Sentenza" |  |  |  |  |
|  | 3.0 | Navigazione | Iscrizione » Assegnazione N° SIEP |  | Visualizzazione pagina "Inserimento Procedimento" |  |  |  |  |
|  | 4.0 | Navigazione | Aggiornamento Posizione Giuridica |  | Visualizzazione pagina "Inserimento Posizione Giuridica" |  |  |  |  |
|  | 5.0 | Azione | Selezionare la voce "Espiazione Pena in Altro Luogo" e scegliere una tra le seguenti voci: "Custodia Cautelare per Questa Causa in Regime di Arresti Domiciliare ex art 89 dpr 309/90"; "Custodia Cautelare per Questa Causa in Regime di Permanenza in Casa"; "Custodia Cautelare per Questa Causa in Collocamento in Comunità"; inserire una "Data di Decorrenza Pena" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Posizione Giuridica" |  |  |  |  |
|  | 6.0 | Navigazione | Validazione Procedimento | Selezionare il procedimento corrente | Visulizzazione pagina "Validazione Procedimento" |  |  |  |  |
|  | 7.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione | Effettuare il calcolo della pena | Visualizzazione pagina "Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO Custodia Cautelare per Questa Causa in Regime di Permanenza in Casa" |  |  |  |  |
|  | 8.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Legge 165/98 Arresti Domiciliari" |  |  |  |  |
|  | 9.0 | Azione | Premere il tasto "Generazione Stampa" |  | Download file .rtf "SIEP_LS_ODARI" |  |  |  |  |
|  | V | Verifica | Verificare che nel documento di stampa, nella sezione "CONSIDERATO", venga riportata la pena residua alla data della stampa e non la pena che il condannato deve scontare. |  |  |  |  |  |  |
| TF001.SIUS | 01 | Mancato deposito dell'ordinanza. |  | Verifica: verificare che il sistema consenta di validare e depositare l'ordinanza di Programma di Trattamento. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti con contenuto "Programma di Trattamento (Non Semilibero)", collegandolo ad un procedimento SIEP |  |  |  |  |  |
|  | 1.0 | Navigazione | Ordinanze » Emissione Ordinanza |  | Visualizzazione pagina "Emissione Ordinanza" |  |  |  |  |
|  | 2.0 | Azione | Inseririe una "Data Emissione" e premere il tasto "Conferma" |  | Visualizzazione pagina "Emissione Ordinanza Generica" |  |  |  |  |
|  | 3.0 | Azione | Inserire un esito e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 4.0 | Azione | Premere il tasto "Generazione Stampa" o "Upload Stampa", spuntare il checkbox "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | V | Verifica | Verificare che il sistema produca il documento di stampa .rtf e permetta la validazione dell'ordinanza stessa |  |  |  |  |  |  |
| TF002.SIUS | 02 | Mancato trasferimento del foglio complementare. |  | Verifica: verificare che il sistema consenta il trasferimento verso il Casellario dei fogli complementari relativi ai procedimenti di riduzione pena da espiare, ovvero risarcimento danni ex art. 35 ter O.P. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 3.0 | Azione | Inserire un esito e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza Rimedi Risarcitori Violazione Art.3 CEDU" |  |  |  |  |
...
|  | 8.0 | Azione | Tornare nella pagina di "Dettaglio Procedimento SIUS" e dal menù orizzontale a tendina scegliere la voce "Compilazione Foglio Complementare" |  | Visualizzazione pagina "Compilazione Foglio Complementare" |  |  |  |  |
|  | 9.0 | Azione | Premere il tasto "Compilazione Foglio Complementare" nella colonna "Azioni" |  | Visualizzazione pagina "Dettaglio Foglio Complementare" |  |  |  |  |
|  | 10.0 | Azione | Premere il tasto "Trasmissione Foglio Complementare al SIC" |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la trasmissione abbia esito positivo |  |  |  |  |  |  |
| TF003.SIUS | 03 | Errore nella presa in carico di un procedimento da altra BDI. |  | Verifica: verificare che il sistema consenta di prendere in carico il procedimento dalla base dati mittente a quella destinataria. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIUS come "Tribunale di Sorvglianza" su un distretto diverso dal proprio (es. Palermo) | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti con contenuto "Concessione Misure Alternative alla Detenzione", collegandolo ad un procedimento SIEP |  |  |  |  |  |
|  | 1.0 | Azione | Emettere, validare e depositare una Ordinanza di "Concessione Misure Alternative alla Detenzione" | Come da riga 31 a 37 | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | 2.0 | Azione | Tornare nella pagina di "Dettaglio Procedimento SIUS" e dal menù orizzontale a tendina scegliere la voce "Deassegnazione Titolo Esecutivo" |  | Visualizzazione pagina "Deassegnazione Titolo Esecutivo Principale" |  |  |  |  |
|  | 3.0 | Azione | Selezionare la voce "Selezionare la seguente casella di controllo" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 4.0 | Azione | Tornare nella pagina di dettaglio deposito ordinanza e trasmettere il provvedimento all'Ufficio di Sorveglianza (es. Torino) |  | Visualizzazione pagina "Trasferimento Ordinanza" |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIUS come "Ufficio di Sorvglianza" | Exxxxx (Ufficio di Sorveglianza) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 5.0 | Navigazione | Presa in carico atti pervenuti » Ricerca per Atti - SIUS |  | Visualizzazione pagina "Lista Atti ricevuti" |  |  |  |  |
|  | 6.0 | Azione | Cercare il procedimento tramesso in precedenza e dalla colonna "Azioni" premere sull'icona "Dettagli" |  | Visualizzazione pagina "Dettaglio Ordinanza Ricevuta" |  |  |  |  |
|  | 7.0 | Azione | Premere il tasto "Conferma presa in Carico" | Dare OK alla popup che si presenta | Visualizzazione pagina "Presa in carico atto pervenuto da SIUS" |  |  |  |  |
|  | V | Verifica | Verificare che la presa in carico sia andata a buon fine e che sia possibile iscrivere un nuovo procedimento |  |  |  |  |  |  |
| TF002.SIEP | 02 | Mancata visualizzazione nel provvedimento della sorveglianza delle Misure di sicurezza. |  | Verifica: verificare che le misure di sicurezza siano visualizzate nel provvedimento della sorveglianza. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario per i Minorenni" | Bxxxxx (Procura della Repubblica Presso il Tribunale Ordinario per i MInorenni) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti di Classe IV e prendere nota di anno e numero fascicolo SIEP |  |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Iscrizione Manuale » Ricerca Titolo Esecutivo per Numero SIEP | Ricercare il fascicolo SIEP di classe IV annotato in precedenza | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 2.0 | Azione | Iscrivere una fascicolo con contenuto "Riesame pericolosita' sociale" ed oggetto "Riesame pericolosita' sociale (art 208/1 C.P.)". Procedere ad emettere Ordinanza con esito "Dichiara cessata la pericolosità sociale e revoca la misura". Validare e depositare. | Come da riga 31 a 37 | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario per i Minorenni" | Bxxxxx (Procura della Repubblica Presso il Tribunale Ordinario per i MInorenni) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 3 | Navigazione | Ricerche » Ricerca Procedimento | Ricercare il fascicolo SIEP di classe IV annotato in precedenza | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 4 | Navigazione | Gestione Misure Sicurezza » Definizione Procedimento - Archiviazione per Provvedimento Sorveglianza |  | Visualizzazione pagina "Definizione Procedimento - Archiviazione per Provvedimento della Sorveglianza" |  |  |  |  |
|  | 5.0 | Azione | Cliccare sul link "Seleziona provvedimento di Sorveglianza dalla lista" |  | Visualizzazione popup "Elenco Provvedimenti della Sorveglianza" |  |  |  |  |
|  | V | Verifica | Verificare che venga visualizzata la popup riportante il provvedimento della sorveglianza "Riesame pericolosita' sociale (art 208/1 C.P.)" con esito "Dichiara cessata la pericolosità sociale e revoca la misura" |  |  |  |  |  |  |
