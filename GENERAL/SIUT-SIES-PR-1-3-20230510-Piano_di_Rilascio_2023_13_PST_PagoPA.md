---
uniqueName: siut-sies-pr-1-3-20230510-pianodirilascio202313pst
displayName: "SIUT SIES PR 1 3 20230510 Piano di Rilascio 2023 13 PST PagoPA"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.3-20230510-Piano_di_Rilascio_2023_13_PST_PagoPA

> **File originale:** `MEV/SCHEDA_013/SIUT-SIES-PR-1.3-20230510-Piano_di_Rilascio_2023_13_PST_PagoPA.docx`  
> **Tipo:** DOCX
...
| 1.3 | 10/05/2023 | Quarta Emissione | Modificato il paragrafo Deploy Applicazione (nella parte riguardante il file f3b.properties) ed aggiornati alcuni riferimenti documentali |
...
| --- | --- | --- |
| RIF1. | SIUT-SIES-SC-1.5-20230510-Scheda_Intervento_2023_13_PST_PagoPA | Scheda Intervento |
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 07 - MEV > Scheda 2023_13 - PagoPa > 05_Verifica di Conformita' | 1.3 | 10/05/2023 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- |
| - | SIUT-SIES-SC-1.5-20230510-Scheda_Intervento_2023_13_PST_PagoPA | - | Integrazione del SIES con PST_PagoPA |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.3-20230510-Piano_di_Rilascio_2023_13_PST_PagoPA.pdf
SIUT-SIES-CT-1.0-20230327-Allegato_al_piano_test_2023_13_PST_PagoPA.xlsx
SIUT-SIES-PT-1.0-20230327-Piano_dei_Test_2023_13_PST_PagoPA.pdf
SIUT-SIES-MU-1.0-20230327-Manuale_Utente_2023_13_PST_PagoPA.pdf
SIUT-SIES-ML-1.9-20230510-Modello_dei_Dati_2023_13_PST_PagoPA.pdf |
...
GENERATIDAGIORNI indica il numero di giorni che determinerà l’intervallo di tempo da considerare per selezionare i bollettini da verificare. La condizione è la seguente:
or (data_scadenza IS NULL and data_generazione_bollettino >= (sysdate - generatiDaGiorni) )
Se, quindi, il valore di generatiDaGiorni è uguale ad 8, si prenderanno in considerazione tutti i bollettini che sono stati generati negli ultimi otto giorni e per i quali non è disponibile la data di scadenza.
Il valore iniziale sarà settato per default ad 8.
