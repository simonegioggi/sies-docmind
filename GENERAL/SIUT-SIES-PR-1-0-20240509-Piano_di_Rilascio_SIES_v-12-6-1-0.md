---
uniqueName: siut-sies-pr-1-0-20240509-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20240509 Piano di Rilascio SIES v 12 6 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20240509-Piano_di_Rilascio_SIES_v.12.6.1.0

> **File originale:** `RILASCIO_12.6.1.0/SIUT-SIES-PR-1.0-20240509-Piano_di_Rilascio_SIES_v.12.6.1.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 09/05/2024 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.6.1.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.6.1.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.6.1.0 2024-05-09 | 12.6.1.0 | 09/05/2024 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 20240228011 | Procura della Repubblica presso il Tribunale di Parma (BO) | L’ufficio segnala che su un fascicolo appare il messaggio “impossibile ricostruire la pena da espiare” | Per la risoluzione della problematica è stata corretta la gestione della pena residua in fase di inserimento cumulo | Il problema era legato al fatto che in fase di iscrizione di una richiesta conversione pena pecuniaria su un fascicolo di classe VII la classe controller sganciava la pena residua dell'evento precedente ed inoltre inseriva una pena complessiva inutile.
Classe modificata:
siap.siep.penapecuniaria.controller.ExInserisciRichiestaConversione.java |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20240509-Piano_di_Rilascio_SIES_v.12.6.1.0.docx
SIUT-SIES-PT-1.0-20240509-Piano_dei_Test_SIES_v.12.6.1.0.docx
SIUT-SIES-CT-1.0-20240509-Allegato_al_piano_test_SIES_v.12.6.1.0.xlsx |
...
# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.6.0.0.
...
Creare sul server DB una cartella V_12_6_1_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_6_1_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_6_1_0 tramite il comando:
chmod 777 V_12_6_1_0
...
Nella cartella appena creata (V_12_6_1_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_6_1_0/log/ in cui si può constatare l’esito dell’esecuzione.
