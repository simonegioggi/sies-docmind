---
uniqueName: siut-sies-ct-1-0-20210428-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20210428 Allegato al piano test AVVOCATURA v 2 6 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210428-Allegato_al_piano_test_AVVOCATURA_v.2.6.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.6.0.0/SIUT-SIES-CT-1.0-20210428-Allegato_al_piano_test_AVVOCATURA_v.2.6.0.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210428-Allegato-al-piano-test_AVVOCATURA_v.2.6.0.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210428-Piano_dei_Test_AVVOCATURA_v.2.6.0.0.docx |
|  | Versione | 1.0 |
|  | Data | 44314.0 |
|  | Intervento | AVVOCATURA v.2.6.0.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA v.2.6.0.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210428-Allegato-al-piano-test_AVVOCATURA_v.2.6.0.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210416017.0 |  |  | 20210416017.0 | problema visibilità emerso nella risoluzione del ticket n. 202104120116 |  | SIUS | SIUS - problema visibilità emerso nella risoluzione del ticket n. 202104120116 | TF001.SIUS | Verifica visualizzazione Data Deposito per provvedimento depositato e validato. |  |  |  | Verifica: verificare che  quando viene popolato l’elenco dei procedimenti del soggetto venga impostata la “Data Deposito” solo se il provvedimento è stato depositato e validato. | 1.0 |  |  |  |  |
| SIUT | SIES | 202104270113.0 |  |  | 202104270113.0 | sius-avvocati 2.6.0.0 Visualizzazione decreto - URGENTE |  | SIUS | SIUS -  sius-avvocati 2.6.0.0 Visualizzazione decreto - URGENTE | TF002.SIUS | Verifica visualizzazione coerente del contenuto colonna "Provvedimento". |  |  |  | Verifica: verificare che  quando viene popolato l’elenco dei procedimenti del soggetto venga impostato il contenuto della colonna "Provvedimento" coerentemente con quanto visibile nella pagina di dettaglio del procedimento nella sezione “Provvedimenti”. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA v.2.6.0.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210428-Allegato-al-piano-test_AVVOCATURA_v.2.6.0.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | 01 | Verifica visualizzazione Data Deposito per provvedimento depositato e validato. |  | Verifica: verificare che  quando viene popolato l’elenco dei procedimenti del soggetto venga impostata la “Data Deposito” solo se il provvedimento è stato depositato e validato. |  | 1.0 |  |  | OK |
...
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento di fissazione udienza validato senza Data Deposito, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
...
|  | V | Verifica | Verificare che il fascicolo (con provvedimento di fissazione udienza validato e senza Data Deposito) non abbia valorizzato il contenuto della colonna Data Deposito ed il contenuto della colonna Esito Provvedimento. La colonna Provvedimento non deve contenere la data di emissione del provvedimento. |  |  |  |  |  |  |
|  | 4 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 5 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un Provvedimento depositato ma non validato, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 6 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo riporti il Provvedimento senza la volorizzazione delle colonne Esito Provvedimento e Data Deposito. La colonna Provvedimento non deve contenere la data di emissione del provvedimento. |  |  |  |  |  |  |
|  | 7 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 8 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento depositato e validato, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 9 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo riporti il provvedimento con la valorizzazione delle colonne Esito Provvedimento e Data Deposito. La colonna Provvedimento non deve contenere la data di emissione del provvedimento. |  |  |  |  |  |  |
| TF002.SIUS | 01 | Verifica visualizzazione coerente del contenuto colonna "Provvedimento". |  | Verifica: verificare che  quando viene popolato l’elenco dei procedimenti del soggetto venga impostato il contenuto della colonna "Provvedimento" coerentemente con quanto visibile nella pagina di dettaglio del procedimento nella sezione “Provvedimenti”. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento validato senza Data Deposito, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 3 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con provvedimento senza Data Deposito) abbia valorizzato il contenuto della colonna Provvedimento con l'informazione sul tipo di provvedimento. |  |  |  |  |  |  |
|  | 4 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 5 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento non validato, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 6 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo riporti la colonna Provvedimento vuota in quanto il Provvedimento non è presente nella sezione apposita non essendo stato validato. |  |  |  |  |  |  |
