---
uniqueName: siut-sies-pr-1-0-20201023-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20201023 Piano di Rilascio SIES v 12 4 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20201023-Piano_di_Rilascio_SIES_v.12.4.4.0

> **File originale:** `RILASCIO_12.4.4.0/SIUT-SIES-PR-1.0-20201023-Piano_di_Rilascio_SIES_v.12.4.4.0.doc`  
> **Tipo:** DOC
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.4.4.0 di SIES.
...
Il presente documento descrive il piano di rilascio di SIES 12.4.4.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
L’utente segnala un problema relativo alla stampa di una richiesta di accertamento pericolosità sociale su un fascicolo SIEP della Procura della Repubblica presso il Tribunale di Milano. Quando si cerca di stampare la richiesta si ha una eccezione generica. 

L’errore è determinato dal fatto che esistono delle casistiche di ordinanze prive di anno e numero che in fase di stampa comportavano il problema segnalato.

La correzione ha coinvolto la classe: “siap.sico.stampa.controller.SIAPStampaController”. In essa è stato aggiunto un controllo che gestisce l’anomalia in caso di anno e numero ordinanza non valorizzati.
...
L’utente segnala un errore che viene rilevato su un procedimento SIUS dell’Ufficio di Sorveglianza, ogni volta che si tenta di stampare dalla pagina di "Dettaglio Richiesta Istruttoria Generica".
...
SIUT-SIES-PR-1.0-20201023-Piano_di_Rilascio_SIES_v.12.4.4.0.doc

SIUT-SIES-PT-1.0-20201023-Piano_dei_Test_SIES_v.12.4.4.0.doc

SIUT-SIES-CT-1.0-20201023-Allegato_al_piano_test_SIES_v.12.4.4.0.xls
...
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.4.3.0.
...
Creare sul server DB una cartella V_12_4_4_0 sotto la directory /home/oracle/;

Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_4_4_0/;

Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_4_4_0 tramite il comando:

chmod 777 V_12_4_4_0
...
Nella cartella appena creata (V_12_4_4_0), lanciare il comando:

./aggiorna_db.sh

Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_4_4_0/log/ in cui si può constatare l’esito dell’esecuzione.
