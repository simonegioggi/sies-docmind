---
uniqueName: siut-sies-pr-1-0-20240628-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20240628 Piano di Rilascio SIES v 12 6 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20240628-Piano_di_Rilascio_SIES_v.12.6.3.0

> **File originale:** `RILASCIO_12.6.3.0/SIUT-SIES-PR-1.0-20240628-Piano_di_Rilascio_SIES_v.12.6.3.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 28/06/2024 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.6.3.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.6.3.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.6.3.0 2024-06-28 | 12.6.3.0 | 28/06/2024 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 202405300125 | Centro di Competenza Sistemi Area Penale | L’ufficio segnala che occorre correggere allegati - le parti evidenziate | Per la risoluzione della problematica sono state apportate le correzioni richieste | Il problema era legato al fatto che nei template indicati erano presenti delle imprecisioni.
Template modificati:
...
| 202405300126 | Centro di Competenza Sistemi Area Penale | L’ufficio segnala correzione template allegati | Per la risoluzione della problematica sono state apportate le correzioni richieste | Il problema era legato al fatto che nei template indicati erano presenti delle imprecisioni.
Template modificati:
siep\pp\SIEP_PP_PR_RIDET_PP.rtf
siep\pp\SIEP_PP_TRASM_RICH_CONV.rtf
import\AvvisoOIPagamRR.rtf
import\AvvisoOIPagamUS.rtf |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20240628-Piano_di_Rilascio_SIES_v.12.6.3.0.docx
SIUT-SIES-PT-1.0-20240628-Piano_dei_Test_SIES_v.12.6.3.0.docx
SIUT-SIES-CT-1.0-20240628-Allegato_al_piano_test_SIES_v.12.6.3.0.xlsx |
...
Creare sul server DB una cartella V_12_6_3_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_6_3_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_6_3_0 tramite il comando:
chmod 777 V_12_6_3_0
...
Nella cartella appena creata (V_12_6_3_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_6_3_0/log/ in cui si può constatare l’esito dell’esecuzione.
