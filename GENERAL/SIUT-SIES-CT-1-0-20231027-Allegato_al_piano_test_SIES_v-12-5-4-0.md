---
uniqueName: siut-sies-ct-1-0-20231027-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20231027 Allegato al piano test SIES v 12 5 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20231027-Allegato_al_piano_test_SIES_v.12.5.4.0

> **File originale:** `RILASCIO_12.5.4.0/SIUT-SIES-CT-1.0-20231027-Allegato_al_piano_test_SIES_v.12.5.4.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20231027-Allegato_al_piano_test_SIES_v.12.5.4.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20231027-Piano_dei_Test_SIES_v.12.5.4.0.docx |
|  | Versione | 1.0 |
|  | Data | 45226.0 |
|  | Intervento | SIES v.12.5.4.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.5.4.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20231027-Allegato_al_piano_test_SIES_v.12.5.4.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220210013.0 |  |  | 20220210013.0 | Verifica destinazione del Casellario locale - errato |  | SIEP | SIEP - Verifica destinazione del Casellario locale - errato | TF001.SIEP | Errore nella destinazione del Casellario Giudiziale nel template indicato |  |  |  | Verifica: Verificare che la stampa del template indicato riporti la destinazione corretta per il Casellario Giudiziale | 1.0 |  |  |  |  |
| SIUT | SIES | 202211110114.0 |  |  | 202211110114.0 | Estrazione dati Sige |  | SIGE | SIGE - Estrazione dati Sige | TF001.SIGE | Errore nella statistica procedimenti SIGE per estremi atto |  |  |  | Verifica: Verificare che la statistica riporti i dati corretti nella colonna "Motivo Altra Definizione Opposizione/Ricorso" | 1.0 |  |  |  |  |
| SIUT | SIES | 202303280119.0 |  |  | 202303280119.0 | ATTESA DEFINIZIONE PROCEDIMENTI |  | SIEP | SIEP - ATTESA DEFINIZIONE PROCEDIMENTI | TF002.SIEP | Errore nella definizione del procedimento |  |  |  | Verifica: Verificare che i provvedimenti con codice motivo '0019' e '0356' siano definiti correttamente | 1.0 |  |  |  |  |
| SIUT | SIES | 202309110116.0 |  |  | 202309110116.0 | SIGE - Ricerca fascicoli per soggetto |  | SIGE | SIGE - SIGE - Ricerca fascicoli per soggetto | TF002.SIGE | Errore nella ricerca procedimenti SIGE per soggetto |  |  |  | Verifica: Verificare che nella ricerca fascicoli SIGE per soggetto, il risultato del numero dei fascicoli combaci col numero dei procedimenti a carico del soggetto stesso | 1.0 |  |  |  |  |
| SIUT | SIES | 20231010019.0 |  |  | 20231010019.0 | SIEP - Fascicolo trasmesso per errore |  | SIEP | SIEP - SIEP - Fascicolo trasmesso per errore | TF003.SIEP | Errore nella trasmissione del fascicolo |  |  |  | Verifica: Verificare che se il fascicolo non è di competenza dell'ufficio, allora non siano visibili i tasti di trasmissione | 1.0 |  |  |  |  |
| SIUT | SIES | 20231017016.0 |  |  | 20231017016.0 | STATISTICHE UFFICIO - TEMPI ISCRIZIONI PROCEDIMENTI |  | SIEP | SIEP - STATISTICHE UFFICIO - TEMPI ISCRIZIONI PROCEDIMENTI | TF004.SIEP | Errore nella statistica estrazione fascicoli calsse I |  |  |  | Verifica: Verificare che la procedura di estrazione dei fascicoli di classe I non estragga anche quelli di altre classi | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.5.4.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20231027-Allegato_al_piano_test_SIES_v.12.5.4.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nella destinazione del Casellario Giudiziale nel template indicato | 23 | Verifica: Verificare che la stampa del template indicato riporti la destinazione corretta per il Casellario Giudiziale |  | 1.0 |  |  | OK |
...
|  | 1.0 | Azione | Ricercare od iscrivere un procedimento con soggetto libero |  |  |  |  |  |  |
|  | 2.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  | Visualizzazione pagina "Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO Libero" |  |  |  |  |
|  | 3.0 | Azione | L'utente riempie i campi obbligatori e clicca su "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine esecuzione legge 165/98 - condannato libero" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sull'icona di stampa |  | Generazione template "Siep_ls_olqni" |  |  |  |  |
|  | V | Verifica | Verificare che la stampa riporti nella sezione del foglio compplementare la destinazione corretta per l'ufficio del Casellario Giudiziale | Es: Procura della Repubblica Presso il Tribunale Ordinario - TORINO | UFFICIO LOCALE DEL CASELLARIO GIUDIZIALE di TORINO |  |  |  |  |
| TF001.SIGE | SIGE | Errore nella statistica procedimenti SIGE per estremi atto |  | Verifica: Verificare che la statistica riporti i dati corretti nella colonna "Motivo Altra Definizione Opposizione/Ricorso" |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Ricerche » Procedimento SIGE per Estremi Atto |  | Visualizzazione pagina "Ricerca Procedimento SIGE per Estremi Atto" |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Statistica" |  | Visualizzazione file "Document.xls" |  |  |  |  |
|  | V | Verifica | Verificare i valori riportati nella colonna "Motivo Altra Definizione Opposizione/Ricorso" in caso di fascicoli definiti |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella definizione del procedimento |  | Verifica: Verificare che i provvedimenti con codice motivo '0019' e '0356' siano definiti correttamente |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Azione | Ricercare un procedimento in stato archiviato con motivo "0019" (archiviazione  per assorbimento in  cumulo stesso ufficio) oppure "0356" (Cumulo stesso ufficio) |  |  |  |  |  |  |
|  | 2.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Riepilogo Ispettivo | Premere "Conferma" due volte, "Seleziona Tutti" e "Conferma" | Visualizzazione file "Document.xls" |  |  |  |  |
|  | 3.0 | Azione | Verificare che il fascicolo ricercato sia presente nel foglio "Dettagli" catalogato come "ATTESA DEFINIZIONE PROCEDIMENTI" |  |  |  |  |  |  |
|  | 4.0 | Azione | Collegarsi al database ed eseguire lo script rilasciato |  |  |  |  |  |  |
|  | 5.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Riepilogo Ispettivo | Premere "Conferma" due volte, "Seleziona Tutti" e "Conferma" | Visualizzazione file "Document.xls" |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo ricercato NON sia più presente nel foglio "Dettagli" catalogato come "ATTESA DEFINIZIONE PROCEDIMENTI" |  |  |  |  |  |  |
| TF002.SIGE | SIGE | Errore nella ricerca procedimenti SIGE per soggetto |  | Verifica: Verificare che nella ricerca fascicoli SIGE per soggetto, il risultato del numero dei fascicoli combaci col numero dei procedimenti a carico del soggetto stesso |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come "Tribunale Ordinario" | Txxxxx (Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare o creare un fascicolo collegato a due titoli esecutivi relativi allo stesso soggetto ma con due date di nascita differenti |  |  |  |  |  |
|  | 1.0 | Navigazione | Ricerche » Procedimenti SIGE per Soggetto |  | Visualizzazione pagina "Ricerca Soggetti con Procedimenti SIGE" |  |  |  |  |
|  | 2.0 | Azione | Inserire Cognome e Nome del soggetto di cui sopra e premere il tasto "Conferma" | Annotarsi il "N° Fascicoli SIGE" | Visualizzazione pagina "Elenco Soggetti con Procedimenti SIGE" |  |  |  |  |
|  | 3.0 | Azione | Cliccare sull'icona di "Elenco Fascicoli del Sogetto" nella colonna "Azioni" |  | Visualizzazione pagina "Elenco Fascicoli per Soggetto" |  |  |  |  |
|  | V | Verifica | Verificare che il numero di fascicoli sige (1,2...n) corrisponda effettivamente al numero di fascicoli visualizzati in elenco |  |  |  |  |  |  |
| TF003.SIEP | SIEP | Errore nella trasmissione del fascicolo |  | Verifica: Verificare che se il fascicolo non è di competenza dell'ufficio, allora non siano visibili i tasti di trasmissione |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario di Palermo) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Per il test servono due distretti per esempio Palermo e Roma |  |  |  |  |  |
|  | 1.0 | Azione | Ricercare un procedimento con istruttoria di cumulo aperta | Fascicolo aaaa/numpa |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario di Roma) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 2.0 | Azione | Ricercare un procedimento pendente | Fascicolo aaaa/numrm |  |  |  |  |  |
|  | 3.0 | Navigazione | Istruttorie/Richieste » Trasmissione per Competenza/Seguito Atti | In Altro Distretto | Visualizzazione pagina "TRASMISSIONE PER COMPETENZA" |  |  |  |  |
|  | 4.0 | Azione | L'utente riempie i campi obbligatori e clicca su "Conferma" | Relativa al Procedimento: (aaaa/numpa)
Oggetto Atto: atti per competenza (per emissione provvedimento cumulo) | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | 5.0 | Azione | L'utente clicca sull'icona di "Generazione Stampa", seleziona il checkBox "Valida Documento" e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario di Palermo) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 6.0 | Navigazione | Ricerche » Procedimento | Selezionare il fascicolo aaaa/numrm del PM di Roma | Visualizzazione pagina "Ricerca Procedimento" |  |  |  |  |
|  | 7.0 | Azione | L'utente preme il tasto "OK" per sottomettere la ricerca nel sistema |  | Visualizzazione pagina "Dettaglio Procedimento da Trasferire" |  |  |  |  |
|  | 8.0 | Azione | L'utente preme il tasto "Conferma Trasferimento Procedimento" |  | Visualizzazione pagina "Dettaglio Trasferimento Procedimento da Altra BDI" |  |  |  |  |
|  | 9.0 | Azione | L'utente, nella sezione "Dati Procedimento", clicca sul link "Anno/Numero" |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 10.0 | Azione | L'utente clicca sull'icona "Elenco Provvedimenti del PM" |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 11.0 | Azione | L'utente, nella colonna "Azioni", clicca sull'icona di "Dettagli" | Provvedimento "Trasmissione atti per competenza (per emissione provvedimento cumulo)" | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina non sia consentito effettuare alcuna attività (tutte le icone ed i tasti sono stati disabilitati se il fascicolo appartiene ad altro ufficio) |  | Pagina di "Dettaglio Trasmissione Competenza" in sola visualizzazione |  |  |  |  |
| TF004.SIEP | SIEP | Errore nella statistica estrazione fascicoli calsse I |  | Verifica: Verificare che la procedura di estrazione dei fascicoli di classe I non estragga anche quelli di altre classi |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Tempi Iscrizione Fascicoli | Premere "Conferma" | Visualizzazione pagina "STATISTICHE UFFICIO - TEMPI ISCRIZIONI PROCEDIMENTI" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori e clicca su "Conferma" |  | Visualizzazione file "Document.xls" |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio di lavoro "Dettaglio" siano riportati solo i fascicoli iscritti in classe I |  |  |  |  |  |  |
