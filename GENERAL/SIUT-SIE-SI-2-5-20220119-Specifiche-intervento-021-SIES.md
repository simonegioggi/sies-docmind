---
uniqueName: siut-sie-si-2-5-20220119-specifiche-intervento-021
displayName: "SIUT SIE SI 2 5 20220119 Specifiche intervento 021 SIES"
category: "GENERAL"
tags: []
---

# SIUT-SIE-SI-2.5-20220119-Specifiche-intervento-021-SIES

> **File originale:** `MEV/SCHEDA_021/Docs/consegna docx/ORIGINALS/SIUT-SIE-SI-2.5-20220119-Specifiche-intervento-021-SIES.docx`  
> **Tipo:** DOCX
...
| Andrea Salvaggio | RTI |  | Responsabile Progetto Sistema Unitario e Technical Manager |
...
1.2	Riferimenti	17
1.3	Glossario	17
1.3.1	Definizioni	17
1.3.2	Acronimi e abbreviazioni	17
2	Definizione dell’Obiettivo	19
3	Architettura del Sistema	20
3.1	Architettura	20
4	Specifiche dei requisiti	21
4.1	Premessa	21
4.2	Elenco Requisiti	21
5	Interfacce	22
6	Descrizione dell’Intervento	22
6.1	REQ-SIE-021-01_FN.01 -  Gestione Nuovi Fori (FORO di NAPOLI NORD)	23
6.1.1	Moduli sw	33
6.1.2	Architettura	37
6.1.3	Interfacce utente	37
6.1.4	Basi dati	40
6.1.4.1	Selezione Lista Fori SIES	40
6.1.4.2	Tabella Avvocati SIES	42
6.1.5	WEB services	42
6.1.6	XSD	42
6.1.7	Configurazione	42
6.1.8	Tutorial	42
6.2	REQ- SIE-021-02_FN.01 -  Ricerca su ReGIndE	42
6.2.1	Moduli sw	43
6.2.2	Architettura	45
6.2.3	Interfacce utente	45
6.2.3.1	Sottosistema SIEP	45
6.2.3.2	Sottosistema SIGE	59
6.2.3.3	Sottosistema SIUS	68
6.2.4	Basi dati	73
6.2.5	WEB services	74
6.2.5.1	Gestione delle fault	76
6.2.6	XSD	76
6.2.7	Configurazione	76
6.2.8	Tutorial	77
6.3	REQ- SIE-021-03_FN.01 – Inserimento Manuale: Indisponibilità ReGIndE o Avvocato Non Presente	77
6.3.1	Moduli sw	77
6.3.2	Architettura	77
6.3.3	Interfacce utente	77
6.3.3.1	Inserimento manuale: Indisponibilità ReGIndE o Avvocato Non Presente	78
6.3.3.2	Inserimento manuale avvocato sul sistema SIES	82
6.3.4	Basi dati	84
6.3.5	WEB services	84
6.3.6	XSD	84
6.3.7	Configurazione	84
6.3.8	Tutorial	84
6.4	REQ- SIE-021-04_FN.01 – Interventi su Funzioni SIES di Gestione Avvocati	84
6.4.1	Moduli sw	85
6.4.2	Architettura	85
6.4.3	Interfacce utente	85
6.4.4	Basi dati	86
6.4.5	WEB services	86
6.4.6	XSD	86
6.4.7	Configurazione	86
6.4.8	Tutorial	86
...
6.5.5	Basi dati	89
6.5.6	WEB services	90
6.5.7	XSD	90
6.5.8	Configurazione	90
6.5.9	Tutorial	90
6.6	REQ- SIE-021-06_FN.01 – Aggiornamento Tabelle COMUNE e CG_REF_CODES di SIES	90
6.6.1	Aggiornamento dei dati presenti nella tabella COMUNE di SIES	91
6.6.2	Aggiornamento dei dati presenti nella tabella CG_REF_CODES (domini PROVINCIA,REGIONE,NAZIONE)	93
...
Figura 1: Architettura del sistema SIES	20
Figura 2: Sezione notifica Difensore	24
Figura 3: Alert per Comune non Esistente	24
Figura 4: Form ricerca Difensori su ReGIndE	25
Figura 5: Combo-box dei fori	26
Figura 6: [Esempio Template 1]	26
Figura 7: [Esempio Template 2]	27
Figura 8 – Messaggio Alert su Dettaglio procedimento SIEP con presenza Avvocato non certificato	28
Figura 9 – Segnalazione su Dettaglio procedimento SIEP per Avvocato non certificato	28
Figura 10 – Alert su Form Rideterminazione pena per procedimento SIEP con Avvocato non certificato	29
Figura 11 – Messaggio Alert su Dettaglio procedimento SIUS con presenza Avvocato non certificato	29
Figura 12 – Segnalazione su Dettaglio procedimento SIUS per Avvocato non certificato	30
Figura 13 – Alert su Form Emissione Ordinanza per procedimento SIUS con Avvocato non certificato	31
Figura 14 – Messaggio Alert su Dettaglio procedimento SIGE con presenza Avvocato non certificato	31
Figura 15 – Segnalazione su Dettaglio procedimento SIGE per Avvocato non certificato	32
Figura 16 – Alert su Form Emissione Ordinanza per procedimento SIGE con Avvocato non certificato	33
Figura 17: Ordine di Esecuzione con Sezione destinatario Notifica difensore modificata	38
Figura 18: Fissazione Udienza con Sezione destinatario Notifica difensore modificata	39
Figura 19: Sezione destinatario Notifica - SIGE	40
Figura 20: Form inserimento difensore procedimento SIEP - attuale	46
Figura 21: Form inserimento difensore procedimento SIEP - nuova	47
Figura 22: Form di attivazione ricerca su ReGIndE	48
Figura 23: Form di ricerca su ReGIndE con segnalazione di eccessive occorrenze con criteri impostati	49
Figura 24: Form Elenco Avvocati ReGIndE	50
Figura 25: Form Inserimento Avvocato selezionato	52
Figura 26: Form dettaglio avvocato procedimento SIEP	54
Figura 27: Form sostituzione Difensore procedimento SIEP	55
Figura 28: Form Iscrizione Istanza da Soggetto - Attuale	56
Figura 29: Form Iscrizione Istanza da Soggetto - Nuova	57
Figura 30: Form Iscrizione Istanza da Titolo Esecutivo -Nuova	58
Figura 31: Form Iscrizione Istanza da Procedimento SIEP - Nuova	59
Figura 32: Form sostituzione Assegnazione Difensore procedimento SIGE - Attuale	60
Figura 33: Form sostituzione Assegnazione Difensore procedimento SIGE - Nuova	61
Figura 34: Form Dettaglio Difensore procedimento SIGE - Attuale	63
Figura 35: Form Dettaglio Difensore procedimento SIGE - Nuova	63
Figura 36: Form Sostituzione Difensore procedimento SIGE - Nuova	64
Figura 37: Form Inserimento Difensore procedimento SIGE – Parti in causa	65
Figura 38: Form Inserimento Difensore Parte	66
Figura 39: Form Dettaglio Fissazione Udienza procedimento SIGE	67
Figura 40: Form Inserimento Difensore procedimento SIGE Parti in casusa - Nuova	68
Figura 41: Form Assegnazione Difensore procedimento SIUS - Attuale	69
Figura 42: Form Assegnazione Difensore procedimento SIUS - Nuova	70
Figura 43: Form Dettaglio Difensore procedimento SIUS - Attuale	72
Figura 44: Form Dettaglio Difensore procedimento SIUS - Nuova	72
Figura 45: Form Sostituzione Difensore procedimento SIUS - Nuova	73
Figura 46: Form Ricerca Difensore su ReGIndE in caso di assenza collegamento	79
Figura 47: Form Ricerca Difensore su ReGIndE in caso nessun occorrenza trovata	80
Figura 48: Form Elenco Avvocati SIES	81
Figura 49: Form Esito Ricerca Difensori SIES in caso di nessun occorrenza trovata	82
Figura 50: Form Inserimento Difensore in SIES	83
Figura 51: Form Gestione Difensori - Attuale	85
Figura 52: Form Gestione Difensori - Nuova	85
Figura 53: Form Elenco Difensori - Attuale	86
Figura 54: Form Elenco Difensori - Nuova	86
...
https://reginde.processotelematico.giustizia.it             	(ambiente di esercizio)
