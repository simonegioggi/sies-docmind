---
uniqueName: siut-sies-pr-1-4-20230517-pianodirilascio202313pst
displayName: "SIUT SIES PR 1 4 20230517 Piano di Rilascio 2023 13 PST PagoPA"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.4-20230517-Piano_di_Rilascio_2023_13_PST_PagoPA

> **File originale:** `MEV/SCHEDA_013/SIUT-SIES-PR-1.4-20230517-Piano_di_Rilascio_2023_13_PST_PagoPA.docx`  
> **Tipo:** DOCX
...
| 1.4 | 17/05/2023 | Quinta Emissione | Modificato il paragrafo Deploy Applicazione (nella parte riguardante il file f3b.properties) ed aggiornati alcuni riferimenti documentali |
...
| --- | --- | --- |
| RIF1. | SIUT-SIES-SC-1.6-20230517-Scheda_Intervento_2023_13_PST_PagoPA | Scheda Intervento |
...
| --- | --- | --- | --- |
| - | SIUT-SIES-SC-1.6-20230517-Scheda_Intervento_2023_13_PST_PagoPA | - | Integrazione del SIES con PST_PagoPA |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.4-20230517-Piano_di_Rilascio_2023_13_PST_PagoPA.pdf
...
I parametri generatiDaGiorni e controllarepergiorni devono essere presi in considerazione solo se valorizzati entrambi positivamente per evitare di controllare all'infinito i bollettini finché non venga inserita la data di scadenza.
