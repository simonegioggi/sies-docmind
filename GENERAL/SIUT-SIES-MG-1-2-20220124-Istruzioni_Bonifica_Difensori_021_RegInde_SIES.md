---
uniqueName: siut-sies-mg-1-2-20220124-istruzionibonificadifens
displayName: "SIUT SIES MG 1 2 20220124 Istruzioni Bonifica Difensori 021 RegInde SIES"
category: "GENERAL"
tags: []
---

# SIUT-SIES-MG-1.2-20220124-Istruzioni_Bonifica_Difensori_021_RegInde_SIES

> **File originale:** `MEV/SCHEDA_021/Docs/consegna docx/ORIGINALS/SIUT-SIES-MG-1.2-20220124-Istruzioni_Bonifica_Difensori_021_RegInde_SIES.docx`  
> **Tipo:** DOCX
...
3.2 Esecuzione Procedura Bonifica Difensori SIES in un unico passaggio	23
...
# 2 	Generalità
Le attività descritte sono preliminari alle attività di installazione del software relativo alla MEV-2019_21 di SIES descritte nel documento SIUT-SIES-PR-1.2-20220124-Piano_di_Rilascio_021_RegInde_SIES.doc.
...
Le attività descritte in questo paragrafo non devono essere eseguite nella fase di messa in esercizio della MEV nei Distretti, che si limiteranno ad importare la tabella  AVVOCATO_REGINDE_18112020.dmp, già precaricata. Le attività sono riportate per permettere, se necessario, di rieseguire tutte le operazioni effettuate per giungere all’ottenimento della suddetta tabella, partendo dal file .xls fornito dall’Amministrazione, contenente gli avvocati estratti da ReGIndE.
...
10) Eseguire XBA_BONIFICA_AVVOCATO.prc
Individuazione degli avvocati SIES deputati a divenire "certificati REGINDE" in base a NOME, COGNOME, Codice Fiscale., LUOGO e DATA di NASCITA.
...
SELECT  count(*) FROM NUOVA_ISTANZA_BONIF
...
E’ possibile eseguire l’intera procedura con il lancio di 4 script, in tal caso  fare riferimento al par. 6.3 del documento SIUT-SIES-PR-1.2-20220124-Piano_di_Rilascio_021_RegInde_SIES.dox relativo al piano di rilascio della MEV.