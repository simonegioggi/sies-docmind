---
uniqueName: siut-sies-pt-1-0-20240802-pianodeitest2024-dna
displayName: "SIUT SIES PT 1 0 20240802 Piano dei Test 2024 DNA"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PT-1.0-20240802-Piano_dei_Test_2024-DNA

> **File originale:** `MEV/SCHEDA_DNA/SIUT-SIES-PT-1.0-20240802-Piano_dei_Test_2024-DNA.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 02/08/2024 | Prima Emissione |  |
...
# Introduzione
## Scopo del documento
Il presente documento descrive il piano dei test per la verifica della risoluzione dei ticket indicati nel piano di rilascio: SIUT-SIES-PR-1.0-20240802-Piano_di_Rilascio_2024-DNA.docx.
## Riferimenti
| Riferimento | Nome Documento | Descrizione Documento |
| --- | --- | --- |
| RIF1 | SIUT-SIES-PR-1.0-20240802-Piano_di_Rilascio_2024-DNA.docx | Il documento riporta l’elenco delle funzionalità modificate con gli interventi eseguiti dal servizio di manutenzione forniti con il presente rilascio.
Riporta inoltre le modalità di installazione degli aggiornamenti in ambiente di esercizio |
| RIF2 | SIUT-SIES-CT-1.0-20240802-Allegato-al-piano-test_2024-DNA.xlsx | Il documento riporta l'elenco dei test eseguiti per la verifica della risoluzione delle anomalie |
...
## Entità da testare
L'entità oggetto di verifica è l'applicativo SIES relativamente alle funzionalità oggetto dei ticket indicati nel piano di rilascio SIUT-SIES-PR-1.0-20240802-Piano_di_Rilascio_2024-DNA.docx.
...
I test sono eseguiti secondo quanto descritto nella relativa scheda contenuta nel documento SIUT-SIES-CT-1.0-20240802-Allegato-al-piano-test_2024-DNA.xlsx. In particolare, è stata compilata la colonna ‘Esito’ per indicare l'esito del test.
# Gestione delle anomalie e ripetizione dei test
N.A.

# Ambiente di test
Per l'esecuzione dei test è stata installata la versione 2024-DNA di SIES secondo quanto stabilito dal documento di rilascio.
...
La descrizione di dettaglio di ciascun caso di test è contenuta nel documento SIUT-SIES-CT-1.0-20240802-Allegato-al-piano-test_2024-DNA.xlsx a complemento del presente piano dei test.
In particolare:
