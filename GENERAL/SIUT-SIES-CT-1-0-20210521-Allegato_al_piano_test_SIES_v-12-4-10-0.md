---
uniqueName: siut-sies-ct-1-0-20210521-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210521 Allegato al piano test SIES v 12 4 10 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210521-Allegato_al_piano_test_SIES_v.12.4.10.0

> **File originale:** `RILASCIO_12.4.10.0/SIUT-SIES-CT-1.0-20210521-Allegato_al_piano_test_SIES_v.12.4.10.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210521-Allegato-al-piano-test_SIES_v.12.4.10.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210521-Piano_dei_Test_SIES_v.12.4.10.0.docx |
|  | Versione | 1.0 |
|  | Data | 44337.0 |
|  | Intervento | SIES v.12.4.10.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.10.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210521-Allegato-al-piano-test_SIES_v.12.4.10.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202104210111.0 |  |  | 202104210111.0 | INSERIMENTO PARTI CIVILI DECRETO FISSAZIONE UDIENZA |  | SIGE | SIGE - INSERIMENTO PARTI CIVILI DECRETO FISSAZIONE UDIENZA | TF001.SIGE | Verifica presenza tasto "Indietro" |  |  |  | Verifica: verificare che la maschera "Assegnazione Difensore" abbia il tasto "Indietro" | 1.0 |  |  |  |  |
| SIUT | SIES | 202104230110.0 |  |  | 202104230110.0 | Ordinanza concessione affidamento |  | SIEP | SIEP - Ordinanza concessione affidamento | TF002.SIEP | Verifica corretta visualizzazione ordinanza concessione misure alternative. |  |  |  | Verifica: verificare che nell'istruttoria di cumulo nel dettaglio dello stato esecuzione sia presente l'ordinanza di concessione della misura. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210430011.0 |  |  | 20210430011.0 | Errore in liberazione anticipata |  | SIEP | SIEP - Errore in liberazione anticipata | TF003.SIEP | Verifica errore su inserimento provvedimento di liberazione anticipata |  |  |  | Verifica: verificare che nell'inserire un'ordinanza Liberazione Anticipata  non venga prodotto l'errore  di "null pointer exception". | 1.0 |  |  |  |  |
| SIUT | SIES | 202105030111.0 |  |  | 202105030111.0 | SIUS-avvocati fissazione dell’udienza |  | SIUS | SIUS - SIUS-avvocati fissazione dell’udienza | TF004.SIUS | Verifica corretta valorizzazione della Data Udienza |  |  |  | Verifica: Verificare che la valorizzazione della Data Udienza sia visibile solo dopo la validazione della fissazione a prescindere dal tipo di ricerca che viene effettuata. | 1.0 |  |  |  |  |
| SIUT | SIES | 202105030112.0 |  |  | 202105030112.0 | SIUS-avvocati |  | SIUS | SIUS - SIUS-avvocati | TF005.SIUS | Verifica stato provvedimento se data deposito non validata. |  |  |  | Verifica: Verificare che lo stato del provvedimento non sia "Emesso Provvedimento" se la data deposito dello stesso non è validata. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210506013.0 |  |  | 20210506013.0 | Errata pendenza in caso di ergastolo e archiviazione per assorbimento |  | SIEP | SIEP -  Errata pendenza in caso di ergastolo e archiviazione per assorbimento | TF006.SIEP | Verifica corretta archiviazione di fascicoli con ergastolo per assorbimento cumulo. |  |  |  | Verifica: Verificare che i fascicoli con ergastolo per assorbimento cumulo dopo l'archiviazione siano catalogati correttamente nella funzione di statistica. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210507017.0 |  |  | 20210507017.0 | SIEP Ricerche del soggetto sempre in attesa di risposta |  | SIEP | SIEP - SIEP Ricerche del soggetto sempre in attesa di risposta | TF007.SIEP | Verifica Ricerca del soggetto su altre BDI. |  |  |  | Verifica: Verificare che la ricerca del soggetto su altre BDI vada a buon fine. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.10.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210521-Allegato-al-piano-test_SIES_v.12.4.10.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIGE | 01 | Verifica presenza tasto "Indietro" |  | Verifica: verificare che la maschera "Assegnazione Difensore" abbia il tasto "Indietro" |  | 1.0 |  |  | OK |
...
|  | 1 | Navigazione | Iscrizione manuale » Ricerca Procedimento SIEP per Numero |  | Visualizzazione pagina Ricerca Procedimento SIEP |  |  |  |  |
|  | 2 | Azione | Ricercare u procedimento SIEP validato |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Tramite la combo delle funzionalità selezionare Iscrizione Procedimento SIGE |  | Visualizzazione pagina Iscrizione Procedimento SIGE da Procedimento SIEP |  |  |  |  |
|  | 4 | Azione | Completare i dati: 
Tipo Atto = Istanza,
Data Arrivo in cancellerie ,
Magistrato. 
Cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Procedimento SIGE |  |  |  |  |
|  | 5 | Azione | Selezionare il link Oggetti. |  | Visualizzazione pagina Gestione Oggetti Relativi alla Richiesta/Atto |  |  |  |  |
|  | 6 | Azione | Cliccare sull'icona Inserisci nuovo oggetto.
Inserire un nuovo  oggetto e cliccare su Conferma. |  | Visualizzazione pagina  Gestione Oggetti Relativi alla Richiesta/Atto |  |  |  |  |
|  | 7 | Navigazione | Udienze/Fissazione/Rinvio/Ruolo » Fissazione Udienza |  | Visualizzazione pagina Inserimento Fissazione Udienza |  |  |  |  |
|  | 8 | Azione | Selezionare:
Rito (monocratico),
data Emissione (oggi),
data udienza (eventualmente fissandone una se non esiste). 
Confermare. |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 9 | Azione | Sulla form successiva selezionare il link Gestione Parti Civili. |  | Visualizzazione pagina Inserimento Parte Civile |  |  |  |  |
|  | 10 | Azione | Completare i dati anagrafici obbligatori e confermare. |  | Visualizzazione pagina Inserimento Difensore Parte |  |  |  |  |
|  | 11 | Azione | Selezionare Gestione Difensore e selezionare un difensore dalla lista. Impostare di Fiducia e confermare. |  | Visualizzazione pagina  Dettaglio Avvocato |  |  |  |  |
|  | 12 | Azione | Sul "Dettaglio Avvocato" selezionare il tasto Indietro. |  | Visualizzazione pagina Assegnazione Difensore |  |  |  |  |
|  | V | Verifica | Verificare che  sulla form "Assegnazione Difensore" sia presente il tasto indietro. |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica corretta visualizzazione ordinanza concessione misure alternative. |  | Verifica: verificare che nell'istruttoria di cumulo nel dettaglio dello stato esecuzione sia presente l'ordinanza di concessione della misura. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento validato senza istruttoria cumulo aperta. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | L'utente effettua l'accesso al sistema SIUS come Tribunale di Sorveglianza | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | 3 | Navigazione | Iscrizione Manuale » Ricerca Titolo Esecutivo per Numero SIEP |  | Visualizzazione pagina Ricerca Titolo Esecutivo |  |  |  |  |
|  | 4 | Azione | Ricercare il Procedimento dello step 2 |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 5 | Azione | Iscrivere un procedimento con contenuto Concessione Misure Alternative alla Detenzione
Tipo atto : Ordinanza.
Inserire i restanti dati obbligatori e confermare. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 6 | Navigazione | Udienza » Fissazione Udienza |  | Visualizzazione pagina Inserimento Fissazione Udienza |  |  |  |  |
|  | 7 | Azione | Inserire i dati necessari e confermare |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 8 | Azione | Stampare e validare |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 9 | Navigazione | Ordinanze » Emissione Ordinanza |  | Visualizzazione pagina Emissione Ordinanza |  |  |  |  |
|  | 10 | Azione | Inserire i dati necessari e confermare |  | Visualizzazione pagina Emissione Ordinanza Misura Alternativa |  |  |  |  |
|  | 11 | Azione | Inserire i di obbligatori e confermare |  | Visualizzazione pagina  Dettaglio Ordinanza |  |  |  |  |
|  | 12 | Azione | Validare l'ordinanza |  | Visualizzazione pagina  Dettaglio Ordinanza |  |  |  |  |
|  | 13 | Navigazione | Ordinanze » Deposito Ordinanza |  | Visualizzazione pagina Deposito Ordinanza |  |  |  |  |
|  | 14 | Azione | Confermare |  | Visualizzazione pagina Deposito Ordinanza SIUS  del DD/MM/AAAA |  |  |  |  |
|  | 15 | Azione | Inserire data deposito in cancelleria e confermare. |  | Visualizzazione pagina Dettaglio Deposito Ordinanza |  |  |  |  |
|  | 16 | Azione | Validare. |  | Visualizzazione pagina Dettaglio Deposito Ordinanza |  |  |  |  |
|  | 17 | Azione | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 18 | Azione | Ricercare il fascicolo dello step 1 |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 19 | Azione | Cliccare sull'icona "C" del menu orizzontale di scelta rapida (Gestione Cumulo). |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 20 | Azione | Cliccare su Apertura Istruttoria |  | Visualizazzione pagina Apertura Istruttoria Cumulo |  |  |  |  |
|  | 21 | Azione | Cliccare su Conferma |  | Viene aperta l'istruttoria di cumulo |  |  |  |  |
|  | 22 | Azione | Ritornare alla pagina di Gestione Cumulo e cliccare su Titoli Coinvolti |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 23 | Azione | Selezionare il link Elenco Titoli Coinvolti, quindi il titolo cumulante. |  | Visualizzazione pagina  Gestione Dati Analitici |  |  |  |  |
|  | V | Verifica | Verificare che sul dettaglio dello stato esecuzione sia presente l'ordinanza di concessione della misura. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica errore su inserimento provvedimento di liberazione anticipata |  | Verifica: verificare che nell'inserire un'ordinanza Liberazione Anticipata  non venga prodotto l'errore  di "null pointer exception". |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento SIEP in stato validato verificando che la posizione giuridica NON SIA detenuto altra causa. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Cliccare sull'icona "C" del menu orizzontale di scelta rapida (Gestione Cumulo). |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 3 | Azione | Cliccare su Apertura Istruttoria |  | Visualizazzione pagina Apertura Istruttoria Cumulo |  |  |  |  |
|  | 4 | Azione | Cliccare su Conferma |  | Viene aperta l'istruttoria di cumulo |  |  |  |  |
|  | 5 | Azione | Ritornare alla pagina di Gestione Cumulo e cliccare su Dati Finali Cumulo |  | Visualizzazione pagina Dati Finali Cumulo |  |  |  |  |
|  | 6 | Azione | Inserire la Data Emissione e cliccare su Conferma. |  | Visualizzazione pagina Dati Finali Cumulo |  |  |  |  |
|  | 7 | Azione | Cliccare su Pene Rideterminate |  | Visualizzazione pagina Dati Finali Cumulo - Pene Determinate in cumulo |  |  |  |  |
|  | 8 | Azione | Compilare la sezione pene rideterminare e confermare. |  | Visualizzazione pagina Dati Finali Cumulo - Pene Determinate in cumulo |  |  |  |  |
|  | 9 | Azione | Cliccare su Posizione Giuridica |  | Visualizzazione pagina Dati Finali Cumulo - Posizione Giuridica - Inserimento |  |  |  |  |
|  | 10 | Azione | Selezionare il radio button "Espiazione Pena in Istituto di Detenzione" e come posizione giuridica "Custodia cautelare altra causa in regime di detenzione", inserire data decorrenza pena ed istituto. Cliccare su Conferma. |  | Visualizazzione pagina Dati Finali Cumulo - Posizione Giuridica |  |  |  |  |
|  | 11 | Azione | Cliccare su Calcolo Pena |  | Visualizzazione pagina Dati Finali Cumulo - Pena Da Eseguire |  |  |  |  |
|  | 12 | Azione | Dopo aver proceduto al calcolo della pena cliccare su Emissione Provvedimento |  | Visualizazzione pagina Dati Finali Cumulo - Emissione Provvedimento |  |  |  |  |
|  | 13 | Azione | Procedere all'emissione del provvedimento di cumulo inserendo i dati obbligatori e selezionando come tipologia (Ordine di esecuzione ex art. 656 comma 1). 
Cliccare su Conferma |  | Visualizzazione pagina Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 14 | Azione | Stampare e validare |  | Visualizzazione pagina Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 15 | Navigazione | Decisioni Sorveglianza > Liberazione Anticipata |  | Visualizazzione pagina Emissione Ordinanza di Liberazione Anticipata |  |  |  |  |
|  | 16 | Azione | Completare la prima form e successivamente cliccare su Conferma |  | Visualizzazione pagina Dettaglio Liberazione Anticipata |  |  |  |  |
|  | 17 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Scarcerazione » Liberazione Anticipata |  | Visualizzazione pagina Ordine di Scarcerazione a seguito di ordinanza Liberazione Anticipata |  |  |  |  |
|  | V | Verifica | Verificare l'apertura della pagina senza l'errore di null pointer segnalato nel ticket |  |  |  |  |  |  |
| TF004.SIUS | 01 | Verifica corretta valorizzazione della Data Udienza |  | Verifica: Verificare che la valorizzazione della Data Udienza sia visibile solo dopo la validazione della fissazione a prescindere dal tipo di ricerca che viene effettuata. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente ha effettuato l'accesso all’applicazione di Consultazione Procedimenti e avvisi SIUS tramite PST (portale servizi telematici) |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento di fissazione udienza validato e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 3 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | 4 | Azione | L'utente seleziona il link contenuto nella colonna N. SIUS |  | Il sistema prospetta il dettaglio del procedimento. |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con provvedimento di fissazione udienza validato) abbia valorizzato il contenuto della Data Udienza. |  |  |  |  |  |  |
|  | 5 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 6 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento di fissazione udienza non validato e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 7 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | 8 | Azione | L'utente seleziona il link contenuto nella colonna N. SIUS |  | Il sistema prospetta il dettaglio del procedimento. |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo riporti il Provvedimento senza la volorizzazione della Data Udienza. |  |  |  |  |  |  |
|  | 9 | Navigazione | Ricerche -> estremi procedimento |  |  |  |  |  |  |
|  | 10 | Azione | Effettuare la ricerca dei fascicoli individuati negli step 4 e 8 |  | Visualizzazione pagina dettaglio procedimento |  |  |  |  |
|  | 11 | Azione | L'utente accede nella sezione Provvedimenti eclicca sulla"lentina" |  | Visualizzazione pagina dettaglio provvedimento |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo riporti il Provvedimento senza la volorizzazione della Data Udienza se è relativo ad un fascicolo fascicolo con un provvedimento di fissazione udienza non validato o con la valorizzazione della Data Udienza se è fascicolo con un provvedimento di fissazione udienza validato |  |  |  |  |  |  |
| TF005.SIUS | 01 | Verifica stato provvedimento se data deposito non validata. |  | Verifica: Verificare che lo stato del provvedimento non sia "Emesso Provvedimento" se la data deposito dello stesso non è validata. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento con data deposito non validata e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 3 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | 4 | Azione | L'utente seleziona il link contenuto nella colonna N. SIUS |  | Il sistema prospetta il dettaglio del procedimento. |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con provvedimento con data deposito non validata) non abbia lo stato valorizzato in "Emesso provvedimento". |  |  |  |  |  |  |
| TF006.SIEP | 01 | Verifica corretta archiviazione di fascicoli con ergastolo per assorbimento cumulo. |  | Verifica: Verificare che i fascicoli con ergastolo per assorbimento cumulo dopo l'archiviazione siano catalogati correttamente nella funzione di statistica. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Iscrivere un fascicolo SIEP per soggetto con posizione giuridica iniziale Libero. |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Completare i dati minimali (Difensore - Posizione Giuridica - Reati - Pena Complessiva (Ergastolo) - Assegnazione al magistrato). |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 4 | Azione | Validare il procedimento dello step 1 cliccando sul pulsante Conferma |  | Visualizazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 5 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati |  | Visualizzazione pagina STATISTICHE - ESTRAZIONE DATI |  |  |  |  |
|  | 6 | Azione | Selezionare Classe I e Riepilogo Ispettivo.
Cliccare su Conferma. |  | Visualizzazione pagina STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI |  |  |  |  |
|  | 7 | Azione | Nella pagina visualizzata cliccare su Conferma |  | Visualizzazione pagina STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI |  |  |  |  |
|  | 8 | Azione | Cliccare su Seleziona Tutti e successivamente su Conferma |  | Viene prodotto un file Excel |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio excel prodotto, nella seconda scheda (Dettagli), il fascicolo dello step 1 sia classificato tra i fascicoli in "Istruttoria". |  |  |  |  |  |  |
|  | 9 | Navigazione | Definizione Procedimento  » Perdita di Competenza |  | Visualizzazione pagina Definizione Procedimento - Perdita di competenza |  |  |  |  |
|  | 10 | Azione | Compilare i dati obbligatori e confermare. |  | Visualizzazione pagina  Dettaglio Definizione Procedimento - Perdita di competenza |  |  |  |  |
|  | 11 | Azione | Cliccare sull'icona posta in alto (Valida Provvedimento) |  | Visualizzazione pagina  Dettaglio Definizione Procedimento - Perdita di competenza |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere gli step da 5 a 8 |  |  |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio excel prodotto, il fascicolo creato nello step 1 sia presente nella terza scheda (Archiviazioni). |  |  |  |  |  |  |
| TF007.SIEP | 01 | Verifica Ricerca del soggetto su altre BDI. |  | Verifica: Verificare che la ricerca del soggetto su altre BDI vada a buon fine. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Selezionare il radio button In altri distretti e come BDI di ricerca l'opzione "Tutte". 
Compilare i campi obbligatori e cliccare su Ricerca. |  | Visualizzazione messaggio Richiesta di ricerca Soggetto sottomessa al Sistema! |  |  |  |  |
|  | 3 | Azione | Cliccare sul pulsante OK del messaggio |  | Visualizzazione pagina Esiti Ricerca Soggetto su altre BDI |  |  |  |  |
|  | 4 | Azione | Cliccare sul pulsante Ricerca |  | Visualizzazione pagina Controllo Esito Messaggi Ricerca Soggetto |  |  |  |  |
|  | 5 | Azione | L'esito dovrebbe visualizzare i risultati delle ricerche dove BDI in attesa di risposta dovrebbe contenere un valore minore di 29 (ATTENZIONE!! se il valore è 29 va ristartato il server). |  |  |  |  |  |  |
|  | 6 | Azione | L'utente effettua l'accesso al sistema SIEP come amministratore di sistema | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 7 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 8 | Navigazione | Test Sistema |  | Viene generata una stampa |  |  |  |  |
|  | 9 | Azione | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 10 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere gli step da 1 a 4 |  |  |  |  |  |  |
|  | V | Verifica | Verificare che l'esito dovrebbe visualizzare i risultati delle ricerche dove BDI in attesa di risposta dovrebbe contenere un valore minore di 29. |  |  |  |  |  |  |
