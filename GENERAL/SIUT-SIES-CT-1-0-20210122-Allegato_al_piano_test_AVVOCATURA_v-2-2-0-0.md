---
uniqueName: siut-sies-ct-1-0-20210122-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20210122 Allegato al piano test AVVOCATURA v 2 2 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210122-Allegato_al_piano_test_AVVOCATURA_v.2.2.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.2.0.0/SIUT-SIES-CT-1.0-20210122-Allegato_al_piano_test_AVVOCATURA_v.2.2.0.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210122-Allegato-al-piano-test_AVVOCATURA_v.2.2.0.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210122-Piano_dei_Test_AVVOCATURA_v.2.2.0.0.doc |
|  | Versione | 1.0 |
|  | Data | 44218.0 |
|  | Intervento | AVVOCATURA v.2.2.0.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA v.2.2.0.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210122-Allegato-al-piano-test_AVVOCATURA_v.2.2.0.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210120013.0 |  |  | 20210120013.0 | SIUS-Avvocati: problema su tasto "indietro" |  | SIUS | SIUS - SIUS-Avvocati: problema su tasto "indietro" | TF001.SIUS | Verifica corretta gestione del tasto "Indietro". |  |  |  | Verifica: verificare che nella pagina del dettaglio provvedimento il tasto indietro riporti correttamente alla pagina precedente (dettaglio procedimento) | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA v.2.2.0.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210122-Allegato-al-piano-test_AVVOCATURA_v.2.2.0.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | 01 | Verifica corretta gestione del tasto "Indietro". |  | Verifica: verificare che nella pagina del dettaglio provvedimento il tasto indietro riporti correttamente alla pagina precedente (dettaglio procedimento) |  | 1.0 |  |  | OK |
...
|  | 6 | Azione | L'utente clicca sul tasto Indietro presente nella zona inferiore della pagina del dettaglio del provvedimento |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga prospettata correttamente la pagina dello step 5 (dettaglio del procedimento). |  |  |  |  |  |  |
