---
uniqueName: siut-sic-ct-1-0-20211126-allegatoalpianotestsippiv
displayName: "SIUT SIC CT 1 0 20211126 Allegato al piano test SIPPI v 9 8 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIC-CT-1.0-20211126-Allegato_al_piano_test_SIPPI_v.9.8.2.0

> **File originale:** `RILASCIO_9.8.2.0_SIPPI/SIUT-SIC-CT-1.0-20211126-Allegato_al_piano_test_SIPPI_v.9.8.2.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIC-CT-1.0-20211126-Allegato_al_piano_test_SIPPI_v.9.8.2.0.xls |
|  | Piano di test | SIUT-SIC-PT-1.0-20211126-Piano_dei_Test_SIPPI_v.9.8.2.0.docx |
|  | Versione | 1.0 |
|  | Data | 44526.0 |
|  | Intervento | SIPPI v. 9.8.2.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIPPI v. 9.8.2.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIC-CT-1.0-20211126-Allegato_al_piano_test_SIPPI_v.9.8.2.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIC_SIPPI | 20211020016.0 |  |  | 20211020016.0 | Impossibilità registrazione foglio complementare |  | SITMP | SITMP - Impossibilità registrazione foglio complementare | TF001.SITMP | Verifica invio Foglio Complementare da SitMP verso Casellario. |  |  |  | Verificare che in fase di registrazione del Foglio Complementare da SitMP verso Casellario, l'operazione vada a buon fine non restituendo il messaggio "codice esito non gestito: errore interno generico", bensì che il sistema SIC_SIPPI risponda con esito positivo. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIPPI v. 9.8.2.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIC-CT-1.0-20211126-Allegato_al_piano_test_SIPPI_v.9.8.2.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SITMP | 01 | Verifica invio Foglio Complementare da SitMP verso Casellario. |  | Verificare che in fase di registrazione del Foglio Complementare da SitMP verso Casellario, l'operazione vada a buon fine non restituendo il messaggio "codice esito non gestito: errore interno generico", bensì che il sistema SIC_SIPPI risponda con esito positivo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIT-MP  effettuando il login con la propria utenza (Cancelliere di Tribunale), è presente un procedimento di "istanza modifica/revoca misure personale" in stato "GIUDIZIO DEFINITIVO" con misure personali definitive |  |  |  |  |  |  |
|  | P | Stato Base | L'utente è autenticato e abilitato all'utilizzo della funzione |  |  |  |  |  |  |
|  | 1 | Navigazione | Login>>Ricerca procedimento su istanza (Modifica/Revoca misure personali) con le caratteristiche indicate nelle pre-condizioni |  |  |  |  |  |  |
|  | 2 | Azione | L'utente seleziona il Procedimento su istanza (Modifica/Revoca misure personali) e preme il bottone [Dettaglio] |  | Il sistema SIT-MP apre la copertina del procedimento selezionato |  |  |  |  |
|  | 3 | Azione | L'utente dal menù di spalla sinistra "Atti-Nuovo" seleziona Atto Esecutivo-Foglio complementare e preme il bottone [Conferma] |  | Il sistema SIT-MP apre la pagina in cui selezionare il soggetto per cui redigere il nuovo foglio complementare |  |  |  |  |
|  | 4 | Azione | L'utente seleziona il soggetto e preme il bottone [Nuovo Foglio] |  | Il sistema SIT-MP apre la pagina per redigere il foglio complementare |  |  |  |  |
|  | 5 | Azione | L'utente compila i dati del foglio complementare e preme il bottone [Salva] |  | Il sistema SIT-MP provvede al salvataggio dei dati immessi |  |  |  |  |
|  | 6 | Azione | L'utente preme il bottone [Invia] |  | Il sistema SIT-MP provvede all'invio dei dati ed il sistema Casellario |  |  |  |  |
|  | V | Verifica | Verificare che  non venga restituito più l'errore di "Codice esito non gestito: errore interno generico" |  |  |  |  |  |  |
