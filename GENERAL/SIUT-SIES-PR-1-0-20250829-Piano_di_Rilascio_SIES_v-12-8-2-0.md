---
uniqueName: siut-sies-pr-1-0-20250829-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20250829 Piano di Rilascio SIES v 12 8 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20250829-Piano_di_Rilascio_SIES_v.12.8.2.0

> **File originale:** `RILASCIO_12.8.2.0/SIUT-SIES-PR-1.0-20250829-Piano_di_Rilascio_SIES_v.12.8.2.0.docx`  
> **Tipo:** DOCX
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.8.2.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.8.2.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.8.2.0 2025-08-29 | 12.8.2.0 | 29/08/2025 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 202507220132 | Tribunale di Bolzano | L’ufficio segnala che nella funzione ricerca utenti indicando l'ufficio, il programma dà il messaggio "il campo sede ufficio non può contenere caratteri non alfabetici" | Per la risoluzione della problematica è stata modificata la pagina di ricerca utente eliminando il controllo alfabetico sul campo interessato | Il problema era legato al fatto che il campo di ricerca "Sede" non consentiva l'inserimento di caratteri speciali tipo "/".
Classe modificata:
siap/sico/utente/LoadRicercaUtentiPerUfficio.jsp |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20250829-Piano_di_Rilascio_SIES_v.12.8.2.0.docx
SIUT-SIES-PT-1.0-20250829-Piano_dei_Test_SIES_v.12.8.2.0.docx
SIUT-SIES-CT-1.0-20250829-Allegato_al_piano_test_SIES_v.12.8.2.0.xlsx |
...
# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.8.1.0.
...
Creare sul server DB una cartella V_12_8_2_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_8_2_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_8_2_0 tramite il comando:
chmod 777 V_12_8_2_0
...
Nella cartella appena creata (V_12_8_2_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_8_2_0/log/ in cui si può constatare l’esito dell’esecuzione.
