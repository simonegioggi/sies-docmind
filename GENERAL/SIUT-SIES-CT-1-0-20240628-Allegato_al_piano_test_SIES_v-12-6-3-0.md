---
uniqueName: siut-sies-ct-1-0-20240628-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20240628 Allegato al piano test SIES v 12 6 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20240628-Allegato_al_piano_test_SIES_v.12.6.3.0

> **File originale:** `RILASCIO_12.6.3.0/SIUT-SIES-CT-1.0-20240628-Allegato_al_piano_test_SIES_v.12.6.3.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.6.3.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20240628-Allegato_al_piano_test_SIES_v.12.6.3.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202405300125 |  |  | 202405300125 | Correzione template ingiunzione di pagamento |  | SIEP | SIEP - Correzione template ingiunzione di pagamento | TF001.SIEP | Errore nel contenuto del template |  |  |  | Verifica: Verificare che in fase di stampa del template indicato siano presenti le modifiche indicate | 1.0 |  |  |  |  |
| SIUT | SIES | 202405300126 |  |  | 202405300126 | Correzione template |  | SIEP | SIEP - Correzione template | TF002.SIEP | Errore nel contenuto del template |  |  |  | Verifica: Verificare che in fase di stampa del template indicato siano presenti le modifiche indicate | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.6.3.0 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20240628-Allegato_al_piano_test_SIES_v.12.6.3.0.xlsx |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |  |  |  |  |  |  |  |  |
| TF001.SIEP | SIEP | Errore nel contenuto del template |  | Verifica: Verificare che in fase di stampa del template indicato siano presenti le modifiche indicate |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o selezionare un procedimento con modalità pagamento rata unica e condannato Libero |  |  |  |  |  |  |  |  |  |  |  |  |  |
...
|  | 3 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | Produzione template "SIEP_PP_OI_PAGAMENTO_UN.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto siano presenti le correzioni indicate |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o selezionare un procedimento con modalità pagamento rata unica e condannato Detenuto |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 4 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione / Altri Provvedimenti » Ordine Ingiunzione |  | Visualizzazione pagina "Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 5 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 6 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | Produzione template "SIEP_PP_OI_PAGAMENTO_UN_DET.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto siano presenti le correzioni indicate |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o selezionare un procedimento con modalità pagamento rateizzato e condannato Libero |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 7 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione / Altri Provvedimenti » Ordine Ingiunzione |  | Visualizzazione pagina "Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 8 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 9 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | Produzione template "SIEP_PP_OI_PAGAMENTO_RR.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto siano presenti le correzioni indicate |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o selezionare un procedimento con modalità pagamento rateizzato e condannato Detenuto |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 10 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione / Altri Provvedimenti » Ordine Ingiunzione |  | Visualizzazione pagina "Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 11 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 12 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | Produzione template "SIEP_PP_OI_PAGAMENTO_RR_DET.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto siano presenti le correzioni indicate |  |  |  |  |  |  |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errore nel contenuto del template |  | Verifica: Verificare che in fase di stampa del template indicato siano presenti le modifiche indicate |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Procura della Repubblica presso il Tribunale" | Axxxxx (Procura della Repubblica presso il Tribunale) |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Selezionare un procedimento su cui sia stato già emesso un ordine di ingiunzione al pagamento |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 1 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione / Altri Provvedimenti » Rideterminazione della Pena Pecuniaria |  | Visualizzazione pagina "Inserimento Provvedimento Rideterminazione della Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Rideterminazione Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 3 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | Produzione template "SIEP_PP_PR_RIDET_PP.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto siano presenti le correzioni indicate |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Selezionare un procedimento su cui sia stato già emesso un ordine di ingiunzione al pagamento |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 4 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione / Altri Provvedimenti » Trasmissione Atti per la Conversione |  | Visualizzazione pagina "Inserimento Provvedimento Trasmissione Atti per la Conversione" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 5 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Trasmissione Atti per la Conversione Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 6 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | Produzione template "SIEP_PP_TRASM_RICH_CONV.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto siano presenti le correzioni indicate |  |  |  |  |  |  |  |  |  |  |  |  |
