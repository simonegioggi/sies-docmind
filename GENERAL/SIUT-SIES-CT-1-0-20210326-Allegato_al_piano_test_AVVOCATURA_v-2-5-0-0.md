---
uniqueName: siut-sies-ct-1-0-20210326-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20210326 Allegato al piano test AVVOCATURA v 2 5 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210326-Allegato_al_piano_test_AVVOCATURA_v.2.5.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.5.0.0/SIUT-SIES-CT-1.0-20210326-Allegato_al_piano_test_AVVOCATURA_v.2.5.0.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210326-Allegato-al-piano-test_AVVOCATURA_v.2.5.0.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210326-Piano_dei_Test_AVVOCATURA_v.2.5.0.0.doc |
|  | Versione | 1.0 |
|  | Data | 44281.0 |
|  | Intervento | AVVOCATURA v.2.5.0.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA v.2.5.0.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210326-Allegato-al-piano-test_AVVOCATURA_v.2.5.0.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202103110112.0 |  |  | 202103110112.0 | versione 2.4.0 - rif Ticket#202103040111 (da Versione 2.3.0 - rif. ticket 20210205017) |  | SIUS | SIUS - versione 2.4.0 - rif Ticket#202103040111 (da Versione 2.3.0 - rif. ticket 20210205017) | TF001.SIUS | Verifica visualizzazione della colonna esito provvedimento solo con Data Deposito presente e validata |  |  |  | Verifica: verificare che l'elenco dei fascicoli ottenuti dalla ricerca per soggetto visualizzano la colonna esito provvedimento solo se la Data Deposito è valorizzata e validata | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA v.2.5.0.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210326-Allegato-al-piano-test_AVVOCATURA_v.2.5.0.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | 01 | Verifica visualizzazione della colonna esito provvedimento solo con Data Deposito presente e validata |  | Verifica: verificare che l'elenco dei fascicoli ottenuti dalla ricerca per soggetto visualizzano la colonna esito provvedimento solo se la Data Deposito è valorizzata e validata |  | 1.0 |  |  | OK |
...
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un procedimento con un'ordinanza con Data Deposito non validata, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
...
|  | V | Verifica | Verificare che per il procedimento avente un'ordinanza con Data Deposito non validata venga prospettato il contenuto della colonna Data Deposito mentre il contenuto della colonna Esito Provvedimento è vuoto. |  |  |  |  |  |  |
|  | 4 | Azione | L'utense seleziona tramite il link contenuto nella colonna N.SIUS il procedimento. |  | Visualizazzione pagina contenente il dettaglio del procedimento |  |  |  |  |
|  | 5 | Azione | Nella sezione Provvedimenti, l'utente visualizza con l'apposita icona della lente il provvedimento |  | Visualizzazione pagina dettaglio provvedimento |  |  |  |  |
|  | V | Verifica | Verificare che non venga prospettata la sezione Esiti mentre è valorizzata la Data del Deposito dell'ordinanza. |  |  |  |  |  |  |
|  | 6 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 7 | Azione | L'utente ricerca un soggetto che abbia almeno un procedimento con un'ordinanza con Data Deposito validata, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 8 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che per il procedimento con un'ordinanza avente Data Deposito validata venga prospettato il contenuto delle colonne Esito Provvedimento e Data Deposito. |  |  |  |  |  |  |
|  | 9 | Azione | L'utente seleziona tramite il link contenuto nella colonna N.SIUS il procedimento. |  | Visualizazzione pagina contenente il dettaglio del procedimento |  |  |  |  |
|  | 10 | Azione | Nella sezione Provvedimenti, l'utente visualizza con l'apposita icona della lente il provvedimento |  | Visualizzazione pagina dettaglio provvedimento |  |  |  |  |
|  | V | Verifica | Verificare che venga prospettata la sezione Esiti con lo stesso contenuto visualizzato nella pagina Elenco Fascicoli dello step 8 e la Data Deposito dell'ordinanza. |  |  |  |  |  |  |
|  | 11 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 12 | Azione | L'utente ricerca un soggetto che abbia almeno un procedimento con un'ordinanza senza Data Deposito, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 13 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che per il procedimento avente un'ordinanza senza Data Deposito non venga prospettato il contenuto della colonna Esito Provvedimento. |  |  |  |  |  |  |
|  | 14 | Azione | L'utente seleziona tramite il link contenuto nella colonna N.SIUS il procedimento. |  | Visualizazzione pagina contenente il dettaglio del procedimento |  |  |  |  |
|  | 15 | Azione | Nella sezione Provvedimenti, l'utente visualizza con l'apposita icona della lente il provvedimento |  | Visualizzazione pagina dettaglio provvedimento |  |  |  |  |
|  | V | Verifica | Verificare che non venga visualizzata sia la sezione Esiti che la Data Deposito. |  |  |  |  |  |  |
