---
uniqueName: siut-sies-ct-1-0-20230526-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20230526 Allegato al piano test SIES v 12 4 29 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20230526-Allegato_al_piano_test_SIES_v.12.4.29.0

> **File originale:** `RILASCIO_12.4.29.0/SIUT-SIES-CT-1.0-20230526-Allegato_al_piano_test_SIES_v.12.4.29.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20230526-Allegato_al_piano_test_SIES_v.12.4.29.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20230526-Piano_dei_Test_SIES_v.12.4.29.0.docx |
|  | Versione | 1.0 |
|  | Data | 45072.0 |
|  | Intervento | SIES v.12.4.29.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.29.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20230526-Allegato_al_piano_test_SIES_v.12.4.29.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.29.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20230526-Allegato_al_piano_test_SIES_v.12.4.29.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | SIUS | Errore nella visualizzazione del procedimento senza magistrato |  | Verifica: verificare che la ricerca del procedimento senza magistrato vada a buon fine |  | 1.0 |  |  | OK |
...
|  | V | Verifica | Verificare che la ricerca vada a buon fine ed il fascicolo sia visualizzato correttamente |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
| TF002.SIUS | SIUS | Errore nella visualizzazione del procedimento |  | Verifica: verificare che la ricerca del procedimento vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | V | Verifica | Verificare che la ricerca vada a buon fine ed il fascicolo sia visualizzato correttamente |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
| TF003.SIUS | SIUS | Errore nella validazione del decreto |  | Verifica: verificare che la validazione del decreto per il procedimento con oggetto "SEMILIBERTA' - Modifica attività lavorativa" non presenti più il messaggio di errore ma vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
| TF001.SIGE | SIGE | Errore nell'inserimento del nominativo di un Magistrato |  | Verifica: verificare che l'inserimento del Magistrato in questione vada a buon fine invece di presentare il messaggio di errore bloccante |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
| TF004.SIUS | SIUS | Errore nella valorizzazione del campo "Data Restituzione" |  | Verifica: verificare che per le "Richieste Istruttorie" la "Data Restituzione" sia valorizzata correttamente |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
