---
uniqueName: siut-sies-sc-1-3-20230329-schedaintervento202313ps
displayName: "SIUT SIES SC 1 3 20230329 Scheda Intervento 2023 13 PST PagoPA"
category: "GENERAL"
tags: []
---

# SIUT-SIES-SC-1.3-20230329-Scheda_Intervento_2023_13_PST_PagoPA

> **File originale:** `MEV/SCHEDA_013/SIUT-SIES-SC-1.3-20230329-Scheda_Intervento_2023_13_PST_PagoPA.docx`  
> **Tipo:** DOCX
...
2.1	Iscrizione Procedimento	7
2.2	Iscrizione Pena Complessiva	7
2.3	Modalità Pagamento Pena Pecuniaria	9
2.4	Civilmente Obbligato per la Pena Pecuniaria	12
2.5	Gestione Riscossione Pene Pecuniarie	15
2.5.1	Ordine di ingiunzione Pagamento	16
2.5.2	Gestione Ordine Ingiunzione	19
2.5.3	Gestione Bollettini PagoPA	20
2.6	Base Dati	24
2.7	Integrazione servizio pagoPA	25
2.7.1	Architettura del servizio	25
2.7.2	Configurazione del certificato di comunicazione	27
2.7.3	Batch di verifica stato del Pagamento	27
2.7.4	Descrizione dei servizi WEB PST	28
3	Interventi su RegeWEB	32
3.1	Gestione Oblazione prevista per i procedimenti di competenza del tribunale ordinario	32
3.1.1	Acquisizione stato pagamenti	34
3.2	Gestione Decreto penale per procedimenti di competenza del tribunale ordinario Artt. 459 e 460 cpp	36
3.3	Abilitazione pagamenti tramite PagoPA	37
...
L’importo da pagare sarà uguale alla somma degli importi (visualizzati nella prima parte della form, per la Pena Pecuniara e per la Pena Pecuniaria sostitutiva) riportati in fase di iscrizione sentenza: sarà comunque modificabile.

L’importo indicato in Pagamento Unica Soluzione o la somma degli importi delle rate indicati inPagamento Rateizzato dovrebbero essere uguali a quanto indicato in Importo da Pagare. In caso di non corrispondenza il sistema invierà il seguente messaggio
...
Per la gestione di tutti gli aspetti connessi alla riscossione delle PenePecuniarie e delle Pene Sostitutive si interverrà nell’attuale  menu delle funzioni che il sistema presenta selezionando la voce
...
ad accedere alla funzione Notifiche per annotare le date di avvenuta notifica delprovvedimento, cliccando sul link .
...
Il batch interrogherà PagoPA per verificare lo stato dei pagamenti dei bollettini presenti sulla tabella BOLLETTINO_PAGOPA per i quali non risulta ancora pagato il bollettino (DATA_AVV_PAGAMENTO null e STATO_PAGAMENTO=NP) e per i quali le date DATA_SCADENZA e DATA_ULTIMO_CONTROLLO soddisfino le condizioni sotto descritte
...
In caso di oblazione per archiviazione totale a seguito di decreto positivo il sistema dovrà modificare la maschera di gestione richieste nel modo seguente, affinché l’utente possa generare il bollettino (pertanto nella casistica specificata il sistema dovrà mostrare il tab “PagoPA”):
...
N.B.: Sul bollettino vien indicato il totale da pagare (somma da oblare più spese)..
...
Analogo intervento deve essere fatto in caso di richiesta oblazione per archiviazione parziale. Anche in questo caso si accede alla funzione di generazione bollettino dalla maschera di gestione richieste.
...
L’utente se abilitato dovrà, quindi accedere ai quadri di gestione dell’imputato cui si riferisce l’oblazione, o in alternativa richiedere ad un utente abilitato, ed inserire il relativo codice fiscale per poi tornare alla funzione di generazione bollettino.
...
Nella casistica attuale, come per l’errore di generazione del bollettino, si potrà visualizzare il dettaglio dell’errore prodotto premendo sull’icona presente in “Stato Ricezione”
...
Nel decreto è indicata la somma da pagare con l’avviso che può essere effettuato il pagamento della pena pecuniaria in misura ridotta di un quinto, nel termine di quindici giorni dalla notificazione del decreto, con rinuncia all’opposizione.
...
Tale importo calcolato, solo nella casistica del Decreto Penale, verrà proposto nel totale della “somma da oblare” all’atto della generazione del bollettino.
...
La stima prevista complessiva è pari a 54.432,00 €.
