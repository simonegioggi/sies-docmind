---
uniqueName: siut-sies-ct-1-0-20230728-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20230728 Allegato al piano test SIES v 12 5 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20230728-Allegato_al_piano_test_SIES_v.12.5.2.0

> **File originale:** `RILASCIO_12.5.2.0/SIUT-SIES-CT-1.0-20230728-Allegato_al_piano_test_SIES_v.12.5.2.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20230728-Allegato_al_piano_test_SIES_v.12.5.2.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20230728-Piano_dei_Test_SIES_v.12.5.2.0.docx |
|  | Versione | 1.0 |
|  | Data | 45135.0 |
|  | Intervento | SIES v.12.5.2.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.5.2.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20230728-Allegato_al_piano_test_SIES_v.12.5.2.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202307130112.0 |  |  | 202307130112.0 | RITM0501535 - SIEP - problemi con "Ordine Esecuzione di Ingiunzione al Pagamento" |  | SIEP | SIEP - RITM0501535 - SIEP - problemi con "Ordine Esecuzione di Ingiunzione al Pagamento" | TF001.SIEP | Errore nella cancellazione di un provvedimento |  |  |  | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine | 1.0 |  |  |  |  |
| SIUT | SIES | 20230717011.0 |  |  | 20230717011.0 | Richiesta chiarimenti SIEP PAGAMENTO |  | SIEP | SIEP - Richiesta chiarimenti SIEP PAGAMENTO | TF002.SIEP | Errore nella cancellazione di un provvedimento |  |  |  | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine | 1.0 |  |  |  |  |
| SIUT | SIES | 20230717016.0 |  |  | 20230717016.0 | SIEP - Validazione provvedimento |  | SIEP | SIEP - SIEP - Validazione provvedimento | TF003.SIEP | Errore nella validazione di un provvedimento |  |  |  | Verifica: verificare che la validazione del provvedimento "Decisioni della Sorveglianza - Rigetto MA" vada a buon fine e che nella statistica "Riepilogo Ispettivo" il procedimento venga catalogato correttamente | 1.0 |  |  |  |  |
| SIUT | SIES | 20230717018.0 |  |  | 20230717018.0 | SIEP - Validazione provvedimento |  | SIEP | SIEP - SIEP - Validazione provvedimento | TF004.SIEP | Errore nella validazione di un provvedimento |  |  |  | Verifica: verificare che per un provvedimento di "Decisioni delle Sorveglianza" - "Affidamento in Prova" - "Concessione/Ratifica", avente come "Oggetto Ordinanza" la voce "Affidamento Servizio Sociale ex art. 94 DPR 309/90", la validazione vada a buon fine | 1.0 |  |  |  |  |
| SIUT | SIES | 202307180127.0 |  |  | 202307180127.0 | richiede di inserimento posizioni giuridiche Sospensione cautelativa 51 ter (Esecuzione presso domicilio della pena detentiva) |  | SIEP | SIEP - richiede di inserimento posizioni giuridiche Sospensione cautelativa 51 ter (Esecuzione presso domicilio della pena detentiva) | TF005.SIEP | Errore nella visualizzazione dell'elenco posizioni giuridiche |  |  |  | Verifica: verificare che nella combo "Posizione Giuridica" sia presente la voce "Sospensione cautelativa 51 ter (Esecuzione presso domicilio della pena detentiva)" | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.5.2.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20230728-Allegato_al_piano_test_SIES_v.12.5.2.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nella cancellazione di un provvedimento | 23 | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine |  | 1.0 |  |  | OK |
...
|  | 1.0 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione Pagamento |  | Visualizzazione pagina "Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori, e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |
|  | 3.0 | Navigazione | Elenco Provvedimenti del PM |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 4.0 | Azione | L'utente, nella colonna "Azioni", clicca sull'icona "Cancella" relativa all'Ordine Esecuzione di Ingiunzione al Pagamento |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la cancellazione vada a buon fine |  | Visualizzazione pagina "Elenco Provvedimenti PM" (se esistono altri provvedimenti per il facicolo) oppure "Dettaglio Procedimento" (se era l'unico provvedimento per il fascicolo) |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella cancellazione di un provvedimento | 23 | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 4.0 | Azione | L'utente, nella colonna "Azioni", clicca sull'icona "Cancella" relativa all'Ordine Esecuzione di Ingiunzione al Pagamento |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la cancellazione vada a buon fine |  | Visualizzazione pagina "Elenco Provvedimenti PM" (se esistono altri provvedimenti per il facicolo) oppure "Dettaglio Procedimento" (se era l'unico provvedimento per il fascicolo) |  |  |  |  |
| TF003.SIEP | SIEP | Errore nella validazione di un provvedimento | 23 | Verifica: verificare che la validazione del provvedimento "Decisioni della Sorveglianza - Rigetto MA" vada a buon fine e che nella statistica "Riepilogo Ispettivo" il procedimento venga catalogato correttamente |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o ricercare un fascicolo in stato validato in cui la posizione giuridica sia "Espiazione Pena in Regime Carcerario" |  |  |  |  |  |
|  | 1.0 | Navigazione | Sospensioni/Interruzioni del PM » Sospensione/Revoca OE |  | Visualizzazione pagina "Sospensione/Revoca dell'esecuzione della pena disposta dal PM" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori, e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Sospensione Esecuzione della pena disposta da pm" |  |  |  |  |
|  | 3.0 | Azione | L'utente clicca sull'icona di "Generazione Stampa", poi seleziona il checkbox "Valida Documento" e preme il tasto "Conferma" |  | Visualizzazione pagina "Trasferimento Decreto Sospensione" |  |  |  |  |
|  | 4.0 | Azione | L'utente clicca sul link "Procedimento: N. Anno/Numero" |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | V | Verifica | Verificare che la posizione giuridica sia "Libero in Sospensione" |  |  |  |  |  |  |
|  | 5.0 | Navigazione | Decisioni Sorveglianza » Rigetto Misure Alternative |  | Visualizzazione pagina "Inserimento Ordinanza Rigetto Misure Alternative" |  |  |  |  |
|  | 6.0 | Azione | L'utente riempie i campi obbligatori, e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza Rigetto Misure Alternative" |  |  |  |  |
|  | 7.0 | Azione | L'utente clicca sull'icona di "Generazione Stampa" | NON VALIDARE IL PROVVEDIMENTO! |  |  |  |  |  |
|  | 8.0 | Azione | L'utente clicca sul link "Procedimento: N. Anno/Numero" |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | V | Verifica | Verificare che puntando il mouse sulla dicitura "NON VALIDATO" la action di riferimento sia la "siap.siep.misuraalternativa.action.ActDettaglioMARigetto" |  |  |  |  |  |  |
|  | 9.0 | Navigazione | Elenco Provvedimenti del PM |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | V | Verifica | Verificare che puntando il mouse sull'icona "Dettagli", nella colonna "Azioni", la action di riferimento sia la "siap.siep.misuraalternativa.action.ActDettaglioMARigetto" |  |  |  |  |  |  |
|  | 10.0 | Azione | L'utente clicca sull'icona di "Modifica PM e Valida" nella colonna "Azioni" |  | Visualizzazione pagina "Modifica Magistrato Firmatario" |  |  |  |  |
|  | 11.0 | Azione | L'utente preme il pulsante "Conferma" | Aggiornamento Documento Avvenuto Correttamente! |  |  |  |  |  |
|  | V | Verifica | Verificare che la validazione vada a buon fine |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 12.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati | Classe I, Riepilogo Ispettivo | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI" |  |  |  |  |
|  | 13.0 | Azione | L'utente preme il pulsante "Conferma" |  | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI" |  |  |  |  |
|  | 14.0 | Azione | L'utente preme il pulsante "Conferma" | Seleziona Tutti | Produzione file "Document.xls" |  |  |  |  |
|  | V | Verifica | Verificare che il procedimento sia classificato, nel foglio "Dettagli", in "PROCEDIMENTI PENDENTI PER FATTORI ESTERNI - Ordini di Esecuzione Trasmessi agli Organi di Polizia e non ancora Eseguiti - Ordini di Esecuzione ex art. 656 co. 1 c.p." |  |  |  |  |  |  |
| TF004.SIEP | SIEP | Errore nella validazione di un provvedimento | 23 | Verifica: verificare che per un provvedimento di "Decisioni delle Sorveglianza" - "Affidamento in Prova" - "Concessione/Ratifica", avente come "Oggetto Ordinanza" la voce "Affidamento Servizio Sociale ex art. 94 DPR 309/90", la validazione vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o ricercare un fascicolo in stato validato in cui la posizione giuridica sia "Libero" |  |  |  |  |  |
...
|  | 2.0 | Azione | L'utente riempie i campi obbligatori, e preme il pulsante "Conferma" | "Oggetto Ordinanza" deve essere "Affidamento Servizio Sociale ex art. 94 DPR 309/90" | Visualizzazione pagina "Dettaglio Concessione Affidamento In Prova" |  |  |  |  |
|  | 3.0 | Azione | L'utente clicca sull'icona di "Generazione Stampa" | NON VALIDARE IL PROVVEDIMENTO! |  |  |  |  |  |
|  | 4.0 | Navigazione | Elenco Provvedimenti del PM |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 5.0 | Azione | L'utente clicca sull'icona di "Modifica PM e Valida" nella colonna "Azioni" |  | Visualizzazione pagina "Modifica Magistrato Firmatario" |  |  |  |  |
|  | 6.0 | Azione | L'utente preme il pulsante "Conferma" | Aggiornamento Documento Avvenuto Correttamente! |  |  |  |  |  |
|  | V | Verifica | Verificare che la validazione vada a buon fine |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
| TF005.SIEP | SIEP | Errore nella visualizzazione dell'elenco posizioni giuridiche | 23 | Verifica: verificare che nella combo "Posizione Giuridica" sia presente la voce "Sospensione cautelativa 51 ter (Esecuzione presso domicilio della pena detentiva)" |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o ricercare un fascicolo non validato |  |  |  |  |  |
|  | 1.0 | Navigazione | Aggiornamento Posizione Giuridica | Espiazione Pena in Istituto di Detenzione | Visualizzazione pagina "Modifica Posizione Giuridica" |  |  |  |  |
|  | V | Verifica | Verificare che nella combo "Posizione Giuridica" sia presente la voce "Sospensione Cautelativa 51 ter (Esecuzione presso domicilio della pena detentiva)". |  |  |  |  |  |  |
