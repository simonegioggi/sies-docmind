---
uniqueName: siut-sies-pt-1-0-20201012-pianodeitestsiesv-12-4-3
displayName: "SIUT SIES PT 1 0 20201012 Piano dei Test SIES v 12 4 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PT-1.0-20201012-Piano_dei_Test_SIES_v.12.4.3.0

> **File originale:** `RILASCIO_12.4.3.0/SIUT-SIES-PT-1.0-20201012-Piano_dei_Test_SIES_v.12.4.3.0.doc`  
> **Tipo:** DOC
...
Il presente documento descrive il piano dei test per la verifica della risoluzione dei ticket indicati nel piano di rilascio: SIUT-SIES-PR-1.0-20201012-Piano_di_Rilascio_SIES_v.12.4.3.0.docx.
...
SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls
...
L'entità oggetto di verifica è l'applicativo SIES relativamente alle funzionalità oggetto dei ticket indicati nel piano di rilascio SIUT-SIES-PR-1.0-20201012-Piano_di_Rilascio_SIES_v.12.4.3.0.doc.
...
I test sono eseguiti secondo quanto descritto nella relativa scheda contenuta nel documento SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls. In particolare, è stata compilata la colonna ‘Esito’ per indicare l'esito del test.
...
Per l'esecuzione dei test è stata installata la versione 12.4.3.0 di SIES secondo quanto stabilito dal documento di rilascio.
...
La descrizione di dettaglio di ciascun caso di test è contenuta nel documento SIUT-SIES-CT-1.0-20201012-Allegato-al-piano-test_SIES_v.12.4.3.0.xls a complemento del presente piano dei test.
