---
uniqueName: siut-sies-ct-1-0-20210115-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20210115 Allegato al piano test AVVOCATURA v 2 1 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210115-Allegato_al_piano_test_AVVOCATURA_v.2.1.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.1.0.0/SIUT-SIES-CT-1.0-20210115-Allegato_al_piano_test_AVVOCATURA_v.2.1.0.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210115-Allegato-al-piano-test_AVVOCATURA_v.2.1.0.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210115-Piano_dei_Test_AVVOCATURA_v.2.1.0.0.doc |
|  | Versione | 1.0 |
|  | Data | 44211.0 |
|  | Intervento | AVVOCATURA v.2.1.0.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA v.2.1.0.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210115-Allegato-al-piano-test_AVVOCATURA_v.2.1.0.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210104012.0 |  |  | 20210104012.0 | Visualizzazione ordinanza su SIUS-Avvocati |  | SIUS | SIUS - Visualizzazione ordinanza su SIUS-Avvocati | TF001.SIUS | Verifica corretta visualizzazione del dettaglio del provvedimento contenente una misura di sicurezza. |  |  |  | Verifica: verificare che nella lista dei provvedimenti associati ad un avvocato e ricercati per un Ufficio di Sorveglianza venga visualizzato correttamente quello contenente una misura di sicurezza. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA v.2.1.0.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210115-Allegato-al-piano-test_AVVOCATURA_v.2.1.0.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | 01 | Verifica corretta visualizzazione del dettaglio del provvedimento contenente una misura di sicurezza. |  | Verifica: verificare che nella lista dei provvedimenti associati ad un avvocato e ricercati per un Ufficio di Sorveglianza venga visualizzato correttamente quello contenente una misura di sicurezza. |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione: Ricerche estremi procedimenti. |  |  |  |  |  |  |
|  | 1 | Azione | L'utente seleziona il tab Consultazione |  | Visualizzazione pagina di Consultazione Avvisi |  |  |  |  |
|  | 2 | Azione | L'utente inserisce i dati di input. | Stato Avviso : Tutti
Distretto: selezionare dalla combo il distretto
Tipo Ufficio: selezionare dalla combo il valore 'Ufficio di Sorveglianza' |  |  |  |  |  |
|  | 3 | Azione | L'utente clicca sul pulsante Ricerca |  | Visualizzazione Elenco Avvisi |  |  |  |  |
|  | 4 | Azione | L'utente seleziona, tramite il link presente nella colonna Tipo Provvedimento, l'avviso che contiene una Misura di Sicurezza |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga prospettato correttamente il dettaglio del Provvedimento |  |  |  |  |  |  |
|  | 5 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 6 | Azione | L'utente ricerca un soggetto che abbia almeno un procedimento contenente una misura di sicurezza. |  |  |  |  |  |  |
|  | 7 | Azione | L'utente imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Il sistema restituisce l' elenco dei soggetti trovati dopo aver invocato il servizio di richiesta dati, passando in input i dati della ricerca ed il codice fiscale dell'utente avvocato che ha effettuato l'accesso. |  |  |  |  |
|  | 8 | Azione | L'utente dopo aver individuato il soggetto di interesse seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | 9 | Azione | L'utense seleziona tramite il link contenuto nella colonna N.SIUS il procedimento contenente delle misure di sicurezza. |  | Visualizazzione pagina contenente il dettaglio del procedimento |  |  |  |  |
|  | 10 | Azione | Nella sezione Provvedimenti, l'utente visualizza con l'apposita icona della lente il provvedimento contenente una misura di sicurezza |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga prospettato correttamente il dettaglio del Provvedimento |  |  |  |  |  |  |
