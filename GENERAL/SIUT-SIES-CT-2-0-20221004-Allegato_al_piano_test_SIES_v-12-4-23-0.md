---
uniqueName: siut-sies-ct-2-0-20221004-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 2 0 20221004 Allegato al piano test SIES v 12 4 23 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-2.0-20221004-Allegato_al_piano_test_SIES_v.12.4.23.0

> **File originale:** `RILASCIO_12.4.23.0/SIUT-SIES-CT-2.0-20221004-Allegato_al_piano_test_SIES_v.12.4.23.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20221004-Allegato_al_piano_test_SIES_v.12.4.23.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20221004-Piano_dei_Test_SIES_v.12.4.23.0.docx |
|  | Versione | 2.0 |
|  | Data | 44838.0 |
|  | Intervento | SIES v.12.4.23.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.23.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20221004-Allegato_al_piano_test_SIES_v.12.4.23.0.xls | Versione | 2.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220801013.0 |  |  | 20220801013.0 | Iscrizione manuale » Ricerca Procedimento SIEP per Soggetto – errore ricerca |  | SIGE | SIGE - Iscrizione manuale » Ricerca Procedimento SIEP per Soggetto – errore ricerca | TF001.SIGE | Errore nella ricerca soggetto per codice C.U.I. |  |  |  | Verifica: verificare che la ricerca soggetto per codice C.U.I. risponda solo col soggetto con quel codice (se esistente) e non con tutti i record dellatabella "SOGGETTO" | 1.0 |  |  |  |  |
| SIUT | SIES | 20220801014.0 |  |  | 20220801014.0 | RICERCA PROCEDIMENTI NON VALIDATI – VISUALIZZAZIONE PROCEDIMENTI DEFINITI |  | SIEP | SIEP - RICERCA PROCEDIMENTI NON VALIDATI – VISUALIZZAZIONE PROCEDIMENTI DEFINITI | TF001.SIEP | Errore nella ricerca dei procedimenti non validati |  |  |  | Verifica: verificare che nella ricerca dei procedimenti non validati non compaiano anche quelli classificati come definiti | 1.0 |  |  |  |  |
| SIUT | SIES | 202208040112.0 |  |  | 202208040112.0 | Trasferimento ordinanza |  | SIGE | SIGE - Trasferimento ordinanza | TF002.SIGE | Errata visualizzazione dell'icona di trasferimento provvedimento |  |  |  | Verifica: verificare che dopo il deposito di un provvedimento (ordinanza o decreto) non sia più visibile l'icona di trasferimento provvedimento | 1.0 |  |  |  |  |
| SIUT | SIES | 20220824016.0 |  |  | 20220824016.0 | EMISSIONE DOPPIA FIRMA MAGISTRATO NEI DECRETI DI ESTINZIONE DELLA L.C. |  | SIUS | SIUS - EMISSIONE DOPPIA FIRMA MAGISTRATO NEI DECRETI DI ESTINZIONE DELLA L.C. | TF001.SIUS | Errore per presenza doppia firma magistrato |  |  |  | Verifica: verificare che nel template incriminato non sia più presente la doppia firma del magistrato | 1.0 |  |  |  |  |
| SIUT | SIES | 20220906012.0 |  |  | 20220906012.0 | Correzione template Siep-ma-revo-affi-sosp |  | SIEP | SIEP - Correzione template Siep-ma-revo-affi-sosp | TF002.SIEP | Errata visualizzazione del destinatario della notifica per tre casi speciali |  |  |  | Verifica: verificare che nel caso che l'utente selezioni una delle tre voci ("Notifica ai sensi dell'art. 148 co. 2 bis c.p.p.", "Notifica ai sensi dell'art. 148 comma 2 bis c.p.p.", "Notifica tramite SNT") nel template venga stampata la dicitura "per la notifica, nei termini di legge, al difensore" | 1.0 |  |  |  |  |
| SIUT | SIES | 20220907011.0 |  |  | 20220907011.0 | Estrazione dati - Oggetto non qualificabile |  | SIGE | SIGE - Estrazione dati - Oggetto non qualificabile | TF003.SIGE | Errata classificazione dei procedimenti privi di oggetto |  |  |  | Verifica: verificare che, in fase di creazione del foglio statistica, per i procedimenti privi di oggetto venga stampata la dicitura  'Oggetto non presente' | 1.0 |  |  |  |  |
| SIUT | SIES | 20220907012.0 |  |  | 20220907012.0 | Riscontro anomalie estrazioni dati con più oggetti |  | SIGE | SIGE - Riscontro anomalie estrazioni dati con più oggetti | TF004.SIGE | Errata classificazione dei procedimenti con più oggetti |  |  |  | Verifica: verificare che, in fase di creazione del foglio statistica, siano gestiti correttamente gli oggetti per i procedimenti con più oggetti | 1.0 |  |  |  |  |
| SIUT | SIES | 202209260112.0 |  |  | 202209260112.0 | Patch mensili - Test- SIES versione 12.4.23.0 ticket 202208040112 - Sige Trasferimento ordinanza |  | SIGE | SIGE - Patch mensili - Test- SIES versione 12.4.23.0 ticket 202208040112 - Sige Trasferimento ordinanza | TF002.SIGE | Errata assenza dell'icona di trasferimento provvedimento |  |  |  | Verifica: verificare che dopo il deposito di un provvedimento (ordinanza o decreto) sia visibile l'icona di trasferimento provvedimento | 2.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.23.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20221004-Allegato_al_piano_test_SIES_v.12.4.23.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIGE | SIGE | Errore nella ricerca soggetto per codice C.U.I. |  | Verifica: verificare che la ricerca soggetto per codice C.U.I. risponda solo col soggetto con quel codice (se esistente) e non con tutti i record dellatabella "SOGGETTO" |  | 1.0 |  |  | OK |
...
|  | 1.0 | Navigazione | Iscrizione manuale » Ricerca Procedimento SIEP per Soggetto |  | Visualizzazione pagina "Ricerca Procedimento SIEP per Soggetto" |  |  |  |  |
|  | 2.0 | Azione | Riempire il campo "Codice CUI" e premere il tasto "Ricerca" |  | Visualizzazione pagina "Elenco Procedimenti SIEP" |  |  |  |  |
|  | V | Verifica | Verificare che la ricerca estragga puntualmente il soggetto col codice C.U.I. immesso e l'elenco dei suoi procedimenti |  |  |  |  |  |  |
| TF001.SIEP | SIEP | Errore nella ricerca dei procedimenti non validati |  | Verifica: verificare che nella ricerca dei procedimenti non validati non compaiano anche quelli classificati come definiti |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Ricerche » Elenchi » Procedimenti non validati |  | Visualizzazione pagina "Ricerca Procedimenti Non Validati" |  |  |  |  |
|  | 2.0 | Azione | Premere il tasto "Ricerca" |  | Visualizzazione pagina "Elenco Procedimenti Non Validati" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di elenco non vengano visualizzati i fascicoli con stato procedimento "Archiviato, Definito, ecc." [ soprattutto i classe 9 (90000)] |  |  |  |  |  |  |
| TF002.SIGE | SIGE | Errata visualizzazione dell'icona di trasferimento provvedimento |  | Verifica: verificare che dopo il deposito di un provvedimento (ordinanza o decreto) non sia più visibile l'icona di trasferimento provvedimento |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come "Gip Presso il Tribunale Ordinario" | P***** (GIP presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare od iscrivere un fascicolo privo di provvedimenti | Visualizzazione pagina "Dettaglio Procedimento SIGE" |  |  |  |  |
|  | 1.0 | Navigazione | Ordinanze/Deposito/Notifiche » Emissione Ordinanza |  | Visualizzazione pagina "Emissione Ordinanza" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 3.0 | Azione | Eseguire l'operazione di "Scarico Esito - Unico per Oggetto", inserire l'esito e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 4.0 | Azione | Premere l'icona di "Generazione Stampa" o "Upload Stampa" e premere il tasto "Conferma" | Ordinanza validata | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 5.0 | Navigazione | Ordinanze/Deposito/Notifiche » Deposito Ordinanza |  | Visualizzazione pagina "Deposito Ordinanza del  gg/mm/aaaa" |  |  |  |  |
|  | 6.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | 8.0 | Azione | Premere l'icona di "Generazione Stampa" o "Upload Stampa" e premere il tasto "Conferma" | Ordinanza depositata | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di "Dettaglio Deposito Ordinanza" non sia presente, accanto all'icona di stampa, l'icona di trasferimento ordinanza | (Ripetere le stesse operazioni per la validazione e deposito di un decreto) |  |  |  |  |  |
| TF001.SIUS | SIUS | Errore per presenza doppia firma magistrato |  | Verifica: verificare che nel template incriminato non sia più presente la doppia firma del magistrato |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare od iscrivere un fascicolo con Contenuto "Dichiarazione estinzione Libertà controllata" |  |  |  |  |  |
|  | 1.0 | Navigazione | Decreti » Emissione Decreto |  | Visualizzazione pagina "Emissione Decreto" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Emissione Decreto Declaratoria Estinzione Sanzioni Sostitutive" |  |  |  |  |
|  | 3.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Decreto Declaratoria Estinzione Sanzioni Sostitutive" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sull'icona di "Generazione Stampa" | Generazione stampa "SIUS_DE_ESTINZIONESS.rtf" |  |  |  |  |  |
|  | V | Verifica | Verificare che nella stampa prodotta la dicitura "IL MAGISTRATO DI SORVEGLIANZA" compaia una sola volta |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errata visualizzazione del destinatario della notifica per tre casi speciali |  | Verifica: verificare che nel caso che l'utente selezioni una delle tre voci ("Notifica ai sensi dell'art. 148 co. 2 bis c.p.p.", "Notifica ai sensi dell'art. 148 comma 2 bis c.p.p.", "Notifica tramite SNT") nel template venga stampata la dicitura "per la notifica, nei termini di legge, al difensore" |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura Generale della Repubblica Presso la Corte D'Appello" | Cxxxxx (Procura Generale della Repubblica Presso la Corte D'Appello) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare od iscrivere un procedimento con un soggetto con Posizione Giuridica "Sospensione Cautelativa 51 Ter (di Aff. in Prova)" |  |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni Sorveglianza >> Affidamento in Prova alServizio Sociale >> Revoca |  | Visualizzazione pagina "Revoca Affidamento in Prova" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Revoca Affidamento in Prova" |  |  |  |  |
|  | 3.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Nella sezione "Destinatario per Notifica", scegliere nel campo "Autorita' Destinazione" una delle tre voci: "Notifica ai sensi dell'art. 148 co. 2 bis c.p.p.", "Notifica ai sensi dell'art. 148 comma 2 bis c.p.p.", "Notifica tramite SNT" | Visualizzazione pagina "Dettaglio Revoca Affidamento in Prova" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sull'icona di "Generazione Stampa" | Generazione stampa "SIEP_MA_REVO_AFFI_SOSP.rtf" |  |  |  |  |  |
|  | V | Verifica | Verificare che nella stampa prodotta esca, nella sezione "MANDA", la dicitura "per la notifica, nei termini di legge, al difensore" |  |  |  |  |  |  |
| TF003.SIGE | SIGE | Errata classificazione dei procedimenti privi di oggetto |  | Verifica: verificare che, in fase di creazione del foglio statistica, per i procedimenti privi di oggetto venga stampata la dicitura  'Oggetto non presente' |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come "Corte D'Appello" | K***** (Corte D'Appello) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati - Ricerca Procedimento SIGE per Estremi Atto |  | Visualizzazione pagina "Ricerca Procedimento SIGE per Estremi Atto" |  |  |  |  |
|  | 2.0 | Azione | Nel campo "Oggetto" selezionare "Oggetto non qualificabile", scegliere il radio button "Solo Pendenti" ed indicare come "Data Fine Pendenza" la data corrente e premere il tasto "Statistica" | Generazione primo file Excel |  |  |  |  |  |
|  | 3.0 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati - Ricerca Procedimento SIGE per Estremi Atto |  | Visualizzazione pagina "Ricerca Procedimento SIGE per Estremi Atto" |  |  |  |  |
|  | 4.0 | Azione | Nel campo "Oggetto" selezionare "Tutti", scegliere il radio button "Solo Pendenti" ed indicare come "Data Fine Pendenza" la data corrente e premere il tasto "Statistica" | Generazione secondo file Excel |  |  |  |  |  |
|  | V | Verifica | Verificare che nel secondo file Excel tutti i procedimenti privi di oggetto riportino la dicitura "Oggetto non presente" e che in entrambi i file Excel il numero di fascicoli con oggetto uguale ad "Oggetto non qualificabile" sia lo stesso |  |  |  |  |  |  |
| TF004.SIGE | SIGE | Errata classificazione dei procedimenti con più oggetti |  | Verifica: verificare che, in fase di creazione del foglio statistica, siano gestiti correttamente gli oggetti per i procedimenti con più oggetti |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati - Ricerca Procedimento SIGE per Estremi Atto |  | Visualizzazione pagina "Ricerca Procedimento SIGE per Estremi Atto" |  |  |  |  |
|  | 2.0 | Azione | Nel campo "Oggetto" selezionare "Applicazione Indulto", scegliere il radio button "Solo Pendenti" ed indicare come "Data Fine Pendenza" la data corrente e premere il tasto "Statistica" | Generazione primo file Excel |  |  |  |  |  |
|  | 3.0 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati - Ricerca Procedimento SIGE per Estremi Atto |  | Visualizzazione pagina "Ricerca Procedimento SIGE per Estremi Atto" |  |  |  |  |
|  | 4.0 | Azione | Nel campo "Oggetto" selezionare "Tutti", scegliere il radio button "Solo Pendenti" ed indicare come "Data Fine Pendenza" la data corrente e premere il tasto "Statistica" | Generazione secondo file Excel |  |  |  |  |  |
|  | V | Verifica | Verificare che, nel primo file Excel, il sistema non visualizzi solo i procedimenti per singola voce; mentre nel secondo file Excel, i procedimenti privi di oggetto non siano classificati come "Applicazione Indulto" e che in entrambi i file Excel il numero di fascicoli con oggetto uguale ad "Applicazione Indulto" sia lo stesso |  |  |  |  |  |  |
| TF002.SIGE | SIGE | Errata assenza dell'icona di trasferimento provvedimento |  | Verifica: verificare che dopo il deposito di un provvedimento (ordinanza o decreto) sia visibile l'icona di trasferimento provvedimento |  | 2.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 6.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | 8.0 | Azione | Premere l'icona di "Generazione Stampa" o "Upload Stampa" e premere il tasto "Conferma" | Ordinanza depositata | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di "Dettaglio Deposito Ordinanza" sia presente, accanto all'icona di stampa, l'icona di trasferimento ordinanza | (Ripetere le stesse operazioni per la validazione e deposito di un decreto) |  |  |  |  |  |
