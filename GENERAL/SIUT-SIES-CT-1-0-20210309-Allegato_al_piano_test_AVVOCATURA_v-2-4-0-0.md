---
uniqueName: siut-sies-ct-1-0-20210309-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20210309 Allegato al piano test AVVOCATURA v 2 4 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210309-Allegato_al_piano_test_AVVOCATURA_v.2.4.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.4.0.0/SIUT-SIES-CT-1.0-20210309-Allegato_al_piano_test_AVVOCATURA_v.2.4.0.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210309-Allegato-al-piano-test_AVVOCATURA_v.2.4.0.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210309-Piano_dei_Test_AVVOCATURA_v.2.4.0.0.doc |
|  | Versione | 1.0 |
|  | Data | 44281.0 |
|  | Intervento | AVVOCATURA v.2.4.0.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA v.2.4.0.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210309-Allegato-al-piano-test_AVVOCATURA_v.2.4.0.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202103040111.0 |  |  | 202103040111.0 | SIES - Avvocatura -  Versione 2.3.0 - rif. ticket 20210205017 |  | SIUS | SIUS - SIES - Avvocatura -  Versione 2.3.0 - rif. ticket 20210205017 | TF001.SIUS | Verifica visualizzazione della colonna esito provvedimento solo con Data Deposito presente |  |  |  | Verifica: verificare che l'elenco dei fascicoli ottenuti dalla ricerca per soggetto visualizzano la colonna esito provvedimento solo se la Data Deposito è valorizzata | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA v.2.4.0.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210309-Allegato-al-piano-test_AVVOCATURA_v.2.4.0.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | 01 | Verifica visualizzazione della colonna esito provvedimento solo con Data Deposito presente |  | Verifica: verificare che l'elenco dei fascicoli ottenuti dalla ricerca per soggetto visualizzano la colonna esito provvedimento solo se la Data Deposito è valorizzata |  | 1.0 |  |  | OK |
...
|  | V | Verifica | Verificare che venga prospettato il contenuto della colonna Esito Provvedimento solo se è valorizzata la Data Deposito. |  |  |  |  |  |  |
...
|  | V | Verifica | Verificare che venga prospettata la sezione Esiti con lo stesso contenuto visualizzato nella pagina Elenco Fascicoli dello step 3 solo se è valorizzata la Data del Deposito dell'ordinanza. |  |  |  |  |  |  |
