---
uniqueName: siut-sies-ct-1-0-20220722-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220722 Allegato al piano test SIES v 12 4 22 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_SIES_v.12.4.22.0

> **File originale:** `RILASCIO_12.4.22.0/SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_SIES_v.12.4.22.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_SIES_v.12.4.22.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220722-Piano_dei_Test_SIES_v.12.4.22.0.docx |
|  | Versione | 1.0 |
|  | Data | 44764.0 |
|  | Intervento | SIES v.12.4.22.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.22.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_SIES_v.12.4.22.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202206270113.0 |  |  | 202206270113.0 | Nella lettera di trasmissione mancano i destinatari |  | SIEP | SIEP - Nella lettera di trasmissione mancano i destinatari | TF001.SIEP | Aggiornamento destinatari nella lettera di trasmissione |  |  |  | Verifica: verificare che, nel template indicato, sia aggiornata la lista dei destinatari | 1.0 |  |  |  |  |
| SIUT | SIES | 20220628015.0 |  |  | 20220628015.0 | iscrizione soggetto manuale – mancata visibilità codice C.U.I. SUL DETTAGLIO DEL PROCEDIMENTO |  | SIGE | SIGE - iscrizione soggetto manuale – mancata visibilità codice C.U.I. SUL DETTAGLIO DEL PROCEDIMENTO | TF001.SIGE | Mancata visibilità codice C.U.I. sul dettaglio del procedimento |  |  |  | Verifica: verificare che nella pagina di dettaglio del procedimento sia visibile il C.U.I. se valorizzato | 1.0 |  |  |  |  |
| SIUT | SIES | 20220706018.0 |  |  | 20220706018.0 | iscrizione decreto penale – visualizzazione maschera errata |  | SIGE | SIGE - iscrizione decreto penale – visualizzazione maschera errata | TF002.SIGE | Errata visualizzazione maschera inserimento Decreto Penale |  |  |  | Verifica: verificare che il sistema presenti la maschera di iscrizione decreto penale piuttosto che quella della sentenza straniera delibata | 1.0 |  |  |  |  |
| SIUT | SIES | 20220712011.0 |  |  | 20220712011.0 | Eliminazione messaggio di attenzione dopo emissione provvedimento di cumulo |  | SIEP | SIEP - Eliminazione messaggio di attenzione dopo emissione provvedimento di cumulo | TF002.SIEP | Errata presentazione messaggio di attenzione dopo emissione provvedimento di cumulo |  |  |  | Verifica: verificare che il sistema non presenti più un messaggio di attenzione dopo aver emesso un provvedimento di cumulo | 1.0 |  |  |  |  |
| SIUT | SIES | 20220713016.0 |  |  | 20220713016.0 | anomalia statistiche sies |  | SIEP | SIEP - anomalia statistiche sies | TF003.SIEP | Errata catalogazione di alcuni procedimenti nel riepilogo ispettivo |  |  |  | Verifica: verificare che, nel riepilogo ispettivo, i procedimenti con stato "Richiesta Informazioni in Data" siano catalogati correttamente | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.22.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_SIES_v.12.4.22.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Aggiornamento destinatari nella lettera di trasmissione |  | Verifica: verificare che, nel template indicato, sia aggiornata la lista dei destinatari |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere un fascicolo di Classe I (soggetto + sentenza) o ricercarne uno con soggetto con posizione giuridica "Affidamento in Prova Provvisorio" a seguito di provvedimento del Tribunale di Sorveglianza | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni Sorveglianza » Affidamento in Prova al Servizio Sociale » Concessione/Ratifica |  | Visualizzazione pagina "Concessione Affidamento In Prova" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Concessione Affidamento In Prova" |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Generazione Stampa" |  | Visualizzazione template "Siep-ma-affi-passaggio" |  |  |  |  |
|  | V | Verifica | Verificare che, nella sezione "MANDA", tra i destinatari compaia "Ufficio Esecuzione Penale Esterna competente" anziché "Centro servizio Sociale competente" |  |  |  |  |  |  |
| TF001.SIGE | SIGE | Mancata visibilità codice C.U.I. sul dettaglio del procedimento |  | Verifica: verificare che nella pagina di dettaglio del procedimento sia visibile il C.U.I. se valorizzato |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 1.0 | Navigazione | Iscrizione manuale » Iscrizione Soggetto |  | Visualizzazione pagina "Inserimento Soggetto" |  |  |  |  |
|  | 2.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" | Riempire anche il campo "Codice CUI" | Visualizzazione pagina "Dettaglio Soggetto" |  |  |  |  |
|  | 3.0 | Navigazione | Dal menù orizzontale a tendina scegliere la voce "Iscrizione Procedimento SIGE" |  | Visualizzazione pagina "Iscrizione Procedimento SIGE da Soggetto" |  |  |  |  |
|  | 4.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Procedimento SIGE" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di dettaglio procedimento SIGE sia riportato il C.U.I. nella sezione "Soggetto" |  |  |  |  |  |  |
| TF002.SIGE | SIGE | Errata visualizzazione maschera inserimento Decreto Penale |  | Verifica: verificare che il sistema presenti la maschera di iscrizione decreto penale piuttosto che quella della sentenza straniera delibata |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come "Tribunale Ordinario" | Txxxxx (Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Iscrizione manuale » Iscrizione Sentenza, Decreto Penale, Sentenza Straniera Delibata |  | Visualizzazione pagina "Inserimento Sentenza, Decreto Penale, Sentenza Straniera Delibata" |  |  |  |  |
|  | 2.0 | Azione | Selezionare il radio button "Decreto Penale" e riempire i campi "Anno/Numero R.G.N.R.", "Anno/Numero Reg.Gen. GIP", "Data Decreto", "Anno/Numero Decreto", "Autorità emittente" e "Luogo Emittente" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Estremi Decreto Penale" |  |  |  |  |
|  | 3.0 | Navigazione | Iscrizione manuale » Iscrizione Sentenza, Decreto Penale, Sentenza Straniera Delibata |  | Visualizzazione pagina "Inserimento Sentenza, Decreto Penale, Sentenza Straniera Delibata" |  |  |  |  |
|  | 4.0 | Azione | Selezionare il radio button "Decreto Penale" e riempire gli stessi campi con gli stessi valori (di cui al punto 2) e premere il tasto "Conferma" |  | Visualizzazione messaggio "Il decreto anno/num - Gip Presso il Tribunale Ordinario di luogo è già presente in archivio." |  |  |  |  |
|  | 5.0 | Azione | Premere il tasto "OK" |  | Visualizzazione pagina "Inserimento Sentenza, Decreto Penale, Sentenza Straniera Delibata" |  |  |  |  |
|  | V | Verifica | Verificare che il sistema presenti la pagina di inserimento "Decreto Penale" con gli stessi dati inseriti in precedenza e modificabili all'occorrenza |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errata presentazione messaggio di attenzione dopo emissione provvedimento di cumulo |  | Verifica: verificare che il sistema non presenti più un messaggio di attenzione dopo aver emesso un provvedimento di cumulo |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Aprire una Istruttoria di Cumulo (icona "Gestione Cumulo") su un fascicolo di Classe I o ricercarne una già aperta (icona "Ricerca Istruttorie Cumulo") | Visualizzazione pagina "Gestione Cumulo" |  |  |  |  |
|  | 1.0 | Navigazione | Chiusura cumulo » Dati Finali Cumulo |  | Visualizzazione pagina "Emissione Ordinanza" |  |  |  |  |
|  | 2.0 | Azione | Valorizzare una alla volta le sezioni "Dati Finali", "Pene Rideterminate", "Ulteriori sanzioni", "Posizione giuridica", "Calcolo Pena", ed "Emissione Provvedimento" ed, al termine, premere il tasto "Conferma" | Come "Posizione Giuridica" scegliere "Libero" e nella sezione "Provvedimento di esecuzione di pene concorrenti" scegliere la tipologia "Ordine di esecuzione per la carcerazione ex Art 656 comma 5 cpp" | Visualizzazione pagina "Dettaglio Provvedimento Determinazione Pene Concorrenti" |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Generazione Stampa" |  | Visualizzazione pagina "Dettaglio Provvedimento Determinazione Pene Concorrenti" |  |  |  |  |
|  | 4.0 | Azione | Selezionare il check box "Valida Documento" e premere il tasto "Conferma" | Premere il tasto "OK" | Visualizzazione pagina "Dettaglio Provvedimento Determinazione Pene Concorrenti" |  |  |  |  |
|  | 5.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Revoca Sospensione Esecuzione ex art. 656 c.p.p. |  | Visualizzazione pagina "Revoca Decreto Sospensione (legge 165/98)" |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non visualizzi il messaggio "Attenzione: Manca l'OE con sospensione" bensì la pagina di inserimento "Revoca Decreto Sospensione" |  |  |  |  |  |  |
| TF003.SIEP | SIEP | Errata catalogazione di alcuni procedimenti nel riepilogo ispettivo |  | Verifica: verificare che, nel riepilogo ispettivo, i procedimenti con stato "Richiesta Informazioni in Data" siano catalogati correttamente |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere un fascicolo di Classe I (e validarlo) o ricercarne uno già validato | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Istruttorie/Richieste » Notizie - Espulsione Sanzione Sostitutiva |  | Visualizzazione pagina "Notizie Espulsione Sanzione Sostitutiva" |  |  |  |  |
|  | 2.0 | Azione | Inseririe un "Luogo Detinazione", selezionare il radio button "Richiesta verifica avvenuta espulsione" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Notizie Espulsione Sanzione Sostitutiva" |  |  |  |  |
|  | 3.0 | Azione | Selezionare l'icona "Generazione Stampa", selezionare il campo "Valida Documento" e premere il tasto "Conferma" | Premere il tasto "OK" | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 4.0 | Navigazione | Assegnazioni » Assegnazione Stato Procedimento |  | Visualizzazione pagina "Assegnazione Stato del Procedimento" |  |  |  |  |
|  | 5.0 | Azione | Selezionare nel campo "Stato del Procedimento" la voce "Richiesta informazioni in data" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Assegnazione Stato del Procedimento" |  |  |  |  |
|  | 6.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Riepilogo ispettivo | Premere il tasto "Conferma" (due volte) | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI" |  |  |  |  |
|  | 7.0 | Azione | Premere il tasto "Seleziona Tutti" e premere il tasto "Conferma" |  | Elaborazione del file "Documento.xls" |  |  |  |  |
|  | V | Verifica | Verificare che nel documento Excel (foglio "Dettagli") il procedimento sia riportato nella categoria "PROCEDIMENTI PENDENTI PER FATTORI INTERNI - Procedimenti in fase istruttoria" |  |  |  |  |  |  |
