---
uniqueName: siut-sies-ct-1-0-20221125-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20221125 Allegato al piano test SIES v 12 4 25 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20221125-Allegato_al_piano_test_SIES_v.12.4.25.0

> **File originale:** `RILASCIO_12.4.25.0/SIUT-SIES-CT-1.0-20221125-Allegato_al_piano_test_SIES_v.12.4.25.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20221125-Allegato_al_piano_test_SIES_v.12.4.25.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20221125-Piano_dei_Test_SIES_v.12.4.25.0.docx |
|  | Versione | 1.0 |
|  | Data | 44890.0 |
|  | Intervento | SIES v.12.4.25.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.25.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20221125-Allegato_al_piano_test_SIES_v.12.4.25.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20221102013.0 |  |  | 20221102013.0 | riscontro trasmissioni/solleciti mancata eliminazione del record dopo annotazione provvedimento |  | SIEP | SIEP - riscontro trasmissioni/solleciti mancata eliminazione del record dopo annotazione provvedimento | TF001.SIEP | Errore nella comunicazione di Emissione Cumulo |  |  |  | Verifica: verificare che, Il sistema elimini il messaggio dopo l’annotazione sul procedimento dell’avvenuto assorbimento in cumulo | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.25.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20221125-Allegato_al_piano_test_SIES_v.12.4.25.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nella comunicazione di Emissione Cumulo |  | Verifica: verificare che, Il sistema elimini il messaggio dopo l’annotazione sul procedimento dell’avvenuto assorbimento in cumulo |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" e come "Procura Generale della Repubblica Presso la Corte D'Appello" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario)
Cxxxxx (Procura Generale della Repubblica Presso la Corte D'Appello) |  |  |  |  |  |
|  | P | Stato Base | L'utente di PGCAP si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un procedimento (in stato validato) | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Gestione Cumulo » Apertura Istruttoria |  | Visualizzazione pagina "Apertura Istruttoria Cumulo" |  |  |  |  |
|  | 2.0 | Azione | Premere il tasto "Conferma" |  | Visualizzazione pagina "Apertura Istruttoria Cumulo" |  |  |  |  |
|  | P | Stato Base | L'utente di PM si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un procedimento (in stato validato) | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 3.0 | Navigazione | Istruttorie/Richieste » Trasmissione per Competenza/Seguito Atti » Nel Distretto |  | Visualizzazione pagina "Ricerca Procedimento" |  |  |  |  |
|  | 4.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Carica" |  | Visualizzazione pagina "TRASMISSIONE PER COMPETENZA" |  |  |  |  |
|  | 5.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza - Seguito Atti" |  |  |  |  |
|  | 6.0 | Azione | Cliccare sull'icona di "Generazione Stampa" |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza - Seguito Atti" |  |  |  |  |
|  | 7.0 | Azione | Selezionare il checkbox "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza - Seguito Atti" |  |  |  |  |
|  | 8.0 | Azione | Cliccare sull'icona "Trasmissione Provvedimento" |  | Visualizzazione pagina "Trasferimento Trasmissione per Competenza - Seguito Atti" |  |  |  |  |
|  | 9.0 | Azione | Premere il tasto "Conferma" | Premere il tasto "OK" | Visualizzazione pagina "Trasferimento Trasmissione per Competenza - Seguito Atti" |  |  |  |  |
|  | P | Stato Base | L'utente di PGCAP si trova nella pagina principale dell'applicazione | Ricercare il procedimento iscritto in precedenza | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 10.0 | Navigazione | Gestione Cumulo » Atti Ricevuti per Competenza |  | Visualizzazione pagina "Lista Atti Ricevuti per Competenza" |  |  |  |  |
|  | 11.0 | Azione | Cliccare, nel campo "Azioni", sull'icona "Dettagli" |  | Visualizzazione pagina "Dettaglio Trasmissione Seguito Atti Competenza Ricevuti" |  |  |  |  |
|  | 12.0 | Azione | Cliccare sul tasto "Presa in Carico" |  | Visualizzazione pagina "Presa in carico Seguito Atti Ricevuti per Competenza" |  |  |  |  |
|  | 13.0 | Azione | Premere il tasto "Salva" ed "Iscrivi in Istruttoria" | Premere il tasto "OK" | Visualizzazione pagina "Elenco Provvedimenti Esecutivi Coinvolti" |  |  |  |  |
|  | 14.0 | Navigazione | Gestione Cumulo » Dati Finali Cumulo |  | Visualizzazione pagina "Dati Finali Cumulo" |  |  |  |  |
|  | 15.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Completare i tabulatori: "Pene Rideterminate" » "Ulteriori sanzioni" » "Posizione giuridica" » "Calcolo Pena" » "Emissione Provvedimento" | Visualizzazione pagina "Dettaglio Provvedimento Determinazione Pene Concorrenti" |  |  |  |  |
|  | 16.0 | Azione | Selezionare il checkbox "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Provvedimento Determinazione Pene Concorrenti" |  |  |  |  |
|  | 17.0 | Navigazione | Comunicazioni » Uffici Esecuzione Penale/Sorveglianza |  | Visualizzazione pagina "Comunicazioni alle Procure e Uffici di Sorveglianza" |  |  |  |  |
|  | 18.0 | Azione | Selezionare il provvedimento del PM e premere il tasto "Conferma" |  | Visualizzazione pagina "DETTAGLIO COMUNICAZIONI DI CUMULO ALLE PROCURE E UFFICI DI SORVEGLIANZA" |  |  |  |  |
|  | 19.0 | Azione | Selezionare il checkbox "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "DETTAGLIO COMUNICAZIONI DI CUMULO ALLE PROCURE E UFFICI DI SORVEGLIANZA" |  |  |  |  |
|  | 20.0 | Azione | Premere il tasto "Tramissione Provvedimento" | Premere il tasto "OK" | Visualizzazione pagina "DETTAGLIO COMUNICAZIONI DI CUMULO ALLE PROCURE E UFFICI DI SORVEGLIANZA" |  |  |  |  |
|  | P | Stato Base | L'utente di PM si trova nella pagina principale dell'applicazione |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 21.0 | Navigazione | Istruttorie/Richieste » Riscontro Trasmissioni/Solleciti |  | Visualizzazione pagina "Riscontro Trasmissioni/Solleciti" |  |  |  |  |
|  | 22.0 | Azione | Cliccare, nel campo "Azioni", sull'icona "Dettagli" | "COMUNICAZIONE CUMULO PROCURE COMPETENTI", "ASSORBITO IN CUMULO" | Visualizzazione pagina "Dettaglio Esito Trasmissione Competenza" |  |  |  |  |
|  | 23.0 | Azione | Premere il tasto "Annotazione Esito" |  | Visualizzazione pagina "ANNOTAZIONE ESITO TRASMISSIONE ATTI PER COMPETENZA" |  |  |  |  |
|  | 24.0 | Azione | Premere il tasto "Conferma" |  | Visualizzazione pagina "DETTAGLIO ANNOTAZIONE ESITO ATTI TRASMISSIONI PER COMPETENZA (ex artt. 663 e 665 comma 4 c.p.p.)" |  |  |  |  |
|  | 25.0 | Azione | Cliccare sull'icona "Valida Provvedimento" | Premere il tasto "OK" | Visualizzazione pagina "DETTAGLIO ANNOTAZIONE ESITO ATTI TRASMISSIONI PER COMPETENZA (ex artt. 663 e 665 comma 4 c.p.p.)" |  |  |  |  |
|  | 26.0 | Navigazione | Istruttorie/Richieste » Riscontro Trasmissioni/Solleciti |  | Visualizzazione pagina "Riscontro Trasmissioni/Solleciti" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di elenco non compaia più il messaggio relativo al riscontro della trasmissione/sollecito |  |  |  |  |  |  |
