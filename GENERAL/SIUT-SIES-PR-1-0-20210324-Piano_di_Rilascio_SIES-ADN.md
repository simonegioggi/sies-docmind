---
uniqueName: siut-sies-pr-1-0-20210324-pianodirilasciosies-adn
displayName: "SIUT SIES PR 1 0 20210324 Piano di Rilascio SIES ADN"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20210324-Piano_di_Rilascio_SIES-ADN

> **File originale:** `MEV/Integrazione SIES-ADN/RILASCIO_MEV_SIES-ADN (PRE GO-LIVE)/20210324_1.0/SIUT-SIES-PR-1.0-20210324-Piano_di_Rilascio_SIES-ADN.docx`  
> **Tipo:** DOCX
...
Gli interventi in oggetto sono rilasciati nell’ambito della release MEV_SIES-ADN di SIES.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 07 - MEV > 2019_002_Casellario_Sostituzione IGI > Verifica Conformità > 02_SIES > pre-golive | 1.0 | 24/03/2021 |
| Note-osservazioni |  |  |  |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20210324-Piano_di_Rilascio_MEV_SIES-ADN.docx
SIUT-SIE-PV-1.0-20210324-Piano delle verifiche_MEV_SIES-ADN.pdf
SIUT-SIE-MU-1.0-20210312-Manuale_Utente_MEV_SIES-ADN.pdf
SIGI_PNL_ML_20210312_1.5_Modello dei Dati_SIES.pdf
SIUT-SIES-PT-1.0-20210324-Piano_dei_Test_MEV_SIES-ADN.pdf
SIUT-SIES-CT-1.0-20210324-Allegato_al_piano_test_MEV_SIES-ADN.xlsx |
| Note-osservazioni |  |  |
...
Creare sul server DB una cartella MEV_SIES-ADN sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/ MEV_SIES-ADN/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella MEV_SIES-ADN tramite il comando:
chmod 777 MEV_SIES-ADN
...
Nella cartella appena creata (MEV_SIES-ADN), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/MEV_SIES-ADN/log/ in cui si può constatare l’esito dell’esecuzione.
