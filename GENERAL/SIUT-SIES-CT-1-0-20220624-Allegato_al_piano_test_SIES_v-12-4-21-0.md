---
uniqueName: siut-sies-ct-1-0-20220624-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220624 Allegato al piano test SIES v 12 4 21 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220624-Allegato_al_piano_test_SIES_v.12.4.21.0

> **File originale:** `RILASCIO_12.4.21.0/SIUT-SIES-CT-1.0-20220624-Allegato_al_piano_test_SIES_v.12.4.21.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220624-Allegato_al_piano_test_SIES_v.12.4.21.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220624-Piano_dei_Test_SIES_v.12.4.21.0.docx |
|  | Versione | 1.0 |
|  | Data | 44736.0 |
|  | Intervento | SIES v.12.4.21.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.21.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220624-Allegato_al_piano_test_SIES_v.12.4.21.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220530011.0 |  |  | 20220530011.0 | SIUS TRIBUNALE DI SORVEGLIANZA - ESITO ERRATO SU ORDINANZA DI REVOCAA |  | SIUS | SIUS - SIUS TRIBUNALE DI SORVEGLIANZA - ESITO ERRATO SU ORDINANZA DI REVOCAA | TF001.SIUS | Errata valorizzazione dell'esito per l'oggetto Revoca Ordinanza |  |  |  | Verifica: verificare che, per un procedimento con oggetto 'Revoca Ordinanza', dopo aver emesso una ordinanza con esito 'Revoca', nel 'Dettaglio Provvedimento' sia riportato l'esito 'Revoca' | 1.0 |  |  |  |  |
| SIUT | SIES | 202206010110.0 |  |  | 202206010110.0 | SIEP - Errore Cautelare sul Foglio Complementare |  | SIEP | SIEP - SIEP - Errore Cautelare sul Foglio Complementare | TF001.SIEP | Mancanza del test sul flagComputabile nel Template di stampa |  |  |  | Verifica: verificare che la stampa dell'ordinanza con oggetto 'archiviazione per estinzione pena Affidamento in Prova' non riporti nella sezione "Si comunica" i periodi di custodia cautelare non computabile | 1.0 |  |  |  |  |
| SIUT | SIES | 20220606017.0 |  |  | 20220606017.0 | esecuzione misura alternativa_luogo_esecuzione_misura |  | SIUS | SIUS - esecuzione misura alternativa_luogo_esecuzione_misura | TF002.SIUS | Errato dimensionamento della colonna LUOGO_ESECUZIONE_MISURA della tabella ESECUZIONE_MISURA_ALTERNATIVA |  |  |  | Verifica: verificare che, per una ordinanza di concessione di una misura, valorizzando il campo 'Luogo Svolgimento della Prova' con una descrizione di più di 100 caratteri, il sistema non presenti alcun messaggio bloccante | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.21.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220624-Allegato_al_piano_test_SIES_v.12.4.21.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | SIUS | Errata valorizzazione dell'esito per l'oggetto Revoca Ordinanza |  | Verifica: verificare che, per un procedimento con oggetto 'Revoca Ordinanza', dopo aver emesso una ordinanza con esito 'Revoca', nel 'Dettaglio Provvedimento' sia riportato l'esito 'Revoca' |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare un fascicolo SIUS già esistente (non definito) oppure iscriverne uno nuovo con contenuto "Concessione Misure Alternative alla Detenzione" | Visualizzazione Pagina "Dettaglio Procedimento SIUS" |  |  |  |  |
|  | 1.0 | Azione | Selezionare l'icona "Modifica" |  | Visualizzazione pagina "Modifica Procedimento" |  |  |  |  |
|  | 2.0 | Azione | Nella sezione "Oggetto" selezionare l'icona "Elenco di tutti gli Oggetti selezionabili", scegliere la voce "Revoca Provvedimento >> Revoca Ordinanza" e premere il tasto "Conferma"; una volta aggiunto l'oggetto salvare il procedimento premendo il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Procedimento SIUS" |  |  |  |  |
|  | 3.0 | Navigazione | Ordinanze » Emissione Ordinanza |  | Visualizzazione pagina "Emissione Ordinanza" |  |  |  |  |
|  | 4.0 | Azione | Inseririe una "Data Emissione" e premere il tasto "Conferma" |  | Visualizzazione pagina "Emissione Ordinanza Misura Alternativa" |  |  |  |  |
|  | 5.0 | Azione | Inserire l'esito "Revoca", in corrispondenza dell'oggetto "Revoca Ordinanza" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | V | Verifica | Verificare che il sistema, nella pagina di "Dettaglio Ordinanza", sezione "Esiti", riporti l'esito 'Revoca' in corrispondenza dell'oggetto "Revoca Ordinanza" |  |  |  |  |  |  |
| TF001.SIEP | SIEP | Mancanza del test sul flagComputabile nel Template di stampa |  | Verifica: verificare che la stampa dell'ordinanza con oggetto 'archiviazione per estinzione pena Affidamento in Prova' non riporti nella sezione "Si comunica" i periodi di custodia cautelare non computabile |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere un fascicolo di Classe I (soggetto + sentenza) o ricercarne uno in stato "Iscritto" | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Dal menù orizzontale a tendina scegliere la voce "Iscrizione Misure Cautelari" |  | Visualizzazione pagina "Misure Cautelari" |  |  |  |  |
|  | 2.0 | Azione | Premere il tasto "Cessata al momento del passaggio in giudicato non computabili" |  | Visualizzazione pagina "Inserimento Misura Cautelare - NON COMPUTABILE" |  |  |  |  |
|  | 3.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Elenco Misure Cautelari" |  |  |  |  |
|  | 4.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizzazione pagina "Emissione Ordine di Esecuzione - Libero" |  |  |  |  |
|  | 5.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine Esecuzione Condannato Libero" |  |  |  |  |
|  | 6.0 | Azione | Selezionare l'icona "Generazione Stampa", selezionare il campo "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine Esecuzione Condannato Libero" |  |  |  |  |
|  | 7.0 | Navigazione | Definizione Procedimento » Provvedimento Altra Autorità |  | Visualizzazione pagina "Definizione Procedimento - Provvedimento Altra Autorità" |  |  |  |  |
|  | 8.0 | Azione | Indicare come "Provvedimento emesso da": "Giudice Sorveglianza"; "Tipo Provvedimento": "Ordinanza"; "Oggetto Definizione": "archiviazione per estinzione pena Affidamento in Prova" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Definizione Procedimento - Provvedimento Altra Autorità" |  |  |  |  |
|  | 9.0 | Azione | Selezionare l'icona "Generazione Stampa" |  | Produzione del template "SIEP_ARC_ALTRA_AUTORITA" |  |  |  |  |
|  | V | Verifica | Verificare che il template di stampa non riporti nella sezione "Si comunica" i periodi di custodia cautelare non computabili |  |  |  |  |  |  |
| TF002.SIUS | SIUS | Errato dimensionamento della colonna LUOGO_ESECUZIONE_MISURA della tabella ESECUZIONE_MISURA_ALTERNATIVA |  | Verifica: verificare che, per una ordinanza di concessione di una misura, valorizzando il campo 'Luogo Svolgimento della Prova' con una descrizione di più di 100 caratteri, il sistema non presenti alcun messaggio bloccante |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIUS come "Tribunale di Sorveglianza" | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti con contenuto "Concessione Misure Alternative Alla Detenzione" e con Udienza fissata |  |  |  |  |  |
|  | 1.0 | Navigazione | Ordinanze » Emissione Ordinanza |  | Visualizzazione pagina "Emissione Ordinanza" |  |  |  |  |
|  | 2.0 | Azione | Inseririe una "Data Emissione" e premere il tasto "Conferma" |  | Visualizzazione pagina "Emissione Ordinanza Misura Alternativa" |  |  |  |  |
|  | 3.0 | Azione | Riempire tutti i campi obbligatori (per il campo "Luogo Svolgimento della Prova" inserire una descrizione di più di 100 caratteri) e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 4.0 | Azione | Selezionare l'icona "Generazione Stampa", selezionare il campo "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 5.0 | Navigazione | Ordinanze » Deposito Ordinanza |  | Visualizzazione pagina "Deposito Ordinanza SIUS del dd/mm/aaaa' |  |  |  |  |
...
|  | 7.0 | Azione | Selezionare l'icona "Generazione Stampa", selezionare il campo "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Deposito Ordinanza" |  |  |  |  |
|  | 8.0 | Azione | Selezionare l'icona "Trasferisci" |  | Visualizzazione pagina "Trasferimento Ordinanza" |  |  |  |  |
|  | 9.0 | Azione | Riempire i campi "Destinatario" e "Sede Destinatario" con i valori dell'Ufficio di Sorveglianza di competenza |  | Visualizzazione pagina "Trasferimento Ordinanza" |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Numero e anno del Procedimento del Tribunale di Sorveglianza di cui in precedenza (punti 1-9) |  |  |  |  |  |
|  | 10.0 | Navigazione | Presa in carico atti pervenuti » Ricerca per Atti - SIUS |  | Visualizzazione pagina "Presa in Carico - Ricerca Atti Per Estremi - SIUS" |  |  |  |  |
|  | 11.0 | Azione | Riempire i campi "Tipo Ufficio" e "Sede Ufficio" con i valori del Tribunale di Sorveglianza di competenza, "Numero SIUS (Anno/Progressivo)" coi dati memorizzati in precedenza |  | Visualizzazione pagina "Lista Atti ricevuti" |  |  |  |  |
|  | 12.0 | Azione | Cliccare sull'icona "Dettagli" nella colonna "Azioni" |  | Visualizzazione pagina "Dettaglio Ordinanza Ricevuta" |  |  |  |  |
|  | 13.0 | Azione | Premere il tasto "Conferma presa in carico" | Premere il tasto "OK" | Visualizzazione pagina "Presa in carico atto pervenuto da SIUS" |  |  |  |  |
|  | 14.0 | Azione | Riempire i campi obbligatori (contenuto "Esecuzione Misure Alternative") e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Procedimento SIUS" |  |  |  |  |
|  | 15.0 | Azione | Cliccare sul link "Anno/Numero" in corrispondenza della riga "Numero Procedimento E.M.A. - Anno/Numero (Esecuzione Misure Alternative)" nella sezione "Procedimento" |  | Visualizzazione pagina "Elenco dei Procedimenti relativi all'Esecuzione della Misura Alternativa" |  |  |  |  |
|  | V | Verifica | Verificare che il campo "Luogo esecuzione da Ordinanza" contenga la descrizione (di più di 100 caratteri) inserita con la form di Emissione Ordinanza dal Tribunale di Sorveglianza |  |  |  |  |  |  |
