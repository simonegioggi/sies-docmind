---
uniqueName: siut-sies-ct-1-0-20220225-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220225 Allegato al piano test SIES v 12 4 17 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220225-Allegato_al_piano_test_SIES_v.12.4.17.0

> **File originale:** `RILASCIO_12.4.17.0/SIUT-SIES-CT-1.0-20220225-Allegato_al_piano_test_SIES_v.12.4.17.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220225-Allegato_al_piano_test_SIES_v.12.4.17.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220225-Piano_dei_Test_SIES_v.12.4.17.0.docx |
|  | Versione | 1.0 |
|  | Data | 44617.0 |
|  | Intervento | SIES v.12.4.17.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.17.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220225-Allegato_al_piano_test_SIES_v.12.4.17.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220124016.0 |  |  | 20220124016.0 | STATISTICHE - ESTRAZIONE DATI - RIEPILOGO MOVIMENTO PROCEDIMENTI - |  | SIEP | SIEP - STATISTICHE - ESTRAZIONE DATI - RIEPILOGO MOVIMENTO PROCEDIMENTI - | TF001.SIEP | Estrazione dei Procedimenti in fase istruttoria iscritti e non validati. |  |  |  | Verifica: verificare che la funzionalità estragga anche i procedimenti con stato pari a ISCRITTO, ed inoltre anche i procedimenti privi di movimentazione. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220127012.0 |  |  | 20220127012.0 | Impossibilità aggiungere fascicoli a cumulo |  | SIEP | SIEP - Impossibilità aggiungere fascicoli a cumulo | TF002.SIEP | Iscrizione titoli in istruttoria di cumulo senza effetto. |  |  |  | Verifica: verificare che se un titolo che si stava iscrivendo era già in istruttoria cumulo, allora si possa proseguire con la lavorazione dell'istruttoria stessa. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220209011 |  |  | 20220209011 | Fascicoli archiviati per cumulo ancora pendenti nel riepilogo ispettivo. |  | SIEP | SIEP - Fascicoli archiviati per cumulo ancora pendenti nel riepilogo ispettivo. | TF003.SIEP | Presenza, nel riepilogo ispettivo, tra i procedimenti "in attesa di definizione", anche dei fascicoli iscritti in istruttoria per cumulo ed archiviati a seguito di emissione del provvedimento di cumulo stesso. |  |  |  | Verifica: verificare che nel riepilogo ispettivo tra i fascicoli pendenti non vi siano quelli iscritti in istruttoria di cumulo ed archiviati per emissione cumulo. | 1.0 |  |  |  |  |
| SIUT | SIES | 202202160112.0 |  |  | 202202160112.0 | Cumulo restituzione atti pervenuti |  | SIEP | SIEP - Cumulo restituzione atti pervenuti | TF004.SIEP | Errore nella funzione restituzione fascicoli - funzione esterna. |  |  |  | Verifica: verificare che dopo la ricerca degli atti presi in carico, la funzionalità di "Restituzione Fascicolo" non restituisca più un msg di errore. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.17.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220225-Allegato_al_piano_test_SIES_v.12.4.17.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Estrazione dei Procedimenti in fase istruttoria iscritti e non validati. |  | Verifica: verificare che la funzionalità estragga anche i procedimenti con stato pari a ISCRITTO, ed inoltre anche i procedimenti privi di movimentazione. |  | 1.0 |  |  | OK |
...
|  | 1.0 | Navigazione | Ricerche >> Procedimento | Tipo Ricerca: Avanzata 
Ricerca valida solo nell'Ufficio >> Intervallo Date di Iscrizione (massimo un anno) >> Classe IV | Visualizzazione pagina "Elenco Procedimenti": prendere nota dei procedimenti in stato "Iscritto" |  |  |  |  |
|  | 2.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati | Classe Procedimento: IV 
Tipologia Statistica: Movimento Procedimenti (Riepilogo Procedimenti Pendenti) | Visualizzazione pagina "RICERCA PROCEDIMENTI CLASSE IV" |  |  |  |  |
|  | 3.0 | Azione | Scegliere un Intervallo Date: "Data Inizio Periodo" e "Data Finale" e cliccare su "Conferma" | Lo stesso intervallo di tempo scelto al punto 1 | Visualizzazione pagina "STATISTICHE - ESTRAZIONE DATI - RIEPILOGO MOVIMENTO PROCEDIMENTI" |  |  |  |  |
|  | 4.0 | Azione | Nel riquadro "Selezione Stampa", selezionare la voce "PROCEDIMENTI ISCRITTI" e cliccare su "Conferma" |  | Download file .xls contenente la statistica richiesta |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio di Dettaglio ("Dettagli") nella categoria 'ISCRITTI' siano riportati tutti i procedimenti in stato di Iscritto, gli stessi presenti nell'elenco della ricerca Avanzata di cui si era presa nota al punto 1 |  |  |  |  |  |  |
| TF002.SIEP | 01 | Iscrizione titoli in istruttoria di cumulo senza effetto. |  | Verifica: verificare che se un titolo che si stava iscrivendo era già in istruttoria cumulo, allora si possa proseguire con la lavorazione dell'istruttoria stessa. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina Inserimento Sentenza |  |  |  |  |
|  | 2.0 | Azione | Iscrivere una nuova sentenza del tribunale ordinario (solo dati del primo grado) |  | Annotare i dati di anno e numero sentenza, data ed autorità emittente |  |  |  |  |
|  | 3.0 | Navigazione | Iscrizione » Soggetto |  | Visualizzazione pagina Inserimento Soggetto |  |  |  |  |
|  | 4.0 | Azione | Iscrivere un nuovo soggetto |  |  |  |  |  |  |
|  | 5.0 | Navigazione | Iscrizione » Procedimento |  | Visualizzazione pagina Inserimento Procedimento |  |  |  |  |
|  | 6.0 | Azione | Iscrivere un nuovo fascicolo SIEP (difensore, posizione giuridica, reati, pena complessiva, assegnazione al magistrato, validazione) |  | Visualizzazione pagina Dettaglio Procedimento in stato validato |  |  |  |  |
|  | 7.0 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina Inserimento Sentenza |  |  |  |  |
|  | 8.0 | Azione | Mantenendo il fascicolo (e soggetto) in sessione (Dati Correnti) procedere all'iscrizione di una nuova sentenza riportando gli stessi dati della precedente e aggiungendo i dati del secondo grado di giudizio |  | Visualizzazione pagina Dettaglio Sentenza |  |  |  |  |
|  | 9.0 | Navigazione | Iscrizione » Procedimento |  | Visualizzazione pagina Inserimento Procedimento |  |  |  |  |
|  | 10.0 | Azione | Iscrivere un nuovo fascicolo SIEP (difensore, posizione giuridica, reati, pena complessiva, assegnazione al magistrato, validazione) |  | Visualizzazione pagina Dettaglio Procedimento in stato validato |  |  |  |  |
|  | 11.0 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina Inserimento Sentenza |  |  |  |  |
|  | 12.0 | Azione | Iscrivere una nuova sentenza diversa dalle prime due |  | Visualizzazione pagina Dettaglio Sentenza |  |  |  |  |
|  | 13.0 | Navigazione | Iscrizione » Procedimento |  | Visualizzazione pagina Inserimento Procedimento |  |  |  |  |
|  | 14.0 | Azione | Iscrivere un nuovo fascicolo SIEP (difensore, posizione giuridica, reati, pena complessiva, assegnazione al magistrato, validazione) sempre sullo stesso soggetto |  | Visualizzazione pagina Dettaglio Procedimento in stato validato |  |  |  |  |
|  | 15.0 | Navigazione | Gestione Cumulo » Apertura Istruttoria | Sul secondo fascicolo creato | Visualizzazione pagina Apertura Istruttoria Cumulo |  |  |  |  |
|  | 16.0 | Azione | Confermare e premere tasto "torna indietro" |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 17.0 | Azione | Cliccare sul link "Elenco Titoli Coinvolti" |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 18.0 | Azione | Premere il tasto "Iscrizione proprio Procedimento" |  | Visualizzazione pagina Ricerca Procedimenti per Titolo e Soggetto |  |  |  |  |
|  | 19.0 | Azione | Nella lista dovrebbero apparire solo i tre fascicoli iscritti di cui il secondo "già in istruttoria";  il terzo (ed ultimo) con gli stessi dati della sentenza del secondo. Spuntare i 2 check disponibili e selezionare il tasto "Iscrivi in istruttoria" |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | V | Verifica | Verificare che il sistema mostri a video una popup che informi che un titolo selezionato è già in istruttoria cumulo |  | Attenzione! Già è presente in Istruttoria Cumulo il Procedimento "anno/numero" con estremi del Titolo Esecutivo uguali a quelli di un procedimento che si sta per iscrivere in istruttoria. Si vuole procedere all'iscrizione del/dei Titolo/i selezionato/i? |  |  |  |  |
| TF003.SIEP | 01 | Presenza, nel riepilogo ispettivo, tra i procedimenti "in attesa di definizione", anche dei fascicoli iscritti in istruttoria per cumulo ed archiviati a seguito di emissione del provvedimento di cumulo stesso. |  | Verifica: verificare che nel riepilogo ispettivo tra i fascicoli pendenti non vi siano quelli iscritti in istruttoria di cumulo ed archiviati per emissione cumulo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Ricerche » Procedimento |  | Visualizzazine pagina Ricerca Procedimento |  |  |  |  |
|  | 2.0 | Azione | Iscrivere/Ricercare un fascicolo SIEP con pena in decorrenza ma con data fine pena ormai trascorsa |  | Tale fascicolo nel riepilogo ispettivo (Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Riepilogo Ispettivo) dovrebbe essere classificato tra quelli in attesa archiviazione |  |  |  |  |
|  | 4.0 | Navigazione | Iscrizione |  | Visualizzazine pagina Inserimento Procedimento |  |  |  |  |
|  | 2.0 | Azione | Iscrivere un secondo fascicolo per lo stesso soggetto (Difensore, Posizione giuridica, Reati, Pena complessiva, Assegnazione al Magistrato) |  | Fascicolo iscritto |  |  |  |  |
|  | 4.0 | Navigazione | Validazione Procedimento |  | Visualizzazine pagina Dettaglio Procedimento |  |  |  |  |
|  | 5.0 | Azione | Validare il fascicolo |  | Fascicolo validato |  |  |  |  |
|  | 6.0 | Navigazione | Gestione Cumulo » Apertura Istruttoria |  | Visualizzazione pagina Apertura Istruttoria Cumulo |  |  |  |  |
|  | 7.0 | Azione | Confermare e premere tasto "torna indietro" |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 8.0 | Azione | Cliccare sul link "Elenco Titoli Coinvolti" |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 9.0 | Azione | Premere il tasto "Iscrizione proprio Procedimento" |  | Visualizzazione pagina Ricerca Procedimenti per Titolo e Soggetto |  |  |  |  |
|  | 10.0 | Azione | Scegliere il fascicolo inizialmente individuato al punto 2; premere il tasto "Iscrivi in istruttoria" |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 11.0 | Azione | Tornare indietro nella pagina di "Gestione Cumulo" e eseguire le operazione di "Chiusura Cumulo » Dati Finali Cumulo" |  | Visualizzazione pagina Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 12.0 | Azione | Stampare e Validare il fascicolo |  | Visualizzazione pagina Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo cumulato esca nel riepilogo ispettivo non più tra quelli in attesa archiviazione ma tra gli archiviati |  |  |  |  |  |  |
| TF004.SIEP | 01 | Errore nella funzione restituzione fascicoli - funzione esterna. |  | Verifica: verificare che dopo la ricerca degli atti presi in carico, la funzionalità di "Restituzione Fascicolo" non restituisca più un msg di errore. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Presa in carico Provvedimenti » Atti Ricevuti per Competenza » Elenco atti presi in carico |  | Visualizzazione pagina Ricerca atti per Competenza |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Ricerca" |  | Visualizzazione pagina Lista Atti per Competenza Presi in Carico |  |  |  |  |
|  | 4.0 | Azione | Supponendo la lista non vuota, per il primo record, nella colonna "Azioni", premere il tasto "Restituzione Fascicolo" e confermare il messaggio che appare in popup |  | Visualizzazione pagina Restituzione Atti |  |  |  |  |
|  | V | Verifica | Verificare che venga presentata la pagina di Restituzione Atti senza errori |  |  |  |  |  |  |
