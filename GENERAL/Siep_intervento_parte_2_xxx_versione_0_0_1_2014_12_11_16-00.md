---
uniqueName: siepinterventoparte2xxxversione0012014121116-00
displayName: "Siep intervento parte 2 xxx versione 0 0 1 2014 12 11 16 00"
category: "GENERAL"
tags: []
---

# Siep_intervento_parte_2_xxx_versione_0_0_1_2014_12_11_16.00

> **File originale:** `MEV/Mev10/Siep_intervento_parte_2_xxx_versione_0_0_1_2014_12_11_16.00.docx`  
> **Tipo:** DOCX
...
18.3	Descrizione dell’intervento	69
18.4	Riferimenti	83
18.5	Sottosistema	83
18.6	Uffici	83
18.7	Modifica funzionalità	84
18.8	Modifica interfacce utente	84
...
Tabella 46 - Tabella <TEMPLATE> Nuovi modelli	68
Tabella 47- Maschere decisione sorveglianza	82
Tabella 48 - Ufficio Emittente	84
Tabella 49 – UEPE / USSM	84
Tabella 50 – Ufficio di Sorveglianza / Magistrato di Sorveglianza per i Minorenni	84
Tabella 51 – Tribunale di Sorveglianza / Tribunale per i  Minorenni in funzione di Tribunale di Sorveglianza	85
Tabella 52- Elenco Istituti detentivi minorili	86
Tabella 53 - Nuovo elenco Istituti detentivi minorili	87
Tabella 54 - Elenco Procure presso Tribunale per i minorenni	88
Tabella 55 - Nuovo elenco Procure presso Tribunale per i minorenni	89
Tabella 56 - Elenco Tribunali per i minorenni	91
Tabella 57 – Nuovo elenco Tribunali per i minorenni	92
Tabella 58 - Elenco Uffici Servizi Sociali Minorenni	93
Tabella 59 - Elenco Uffici Servizi Sociali Minorenni sedi distaccate	94
Tabella 60 - Nuovo record istituto minorile	95
Tabella 61 – Tabella <UFFICIO> - riferimenti aggiornati UEPE  Vibo Valentia	96
Tabella 62 - Tabella <CSSA> - riferimenti aggiornati UEPE  Vibo Valentia	96
Tabella 63 – Tabella <UFFICIO> - USSM	98
Tabella 64 – USSM – Sedi distaccate	99
Tabella 65 – Tabella <CSSA> - USSM	102
Tabella 66 – Tabella <CSSA> - USSMSS	104
Tabella 67 - Tabella <CG_REG_CODES>	104
...
Il presente documento riporta suddivisi in capitoli gli interventi richiesti dall’Amministrazione nel documento “”.
...
Tabella  - Giudici della cognizione
...
Tabella  - Giudici dell'esecuzione
...
Inizialmente per default viene mostrata la sezione “C” () e la sezione “L” ().
...
Se l’operatore spunta la casella di spunta (checkbox) “Detenuto per altra causa” il sistema mostra la sezione “D” ().
...
L’operatore può visualizzare le informazioni relative alla posizione giuridica richiamando dalla barra del dettaglio del procedimento la funzione “Elenco Posizioni giuridiche” e premendo sull’icona “Vai” ().
Il sistema visualizza l’elenco delle posizioni giuridiche del soggetto e permette all’utente di vedere il dettaglio premendo sull’icona  oppure di cancellare la posizione premendo sull’icona ().
...
Riassumendo in fase di inserimento l’operatore accede alla funzionalità di “iscrizione posizione giuridica iniziale” ed il sistema visualizza la maschera come mostrata in .
|  |  |
| --- | --- |
|  |  |
|  |  |
...
Se l’operatore seleziona la casella di opzione (radiobutton) “Espiazione Pena in Istituto di Detenzione” il sistema visualizza la maschera in .
|  |  |
| --- | --- |
|  |  |
|  |  |
...
Se l’operatore seleziona la casella di opzione (radiobutton) “Espiazione Pena in Altro Luogo” il sistema visualizza la maschera in .
|  |  |
| --- | --- |
|  |  |
|  |  |
...
Se l’operatore nella maschera spunta ()
seleziona la casella di opzione “Misura Cautelare – in Istituto di Detenzione”  ed il sistema visualizza la maschera in ().
...
## Modifica funzionalità
## Modifica interfacce utente
Le interfacce devono essere realizzate componendo le sezioni con i criteri descritti nel paragrafo precedente ().
...
|  | Data Scadenza Pena |  |  | Data (2 gg  4 anno) – controllare correttezza formale data |
...
| N. | Campo | O | D | Nota |
| --- | --- | --- | --- | --- |
|  | Data di Decorrenza Pena |  |  | Data (2 gg  4 anno) – controllare correttezza formale data |
|  | Istituto di Detenzione |  |  | Valorizzato tramite funzione “Ricerca istituto detenzione”.
L’operatore può svuotare il campo tramite la funzione “Cancella”. |
...
L’operatore dopo aver selezionato “Arresti domiciliari art. 656 comma  il sistema mostra la maschera (Figura 23) per permettere la selezione di 1 dei seguenti successivi 4 passaggi:
...
L’intervento prevede l’inserimento di 8 nomi provvedimento ().
I nuovi “Nome provvedimento” mappano uno a uno i nuovi template ()
...
la posizione giuridica           [utilizzando le nuove posizioni giuridiche     ()].
lo stato del procedimento  [utilizzando i nuovi stati del procedimento  ()].
...
A seguito del nuovo intervento devono essere create le  seguenti  nuove “Posizione giuridica” ():
Sospensione provvisoria 51 ter   Arresti Domiciliari ex art. 656 comma 10
Sospensione provvisoria 51 ter   Domiciliari ex art 89 dpr 309/90
Sospensione provvisoria 51 ter   Permanenza in Casa
Sospensione provvisoria 51 ter   Collocamento in Comunità.
...
| N. | Campo | O | D | Nota |
| --- | --- | --- | --- | --- |
|  | Data Emissione |  |  | Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema |
|  | Data Trasmissione |  |  | Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema |
...
|  | Oggetto Ordinanza |  |  | Valorizzato dall’operatore tramite la selezione di un valore presente nel seguente elenco:
 {“Revoca Arresti domiciliari ex art. 656 comma 
“Revoca Arresti Domiciliari ex art 89 dpr 309/90”
“Revoca Permanenza in casa  ex art. 656 comma 
“Revoca Collocamento in comunità  ex art.  656 comma 10”}.
L’elenco è popolato selezionando dalla tabella <CG_REF_CODES> le tuple aventi il campo <RV_DOMAIN> = “MOTIVO_PROVVEDIMENTO” e <RV_LOW_VALUE> = ad uno valori indicati nella .
Prevalorizzato uguale a “-“ |
|  | Data Emissione Ordinanza |  |  | Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema
...
{“Sospensione provvisoria  Arresti Domiciliari ex art. 656 comma , 
“Sospensione provvisoria Domiciliari ex art. 89 dpr 309/90”, 
“Sospensione provvisoria Permanenza in Casa”,
”Sospensione provvisoria Collocamento in Comunità”}.
L’elenco è popolato selezionando dalla tabella <CG_REF_CODES> le tuple aventi il campo <RV_DOMAIN> = “MOTIVO_PROVVEDIMENTO” e <RV_LOW_VALUE> = ad uno valori indicati nella .
Prevalorizzato uguale a “-”. |
|  | Data Emissione decreto |  |  | Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema
Prevalorizzata con la data di sistema |
|  | Note |  |  | Testo libero max 1000 caratteri alfanumerici |
...
Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema |
...
{“Rigetto revoca  prosecuzione arresti domiciliari ex art. 656 comma 
“Rigetto revoca  prosecuzione Arresti Domiciliari ex art 89 dpr 309/90”
“Rigetto revoca  prosecuzione permanenza in casa  ex art. 656 comma 
“Rigetto revoca  prosecuzione collocamento in comunità  ex art.  656 comma 10”}.
...
{“Perdita di efficacia -  Sospensione provvisoria  prosecuzione arresti domiciliari ex art. 656 comma 
“Perdita di efficacia - Sospensione provvisoria  prosecuzione Arresti Domiciliari ex art 89 dpr 309/90”
“Perdita di efficacia - Sospensione provvisoria  prosecuzione permanenza in casa  ex art. 656 comma 
“Perdita di efficacia - Sospensione provvisoria  prosecuzione collocamento in comunità  ex art.  656 comma .
L’elenco è popolato selezionando dalla tabella <CG_REF_CODES> le tuple aventi il campo <RV_DOMAIN> = “MOTIVO_PROVVEDIMENTO” e <RV_LOW_VALUE> = ad uno valori indicati nella .
Prevalorizzato uguale a “-”. |
|  | Data Emissione Decisione |  |  | Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema
Prevalorizzata con la data di sistema |
...
|  | Data Scarcerazione |  |  | Data (2 gg  4 anno) – controllare correttezza formale data  
Data iscrizione procedimento <= data <= data di sistema |
...
|  | SIEP_MA_555 | SIEP_MA_ARDOM_REVO_SOSPENSIONE | Revoca_arresti_domiciliari_dopo_sospensione | c:\template\siep\ma\ | 01 | 03 | 2745 | 1 | NULL | NULL | NULL | NULL |
...
Figura  - Dettaglio maschera decisione della sorveglianza
...
L’intervento prevede nel primo caso della immagine () e nel secondo caso della immagine () l’inserimento di una casella di selezione (combobox) (Figura 61) contenente il seguente elenco:
Tribunale di Sorveglianza
Magistrato di Sorveglianza
Tribunale per i  Minorenni in Funzione di Tribunale di Sorveglianza
Magistrato di sorveglianza per i Minorenni.
...
I 4 casi descritti nelle immagini (, ,  e ) dopo l’intervento sono ridotti a soli 2 ( e ).
...
Il risultato del censimento delle maschere è contenuto nella successiva Tabella 49- Maschere decisione sorveglianza.
...
Tabella 49- Maschere decisione sorveglianza
...
Tabella  – Ufficio di Sorveglianza / Magistrato di Sorveglianza per i Minorenni
...
Tabella  – Tribunale di Sorveglianza / Tribunale per i  Minorenni in funzione di Tribunale di Sorveglianza
...
Pertanto, selezionando dalla tabella <ISTITUTI_DETENZIONE>  per campo <COD_TIPO_ISTITUTO> uguali a “ oppure “ oppure “ si ottengono i seguenti risultati.
| N. | ID_
ISTITUTO__
...
Tabella - Elenco Istituti detentivi minorili
...
Tabella 55 - Nuovo elenco Istituti detentivi minorili
...
Tabella  - Elenco Procure presso Tribunale per i minorenni
...
Tabella 57 - Nuovo elenco Procure presso Tribunale per i minorenni
...
Tabella  - Elenco Tribunali per i minorenni
...
Tabella 59 – Nuovo elenco Tribunali per i minorenni
...
|  |  | SASSARI | VIA PREDDA NIEDDA, | 07100 | 079.2633024 | ussm.sassari.dgm@giustizia.it |
...
Tabella 60 - Elenco Uffici Servizi Sociali Minorenni
...
Tabella 61 - Elenco Uffici Servizi Sociali Minorenni sedi distaccate
...
Tabella 62 - Nuovo record istituto minorile

Aggiornamento della tabella <ISTITUTO_DETENZIONE>: vedere .

Aggiornamento della tabella <UFFICIO> delle occorrenze per il <COD_TIPO_UFFICIO> uguale a  “PMM”: vedere .

Aggiornamento della tabella <UFFICIO> delle occorrenze per il <COD_TIPO_UFFICIO> uguale a  “DIBM”: vedere .
...
Tabella 63 – Tabella <UFFICIO> - riferimenti aggiornati UEPE  Vibo Valentia
...
Tabella 64 - Tabella <CSSA> - riferimenti aggiornati UEPE  Vibo Valentia
...
|  | 09006400812 | SS | 090064 | 09006400608 | NULL | VIA PREDDA NIEDDA, | 07100 | 079.2633024 | NULL | ussm.sassari.dgm@giustizia.it |
...
Tabella 65 – Tabella <UFFICIO> - USSM
I seguenti campi sono uguali per tutte le occorrenze della tabella precedente.
...
Tabella 66 – USSM – Sedi distaccate
...
|  | 107 | USSM | SASSARI | VIA PREDDA NIEDDA, | ussm.sassari.dgm@giustizia.it | NULL | 792.633.024 | NULL | NULL | NULL | NULL | 01/11/2014 0.00.00 |
...
Tabella 68 – Tabella <CSSA> - USSMSS
...
Tabella 69 - Tabella <CG_REG_CODES>
## Modifica template
Nessuna modifica prevista.