---
uniqueName: siut-sies-ct-1-0-20210428-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210428 Allegato al piano test SIES v 12 4 9 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210428-Allegato_al_piano_test_SIES_v.12.4.9.0

> **File originale:** `RILASCIO_12.4.9.0/SIUT-SIES-CT-1.0-20210428-Allegato_al_piano_test_SIES_v.12.4.9.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210428-Allegato-al-piano-test_SIES_v.12.4.9.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210428-Piano_dei_Test_SIES_v.12.4.9.0.docx |
|  | Versione | 1.0 |
|  | Data | 44314.0 |
|  | Intervento | SIES v.12.4.9.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.9.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210428-Allegato-al-piano-test_SIES_v.12.4.9.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202103180118.0 |  |  | 202103180118.0 | Problemi cumulo SIEP - Presa in carico SIEP altra BDI |  | SIEP | SIEP - Problemi cumulo SIEP - Presa in carico SIEP altra BDI | TF001.SIEP | Verifica corretta cancellazione Altra Causa collegato all'evento |  |  |  | Verifica: verificare che la SP elimini solo le informazioni collegati all'evento e non a tutto il fascicolo. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210322016.0 |  |  | 20210322016.0 | Problemi riunione |  | SIGE | SIGE - Problemi riunione | TF002.SIGE | Verifica cancellazione del Verbale e del Decreto Unificazione |  |  |  | Verifica: verificare che la cancellazione del Verbale e del Decreto Unificazione non vada in errore. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210324012.0 |  |  | 20210324012.0 | Corpo e carattere del foglio complementare ex L. 165/98 |  | SIEP | SIEP - Corpo e carattere del foglio complementare ex L. 165/98 | TF003.SIEP | Verifica corretta visualizzazione del template SIEP_LS_OLQNI |  |  |  | Verifica: verificare che il template SIEP_LS_OLQNI.rtf contenga al suo interno lo stesso Font di caratteri. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210324015.0 |  |  | 20210324015.0 | statistiche ricorso/opposizione |  | SIGE | SIGE -  statistiche ricorso/opposizione | TF004.SIGE | Verifica corretta estrazione dati in Ricerca Procedimenti con Ricorso/Opposizione |  |  |  | Verifica: Verificare che nella Ricerca Procedimenti con Ricorso/Opposizione vengano estratti in maniera corretta i dati in base ai parametri di ricerca. | 1.0 |  |  |  |  |
| SIUT | SIES | 202104010118.0 |  |  | 202104010118.0 | Problematiche monitoraggio ricorsi SIES - SIGE |  | SIGE | SIGE - Problematiche monitoraggio ricorsi SIES - SIGE |  |  |  |  |  |  |  |  |  |  |  |
| SIUT | SIES | 20210329018.0 |  |  | 20210329018.0 | Integrazione template con periodi di custodia cautelare mancanti |  | SIEP | SIEP - Integrazione template con periodi di custodia cautelare mancanti | TF005.SIEP | Verifica corretta visualizzazione del template Siep_arc_foglio_comp_esp |  |  |  | Verifica: Verificare che la stampa Siep_arc_foglio_comp_esp.rtf riporti i periodi di custodia cautelare in regime di permanenza in casa e di Collocamento in comunità. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210408012.0 |  |  | 20210408012.0 | invio FC da SIEP al Casellario |  | SIEP | SIEP - invio FC da SIEP al Casellario | TF006.SIEP | Verifica disattivazione invio Foglio Complementare |  |  |  | Verifica: Verificare che nel caso di un fascicolo associato ad un Ordine di esecuzione di arresti domiciliari la funzione invio Foglio Complementare risulti disattivata | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.9.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210428-Allegato-al-piano-test_SIES_v.12.4.9.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica corretta cancellazione Altra Causa collegato all'evento |  | Verifica: verificare che la SP elimini solo le informazioni collegati all'evento e non a tutto il fascicolo. |  | 1.0 |  |  | OK |
...
Posizione Giuridica, 
Pena Complessiva, 
Assegnazione al magistrato.
Per ognuna di queste voci inserire le informazioni obbligatorie. In particolare la Posizione Giuridica deve essere "Espiazione pena per Altra Causa in Regime di Detenzione". |  | Visualizzazione pagine delle singole voci selezionate |  |  |  |  |
...
|  | 5 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizzazione pagina  Emissione Ordine di Esecuzione - DETENUTO PER ALTRA CAUSA |  |  |  |  |
|  | 6 | Azione | Compilare i dati in maschera e confermare |  | Visualizazzione pagina Dettaglio Ordine Esecuzione Condannato Detenuto per Altra Causa |  |  |  |  |
|  | 7 | Azione | Stampare e validare. |  |  |  |  |  |  |
|  | 8 | Azione | Collegarsi come utente Procura della Repubblica Presso il Tribunale Ordinario di un ufficio di altro distretto | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 9 | Navigazione | Ricerche » Procedimento |  | Visualizzazione pagina  Ricerca Procedimento |  |  |  |  |
|  | 10 | Azione | Digitare gli estremi del Fascicolo creato nello step 1 con il distretto di appartenenza e cliccare su Ricerca. |  | Visualizzazione messaggio "Richiesta di ricerca Procedimento sottomessa al Sistema!" |  |  |  |  |
|  | 11 | Azione | Premere OK |  | Visualizzazione pagina Dettaglio Procedimento da Trasferire |  |  |  |  |
|  | 12 | Azione | Selezionare il pulsante Conferma Trasferimento Procedimento |  |  |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere dallo step 9 |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la procedura non vada in errore ma si concludi correttamente. |  |  |  |  |  |  |
| TF002.SIGE | 01 | Verifica cancellazione del Verbale e del Decreto Unificazione |  | Verifica: verificare che la cancellazione del Verbale e del Decreto Unificazione non vada in errore. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche » Procedimento per n° SIGE |  | Visualizzazione pagina Ricerca Procedimento SIGE |  |  |  |  |
|  | 2 | Azione | Ricercare due procedimenti in stato Iscritto |  |  |  |  |  |  |
|  | 3 | Navigazione | Unificazioni » Unificazione di Procedimenti da Verbale |  | Visualizzazione pagina Ricerca Procedimento Unificante |  |  |  |  |
|  | 4 | Azione | Indicare come Procedimento Unificante il primo fascicolo individuato nello step 2 e confermare. |  | Visualizzazione pagina Inserimento Verbale Unificazione Sige |  |  |  |  |
|  | 5 | Azione | Indicare come "Anno e Numero del Procedimento Sige da Unificare" i dati del secondo fascicolo. Cliccare su Avanti. |  | Visualizzazione pagina Inserimento Verbale Unificazione Sige |  |  |  |  |
|  | V | Verifica | Verificare che i due fascicoli siano correttamente associati alla rispettiva voce Procedimento Sige Unificante e Procedimento Sige da Unificare |  |  |  |  |  |  |
|  | 6 | Azione | Cliccare su Conferma |  | Visualizzazione poagina Dettaglio Verbale Unificazione Sige |  |  |  |  |
|  | 7 | Azione | Cliccare sull'icona Cancella e confermare la cancellazione |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la cancellazione non vada in errore. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica corretta visualizzazione del template SIEP_LS_OLQNI |  | Verifica: verificare che il template SIEP_LS_OLQNI.rtf contenga al suo interno lo stesso Font di caratteri. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale per i Minori | Bxxxxx (Procura della Repubblica Presso il Tribunale per i Minori) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche » Procedimento |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 2 | Azione | Ricercare un Procedimento validato con Condannato Libero |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  | Visualizzazione pagina Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO Libero |  |  |  |  |
|  | 4 | Azione | Inserire i dati obbligatori e cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Ordine esecuzione legge 165/98 - condannato libero |  |  |  |  |
|  | 5 | Azione | Stampare |  | Generazione documento SIEP_LS_OLQNI.rtf |  |  |  |  |
|  | V | Verifica | Verificare che la stampa del foglio complementare per il casellario, a corredo dell'ordine di esecuzione sospeso, presenti lo stesso FONT times new roman. |  |  |  |  |  |  |
| TF004.SIGE | 01 | Verifica corretta estrazione dati in Ricerca Procedimenti con Ricorso/Opposizione |  | Verifica: Verificare che nella Ricerca Procedimenti con Ricorso/Opposizione vengano estratti in maniera corretta i dati in base ai parametri di ricerca. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come Tribunale Ordinario | Txxxxx (Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati » Ricerca Procedimenti con Ricorso/Opposizione |  | Visualizzazione pagina Ricerca Procedimenti con Ricorso/Opposizione |  |  |  |  |
|  | 2 | Azione | Selezionare dalla combo Tipo/Ricorso opposizione la voce  "ricorso senza esito", 
indicare un periodo nella sezione Intervallo Estremi Ricorso/Opposizioni.
Cliccare su Ricerca. |  | Visualizzazione pagina  Ricerca Procedimenti Sige Con Ricorso/Opposizione |  |  |  |  |
|  | V | Verifica | Verificare che il sistema trovi dei procedimenti. |  |  |  |  |  |  |
|  | 3 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati » Ricerca Procedimenti con Ricorso/Opposizione |  | Visualizzazione pagina Ricerca Procedimenti con Ricorso/Opposizione |  |  |  |  |
|  | 4 | Azione | Selezionare dalla combo Tipo/Ricorso opposizione la voce  "Tutti", 
indicare nella sezione Intervallo Estremi Ricorso/Opposizioni lo stesso periodo utilizzato nello step 2 .
Cliccare su Ricerca. |  | Visualizzazione pagina  Ricerca Procedimenti Sige Con Ricorso/Opposizione |  |  |  |  |
|  | V | Verifica | Verificare che i fascicoli ricercati nello step 2 siano presenti anche nella ricerca dello step 4. |  |  |  |  |  |  |
| TF005.SIEP | 01 | Verifica corretta visualizzazione del template Siep_arc_foglio_comp_esp |  | Verifica: Verificare che la stampa Siep_arc_foglio_comp_esp.rtf riporti i periodi di custodia cautelare in regime di permanenza in casa e di Collocamento in comunità. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Iscrivere un nuovo fascicolo valorizzando le informazioni su:
sentenza,
difensore,
Posizione giuridica,
Reati,
Pena complessiva. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Inserire le Misure Cautelari selezionando la funzione Iscrizione Misura Cautelare ed infine Cessata al momento del passaggio in giudicato computabili. |  | Visualizzazione pagina Inserimento Misura Cautelare - COMPUTABILE |  |  |  |  |
|  | 3 | Azione | Selezionare il radio Button "Espiazione pena in altro luogo"  quindi dalla combo "Misura" la voce "Custodia Cautelare in Regime di Permanenza in Casa".
Indicare il periodo da - a e cliccare su conferma. |  | Visualizzazione pagina Elenco Misure Cautelari |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere dallo step 2 selezionando dalla combo "Misura" la voce "Custodia Cautelare in Collocamento in Comunita'". |  | Visualizzazione pagina Assegnazione/Cambio Magistrato |  |  |  |  |
|  | 4 | Azione | Dal dettaglio del procedimento selezionare la funzione Assegnazione procedimento al magistrato. |  | Visualizzazione pagina Elenco Misure Cautelari |  |  |  |  |
|  | 5 | Azione | Inserire il magistrato e confermare |  | Visualizzazione pagina Dettaglio Assegnazione/Cambio Magistrato |  |  |  |  |
|  | 6 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 7 | Azione | Validare il procedimento |  | Visualizazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 8 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione - (Se richiesto cliccare su OK per effettuare il calcolo della pena) |  | Visualizzazione pagina Emissione Ordine di Esecuzione - Libero |  |  |  |  |
|  | 9 | Azione | Inserire i dati obbligatori e cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Ordine Esecuzione Condannato Libero |  |  |  |  |
|  | 10 | Azione | Stampare e Validare |  | Visualizzazione pagina  Dettaglio Ordine Esecuzione Condannato Libero |  |  |  |  |
|  | 11 | Navigazione | Definizione Procedimento > Fine espiazione |  | Visualizzazione pagina Definizione Procedimento - Pena Espiata |  |  |  |  |
|  | 12 | Azione | Selezionare come Oggetto Definizione: Archiviazione per pena espiata in regime carcerario.
Cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Definizione Procedimento - Pena Espiata |  |  |  |  |
|  | 13 | Azione | Stampare |  | Viene generata la stampa Siep_arc_foglio_comp_esp |  |  |  |  |
|  | V | Verifica | Verificare che che la stampa riporti i periodi di custodia cautelare in regime di permanenza in casa e di Collocamento in comunità. |  |  |  |  |  |  |
| TF006.SIEP | 02 | Verifica disattivazione invio Foglio Complementare |  | Verifica: Verificare che nel caso di un fascicolo associato ad un Ordine di esecuzione di arresti domiciliari la funzione invio Foglio Complementare risulti disattivata |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Tramite l'apposita icona posta in alto accedere ad Elenco Provvedimenti del PM |  | Visualizazzione pagina Ricerca Procedimento |  |  |  |  |
|  | 2 | Azione | Ricercare un fascicolo validato con posizione giuridica  Arresti Domiciliari ex art.656 comma 10 cpp associato ad un Ordine Esecuzione |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | 3 | Azione | Cliccare sull'icona della lentina presente nella colonna Azioni dell' Ordine di Esecuzione |  | Visualizzazione pagina  Dettaglio Legge 165/98 Arresti Domiciliari |  |  |  |  |
|  | 4 | Azione | Cliccare sull'icona di inserimento Foglio Complementare |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga prospettato il messaggio di funzione foglio complementare non disponibile per il profilo abilitato. |  |  |  |  |  |  |
