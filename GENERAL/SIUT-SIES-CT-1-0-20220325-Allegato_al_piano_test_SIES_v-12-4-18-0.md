---
uniqueName: siut-sies-ct-1-0-20220325-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220325 Allegato al piano test SIES v 12 4 18 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220325-Allegato_al_piano_test_SIES_v.12.4.18.0

> **File originale:** `RILASCIO_12.4.18.0/SIUT-SIES-CT-1.0-20220325-Allegato_al_piano_test_SIES_v.12.4.18.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220325-Allegato_al_piano_test_SIES_v.12.4.18.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220325-Piano_dei_Test_SIES_v.12.4.18.0.docx |
|  | Versione | 1.0 |
|  | Data | 44645.0 |
|  | Intervento | SIES v.12.4.18.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.18.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220325-Allegato_al_piano_test_SIES_v.12.4.18.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220222015.0 |  |  | 20220222015.0 | STATISTICHE - ESTRAZIONE DATI - RIEPILOGO LAVORO MAGISTRATI - VISTO DEL PM PER ARCHIVIAZIONE |  | SIEP | SIEP - STATISTICHE - ESTRAZIONE DATI - RIEPILOGO LAVORO MAGISTRATI - VISTO DEL PM PER ARCHIVIAZIONE | TF001.SIEP | Mancata estrazione nel riepilogo lavoro magistrati del visto del Pm per archiviazione. |  |  |  | Verifica: verificare nella statistica di estrazione dati, riepilogo lavoro magistrati, la presenza di dati nella categoria Visto del Pubblico Ministero. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220224014.0 |  |  | 20220224014.0 | cumulo - concessione risarcimento danni D.L. 92/2014 |  | SIEP | SIEP - cumulo - concessione risarcimento danni D.L. 92/2014 | TF002.SIEP | Mancato trasferimento della concessione risarcimento danni D.L. 92/2014 nell'istruttoria cumulo. |  |  |  | Verifica: verificare che il sistema trasferisca il dato sulla concessione risarcimento danni D.L. 92/2014 nell'istruttoria cumulo. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220224017.0 |  |  | 20220224017.0 | Anomalia statistiche Minori CT |  | SIEP | SIEP - Anomalia statistiche Minori CT | TF003.SIEP | Mancato rilevamento della prima attività del Pubblico Ministero nella statistica delle esecuzioni iniziate dopo 90 giorni dall'iscrizione del fascicolo. |  |  |  | Verifica: verificare che nella statistica "Elenco delle esecuzioni iniziate dopo 90 giorni dall'iscrizione del fascicolo" sia rilevata la prima attività del PM. | 1.0 |  |  |  |  |
| SIUT | SIES | 202202280122.0 |  |  | 202202280122.0 | RIEPILOGO ISPETTIVO DIFFERIMENTO PENA MANCATA CLASSIFICAZIONE DEL PROCEDIMENTO |  | SIEP | SIEP - RIEPILOGO ISPETTIVO DIFFERIMENTO PENA MANCATA CLASSIFICAZIONE DEL PROCEDIMENTO | TF004.SIEP | Errore nella classificazione del procedimento di differimento pena nel riepilogo ispettivo. |  |  |  | Verifica: verificare nel prospetto riepilogativo delle esecuzioni pendenti ed in corso distinte secondo lo stato della procedura, tra i procedimenti sospesi in attesa decisione della magistratura di sorveglianza, dei provvedimenti di differimento pena. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220311014.0 |  |  | 20220311014.0 | CLASSE 20000 - PENDENZA IN FASE ISTRUTTORIA |  | SIEP | SIEP - CLASSE 20000 - PENDENZA IN FASE ISTRUTTORIA | TF005.SIEP | Pendenza in fase istruttoria dei fascicoli di classe II. |  |  |  | Verifica: verificare, nel foglio excel ("Dettaglio") prodotto nelle "Statistiche/Monitoraggio >> Statistiche - Estrazione Dati - Classe I - Riepilogo ispettivo", che non siano riportati procedimenti di classe II. | 1.0 |  |  |  |  |
| SIUT | SIES | 20220311015.0 |  |  | 20220311015.0 | ERRORE ATTO FINALE |  | SIEP | SIEP - ERRORE ATTO FINALE | TF006.SIEP | Gestione della posizione giuridica "Detenzione Domiciliare Provvisoria" nel template "SIEP_ARC_FOGLIO_COMP_ESP". |  |  |  | Verifica: verificare che nel template indicato sia riportata la dicitura "in regime di detenzione domiciliare provvisoria" ed il periodo di inizio e fine pena espiata. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.18.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220325-Allegato_al_piano_test_SIES_v.12.4.18.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Mancata estrazione nel riepilogo lavoro magistrati del visto del Pm per archiviazione. |  | Verifica: verificare nella statistica di estrazione dati, riepilogo lavoro magistrati, la presenza di dati nella categoria Visto del Pubblico Ministero. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) oppure Bxxxxx (Procura della Repubblica Presso il Tribunale per i Minorenni) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati | Classe Procedimento: I
Tipologia Statistica: Attivita' Magistrati | Visualizzazione pagina "STATISTICHE UFFICIO - ATTIVITA' MAGISTRATI" |  |  |  |  |
|  | 2.0 | Azione | Scegliere un Intervallo Date: "Data Iniziale" e "Data Finale" e cliccare su "Visualizza Magistrati" |  | Visualizzazione pagina "STATISTICHE UFFICIO - ATTIVITA' MAGISTRATI" |  |  |  |  |
|  | 3.0 | Azione | Nel riquadro "Magistrato", selezionare la voce "Tutti" oppure il singolo Magistrato e premere il tasto "Conferma" |  | Download file .xls contenente la statistica richiesta |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio di "Riepilogo" e di "Dettaglio" nella categoria 'Visto del Pubblico Ministero' siano conteggiati i procedimenti di tipo "Visto del Pubblico Ministero per archiviazione" |  |  |  |  |  |  |
| TF002.SIEP | 01 | Mancato trasferimento della concessione risarcimento danni D.L. 92/2014 nell'istruttoria cumulo. |  | Verifica: verificare che il sistema trasferisca il dato sulla concessione risarcimento danni D.L. 92/2014 nell'istruttoria cumulo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti con contenuto "Rimedi risarcitori per violazione art. 3 CEDU", collegandolo ad un procedimento SIEP. |  |  |  |  |  |
|  | 1.0 | Navigazione | Ordinanze » Emissione Ordinanza |  | Visualizzazione pagina "Emissione Ordinanza" |  |  |  |  |
|  | 2.0 | Azione | Inseririe una "Data Emissione" e premere il tasto "Conferma". |  | Visualizzazione pagina "Emissione Ordinanza di Rimedi Risarcitori Violazione Art.3 CEDU" |  |  |  |  |
|  | 3.0 | Azione | Inserire l'esito "DISPONE RIDUZIONE PENA DETENTIVA", riempire i campi "Riduzione Pena: Totale giorni Riduzione concessi" e "Periodo" e premere il tasto "Conferma". |  | Visualizzazione pagina "Dettaglio Ordinanza Rimedi Risarcitori Violazione Art.3 CEDU". |  |  |  |  |
|  | 4.0 | Azione | Premere il tasto "Generazione Stampa" o "Upload Stampa", spuntare il checkbox "Valida Documento" e premere il tasto "Conferma". |  | Visualizzazione pagina "Dettaglio Ordinanza Rimedi Risarcitori Violazione Art.3 CEDU". |  |  |  |  |
|  | 5.0 | Navigazione | Ordinanze » Deposito Ordinanza | Procedimento corrente | Visualizzazione pagina "Deposito Ordinanza SIUS del ..." |  |  |  |  |
|  | 6.0 | Azione | Riempire il campo "Data deposito in cancelleria" e premere il tasto "Conferma". |  | Visualizzazione pagina "Dettaglio Deposito Ordinanza". |  |  |  |  |
|  | 7.0 | Azione | Premere il tasto "Generazione Stampa" o "Upload Stampa", spuntare il checkbox "Valida Documento" e premere il tasto "Conferma". |  | Visualizzazione pagina "Dettaglio Deposito Ordinanza". |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | E' lo stesso ufficio proprietario del fascicolo SIEP collegato al procedimento SIUS di cui nei punti precedenti. |  |  |  |  |  |
|  | 8.0 | Navigazione | Stato esecuzione » Gestione Stato Esecuzione |  | Visualizzazione pagina "Ricerca Procedimento". |  |  |  |  |
|  | 9.0 | Azione | Riempire il campo "Anno/Numero SIEP" e premere il tasto "Conferma". | Inserire anno e numero del fascicolo SIEP collegato al procedimento SIUS di cui nei punti precedenti. | Visualizzazione pagina "Gestione Stato Esecuzione". |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina i checkbox  "Stampa" e "Visualizza" risultino spuntati in corrispondenza della "Ordinanza Riduzione pena da espiare/risarcimento del danno (art. 35 ter O.P.)" di cui nei punti precedenti. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Mancato rilevamento della prima attività del Pubblico Ministero nella statistica delle esecuzioni iniziate dopo 90 giorni dall'iscrizione del fascicolo. |  | Verifica: verificare che nella statistica "Elenco delle esecuzioni iniziate dopo 90 giorni dall'iscrizione del fascicolo" sia rilevata la prima attività del PM. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti su cui siano presenti "Ordine di esecuzione con contestuale Sospensione - Permanenza in casa" oppure "Ordine di esecuzione con contestuale Sospensione - Collocamento in Comunità". |  |  |  |  |  |
|  | 1.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati | Classe Procedimento: I
Tipologia Statistica: Tempi Emissione Provvedimenti | Visualizzazione pagina "STATISTICHE UFFICIO - ATTIVITA' MAGISTRATI" |  |  |  |  |
|  | 2.0 | Azione | Scegliere un "Intervallo di Tempo da verificare": "Data Iniziale" e "Data Finale" e cliccare su "Visualizza Intervalli e Magistrati" |  | Visualizzazione pagina "STATISTICHE UFFICIO - TEMPI EMISSIONE PROVVEDIMENTI" |  |  |  |  |
|  | 3.0 | Azione | Nel riquadro "Intervallo di tempo" scegliere "Oltre 90 giorni" ed in quello "Magistrato", selezionare la voce "Tutti" oppure il singolo Magistrato e premere il tasto "Conferma" |  | Download file .xls contenente la statistica richiesta |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio di "Dettaglio" nella categoria 'Indicazione atto o provvedimento' siano presenti i procedimenti di tipo "Ordine di esecuzione con contestuale Sospensione - Permanenza in casa" oppure "Ordine di esecuzione con contestuale Sospensione - Collocamento in Comunità". |  |  |  |  |  |  |
| TF004.SIEP | 01 | Errore nella classificazione del procedimento di differimento pena nel riepilogo ispettivo. |  | Verifica: verificare nel prospetto riepilogativo delle esecuzioni pendenti ed in corso distinte secondo lo stato della procedura, tra i procedimenti sospesi in attesa decisione della magistratura di sorveglianza, dei provvedimenti di differimento pena. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Selezionare od iscrivere un procedimento con soggetto libero. |  |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni della Sorveglianza >> Differimento >> Differimento Provvisorio o Definitivo |  | Visualizzazione pagina "Differimento / Rinvio dell'esecuzione Definitiva". |  |  |  |  |
|  | 2.0 | Azione | Inserire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Differimento / Rinvio dell'esecuzione Definitiva". |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Conferma" e nella pagina risultante premere il tasto "Generazione Stampa", spuntare il checkbox "Valida Documento" e premere il tasto "Conferma". |  | Visualizzazione pagina "Differimento / Rinvio dell'esecuzione Definitiva". |  |  |  |  |
|  | 4.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Riepilogo Ispettivo |  | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI". |  |  |  |  |
|  | 5.0 | Azione | Premere il tasto "Conferma". |  | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI". |  |  |  |  |
|  | 6.0 | Azione | Premere il tasto "Seleziona Tutti" e premere il tasto "Conferma". |  | Download file .xls contenente la statistica richiesta |  |  |  |  |
|  | V | Verifica | Verificare che, nel foglio excel prodotto, nella scheda "Dettaglio", il fascicolo di cui sopra sia classificato nella sezione "PROCEDIMENTI SOSPESI IN ATTESA DECISIONE DELLA MAGISTRATURA DI SORVEGLIANZA". |  |  |  |  |  |  |
| TF005.SIEP | 01 | Pendenza in fase istruttoria dei fascicoli di classe II. |  | Verifica: verificare, nel foglio excel ("Dettaglio") prodotto nelle "Statistiche/Monitoraggio >> Statistiche - Estrazione Dati - Classe I - Riepilogo ispettivo", che non siano riportati procedimenti di classe II. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti di Classe II. |  |  |  |  |  |
|  | 1.0 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati » Classe I » Riepilogo ispettivo |  | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI". |  |  |  |  |
|  | 5.0 | Azione | Premere il tasto "Conferma". |  | Visualizzazione pagina "STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI". |  |  |  |  |
|  | 6.0 | Azione | Premere il tasto "Seleziona Tutti" e premere il tasto "Conferma". |  | Download file .xls contenente la statistica richiesta |  |  |  |  |
|  | V | Verifica | Verificare che, nel foglio excel prodotto, nella schede "Dettaglio", non siano riportati procedimenti di Classe II. |  |  |  |  |  |  |
| TF006.SIEP | 01 | Gestione della posizione giuridica "Detenzione Domiciliare Provvisoria" nel template "SIEP_ARC_FOGLIO_COMP_ESP". |  | Verifica: verificare che nel template indicato sia riportata la dicitura "in regime di detenzione domiciliare provvisoria" ed il periodo di inizio e fine pena espiata. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti con condannato in posizione giuridica "Detenzione Domiciliare Provvisoria". |  |  |  |  |  |
|  | 1.0 | Navigazione | Definizione Procedimento » Fine Espiazione |  | Visualizzazione pagina "Definizione Procedimento - Pena Espiata". |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma". |  | Visualizzazione pagina "Dettaglio Definizione Procedimento - Pena Espiata". |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Generazione Stampa", spuntare il checkbox "Valida Documento" e premere il tasto "Conferma". |  | Visualizzazione pagina "Dettaglio Definizione Procedimento - Pena Espiata". |  |  |  |  |
|  | V | Verifica | Veificare che nel template "SIEP_ARC_FOGLIO_COMP_ESP" prodotto sia riportata la dicitura "in regime di detenzione domiciliare provvisoria" ed il periodo di inizio e fine pena espiata. |  |  |  |  |  |  |
