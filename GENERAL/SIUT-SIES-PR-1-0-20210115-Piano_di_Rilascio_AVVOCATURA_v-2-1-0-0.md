---
uniqueName: siut-sies-pr-1-0-20210115-pianodirilascioavvocatur
displayName: "SIUT SIES PR 1 0 20210115 Piano di Rilascio AVVOCATURA v 2 1 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20210115-Piano_di_Rilascio_AVVOCATURA_v.2.1.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.1.0.0/SIUT-SIES-PR-1.0-20210115-Piano_di_Rilascio_AVVOCATURA_v.2.1.0.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 15/01/2021 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 2.1.0.0 di AVVOCATURA.
...
# Generalità
Il presente documento descrive il piano di rilascio di AVVOCATURA 2.1.0.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- | --- |
| Portale Fornitura | 1 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.1.0.0 2021-01-15 > Documentazione > documentazione.zip | 2.1.0.0 | 15/01/2021 |
| Portale Fornitura | 2 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.1.0.0 2021-01-15 > Applicazione > avvocatura.war | 2.1.0.0 | 15/01/2021 |
| Portale Fornitura | 3 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.1.0.0 2021-01-15 > Sorgenti > sorgenti.zip | 2.1.0.0 | 15/01/2021 |
| Note-osservazioni |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 20210104012 | DGSIA - Referenti Applicativi | L’utente segnala un errore in fase di visualizzazione di una ordinanza | Per la risoluzione della problematica si è intervenuti con la modifica della jsp contenente l’errore eliminando il riferimento alla proprietà non esistente (“idEvento”) per la classe “ProcedimentoBean” | E’ stata modificata la pagina “elencoMisureSicurezza.jsp” eliminando il riferimento “ProcedimentoBean.idEvento” non esistente nella classe |  |
|  |  |  |  |  |  |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20210115-Piano_di_Rilascio_AVVOCATURA_v.2.1.0.0.doc
SIUT-SIES-PT-1.0-20210115-Piano_dei_Test_AVVOCATURA _v.2.1.0.0.doc
SIUT-SIES-CT-1.0-20210115-Allegato_al_piano_test_AVVOCATURA_v.2.1.0.0.xls |
| Note-osservazioni |  |  |


Installazione
## Prerequisiti
Per l’installazione della release AVVOCATURA, oggetto del presente rilascio, è necessario aver installato la precedente release 2.0.0.0.
