---
uniqueName: siut-sies-pt-1-0-20211011-pianodeitest006siusavvoc
displayName: "SIUT SIES PT 1 0 20211011 Piano dei Test 006 SIUS Avvocati"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PT-1.0-20211011-Piano_dei_Test_006_SIUS_Avvocati

> **File originale:** `MEV/SCHEDA_006/SIUT-SIES-PT-1.0-20211011-Piano_dei_Test_006_SIUS_Avvocati.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 11/10/2021 | Prima Emissione |  |
|  |  |  |  |
...
# Introduzione
## Scopo del documento
Il presente documento descrive l’elenco delle funzionalità oggetto di verifica, a valle delle attività previste nella scheda SIUT-GEN-SC-1.1-20191015 Scheda intervento SIUS_Avvocati.pdf [RIF.1] e dalle successive analisi dei risultati SIUT-SIAV-PT-1.0-20201020-Analisi dei risultati dei Test di Performance del sistema SIES-Avvocatura.pdf [RIF. 2].
.
## Riferimenti
| Riferimento | Nome Documento | Descrizione Documento |
| --- | --- | --- |
| RIF.1 | SIUT-GEN-SC-1.1-20191015 Scheda intervento SIUS_Avvocati.pdf | Scheda di Intervento |
| RIF.2 | SIUT-SIAV-PT-1.0-20201020-Analisi dei risultati dei Test di Performance del sistema SIES-Avvocatura.pdf | Analisi dei Risultati |
| RIF.3 | SIUT-SIES-PR-1.0-20211011-Piano_di_Rilascio_006_SIUS_Avvocati.docx | Il documento riporta l’elenco delle applicazioni oggetto del presente rilascio. Riporta inoltre le modalità di installazione delle varie componenti in ambiente di esercizio. |
| RIF.4 | SIUT-SIE-CT-1.0-20211011-Allegato_al_piano_test_006_SIUS_Avvocati.xlsx | Elenco del piano dei test da eseguire per la verifica di conformità |
...
## Entità da testare
L'entità oggetto di verifica è l'applicativo SIES relativamente alle funzionalità oggetto delle Analisi dei Risultati [Rif.2].
## Entità escluse dal test
Sono oggetto di verifica esclusivamente i casi di test consegnati.
# Esecuzione dei test
I test si svolgono nell’ambiente di collaudo dell’Amministrazione secondo le modalità indicate nel piano di test e così come dettagliato nel documento SIUT-SIE-CT-1.0-20211011-Allegato_al_piano_test_006_SIUS_Avvocati.xlsx [RIF.4].
# Documentazione esecuzione test
L’esito dei test sarà indicato nella colonna predisposta, con descrizione ‘Esito’, all’interno del documento SIUT-SIE-CT-1.0-20211011-Allegato_al_piano_test_006_SIUS_Avvocati.xlsx [RIF.4].
...
Fare riferimento al documento SIUT-SIAV-PT-1.0-20201020-Analisi dei risultati dei Test di Performance del sistema SIES-Avvocatura.pdf [RIF.2] e SIUT-SIES-PR-1.0-20211011-Piano_di_Rilascio_006_SIUS_Avvocati.docx [RIF.3].
## Sistemi esterni
N.A.
