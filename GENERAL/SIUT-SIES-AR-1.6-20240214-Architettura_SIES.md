---
uniqueName: siut-sies-ar-16-20240214-architetturasies
displayName: "SIUT SIES AR 1.6 20240214 Architettura SIES"
category: "GENERAL"
tags: []
---
...
Interconnessione WEB tra SIES ed NSC: ovvero da SIES si può aprire il modulo di interoperabilità per effettuare ricerche direttamente su NSC. L’utente SIES non necessita diautenticarsi nuovamente sul sistema NSC perché le sue credenziali viaggiano attraverso il protocollo SAML.
...
SI (es. 15 e 10)NOgeneratiDaGiorni e controllarePerGiorni sono valorizzati?Controlla i bollettini scaduti da 3 giorni o che scadranno tra 3 giorni oppure quelli senza data scadenzaa partire dal quindicesimo giorno dalla loro generazione e per unmassimo di 10 giorniControlla i bollettini scaduti da 3 giorni o che scadranno tra 3 giorniSI (es. 3)SI (es. 5)SI (es. 15 e 10)NOFINEControlla solo i bollettini che NON sono stati controllati negli ultimi 5 giornicontrollateDaGiorni è valorizzato?NOControlla i bollettinia partire dal quindicesimo giorno dalla loro generazione e per unmassimo di 10 giorniNOgeneratiDaGiorni e controllarePerGiorni sono valorizzati?inScadenzaTraGiorni è valorizzato?INIZIO
...
Figura 7Componenti SIUS Avvocatura
...
Infatti, partendo da un template RTF contenente dei tag XSLPathed un XML viene generato il documento finale pronto per la stampa.
