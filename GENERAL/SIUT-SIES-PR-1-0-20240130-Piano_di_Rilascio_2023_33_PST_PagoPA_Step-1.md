---
uniqueName: siut-sies-pr-1-0-20240130-pianodirilascio202333pst
displayName: "SIUT SIES PR 1 0 20240130 Piano di Rilascio 2023 33 PST PagoPA Step 1"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20240130-Piano_di_Rilascio_2023_33_PST_PagoPA_Step-1

> **File originale:** `MEV/SCHEDA_033/SIUT-SIES-PR-1.0-20240130-Piano_di_Rilascio_2023_33_PST_PagoPA_Step-1.docx`  
> **Tipo:** DOCX
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.5.6.0-MEV_2023_3_STEP_1 di SIES.
Riporta inoltre le modalità di installazione degli aggiornamenti in ambiente di esercizio.
## Riferimenti
| Riferimento | Nome Documento | Descrizione Documento |
| --- | --- | --- |
| RIF1. | SIUT-SIES-SC-1.3-20231123-Scheda_Intervento_2023_33_PST_PagoPA_Step-1.pdf | Scheda Intervento |
...
# Generalità
Il presente documento descrive il piano di rilascio del software relativo alla MEV_2023_33-Step-1 di SIES, contenente l’integrazione della suddetta MEV con la versione SIES 12.5.6.0.

Sono elencati i passi da compiere per la corretta installazione di tutti gli elementi in ambiente di esercizio.
# Identificazione degli elementi rilasciati
| Supporto | Oggetti: | Ver. | Del |
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 07 - MEV > 2023_33_SIES-Cartabia e PST_PagoPA > 05_Verifica di Conformita' |  |  |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- |
| - | SIUT-SIES-SC-1.3-20231123-Scheda_Intervento_2023_33_PST_PagoPA_Step-1.pdf | - | Integrazione del SIES con PST_PagoPA |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20240130-Piano_di_Rilascio_2023_33_PST_PagoPA_Step-1.pdf
SIUT-SIES-CT-1.0-20240130-Allegato_al_piano_Test_2023_33_PST_PagoPA_Step-1.xlsx
SIUT-SIES-PT-1.0-20240130-Piano_dei_Test_2023_33_PST_PagoPA_Step-1.pdf
SIUT-SIES-MU-1.0-20240130-Manuale_Utente_2023_33_PST_PagoPA_Step-1.pdf
SIUT-SIES-ML-1.10-20240130-Modello_dei_Dati_2023_33_PST_PagoPA_Step-1.pdf |
| template.zip | Template | AvvisoCartabia.rtf
NotificaAvvocati.rtf
PenaComplessivaSoloPecuniaria.rtf
SanzioneSostitutiva.rtf
StatoEsecuzione.rtf
Variabili.rtf
SIEP_ARC_FOGLIO_COMP_ESP.rtf
SIEP_PP_NT_TRASM_BOLL.rtf
SIEP_PP_OI_PAGAMENTO_RR.rtf
SIEP_PP_OI_PAGAMENTO_RR_DET.rtf
SIEP_PP_OI_PAGAMENTO_UN.rtf
SIEP_PP_OI_PAGAMENTO_UN_DET.rtf
SIEP_PP_PR_AVV_MAN_PAG.rtf
SIEP_PP_PR_AVVPAGAM_PP.rtf
SIEP_PP_PR_RIDET_PP.rtf
SIEP_PP_TRASM_RICH_CONV.rtf
NOTA_TRASM_PENSOS.rtf
NOTA_TRASM_PENSOS_2.rtf
NOTA_TRASM_PENSOS_3.rtf
NOTA_TRASM_PENSOS_4.rtf
NOTA_TRASM_PENSOS_5.rtf
SIGE_DE_DECRFISSAZIONEUDIENZA.rtf
SIGE_DE_DECRFISSAZIONEUDIENZA_P1.rtf |
| Note-osservazioni |  |  |

# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.5.6.0.
...
Creare sul server DB una cartella MEV_2023_33_STEP_1 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/MEV_2023_33_STEP_1/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella MEV_2023_33_STEP_1 tramite il comando:
chmod 777 MEV_2023_33_STEP_1
...
Nella cartella appena creata (MEV_2023_33_STEP_1), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/MEV_2023_33_STEP_1/log/ in cui si può constatare l’esito dell’esecuzione.
...
“/var/SIES/CONFIG”;
Editare il file “stampa.properties” ed aggiungere alla fine del file le seguenti righe:
#MEV_2023_33_STEP_1: aggiunta proprietà di stampa per il civilmente obbligato
NOTIFICA_CIVILMENTE=a Civilmente Obbligato
...
Copiare i files contenuti nella cartella template\siep\sp
nella nuova cartella “/var/SIES/template/siep/sp”, da creare tramite i seguenti comandi:
...
Copiare i files contenuti nella cartella template\sige\de
nella cartella “/var/SIES/template/sige/de” sovrascrivendo quelli precedenti;
