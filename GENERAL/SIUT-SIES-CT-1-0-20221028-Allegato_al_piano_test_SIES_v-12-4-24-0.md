---
uniqueName: siut-sies-ct-1-0-20221028-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20221028 Allegato al piano test SIES v 12 4 24 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20221028-Allegato_al_piano_test_SIES_v.12.4.24.0

> **File originale:** `RILASCIO_12.4.24.0/SIUT-SIES-CT-1.0-20221028-Allegato_al_piano_test_SIES_v.12.4.24.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20221028-Allegato_al_piano_test_SIES_v.12.4.24.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20221028-Piano_dei_Test_SIES_v.12.4.24.0.docx |
|  | Versione | 1.0 |
|  | Data | 44862.0 |
|  | Intervento | SIES v.12.4.24.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.24.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20221028-Allegato_al_piano_test_SIES_v.12.4.24.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202209120114.0 |  |  | 202209120114.0 | SIEP 481/2021 procura generale di bari |  | SIEP | SIEP - SIEP 481/2021 procura generale di bari | TF001.SIEP | Errore nella validazione del fascicolo se Autorità è "Presidente della Repubblica" |  |  |  | Verifica: verificare che all'atto di validare un procedimento con Provvedimento Altra Autorità, quando l'altra Autorità è "Presidente della Repubblica" il sistema non restituisca più errore | 1.0 |  |  |  |  |
| SIUT | SIES | 20220919012.0 |  |  | 20220919012.0 | SIES - sede luogo di nascita condannato |  | SIEP | SIEP - SIES - sede luogo di nascita condannato | TF002.SIEP | Errore nella definizione della sede del Casellario Giudiziale |  |  |  | Verifica: verificare che nel template indicato la sede del Casellario Giudiziale non sia quella del luogo di nascita del condannato bensì quella dell’Ufficio emittente | 1.0 |  |  |  |  |
| SIUT | SIES | 202209190112.0 |  |  | 202209190112.0 | SIEP ORDINE DI ESECUZIONE ERRORE BLOCCANTE - ELIMINARE ANOMALIA |  | SIEP | SIEP - SIEP ORDINE DI ESECUZIONE ERRORE BLOCCANTE - ELIMINARE ANOMALIA | TF003.SIEP | Errore nell'inserimento di un ordine di esecuzione con anno data fine pena maggiore del 2050 |  |  |  | Verifica: verificare che, in fase di inserimento di un ordine di esecuzione, se l'anno della data di fine è maggiore del 2050, il sistema non restituisca un messaggio di errore bloccante | 1.0 |  |  |  |  |
| SIUT | SIES | 20221005019.0 |  |  | 20221005019.0 | valore su CG_REF_CODES |  | SIES | SIES - valore su CG_REF_CODES | TF001.SIES | Errore nella mancata codifica del codice tipo funzione pari ad 'F' |  |  |  | Verifica: verificare che nel database sia presente la codifica del valore 'F' nella tabella 'CG_REF_CODES' e dominio 'TIPO_FUNZIONE' | 1.0 |  |  |  |  |
| SIUT | SIES | 202210060112.0 |  |  | 202210060112.0 | Siep - errore copia reati |  | SIEP | SIEP - Siep - errore copia reati | TF004.SIEP | Errore nella selezione dei reati da copiare |  |  |  | Verifica: verificare che, nella funzionalità di copia reati, in caso che il numero dei reati sia maggiore di uno, sia obbligatorio selezionare almeno un reato | 1.0 |  |  |  |  |
| SIUT | SIES | 202210060114.0 |  |  | 202210060114.0 | siep correzione template SIEP_MS_TRASM_COMP |  | SIEP | SIEP - siep correzione template SIEP_MS_TRASM_COMP | TF005.SIEP | Errore nella gestione del Titolo Esecutivo associato alla Misura Sicurezza |  |  |  | Verifica: verificare che, nel template indicato, il Titolo Esecutivo associato alla Misura Sicurezza se differente dal titolo del procedimento venga citato al posto del titolo principale | 1.0 |  |  |  |  |
| SIUT | SIES | 202210130113.0 |  |  | 202210130113.0 | Siep cumulo - messaggio restituzione atti |  | SIEP | SIEP - Siep cumulo - messaggio restituzione atti | TF006.SIEP | Errore nella mancata gestione del codice di rigetto '01007' che doveva essere gestito alla stregua del codice di restituzione atti (01003) |  |  |  | Verifica: verificare che, nella pagina di dettaglio della trasmissione non compaia più il messaggio relativo agli atti rigettati | 1.0 |  |  |  |  |
| SIUT | SIES | 202210170122.0 |  |  | 202210170122.0 | SIEP |  | SIEP | SIEP - SIEP | TF007.SIEP | Errore nella iscrizione di un provvedimento di Concessione detenzione domiciliare a termine |  |  |  | Verifica: verificare che, nella emissione di un provvedimento di Concessione detenzione domiciliare a termine, nel caso di posizione giuridica attuale "Espiazione Pena in Regime di Detenzione Domiciliare" e posizione giuridica precedente "Libero", il sistema non restituisca un messaggio di errore | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.24.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20221028-Allegato_al_piano_test_SIES_v.12.4.24.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nella validazione del fascicolo se Autorità è "Presidente della Repubblica" |  | Verifica: verificare che all'atto di validare un procedimento con Provvedimento Altra Autorità, quando l'altra Autorità è "Presidente della Repubblica" il sistema non restituisca più errore |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un fascicolo non archiviato | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Definizione Procedimento » Provvedimento Altra Autorità |  | Visualizzazione pagina "Definizione Procedimento - Provvedimento Altra Autorità" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Scegliere nel campo "Autorità Emittente" la voce "Presidente della Repubblica"; lasciare vuoto il campo "Sede" | Visualizzazione pagina "Dettaglio Definizione Procedimento - Provvedimento Altra Autorità" |  |  |  |  |
|  | 3.0 | Azione | Premere l'icona di "Valida Provvedimento" | Procedimento Archiviato |  |  |  |  |  |
|  | V | Verifica | Verificare che l'operazione di archiviazione vada a buon fine |  | Visualizzazione pagina "Dettaglio Definizione Procedimento - Provvedimento Altra Autorità" |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella definizione della sede del Casellario Giudiziale |  | Verifica: verificare che nel template indicato la sede del Casellario Giudiziale non sia quella del luogo di nascita del condannato bensì quella dell’Ufficio emittente |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Aprire una istruttoria di cumulo o ricercarne una in stato "APERTA" | Visualizzazione pagina "Gestione Cumulo" |  |  |  |  |
|  | 1.0 | Navigazione | Chiusura cumulo » Dati Finali Cumulo |  | Visualizzazione pagina "Dati Finali Cumulo" |  |  |  |  |
|  | 2.0 | Azione | Scegliere il tabulatore "Emisione Provvedimento" (dopo aver compilato tutti i precedenti tabulatori) |  | Visualizzazione pagina "Dati Finali Cumulo - Emissione Provvedimento" |  |  |  |  |
|  | 3.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Nela campo "Tipologia (*)" selezionare la voce "Provvedimento di unificazione di pene concorrenti (generico)" | Visualizzazione pagina "Dettaglio Provvedimento Determinazione Pene Concorrenti" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sull'icona di "Generazione Stampa" | Generazione stampa "SIEP_CUMULO_GENERICO_NEW.rtf" |  |  |  |  |  |
|  | V | Verifica | Verificare che nel documento di stampa prodotto il Casellario Giudiziale deputato a processare il foglio complementare relativo ad un dato provvedimento è sempre quello della sede dell’Ufficio Giudiziario che quel provvedimento emette, e la regola vale anche per i soggetti stranieri |  |  |  |  |  |  |
| TF003.SIEP | SIEP | Errore nell'inserimento di un ordine di esecuzione con anno data fine pena maggiore del 2050 |  | Verifica: verificare che, in fase di inserimento di un ordine di esecuzione, se l'anno della data di fine è maggiore del 2050, il sistema non restituisca un messaggio di errore bloccante |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere un fascicolo con soggetto in posizione giuridica di "Custodia Cautelare per questa causa in regime di detenzione" dal 01.07.2022 non validato |  |  |  |  |  |
|  | 1.0 | Navigazione | Validazione Procedimento | Inserire una pena complessiva pari ad almeno 29 anni | Visualizzazione pagina "Validazione Procedimento" |  |  |  |  |
|  | 2.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizzazione pagina "Emissione Ordine di Esecuzione - Custodia Cautelare per Questa Causa in Regime di Detenzione" |  |  |  |  |
|  | 3.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Verificare che nel campo "Data Fine Pena" sia riportata una data con anno > 2050 |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema inserisca correttamente l'Ordine di Esecuzione senza messagi di errori bloccanti |  | Visualizzazione pagina "Dettaglio Ordine Esecuzione - Custodia Cautelare per Questa Causa in Regime di Detenzione" |  |  |  |  |
| TF001.SIES | SIES | Errore nella mancata codifica del codice tipo funzione pari ad 'F' |  | Verifica: verificare che nel database sia presente la codifica del valore 'F' nella tabella 'CG_REF_CODES' e dominio 'TIPO_FUNZIONE' |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso ad "Oracle" (con qualsiasi strumento tipo "toad", "developer", …) come utente siesxx | Dove xx è la sigla del distretto di appartenenza, per esempio: rm per Roma | Utente collegato al database |  |  |  |  |
|  | 1.0 | Azione | Eseguire la query | select count(*) from CG_REF_CODES c where c.rv_domain = 'TIPO_FUNZIONE' and c.rv_low_value = 'F'; | Risposta del database |  |  |  |  |
|  | V | Verifica | Verificare che il valore di ritorno sia pari ad 1 |  |  |  |  |  |  |
| TF004.SIEP | SIEP | Errore nella selezione dei reati da copiare |  | Verifica: verificare che, nella funzionalità di copia reati, in caso che il numero dei reati sia maggiore di uno, sia obbligatorio selezionare almeno un reato |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un procedimento (in stato iscritto) | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Iscrizione Reati |  | Visualizzazione pagina "Inserimento Reato" |  |  |  |  |
|  | 2.0 | Azione | Cliccare sull'icona di "Copia Reati" |  | Visualizzazione popup "Ricerca Reati Fascicolo" |  |  |  |  |
|  | 3.0 | Azione | Riempire i campi "Anno/Numero Procedimento" e premere il tasto "Ricerca" | Ricercare un procedimento che abbia almeno due reati | Visualizzazione popup "Elenco Reati" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sul tasto "Copia" | NON SELEZIONARE ALCUN REATO |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non restituisca errore bensì obblighi la selezione di almeno un reato |  |  |  |  |  |  |
| TF005.SIEP | SIEP | Errore nella gestione del Titolo Esecutivo associato alla Misura Sicurezza |  | Verifica: verificare che, nel template indicato, il Titolo Esecutivo associato alla Misura Sicurezza se differente dal titolo del procedimento venga citato al posto del titolo principale |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un procedimento di Misura di Siciurezza (classe IV) con due misure: una senza titolo associato, l'altra associando un titolo differente dal principale | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Gestione Misure Sicurezza » Trasmissione Atti per Competenza |  | Visualizzazione pagina "TRASMISSIONE PER COMPETENZA ESECUZIONE MISURE DI SICUREZZA" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "DETTAGLIO TRASMISSIONE PER COMPETENZA ESECUZIONE MISURE DI SICUREZZA" |  |  |  |  |
|  | 3.0 | Azione | Cliccare sull'icona di "Generazione Stampa" | Generazione stampa "SIEP_MS_TRASM_COMP.rtf" |  |  |  |  |  |
|  | V | Verifica | Verificare che nel documento di stampa prodotto per ciascuna Misura di Sicurezza sia citato correttamente il titolo esecutivo associato |  |  |  |  |  |  |
| TF006.SIEP | SIEP | Errore nella mancata gestione del codice di rigetto '01007' che doveva essere gestito alla stregua del codice di restituzione atti (01003) |  | Verifica: verificare che, nella pagina di dettaglio della trasmissione non compaia più il messaggio relativo agli atti rigettati |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un procedimento (in stato validato) | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Istruttorie/Richieste » Trasmissione per Competenza/Seguito Atti » Nel Distretto |  | Visualizzazione pagina "Ricerca Procedimento" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Carica" | Selezionare un fascicolo esistente di altro ufficio (es: PGCAP) | Visualizzazione pagina "TRASMISSIONE PER COMPETENZA" |  |  |  |  |
|  | 3.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Valorizzare il campo "Oggetto Atto" con la voce "atti per competenza (per emissione provvedimento cumulo)" | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sull'icona di "Generazione Stampa" |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | 5.0 | Azione | Selezionare il checkbox "Valida Documento" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | 6.0 | Azione | Cliccare sull'icona "Trasmissione Provvedimento" |  | Visualizzazione pagina "Trasferimento Trasmissione per Competenza" |  |  |  |  |
|  | 7.0 | Azione | Premere il tasto "Conferma" | Premere il tasto "OK" | Visualizzazione pagina "Trasferimento Trasmissione per Competenza" |  |  |  |  |
|  | 8.0 | Azione | Cliccare sull'icona "Dettaglio Procedimento" | Il sistema avviserà con il messaggio: "Attenzione! Il procedimento risulta trasmesso in data gg-mm-aaaa a Ufficio di Sede per assorbimento in cumulo sul procedimento anno/numero. | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 9.0 | Navigazione | Elenco Provvedimenti del PM |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 10.0 | Azione | Cliccare, nel campo "Azioni", sull'icona "Dettagli" del provvedimento appena emesso |  | Visualizzazione pagina "Dettaglio Trasmissione Competenza" |  |  |  |  |
|  | 11.0 | Azione | Cliccare sul tasto "ANNOTAZIONE ESITO" |  | Visualizzazione pagina "ANNOTAZIONE ESITO TRASMISSIONE ATTI PER COMPETENZA" |  |  |  |  |
|  | 12.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" | Valorizzare il campo "Esito Provvedimento" con la voce "Atti Rigettati" | Visualizzazione pagina "DETTAGLIO ANNOTAZIONE ESITO ATTI TRASMISSIONI PER COMPETENZA (ex artt. 663 e 665 comma 4 c.p.p.)" |  |  |  |  |
|  | 13.0 | Azione | Cliccare sull'icona "Valida Provvedimento" | Premere il tasto "OK" | Visualizzazione pagina "DETTAGLIO ANNOTAZIONE ESITO ATTI TRASMISSIONI PER COMPETENZA (ex artt. 663 e 665 comma 4 c.p.p.)" |  |  |  |  |
|  | 14.0 | Azione | Cliccare sull'icona "Dettaglio Procedimento" |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di dettaglio non compaia più il messaggio relativo agli atti rigettati |  |  |  |  |  |  |
| TF007.SIEP | SIEP | Errore nella iscrizione di un provvedimento di Concessione detenzione domiciliare a termine |  | Verifica: verificare che, nella emissione di un provvedimento di Concessione detenzione domiciliare a termine, nel caso di posizione giuridica attuale "Espiazione Pena in Regime di Detenzione Domiciliare" e posizione giuridica precedente "Libero", il sistema non restituisca un messaggio di errore |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (od iscrivere) un procedimento (in stato validato) in cui la sequenza delle posizioni giuridiche sia "Libero" prima ed "Espiazione Pena in Regime di Detenzione Domiciliare" dopo | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni Sorveglianza » Differimento pena nelle forme della detenzione domiciliare » Concessione |  | Visualizzazione pagina "CONCESSIONE DETENZIONE DOMICILIARE A TERMINE" |  |  |  |  |
|  | 2.0 | Azione | Riempire tutti i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Detenzione Domiciliare a Termine" |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non restituisca errore bensì proponga la pagina di dettaglio |  |  |  |  |  |  |
