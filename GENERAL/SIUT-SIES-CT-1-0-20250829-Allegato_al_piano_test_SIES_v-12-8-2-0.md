---
uniqueName: siut-sies-ct-1-0-20250829-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20250829 Allegato al piano test SIES v 12 8 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20250829-Allegato_al_piano_test_SIES_v.12.8.2.0

> **File originale:** `RILASCIO_12.8.2.0/SIUT-SIES-CT-1.0-20250829-Allegato_al_piano_test_SIES_v.12.8.2.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.8.2.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20250829-Allegato_al_piano_test_SIES_v.12.8.2.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202507220132 |  |  | 202507220132 | SIES - ricerca utenti il campo sede non può avere caratteri speciali |  | SIEP | SIEP - SIES - ricerca utenti il campo sede non può avere caratteri speciali | TF001.SIEP | Errore nell'inserimento del valore "Bolzano/Bozen" nel campo "Sede" |  |  |  | Verifica: Verificare che la ricerca di un utente non vada in errore se il campo "Sede" dell'ufficio comprende un carattere non alfabetico | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.8.2.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20250829-Allegato_al_piano_test_SIES_v.12.8.2.0.xlsx |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nell'inserimento del valore "Bolzano/Bozen" nel campo "Sede" |  | Verifica: Verificare che la ricerca di un utente non vada in errore se il campo "Sede" dell'ufficio comprende un carattere non alfabetico |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Amministratore di Sistema" | ADMINxx (Procura della Repubblica presso il Tribunale)
(dove xx è la sigla del distretto di appartenenza, per esempio: RM per Roma) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione |  |  | Visualizzazione pagina "" |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Ricerca" | Inserire nel campo "Ufficio" il valore "Tribunale Ordinario" ed in quello "Sede" il valore "BOLZANO/BOZEN" | Visualizzazione pagina "" |  |  |  |  |
|  | V | Verifica | L'utente ha ricercato l'Utente dell'ufficio |  | Il risultato atteso è che la ricerca sia andata a buon fine |  |  |  |  |
