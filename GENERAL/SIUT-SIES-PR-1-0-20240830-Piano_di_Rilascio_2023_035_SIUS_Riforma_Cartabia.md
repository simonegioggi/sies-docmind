---
uniqueName: siut-sies-pr-1-0-20240830-pianodirilascio2023035si
displayName: "SIUT SIES PR 1 0 20240830 Piano di Rilascio 2023 035 SIUS Riforma Cartabia"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20240830-Piano_di_Rilascio_2023_035_SIUS_Riforma_Cartabia

> **File originale:** `MEV/SCHEDA_035/ORIGINALI/SIUT-SIES-PR-1.0-20240830-Piano_di_Rilascio_2023_035_SIUS_Riforma_Cartabia.docx`  
> **Tipo:** DOCX
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.6.4.0-MEV_2023_35 di SIES.
Riporta inoltre le modalità di installazione degli aggiornamenti in ambiente di esercizio.
## Riferimenti
| Riferimento | Nome Documento | Descrizione Documento |
| --- | --- | --- |
| RIF1. | SIUT-SIE-SI-1.2-20240318_Specifiche_Intervento_MEV_2023_035_SIUS_Riforma_Cartabia | Specifiche Intervento |
...
# Generalità
Il presente documento descrive il piano di rilascio del software relativo alla MEV 2023-035 - SIUS Riforma Cartabia di SIES, contenente l’integrazione della suddetta MEV con la versione SIES 12.6.4.0.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 07 - MEV > Scheda 2023_ 035 - SIUS Riforma Cartabia > 05_Verifica di Conformita' | 1.0 | 30/08/2024 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- |
| - | SIUT-SIE-SI-1.2-20240318_Specifiche_Intervento_MEV_2023_035_SIUS_Riforma_Cartabia | - | Adeguamento al d.lgs. 10 ottobre 2022, n. 150 |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20240830-Piano_di_Rilascio_2023_035_SIUS_Riforma_Cartabia.pdf
SIUT-SIES-CT-1.0-20240830-Allegato_al_piano_Test_2023_035_SIUS_Riforma_Cartabia.xlsx
SIUT-SIES-PT-1.0-20240830-Piano_dei_Test_2023_035_SIUS_Riforma_Cartabia.pdf
SIUT-SIES-MU-1.0-20240830-Manuale_Utente_2023_035_SIUS_Riforma_Cartabia.pdf
SIUT-SIES-ML-1.12-20240830-Modello_dei_Dati_2023_035_SIUS_Riforma_Cartabia.pdf |
...
Creare sul server DB una cartella MEV_2023_35 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/MEV_2023_35/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella MEV_2023_35 tramite il comando:
chmod 777 MEV_2023_35
...
Nella cartella appena creata (MEV_2023_35), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/MEV_2023_35/log/ in cui si può constatare l’esito dell’esecuzione.
