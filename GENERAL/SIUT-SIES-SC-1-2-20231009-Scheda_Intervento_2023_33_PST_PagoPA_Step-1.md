---
uniqueName: siut-sies-sc-1-2-20231009-schedaintervento202333ps
displayName: "SIUT SIES SC 1 2 20231009 Scheda Intervento 2023 33 PST PagoPA Step 1"
category: "GENERAL"
tags: []
---

# SIUT-SIES-SC-1.2-20231009-Scheda_Intervento_2023_33_PST_PagoPA_Step-1

> **File originale:** `MEV/SCHEDA_033/SIUT-SIES-SC-1.2-20231009-Scheda_Intervento_2023_33_PST_PagoPA_Step-1.docx`  
> **Tipo:** DOCX
...
2.3	Gestione ordine di Ingiunzione	10
2.3.1	Notifiche	11
...
2.5.2.1	Rideterminazione della pena pecuniaria	28
2.5.2.2	Avviso Mancato Pagamento	30
2.5.2.3	Provvedimento Estinzione della Pena Pecuniaria	31
2.5.2.4	Trasmissione Atti per la Conversione	32
2.5.2.5	Definizione Procedimento Pena Pecuniaria	33
2.6	Verifica Stato Bollettini	33
2.7	Scadenzari	34
2.7.1	Scadenzario Stato Pagamenti	34
2.7.2	Ricerca procedimenti per Stato Pagamenti	36
2.8	Gestione Pene Sostitutive Brevi	38
2.8.1	Semilibertà/Detenzione Domiciliare Sostitutive	38
2.8.1.1	Trasmissione Atti per Esecuzione	39
2.8.1.2	Riscontro Trasmissione Atti per Esecuzione	40
2.9	Batch di verifica stato del Pagamento	41
2.10	Interventi sottosistema SIGE	41
2.10.1	Aggiornamento template Fissazione Udienza	41
2.10.2	Integrazione Tabelle Oggetti	42
2.10.2.1	Art. 95 disposizioni transitorie in materia di pene sostitutive delle pene detentive	42
2.10.2.2	Riduzione pena art. 442, comma 2-bis - D.lgs. 150/22	42
2.11	Gestione errori con pagoPA	43
2.11.1	Cruscotto per funzionalità Batch	43
2.11.1.1	Informazione per gli uffici	44
2.11.2	Cruscotto per funzionalità web	46
2.12	Test di Sistema	48
3	Piano delle attività	49
3.1	Ciclo di sviluppo	49
3.2	Piano delle attività	49
3.3	Gantt	49
3.4	Vincoli	49
3.5	Luogo di lavoro	49
4	Dimensionamento	50
4.1	Stima dell'effort	50
4.1.1	Attività progettuali a corpo	50
4.2	Dettaglio dei costi	50
...
Per quanto riguarda il calcolo date scadenze, al momento dell’annotazione della data di avvenuta notifica al condannato, il sistema dovrà procedere al calcolo della data scadenza per il pagamento del primo bollettino e dei restanti bollettini, in caso di rateizzaziome , secondo i seguenti principi:
...
A seguito delle modifiche apportate alla gestione Modalità di Pagamento, la form di Verifica Stato Pagamenti presenterà l’elenco dei provvedimenti che hanno comportato la generazione di Bollettini pagoPA per ciascun provvedimento
...
Selezionando l’icona di Dettaglio nella colonna “Azioni”, il sistema visualizzerà la form della funzionalità in errore al fine di reinnescarla dal punto precedente al verificarsi dell’errore.
Test di Sistema
