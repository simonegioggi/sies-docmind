---
uniqueName: siut-sies-ct-1-0-20260227-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20260227 Allegato al piano test SIES v 12 9 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20260227-Allegato_al_piano_test_SIES_v.12.9.1.0

> **File originale:** `RILASCIO_12.9.1.0/SIUT-SIES-CT-1.0-20260227-Allegato_al_piano_test_SIES_v.12.9.1.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.9.1.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20260227-Allegato_al_piano_test_SIES_v.12.9.1.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202602190150 |  |  | 202602190150 | SIES - Sius - Richiesta password NSC |  | SIUS | SIUS - SIES - Sius - Richiesta password NSC | TF001.SIUS | Errore aggiornamento password richiesta certificato NSC |  |  |  | Verifica: Verificare la validità dell'aggiornamento della password per la richiesta certificato | 1.0 |  |  |  |  |
| SIUT | SIES | 202602190169 |  |  | 202602190169 | PROCURA GENERALE NAPOLI |  | SIEP | SIEP - PROCURA GENERALE NAPOLI | TF001.SIEP | Errore aggiornamento password richiesta certificato NSC |  |  |  | Verifica: Verificare la validità dell'aggiornamento della password per la richiesta certificato | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.9.1.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20260227-Allegato_al_piano_test_SIES_v.12.9.1.0.xlsx |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | SIUS | Errore aggiornamento password richiesta certificato NSC |  | Verifica: Verificare la validità dell'aggiornamento della password per la richiesta certificato |  | 1.0 |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Tribunale si Sorveglianza" | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | P | Stato Base | L'utente ricerca un procedimento |  | Visualizzazione pagina "Dettaglio Procedimento SIUS" |  |  |  |  |
|  | 1 | Navigazione | selezionare dal menù orizzontale la funzione "Richiesta Certificato Penale" | Userid e Password valorizzati | Visualizzazione pagina "Richiesta Certificato Penale" |  |  |  |  |
|  | V | Verifica | Verificare nell'HTML della pagina che la password sia presente in chiaro e non codificata | Tasto destro del mouse e premere "HTML" |  |  |  |  |  |
|  | 2 | Azione | Modificare la password |  | Visualizzazione pagina "Richiesta Certificato Penale" |  |  |  |  |
|  | V | Verifica | Verificare nell'HTML della pagina che la password sia presente (modificata) in chiaro e non codificata | Tasto destro del mouse e premere "HTML" |  |  |  |  |  |
| TF001.SIEP | SIEP | Errore aggiornamento password richiesta certificato NSC |  | Verifica: Verificare la validità dell'aggiornamento della password per la richiesta certificato |  | 1.0 |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 1 | Navigazione | selezionare la funzione "Istruttorie/Richieste" nel menu verticale |  | Visualizzazione pagina "Istruttorie/Richieste" |  |  |  |  |
|  | 2 | Azione | Cliccare sul pulsante "Richiesta Certificato Penale" |  | Visualizzazione pagina "Richiesta Certificato Penale" |  |  |  |  |
|  | V | Verifica | Verificare nell'HTML della pagina che la password sia presente in chiaro e non codificata | Tasto destro del mouse e premere "HTML" |  |  |  |  |  |
|  | 3 | Azione | Modificare la password |  | Visualizzazione pagina "Richiesta Certificato Penale" |  |  |  |  |
|  | V | Verifica | Verificare nell'HTML della pagina che la password sia presente (modificata) in chiaro e non codificata | Tasto destro del mouse e premere "HTML" |  |  |  |  |  |
