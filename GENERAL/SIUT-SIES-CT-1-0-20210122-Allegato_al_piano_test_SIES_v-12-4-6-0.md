---
uniqueName: siut-sies-ct-1-0-20210122-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210122 Allegato al piano test SIES v 12 4 6 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210122-Allegato_al_piano_test_SIES_v.12.4.6.0

> **File originale:** `RILASCIO_12.4.6.0/SIUT-SIES-CT-1.0-20210122-Allegato_al_piano_test_SIES_v.12.4.6.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210122-Allegato-al-piano-test_SIES_v.12.4.6.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210122-Piano_dei_Test_SIES_v.12.4.6.0.doc |
|  | Versione | 1.0 |
|  | Data | 44218.0 |
|  | Intervento | SIES v.12.4.6.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.6.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210122-Allegato-al-piano-test_SIES_v.12.4.6.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202012020116.0 |  |  | 202012020116.0 | Provvedimento di cumulo revoca misura alternativa |  | SIEP | SIEP - Provvedimento di cumulo revoca misura alternativa | TF001.SIEP | Verifica corretta visualizzazione dei dati relativi alla revoca della misura alternativa. |  |  |  | Verifica: verificare che nel Dettaglio Revoca Misura Alternativa vengano visualizzati correttamente i campi Data inizio e fine misura. | 1.0 |  |  |  |  |
| SIUT | SIES | 20201204019.0 |  |  | 20201204019.0 | Calcolo errato revoca benefici applicati con sentenza di condanna |  | SIEP | SIEP - Calcolo errato revoca benefici applicati con sentenza di condanna | TF002.SIEP | Verifica che il calcolo revoca benefici applicati con sentenza di condanna sia corretto. |  |  |  | Verifica: verificare che nel "Dettaglio della Pena" in fondo alla popup nella sezione "Totale Quantum" non vi siano quantum di arresto negativi pari alla Misura cautelare sofferta. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.6.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210122-Allegato-al-piano-test_SIES_v.12.4.6.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica corretta visualizzazione dei dati relativi alla revoca della misura alternativa. |  | Verifica: verificare che nel Dettaglio Revoca Misura Alternativa vengano visualizzati correttamente i campi Data inizio e fine misura. |  | 1.0 |  |  | OK |
...
| TF002.SIEP | 02 | Verifica che il calcolo revoca benefici applicati con sentenza di condanna sia corretto. |  | Verifica: verificare che nel "Dettaglio della Pena" in fondo alla popup nella sezione "Totale Quantum" non vi siano quantum di arresto negativi pari alla Misura cautelare sofferta. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
