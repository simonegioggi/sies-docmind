---
uniqueName: siut-sies-pt-1-0-20240927-pianodeitestsiesv-12-6-4
displayName: "SIUT SIES PT 1 0 20240927 Piano dei Test SIES v 12 6 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PT-1.0-20240927-Piano_dei_Test_SIES_v.12.6.4.0

> **File originale:** `RILASCIO_12.6.4.0/SIUT-SIES-PT-1.0-20240927-Piano_dei_Test_SIES_v.12.6.4.0.docx`  
> **Tipo:** DOCX
...
# Introduzione
## Scopo del documento
Il presente documento descrive il piano dei test per la verifica della risoluzione dei ticket indicati nel piano di rilascio: SIUT-SIES-PR-1.0-20240927-Piano_di_Rilascio_SIES_v.12.6.4.0.docx.
## Riferimenti
| Riferimento | Nome Documento | Descrizione Documento |
| --- | --- | --- |
| RIF1 | SIUT-SIES-PR-1.0-20240927-Piano_di_Rilascio_SIES_v.12.6.4.0.docx | Il documento riporta l’elenco delle funzionalità modificate con gli interventi eseguiti dal servizio di manutenzione forniti con il presente rilascio.
Riporta inoltre le modalità di installazione degli aggiornamenti in ambiente di esercizio |
| RIF2 | SIUT-SIES-CT-1.0-20240927-Allegato-al-piano-test_SIES_v.12.6.4.0.xlsx | Il documento riporta l'elenco dei test eseguiti per la verifica della risoluzione delle anomalie |
...
## Entità da testare
L'entità oggetto di verifica è l'applicativo SIES relativamente alle funzionalità oggetto dei ticket indicati nel piano di rilascio SIUT-SIES-PR-1.0-20240927-Piano_di_Rilascio_SIES_v.12.6.4.0.docx.
...
I test sono eseguiti secondo quanto descritto nella relativa scheda contenuta nel documento SIUT-SIES-CT-1.0-20240927-Allegato-al-piano-test_SIES_v.12.6.4.0.xlsx. In particolare, è stata compilata la colonna ‘Esito’ per indicare l'esito del test.
# Gestione delle anomalie e ripetizione dei test
N.A.

# Ambiente di test
Per l'esecuzione dei test è stata installata la versione 12.6.4.0 di SIES secondo quanto stabilito dal documento di rilascio.
...
La descrizione di dettaglio di ciascun caso di test è contenuta nel documento SIUT-SIES-CT-1.0-20240927-Allegato-al-piano-test_SIES_v.12.6.4.0.xlsx a complemento del presente piano dei test.
In particolare:
