---
uniqueName: siut-sies-ct-1-0-20211022-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20211022 Allegato al piano test SIES v 12 4 14 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20211022-Allegato_al_piano_test_SIES_v.12.4.14.0

> **File originale:** `RILASCIO_12.4.14.0/SIUT-SIES-CT-1.0-20211022-Allegato_al_piano_test_SIES_v.12.4.14.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20211022-Allegato-al-piano-test_SIES_v.12.4.14.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20211022-Piano_dei_Test_SIES_v.12.4.14.0.docx |
|  | Versione | 1.0 |
|  | Data | 44491.0 |
|  | Intervento | SIES v.12.4.14.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.14.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20211022-Allegato-al-piano-test_SIES_v.12.4.14.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210922015.0 |  |  | 20210922015.0 | inserimento autorità minorile |  | SIEP | SIEP - inserimento autorità minorile | TF001.SIEP | Verifica corretto popolamento della combo "Ufficio Recupero Crediti presso" |  |  |  | Verifica: verificare che  la combo relativa all'"Ufficio Recupero Crediti presso" contenga anche le voci "Tribunale per i Minorenni" e "Sezione di Corte di Appello per i minorenni | 1.0 |  |  |  |  |
| SIUT | SIES | 20210924018.0 |  |  | 20210924018.0 | Pagine di Errore - SIEP PROCURA GENERALE DI BARI |  | SIEP | SIEP - Pagine di Errore - SIEP PROCURA GENERALE DI BARI | TF002.SIEP | Verifica visualizzazione messaggio su cancellazione pene accessorie di due procedimenti SIEP e SIGE collegati |  |  |  | Verifica: verificare che il sistema visualizzi un messaggio che spieghi l'impossibilità di eliminare delle pene accessorie da un procedimento SIEP se è collegato anche ad un procedimento SIGE | 1.0 |  |  |  |  |
| SIUT | SIES | 202109290111.0 |  |  | 202109290111.0 | ESTRAZIONE DATI RELATIVI A MISURE DI SICUREZZA |  | SIEP | SIEP - ESTRAZIONE DATI RELATIVI A MISURE DI SICUREZZA | TF003.SIEP | Verifica presenza nel file delle statistiche della scheda "Altre Posizioni" dei Totali  Finali. |  |  |  | Verifica: verificare che nelle statistiche relative ai procedimenti di Classe IV sia presente anche la scheda "Altre Posizioni" e siano presenti i Totali Finali. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210930015.0 |  |  | 20210930015.0 | Rif TT 20210929016 |  | SIEP | SIEP - Rif TT 20210929016 | TF004.SIEP | Verifica corretta prospettazione template |  |  |  | Verifica: verificare che il template SIEP_MA_TRASF_ATTI_51BIS riporti le modifiche richieste nel ticket. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210928015.0 |  |  | 20210928015.0 | Sige - errore estrazionedati |  | SIGE | SIGE - Sige - errore estrazionedati | TF005.SIGE | Verifica non duplicazione oggetti in statistica SIGE |  |  |  | Verifica: verificare che per il procedimento preso in esame nella colonna Tipologia Incidente d'esecuzione non sia ripetuta la descrizione dell'oggetto per Tipologia d'Atto. | 1.0 |  |  |  |  |
| SIUT | SIES | 20211006019.0 |  |  | 20211006019.0 | SIEP 471_2021 impossibiule modificare i dati del titolo esecutivo |  | SIEP | SIEP - SIEP 471_2021 impossibiule modificare i dati del titolo esecutivo | TF006.SIEP | Verifica corretta gestione provvedimento sospensione esecuzione pena. |  |  |  | Verifica: verificare che il sistema permetta l'inserimento e la successiva eventuale cancellazione di un provvedimento per sospensione esecuzione pena. | 1.0 |  |  |  |  |
| SIUT | SIES | 20211011015.0 |  |  | 20211011015.0 | ERRORE BLOCCANTE |  | SIEP | SIEP - ERRORE BLOCCANTE | TF007.SIEP | Verifica corretta chiamata a funzione"Inserimento Variazione Decorrenza/Scadenza Questa Causa" |  |  |  | Verifica: verificare che la chiamata alla funzione Inserimento Variazione Decorrenza/Scadenza Questa Causa" non produca un errore software. | 1.0 |  |  |  |  |
| SIUT | SIES | 202110140115.0 |  |  | 202110140115.0 | siep 144/2021 stampa template ordine di esecuzione per la carcerazione - modello SIEP_OE_LIB |  | SIEP | SIEP - siep 144/2021 stampa template ordine di esecuzione per la carcerazione - modello SIEP_OE_LIB | TF008.SIEP | Verifica presenza dati GUP nella stampa dell'ordine di esecuzione/scarcerazione |  |  |  | Verifica: verificare che la stampa SIEP_OE_LIB riporti anno/numero Reg. Gen. se relativo al GUP | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.14.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20211022-Allegato-al-piano-test_SIES_v.12.4.14.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica corretto popolamento della combo "Ufficio Recupero Crediti presso" |  | Verifica: verificare che  la combo relativa all'"Ufficio Recupero Crediti presso" contenga anche le voci "Tribunale per i Minorenni" e "Sezione di Corte di Appello per i minorenni |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Ricercare un procedimento con posizione giuridica Espiazione Pena in regime di Affidamento  in Prova. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Navigazione | Decisioni Sorveglianza |  | Visualizzazione pagina Decisioni Sorveglianza |  |  |  |  |
|  | 3 | Azione | Selezionare Espulsione |  | Visualizazione pagina  ESPULSIONE DAL TERRITORIO DELLO STATO ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD. |  |  |  |  |
|  | 4 | Azione | Selezionare Avvenuta Espulsione |  | Visualizzazione pagina AVVENUTA ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD. |  |  |  |  |
|  | 5 | Azione | Inserire i dati richiesti nella pagina e cliccare su Calcola |  | Visualizzazione pagina AVVENUTA ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD. |  |  |  |  |
|  | V | Verifica | Verificare che la combo relativa all'Ufficio Recupero Crediti presso contenga anche le voci "Tribunale per i Minorenni" e "Sezione di Corte di Appello per i minorenni" |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica visualizzazione messaggio su cancellazione pene accessorie di due procedimenti SIEP e SIGE collegati |  | Verifica: verificare che il sistema visualizzi un messaggio che spieghi l'impossibilità di eliminare delle pene accessorie da un procedimento SIEP se è collegato anche ad un procedimento SIGE |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un fascicolo SIEP non archiviato. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Verificare la presenza di Pene Accessorie tramite la voce "Elenco Pene Accessorie" selezionabile dalla combo presente sul dettaglio. Se assenti passare allo step successivo altrimenti allo step 4. |  | Visualizzazione pagina Elenco Pene Accessorie |  |  |  |  |
|  | 3 | Azione | Selezionare dalla combo la voce "Iscrizione Pena Accessoria" e procedere all'iscrizione di una pena selezionando il tipo di pena e la durata, gli altri dati non sono necessari. Confermare. |  | Visualizzazione pagina  Inserimento Pena Accessoria |  |  |  |  |
|  | 4 | Azione | L'utente effettua l'accesso al sistema SIGE come Tribunale Ordinario | Txxxxx (Tribunale Ordinario) |  |  |  |  |  |
|  | 5 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 6 | Navigazione | Iscrizione manuale » Ricerca Procedimento SIEP per Numero |  |  |  |  |  |  |
|  | 7 | Azione | Ricercare il fascicolo SIEP su cui sono state precedentemente inserite le Pene Accessorie |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 8 | Azione | Selezionare "Iscrizione Procedimento Sige" dalla combo. |  | Visualizzazione pagina Iscrizione Procedimento SIGE da Procedimento SIEP |  |  |  |  |
|  | 9 | Azione | Indicare Tipo Atto, Data arrivo in cancelleria, Magistrato e confermare. |  | Visualizzazione pagina Dettaglio Procedimento SIGE |  |  |  |  |
|  | 10 | Azione | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 11 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 12 | Azione | Ricercare il Fascicolo SIEP dello step 3 |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 13 | Azione | selezionare dalla combo del dettaglio "Elenco Pene Accessorie" |  | Visualizzazione pagina Elenco Pene Accessorie |  |  |  |  |
|  | 14 | Azione | Cancellare la Pena accessoria tramite l'apposita icona di cancellazione |  | Viene visualizzato il messaggio di Conferma Cancellazione |  |  |  |  |
|  | 15 | Azione | Cliccare su  OK |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga visualizzato un messaggio che indichi l'impossibilità della cancellazione per la presenza di uno (creato nello step 9) o più fascicoli SIGE collegati. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica presenza nel file delle statistiche della scheda "Altre Posizioni" dei Totali  Finali. |  | Verifica: verificare che nelle statistiche relative ai procedimenti di Classe IV sia presente anche la scheda "Altre Posizioni" e siano presenti i Totali Finali. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Selezionare l'opzione "Classe IV". 
Selezionare "Movimento Procedimenti (Riepilogo Procedimenti Pendenti)" .
Cliccare su conferma. |  | Visualizzazione pagina  RICERCA PROCEDIMENTI CLASSE IV |  |  |  |  |
|  | 3 | Azione | Indicare come "Data Inizio Periodo" 01-01-2015 e "Data Fine Periodo" la data odierna e confermare. |  | Visualizzazione pagina STATISTICHE - ESTRAZIONE DATI - RIEPILOGO MOVIMENTO PROCEDIMENTI |  |  |  |  |
|  | 4 | Azione | Selezionare quindi il tasto "seleziona tutti" e in bassso il tasto "Conferma" |  | Viene prodotto il file Documento.xls |  |  |  |  |
|  | V | Verifica | Verificare che sul file excel scaricato vi sia la scheda "altre posizioni" e che siano riportati i Totali sulla scheda di Riepilogo. |  |  |  |  |  |  |
| TF004.SIEP | 01 | Verifica corretta prospettazione template |  | Verifica: verificare che il template SIEP_MA_TRASF_ATTI_51BIS riporti le modifiche richieste nel ticket. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | V | Verifica | Verificare che la stampa contenga le modifiche richieste nel ticket 20210929016 da parte del referente SIEP Michele Testa. |  |  |  |  |  |  |
| TF005.SIGE | 01 | Verifica non duplicazione oggetti in statistica SIGE |  | Verifica: verificare che per il procedimento preso in esame nella colonna Tipologia Incidente d'esecuzione non sia ripetuta la descrizione dell'oggetto per Tipologia d'Atto. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento SIGE nello stato di Decreto Fissazione Udienza |  | Visualizzazione pagina  Dettaglio Procedimento SIGE |  |  |  |  |
|  | 2 | Navigazione | Udienze/Fissazione/Rinvio/Ruolo » Rinvio Udienza da Verbale |  | Visualizzazione pagina Inserimento Ordinanza Rinvio Udienza da Verbale |  |  |  |  |
|  | 3 | Azione | Inserire i dati obbligatori richiesti. Confermare |  | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza da Verbale |  |  |  |  |
|  | 4 | Azione | Validare l'ordinanza. |  | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza da Verbale |  |  |  |  |
|  | R1 | Riciclo Script | Ripetere gli step 3 e 4  almeno una volta | L'oggetto del Provvedimento deve essere sempre lo stesso | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza da Verbale |  |  |  |  |
|  | 5 | Navigazione | Ricerche » Procedimento SIGE per Estremi Atto |  | Visualizzazione pagina Ricerca Procedimento SIGE per Estremi Atto |  |  |  |  |
|  | 6 | Azione | Effettuare una ricerca con i seguenti dati di input:
Oggetto: Tutti;
Solo Pendenti;
Data Fine pendenza: Indicare una data per esempio 28/09/2021.
Cliccare su Statistica |  | Generazione Statistica (Documento.xls) |  |  |  |  |
|  | V | Verifica | Verificare che per il procedimento preso in esame nella colonna Tipologia Incidente d'esecuzione non sia ripetuta la descrizione dell'oggetto per Tipologia d'Atto. |  |  |  |  |  |  |
| TF006.SIEP | 01 | Verifica corretta gestione provvedimento sospensione esecuzione pena. |  | Verifica: verificare che il sistema permetta l'inserimento e la successiva eventuale cancellazione di un provvedimento per sospensione esecuzione pena. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un fascicolo non Archiviato |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Navigazione | Decisioni Sorveglianza |  | Visualizzazione pagina Decisioni Sorveglianza |  |  |  |  |
|  | 3 | Azione | Selezionare Sospensione Esecuzione Pena |  | Visualizzazione pagina Sospensione dell'esecuzione della pena |  |  |  |  |
|  | V | Verifica | Verificare che la combo "Oggetto Provvedimento" contenga le seguenti 3 voci:
...
|  | 4 | Azione | Compilare i dati della form e confermare. |  | Visualizzazione pagina Sospensione dell'esecuzione della pena |  |  |  |  |
|  | 5 | Azione | Selezionare l'cona posta in alto Elenco Procedimenti Sorveglianza e GE |  | Visuualizzazione pagina Elenco Procedimenti Sorveglianza e GE |  |  |  |  |
|  | V | Verifica | Verificare che sia presente un rigo relativo al provvedimento appena inserito (non validato) con la x per cancellarlo. |  |  |  |  |  |  |
|  | 6 | Azione | Effettuare la cancellazione del Provvedimento |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la cancellazione sia andata a buon fine senza errori. |  |  |  |  |  |  |
| TF007.SIEP | 01 | Verifica corretta chiamata a funzione"Inserimento Variazione Decorrenza/Scadenza Questa Causa" |  | Verifica: verificare che la chiamata alla funzione Inserimento Variazione Decorrenza/Scadenza Questa Causa" non produca un errore software. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Iscrivere un fascicolo SIEP per soggetto con posizione giuridica iniziale Libero, selezionare il check Detenuto per altra causa, selezionare il radio Definitivo - in Istituto di Detenzione, indicare come Tipo Misura Espiazione Pena per Altra Causa in Regime di Detenzione. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Completare i dati minimali (Difensore - Posizione Giuridica - Reati - Pena Complessiva - Assegnazione al magistrato). |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Validare il Procedimento |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 4 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizazione pagina Emissione Ordine di Esecuzione - Custodia Cautelare per Questa Causa in Regime di Detenzione |  |  |  |  |
|  | 5 | Azione | Dopo aver effettuato il calcolo della pena inserire i dati obbligatori e confermare |  | Visualizzazione pagina Dettaglio Ordine Esecuzione - Custodia Cautelare per Questa Causa in Regime di Detenzione |  |  |  |  |
|  | 6 | Azione | Stampare e Validare |  | Visualizzazione pagina Dettaglio Ordine Esecuzione - Espiazione Pena in Regime Carcerario |  |  |  |  |
|  | 7 | Navigazione | Verbali Arresto/Vane Ricerche Notifica Carcere » Verbale di Arresto |  | Visualizazione pagina   Inserimento Verbale di Arresto |  |  |  |  |
|  | 8 | Azione | Inserire i dati obbligatori e confermare |  | Visualizzazione pagina Dettaglio Verbale Arresto |  |  |  |  |
|  | 9 | Azione | Cliccare su validazione fine pena |  | Visualizzazione pagina Dettaglio Verbale Arresto |  |  |  |  |
|  | 10 | Azione | Cliccare su Ordine di scarcerazione |  | Visualizazzione pagina Emissione Ordine di Scarcerazione |  |  |  |  |
|  | 11 | Azione | Inserire i dati obbligatori e confermare |  | Visualizzazione pagina Dettaglio Ordine Scarcerazione |  |  |  |  |
|  | 12 | Azione | Stampare e Validare |  | Visualizzazione pagina Dettaglio Ordine Scarcerazione |  |  |  |  |
|  | 13 | Navigazione | Ordini di Esecuzione/Scarcerazione » Variazione Decorrenza/Scadenza Pena |  |  |  |  |  |  |
|  | V | Verifica | Verificare che l'applicazione rimandi alla pagina Inserimento Variazione Decorrenza/Scadenza Questa Causa  senza l'errore. |  |  |  |  |  |  |
| TF008.SIEP | 01 | Verifica presenza dati GUP nella stampa dell'ordine di esecuzione/scarcerazione |  | Verifica: verificare che la stampa SIEP_OE_LIB riporti anno/numero Reg. Gen. se relativo al GUP |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare tramite l'apposita icona un soggetto |  | Visualizzazione pagina Ricerca Procedimento per Soggetto |  |  |  |  |
|  | 2 | Azione | Se la ricerca ha prodotto un elenco con più soggetti selezionarne uno. |  |  |  |  |  |  |
|  | 3 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina  Inserimento Sentenza |  |  |  |  |
|  | 4 | Azione | Indicare i dati della sentenza selezionando dalla combo "Anno/Numero Reg.Gen." il GUP. 
Confermare |  | Visualizzazione pagina Dettaglio Sentenza |  |  |  |  |
|  | 5 | Azione | Nella combo delle funzionalità selezionare Assegnazione N. SIEP |  | Visualizzazione pagina  Inserimento Procedimento |  |  |  |  |
|  | 6 | Azione | Procedere con l'iscrizione del fascicolo: Difensore,  Posizione Giuridica "Libero", Reati, Pena Complessiva, Assegnazione Magistrato e validarlo. |  | Visualizzazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 7 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizzazione pagina  Emissione Ordine di Esecuzione - Libero |  |  |  |  |
|  | 8 | Azione | Inserire i dati obbligatori e confermare |  | Visualizzazione pagina Dettaglio Ordine Esecuzione Condannato Libero |  |  |  |  |
|  | 9 | Azione | Cliccare sull'icona di Stampa |  | Generazione documento SIEP_OE_LIB |  |  |  |  |
|  | V | Verifica | Verificare che il template SIEP_OE_LIB.rtf riporti anno/numero Reg. Gen. se relativo al GUP. |  |  |  |  |  |  |
