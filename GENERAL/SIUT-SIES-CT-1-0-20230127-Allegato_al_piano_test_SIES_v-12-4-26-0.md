---
uniqueName: siut-sies-ct-1-0-20230127-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20230127 Allegato al piano test SIES v 12 4 26 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20230127-Allegato_al_piano_test_SIES_v.12.4.26.0

> **File originale:** `RILASCIO_12.4.26.0/SIUT-SIES-CT-1.0-20230127-Allegato_al_piano_test_SIES_v.12.4.26.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20230127-Allegato_al_piano_test_SIES_v.12.4.26.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20230127-Piano_dei_Test_SIES_v.12.4.26.0.docx |
|  | Versione | 1.0 |
|  | Data | 44953.0 |
|  | Intervento | SIES v.12.4.26.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.26.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20230127-Allegato_al_piano_test_SIES_v.12.4.26.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20220719014.0 |  |  | 20220719014.0 | Correzione template cessazione misura alternativa. |  | SIEP | SIEP - Correzione template cessazione misura alternativa. | TF001.SIEP | Errore nella produzione della stampa di alcuni templates poiché mancanti della sezione "COMUNICA" |  |  |  | Verifica: verificare che nella stampa dei templates indicati sia presente la sezione "COMUNICA" | 1.0 |  |  |  |  |
| SIUT | SIES | 20221011018.0 |  |  | 20221011018.0 | Integrazione frase template. |  | SIEP | SIEP - Integrazione frase template. |  |  |  |  |  |  |  |  |  |  |  |
| SIUT | SIES | 202210270116.0 |  |  | 202210270116.0 | Ricerca procedimento con posizione giuridica Libero e assimilati |  | SIEP | SIEP - Ricerca procedimento con posizione giuridica Libero e assimilati | TF002.SIEP | Errore nella individuazione dei procedimenti legati alla posizione giuridica |  |  |  | Verifica: verificare che nella "Ricerca Procedimenti per applicazioni Benefici" il risultato sia visualizzato anche nel caso di mancata decodifica della Nazionalità del soggetto | 1.0 |  |  |  |  |
| SIUT | SIES | 20221209011.0 |  |  | 20221209011.0 | problema Sies Udsm Tribunale Minorenni di Roma |  | SIUS | SIUS - problema Sies Udsm Tribunale Minorenni di Roma | TF001.SIUS | Errore nella validazione e deposito del provvedimento |  |  |  | Verifica: verificare che per il contenuto "Proposta Rilascio Permesso di Soggiorno allo Straniero" sia possibile emettere e depositare decreto od ordinanza | 1.0 |  |  |  |  |
| SIUT | SIES | 20230107012.0 |  |  | 20230107012.0 | Calcolo statistiche |  | SIEP | SIEP - Calcolo statistiche | TF003.SIEP | Errore nella statistica dei fascicoli di classe IV |  |  |  | Verifica: verificare che per la statistica di classe IV i dati estratti siano coerenti | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.26.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20230127-Allegato_al_piano_test_SIES_v.12.4.26.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nella produzione della stampa di alcuni templates poiché mancanti della sezione "COMUNICA" |  | Verifica: verificare che nella stampa dei templates indicati sia presente la sezione "COMUNICA" |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare od iscrivere un procedimento con soggetto in posizione giuridica "Espiazione Pena in Regime di Affidamento in Prova" |  |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni Sorveglianza » Affidamento in Prova al Servizio Sociale » Cessazione Della Misura In Corso 51 Bis |  | Visualizzazione pagina "Cessazione Art.51 Bis Affidamento In Prova" |  |  |  |  |
|  | 2.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" | Scegliere il radio button "Esecuzione contro Soggetto detenuto" e riempire i campi "Data Ingresso in carcere" | Visualizzazione pagina "Cessazione Art.51 Bis Affidamento In Prova" |  |  |  |  |
|  | 3.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Cessazione Art.51 Bis Affidamento In Prova" |  |  |  |  |
|  | 4.0 | Azione | Cliccare sull'icona di "Generazione Stampa" |  |  |  |  |  |  |
|  | V | Verifica | Verificare che nella stampa prodotta sia presente la sezione "COMUNICA" e la correttezza della descrizione relativa ai destinatari | Ripetere le stesse operazioni per procedimenti con soggetto in Posizione Giuridica "Espiazione Pena in Regime di Detenzione Domiciliare", "Espiazione Pena in Regime di Semilibertà" ed in "Esecuzione presso domicilio della pena detentiva" |  |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella individuazione dei procedimenti legati alla posizione giuridica |  | Verifica: verificare che nella "Ricerca Procedimenti per applicazioni Benefici" il risultato sia visualizzato anche nel caso di mancata decodifica della Nazionalità del soggetto |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 1.0 | Navigazione | Rideterminazione Pena » Ricerche per Applicazione Benefici » Indulto |  | Visualizzazione pagina "Ricerca Procedimenti per applicazioni Benefici" |  |  |  |  |
|  | 2.0 | Azione | Premere il tasto "Conferma" | Scegliere l'opzione "Libero e assimilati" nella sezione "Posizione giuridica aggregata" | Visualizzazione pagina "Elenco Procedimenti per Applicazione Benefici" |  |  |  |  |
|  | V | Verifica | Verificare che la ricerca restituisca l'elenco dei Procedimenti per Applicazione Benefici, piuttosto che il messaggio "Nessun Elemento trovato" | La ricerca deve prevedere la presenza di un procedimento a carico di un soggetto nato in una nazione non censita nella tabella "CG_REF_CODES" e dominio "NAZIONE" (ad esempio 271 - SERBIA) |  |  |  |  |  |
| TF001.SIUS | SIUS | Errore nella validazione e deposito del provvedimento |  | Verifica: verificare che per il contenuto "Proposta Rilascio Permesso di Soggiorno allo Straniero" sia possibile emettere e depositare decreto od ordinanza |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare o iscrivere un procedimento con contenuto ed oggetto "Proposta Rilascio permesso di soggiorno" |  |  |  |  |  |
|  | 1.0 | Navigazione | Decreti » Emissione Decreto |  | Visualizzazione pagina "Emissione Decreto" |  |  |  |  |
|  | 2.0 | Azione | Editare il campo obbligatorio "Data Emissione" e premere il tasto "Conferma" |  | Visualizzazione pagina "Emissione Decreto Generico" |  |  |  |  |
|  | 3.0 | Azione | Editare il campo obbligatorio "Esito" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Decreto Generico" |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina di dettaglio sia possibile stampare il documento e validare il decreto |  |  |  |  |  |  |
| TF003.SIEP | SIEP | Errore nella statistica dei fascicoli di classe IV |  | Verifica: verificare che per la statistica di classe IV i dati estratti siano coerenti |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 3.0 | Azione | Inserire un intervallo di date di interesse e premere il tasto "Conferma" | Come esempio, selezionare come "Intervallo Date" un periodo a cavallo di più anni (01/01/2016 - 31/12/2018) | Elaborazione documento Excel |  |  |  |  |
