---
uniqueName: siut-sies-ct-1-0-20240524-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20240524 Allegato al piano test SIES v 12 6 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20240524-Allegato_al_piano_test_SIES_v.12.6.2.0

> **File originale:** `RILASCIO_12.6.2.0/SIUT-SIES-CT-1.0-20240524-Allegato_al_piano_test_SIES_v.12.6.2.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.6.2.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20240524-Allegato_al_piano_test_SIES_v.12.6.2.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202405170122 |  |  | 202405170122 | errore nella ricerca di fascicoli SIUS in cui è presente una richiesta istruttoria |  | SIUS | SIUS - errore nella ricerca di fascicoli SIUS in cui è presente una richiesta istruttoria | TF001.SIUS | Errore nella ricerca di fascicoli con richieste d'istruttoria |  |  |  | Verifica: Verificare che in fase di ricerca di un fascicolo con una richiesta d'istruttoria non si presenti a videoil messaggio di errore | 1.0 |  |  |  |  |
| SIUT | SIES | 202405200130 |  |  | 202405200130 | Errore verbnale di vane |  | SIEP | SIEP - Errore verbnale di vane | TF001.SIEP | Errore nella ricerca Evento Notifica per Id Fascicolo e Descrizione Motivo |  |  |  | Verifica: Verificare che in fase di iscrizione verbale vane ricerche non si presenti a video il messaggio di errore | 1.0 |  |  |  |  |
| SIUT | SIES | 20240521012 |  |  | 20240521012 | Errore batch notturno |  | SIEP | SIEP - Errore batch notturno | TF002.SIEP | Errore nella elaborazione del batch notturno |  |  |  | Verifica: Verificare che in fase di elaborazione del batch notturno non sia più presente il messaggio di errore per xml di risposta troppo grande per il campo in banca dati | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.6.2.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20240524-Allegato_al_piano_test_SIES_v.12.6.2.0.xlsx |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | SIUS | Errore nella ricerca di fascicoli con richieste d'istruttoria |  | Verifica: Verificare che in fase di ricerca di un fascicolo con una richiesta d'istruttoria non si presenti a videoil messaggio di errore |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere un nuovo procedimento ed associare ad esso una richiesta di istruttoria oppure ricercare un fascicolo in questa condizione | Fascicolo aaaa/num |  |  |  |  |
|  | 1 | Navigazione | Ricerche e Visualizzazioni » Procedimento per n° SIUS |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Ricerca" | Ricercare il fascicolo aaaa/num | Visualizzazione pagina "Dettaglio Procedimento SIUS" |  |  |  |  |
|  | V | Verifica | L'utente si trova nella pagina di dettaglio procedimento |  | Il risultato atteso è che non venga visualizzato il messaggio di errore della mancanza della colonna "ID_CIVILMENTE_OBBLIGATO" |  |  |  |  |
| TF001.SIEP | SIEP | Errore nella ricerca Evento Notifica per Id Fascicolo e Descrizione Motivo |  | Verifica: Verificare che in fase di iscrizione verbale vane ricerche non si presenti a video il messaggio di errore |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere un nuovo procedimento ed associare ad esso un "Ordine Esecuzione  con contestuale Sospensione - Libero" oppure ricercare un fascicolo in questa condizione |  |  |  |  |  |
|  | 1 | Navigazione | Verbali Arresto/Vane Ricerche Notifica Carcere » Verbale Vane Ricerche |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Inserimento Verbale Vane Ricerche" |  |  |  |  |
|  | V | Verifica | L'utente si trova nella pagina di "Dettaglio Verbale Vane Ricerche" |  | Il risultato atteso è che non venga visualizzato il messaggio di errore "Nessun Provvedimento registrato in relazione al Verbale Vane Ricerche!" |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella elaborazione del batch notturno |  | Verifica: Verificare che in fase di elaborazione del batch notturno non sia più presente il messaggio di errore per xml di risposta troppo grande per il campo in banca dati |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Amministratore di Sistema" | ADMINxx (Amministratore di Sistema) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione | Esecuzione Batch PagoPa |  |  |  |  |  |  |
|  | 2 | Azione | L'utente seleziona nella colonna "Azioni" l'icona di lente in corrispondenza della prima riga della tabella con scritto "Batch terminato con segnalazioni" in rosso |  | Visualizzazione pagina "Dettaglio Esecuzione Batch PagoPa" |  |  |  |  |
|  | 3 | Azione | L'utente clicca sul tasto "Lancio Manuale Batch" |  | Visualizzazione pagina "Dettaglio Batch PagoPa" |  |  |  |  |
|  | V | Verifica | L'utente si trova nella pagina di "Dettaglio Batch PagoPa" |  | Il risutato atteso è che l'xml di risposta venga scritto nella nuova colonna XML_RISPOSTA_CLOB senza errore anche se le dimensioni superano i 4000 caratteri |  |  |  |  |
