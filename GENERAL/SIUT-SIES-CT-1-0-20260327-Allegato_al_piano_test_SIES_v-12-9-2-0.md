---
uniqueName: siut-sies-ct-1-0-20260327-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20260327 Allegato al piano test SIES v 12 9 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20260327-Allegato_al_piano_test_SIES_v.12.9.2.0

> **File originale:** `RILASCIO_12.9.2.0/SIUT-SIES-CT-1.0-20260327-Allegato_al_piano_test_SIES_v.12.9.2.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.9.2.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20260327-Allegato_al_piano_test_SIES_v.12.9.2.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202602260149 |  |  | 202602260149 | PROCURA DI NOCERA - SIEP |  | SIEP | SIEP - PROCURA DI NOCERA - SIEP | TF001.SIEP | Errore inserimento dati con apostrofo |  |  |  | Verifica: Verificare il corretto inserimento di nome, cognome o comune contenenti un apostrofo | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.9.2.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20260327-Allegato_al_piano_test_SIES_v.12.9.2.0.xlsx |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore inserimento dati con apostrofo |  | Verifica: Verificare il corretto inserimento di nome, cognome o comune contenenti un apostrofo |  | 1.0 |  |  |  |
...
|  | P | Stato Base | L'utente ricerca un procedimento SIEP con una istruttoria aperta | Il condannato deve contenere nel nome, cognome o comune di nascita, un apostrofo | Visualizzazione pagina di "Dettaglio Procedimento" |  |  |  |  |
|  | 1 | Navigazione | Aperta Istruttoria Cumulo N. : anno / numero | Nella pagina di dettaglio procedimento | Visualizzazione pagina "Gestione Cumulo" |  |  |  |  |
|  | 2 | Azione | Cliccare sul link "(Elenco Titoli Coinvolti)" |  | Visualizzazione pagina "Elenco Provvedimenti Esecutivi Coinvolti" |  |  |  |  |
|  | 3 | Azione | Cliccare sul pulsante "Iscrizione Proprio Procedimento" |  | Visualizzazione pagina "Ricerca Procedimenti per Titolo e Soggetto" |  |  |  |  |
|  | V | Verifica | Verificare che selezionando il check “Ricerca per Procedimento” vengano corretamente abilitati i campi senza errori javascript |  | Abilitazione dei campi "Anno/Numero Procedimento" e "Ufficio Accorpato" |  |  |  |  |
