---
uniqueName: siut-sies-ct-1-0-20200605-allegato-al-piano-testsi
displayName: "SIUT SIES CT 1 0 20200605 Allegato al piano test SIES v 12 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20200605-Allegato-al-piano-test_SIES_v.12.3.0

> **File originale:** `RILASCIO_12.3.0/SIUT-SIES-CT-1.0-20200605-Allegato-al-piano-test_SIES_v.12.3.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20200605-Allegato-al-piano-test_SIES_v.12.3.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20200605-Piano_dei_Test_SIES_v.12.3.0.docx |
|  | Versione | 1.0 |
|  | Data | 43987.0 |
|  | Intervento | SIES v.12.3.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.3.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20200605-Allegato-al-piano-test_SIES_v.12.3.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20200422018.0 |  |  | 20200422018.0 | NON GENERA IL PROVVEDIMENTO DI SCARCERAZIONE PROVVISORIA |  | SIEP | SIEP - NON GENERA IL PROVVEDIMENTO DI SCARCERAZIONE PROVVISORIA | TF001.SIEP | Verifica generazione template provvedimento provvisorio di scarcerazione |  |  |  | Verifica: verificare che nel caso di revoca sentenza per depenalizzazione con anticipazione degli  effetti, il sistema generi il provvedimento di scarcerazione provvisoria | 1.0 |  |  |  |  |
| SIUT | SIES | 20200525015.0 |  |  | 20200525015.0 | restituzione ordine consegna per MS versione 12.0 |  | SIEP | SIEP - restituzione ordine consegna per MS versione 12.0 | TF002.SIEP | Verifica data emissione Restituzione Ordine di Consegna |  |  |  | Verifica: Nella stampa, verificare che la data associata all'Ordine di Consegna per cui si sta chiedendo la restituzione corrisponda alla data di emissione dello stesso provvedimento.
Inoltre verificare  che la data della sezione FIRMA corrisponda alla data odierna.
Nell'elenco del PM e nello stato di esecuzione, verificare che la data emissione del provvedimento di Restituzione Ordine di Consegna sia la data in cui è stato emesso il provvedimento stesso. | 1.0 |  |  |  |  |
| SIUT | SIES | 20200525016.0 |  |  | 20200525016.0 | validazione provvedimento MS - versione 12.x |  | SIEP | SIEP - validazione provvedimento MS - versione 12.x | TF003.SIEP | Verifica operazione di validazione di un provvedimento |  |  |  | Verifica: verificare il buon esito dell'operazione di validazione di un procedimento che abbia uno dei seguenti provvedimenti: Archiviazione Provvedimento Giudice Esecuzione; Archiviazione per Provvedimento Giudice / Cassazione; Archiviazione Manuale; Revoca di Decreto di Sospensione art. 656 c.8 c.p.p. - Libero; Ordini di Esecuzione/Scarcerazione Detenuto per Questa Causa. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.3.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20200605-Allegato-al-piano-test_SIES_v.12.3.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica generazione template provvedimento provvisorio di scarcerazione |  | Verifica: verificare che nel caso di revoca sentenza per depenalizzazione con anticipazione degli  effetti, il sistema generi il provvedimento di scarcerazione provvisoria |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Individuare un fascicolo con Posizione Giuridica 'Espiazione Pena in Regime Carcerario' |  |  |  |  |  |  |
|  | 2 | Azione | Spostarsi sul menù Rideterminazione Pena e cliccare su Depenalizzazione |  | Visualizzazione pagina Richiesta/Anticipazione Depenalizzazione |  |  |  |  |
|  | 3 | Azione | Inserire i dati obbligatori facendo attenzione a scegliere come tipologia di richiesta la 'Depenalizzazione' e confermare l'operazione. |  | Visualizzazione pagina Dettaglio Anticipazioni Depenalizzazione |  |  |  |  |
|  | 4 | Azione | Cliccare sul pulsante Stampe presente nella pagina |  | Visualizzazione pagina Provvedimenti e Stampe per Rideterminazione Pena |  |  |  |  |
|  | 5 | Azione | L'utente seleziona il pulsane 'Ordine di scarcerazione per revoca sent. e Incost.'. |  | Visualizzazione pagina  Ordine Provvisorio di Scarcerazione per Ex artt. 673 c.p. e 672 comma 3° c.p.p |  |  |  |  |
|  | 6 | Azione | L'utente inserisce i dati di interesse  nei campi di input e clicca sul pulsante Conferma |  | Visualizazzione pagina Dettaglio Ordine Provvisorio di Scarcerazione per Ex artt. 673 c.p. e 672 comma 3° c.p.p. |  |  |  |  |
|  | 7 | Azione | L'utente clicca sull'icona di stampa |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema produca la stampa  SIEP_OS_SCARPROVDEPINC.rtf |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica data emissione Restituzione Ordine di Consegna |  | Verifica: Nella stampa, verificare che la data associata all'Ordine di Consegna per cui si sta chiedendo la restituzione corrisponda alla data di emissione dello stesso provvedimento.
Inoltre verificare  che la data della sezione FIRMA corrisponda alla data odierna.
Nell'elenco del PM e nello stato di esecuzione, verificare che la data emissione del provvedimento di Restituzione Ordine di Consegna sia la data in cui è stato emesso il provvedimento stesso. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Individuare un procedimento di classe IV di misure di sicurezza per cui sia stato inserito un Ordine di Consegna oppure un Ordine di Internamento |  |  |  |  |  |  |
|  | 2 | Navigazione | Gestione Misure di Sicurezza > Restituzione Ordine di Consegna |  | Il sistema presenta la pagina di elenco dei provvedimenti |  |  |  |  |
|  | 3 | Azione | Selezionare un provvedimento per cui richiedere la Restituzione dell'Ordine di Consegna e cliccare sul pulsante Conferma |  | Il sistema presenta la pagina di dettaglio |  |  |  |  |
|  | 4 | Azione | Cliccare sull'icona di stampa |  | Il sistema esegue la stampa SIEP_MS_RICH_REST_ODC.rtf |  |  |  |  |
|  | V | Verifica | Nella stampa, verificare che la data associata all'Ordine di Consegna per cui si sta chiedendo la restituzione corrisponda alla data di emissione dello stesso provvedimento.
Inoltre verificare  che la data della sezione FIRMA corrisponda alla data odierna. |  |  |  |  |  |  |
|  | 5 | Navigazione | Elenco Provvedimenti del PM |  | Il sistema presenta la pagina di elenco |  |  |  |  |
|  | V | Verifica | Verificare che la data emissione del provvedimento di Restituzione Ordine di Consegna sia la data in cui è stato emesso il provvedimento stesso. |  |  |  |  |  |  |
|  | 6 | Navigazione | Stato Esecuzione > Gestione Stato Esecuzione |  | Il sistema presenta la pagina dello Stato di Esecuzione |  |  |  |  |
|  | V | Verifica | Verificare che la data emissione del provvedimento di Restituzione Ordine di Consegna sia la data in cui è stato emesso il provvedimento stesso. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica operazione di validazione di un provvedimento |  | Verifica: verificare il buon esito dell'operazione di validazione di un procedimento che abbia uno dei seguenti provvedimenti: Archiviazione Provvedimento Giudice Esecuzione; Archiviazione per Provvedimento Giudice / Cassazione; Archiviazione Manuale; Revoca di Decreto di Sospensione art. 656 c.8 c.p.p. - Libero; Ordini di Esecuzione/Scarcerazione Detenuto per Questa Causa. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerca Provvedimenti Non Validati |  | Il sistema presenta la pagina di elenco |  |  |  |  |
|  | 2 | Azione | Individuare un procedimento che abbia uno dei provvedimenti elencati nella descrizione della Verifica |  |  |  |  |  |  |
|  | 3 | Azione | Selezionare l'icona Modifica PM e Valida in corrispondenza del procedimento individuato e cliccare sul pulsante Conferma |  |  |  |  |  |  |
|  | V | Verifica | Verificare che l'operazione si concluda correttamente |  |  |  |  |  |  |
