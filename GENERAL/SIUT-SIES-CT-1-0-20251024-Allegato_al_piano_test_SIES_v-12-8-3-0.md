---
uniqueName: siut-sies-ct-1-0-20251024-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20251024 Allegato al piano test SIES v 12 8 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20251024-Allegato_al_piano_test_SIES_v.12.8.3.0

> **File originale:** `RILASCIO_12.8.3.0/SIUT-SIES-CT-1.0-20251024-Allegato_al_piano_test_SIES_v.12.8.3.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.8.3.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20251024-Allegato_al_piano_test_SIES_v.12.8.3.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202510090125 |  |  | 202510090125 | Correzione template -SIEP_PP_PR_AVVPAGAM_PP |  | SIEP | SIEP - Correzione template -SIEP_PP_PR_AVVPAGAM_PP | TF001.SIEP | Errore nell'impostazione di alcune frasi |  |  |  | Verifica: Verificare che le frasi all'interno del template siano corrette | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.8.3.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20251024-Allegato_al_piano_test_SIES_v.12.8.3.0.xlsx |  |  |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare un fascicolo in cui sia presente un Ordine Esecuzione di Ingiunzione al Pagamento della Pena Pecuniaria "pagata" |  |  |  |  |  |
|  | 1 | Navigazione | Gestione Altre Sanzioni >> Riscossione Pene Pecuniarie >> Ordine Ingiunzione / Altri Provvedimenti >> Provvedimento Avvenuto Pagamento |  | Visualizzazione pagina "Gestione Provvedimento Avvenuto Pagamento" |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Provvedimento Avvenuto Pagamento Pena Pecuniaria" |  |  |  |  |
|  | 3 | Azione | L'utente preme il tasto "Generazione Stampa" |  | Produzione del template "SIEP_PP_PR_AVVPAGAM_PP.rtf" |  |  |  |  |
