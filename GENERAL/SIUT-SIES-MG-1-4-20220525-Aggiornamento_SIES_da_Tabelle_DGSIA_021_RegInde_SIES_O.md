---
uniqueName: siut-sies-mg-1-4-20220525-aggiornamentosiesdatabel
displayName: "SIUT SIES MG 1 4 20220525 Aggiornamento SIES da Tabelle DGSIA 021 RegInde SIES O"
category: "GENERAL"
tags: []
---

# SIUT-SIES-MG-1.4-20220525-Aggiornamento_SIES_da_Tabelle_DGSIA_021_RegInde_SIES_ORIG

> **File originale:** `MEV/SCHEDA_021/Docs/consegna docx/ORIGINALS/SIUT-SIES-MG-1.4-20220525-Aggiornamento_SIES_da_Tabelle_DGSIA_021_RegInde_SIES_ORIG.docx`  
> **Tipo:** DOCX
...
3.3.1 STEP 1	9
3.3.2 STEP 2	11
4 	Descrizione delle Attività eseguite per allineamento tabelle	14
4.1.1	Aggiornamento tabella COMUNE	14
4.1.2	Aggiornamento Dominio PROVINCIA nella CG_REF_CODES	20
4.1.3	Aggiornamento Dominio NAZIONE nella CG_REF_CODES	22
4.1.4	Aggiornamento Dominio REGIONE nella CG_REF_CODES	24
4.1.5	Aggiornamento tabella CODICI_SIES_NSC   per   CO_DOMAIN = ‘COMUNE’	24
4.1.6	Aggiornamento tabella CODICI_SIES_NSC   per   CO_DOMAIN = ‘NAZIONE’	26
4.1.7	Aggiornamento tabelle COMUNI e STATI   di SIES-AVVOCATURA	29
...
In caso di esito negativo di una o più verifiche dei suddetti dieci punti, CONTATTARE IL FORNITORE TRAMITE APERTURA DI TICKET SU OTRS.
...
Alla fine di queste attività di aggiornamento, passare al punto 3 del paragrafo 6.1 del documento “SIUT-SIES-PR-1.3-20220422-Piano_di_Rilascio_021_RegInde_SIES.docx”.
## 3.3.2 STEP 2
QUESTO STEP VA ESEGUITO SOLO IN CASO DI ERRORI VERIFICATISI NELL’ESECUZIONE DELLO STEP PRECEDENTE E SOLO SU INDICAZIONE DEI TECNICI DEL FORNITORE, COINVOLTI A SEGUITO APERTURA TICKET SU OTRS.
...
Verificare che nel file /home/oracle/MEV-2019_21/log/Log_Restore_DB.log non siano riportati errori oracle;
...
non deve estrarre alcun record.
# Descrizione delle Attività eseguite per allineamento tabelle
NON DEVE ESSERE CONSEGNATO SUL TERRITORIO: STACCARLO CON NOME APPROPRIATO E RICONSEGNARE
