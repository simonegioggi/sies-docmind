---
uniqueName: siut-sies-pr-1-0-20210428-pianodirilascioavvocatur
displayName: "SIUT SIES PR 1 0 20210428 Piano di Rilascio AVVOCATURA v 2 6 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20210428-Piano_di_Rilascio_AVVOCATURA_v.2.6.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.6.0.0/SIUT-SIES-PR-1.0-20210428-Piano_di_Rilascio_AVVOCATURA_v.2.6.0.0.docx`  
> **Tipo:** DOCX
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 2.6.0.0 di AVVOCATURA.
...
# Generalità
Il presente documento descrive il piano di rilascio di AVVOCATURA 2.6.0.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- | --- |
| Portale Fornitura | 1 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.6.0.0 2021-04-28 > Documentazione > documentazione.zip | 2.6.0.0 | 28/04/2021 |
| Portale Fornitura | 2 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.6.0.0 2021-04-28 > Applicazione > avvocatura.war | 2.6.0.0 | 28/04/2021 |
| Portale Fornitura | 3 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.6.0.0 2021-04-28 > Sorgenti > sorgenti.zip | 2.6.0.0 | 28/04/2021 |
| Note-osservazioni |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 20210416017 | DGSIA - Referente Applicativo | L’utente segnala che le informazioni visibili siano sempre le stesse, qualunque funzione venga utilizzata (ricerca per procedimento, avvisi, ricerca per soggetto) e la visibilità deve avvenire al momento stabilito in fase di analisi. Per ora, le incongruenze emerse riguardano la  ricerca per soggetto, nel momento in cui sia visualizzato l'elenco dei procedimenti  a carico di un soggetto specifico.
Le informazioni visibili devono essere solo quelle delle colonne indicate nell'elenco e devono essere visibili in modo coerente con la visibilità delle informazioni raggiungibili sia tramite la funzione "avvisi" sia tramite la funzione "ricerca per numero procedimento". | Per la risoluzione della problematica si è intervenuti con la modifica della classe in cui viene popolato l’elenco dei procedimenti del soggetto impostando nella colonna “Data Deposito” il valore solamente se il provvedimento è stato depositato e validato, e togliendo la data del provvedimento nella colonna “Provvedimento”. | E’ stata modificata la classe:
“ProcedimentoPerSoggettoXmlUtil.java”
modificando le proprietà impostate per popolare le colonne “Provvedimento” e “Data Deposito” che viene valorizzata solamente in caso di deposito presente e validato. |  |
| 202104270113 | DGSIA - Referente Applicativo | L’utente segnala l'errore in visualizzazione di un decreto non ancora depositato. | Per la risoluzione della problematica si è intervenuti con la modifica della classe in cui viene popolato l’elenco dei procedimenti del soggetto impostando nella colonna “Provvedimento” il valore corretto coerentemente con quanto visibile nella pagina di dettaglio del procedimento nella sezione “Provvedimenti”. | E’ stata modificata la classe:
“ProcedimentoPerSoggettoXmlUtil.java”
modificando le proprietà impostate per popolare le colonne “Provvedimento” che viene valorizzata coerentemente con quanto visibile nella pagina di dettaglio del procedimento, nella sezione “Provvedimenti”. |  |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20210428-Piano_di_Rilascio_AVVOCATURA_v.2.6.0.0.docx
SIUT-SIES-PT-1.0-20210428-Piano_dei_Test_AVVOCATURA _v.2.6.0.0.docx
SIUT-SIES-CT-1.0-20210428-Allegato_al_piano_test_AVVOCATURA_v.2.6.0.0.xls |
| Note-osservazioni |  |  |


Installazione
## Prerequisiti
Attenzione! La risoluzione dei ticket 20210416017 e 202104270113 che riguardano il dialogo tra i sistemi “AVVOCATURA SIUS” e “SIES”, comporta l’installazione contemporanea dei due applicativi:
