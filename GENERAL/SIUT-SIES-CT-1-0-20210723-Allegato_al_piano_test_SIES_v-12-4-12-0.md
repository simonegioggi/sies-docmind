---
uniqueName: siut-sies-ct-1-0-20210723-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210723 Allegato al piano test SIES v 12 4 12 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210723-Allegato_al_piano_test_SIES_v.12.4.12.0

> **File originale:** `RILASCIO_12.4.12.0/SIUT-SIES-CT-1.0-20210723-Allegato_al_piano_test_SIES_v.12.4.12.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210723-Allegato-al-piano-test_SIES_v.12.4.12.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210723-Piano_dei_Test_SIES_v.12.4.12.0.docx |
|  | Versione | 1.0 |
|  | Data | 44400.0 |
|  | Intervento | SIES v.12.4.12.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.12.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210723-Allegato-al-piano-test_SIES_v.12.4.12.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210621016.0 |  |  | 20210621016.0 | Assenza della funzione di dettaglio per la consultazione dei procedimenti presenti nell’elenco |  | SIEP | SIEP - Assenza della funzione di dettaglio per la consultazione dei procedimenti presenti nell’elenco | TF001.SIEP | Verifica prossibilità di accedere al dettaglio del procedimento nella ricerca per soggetto. |  |  |  | Verifica: verificare che nella ricerca per soggetto si possa accedere al dettaglio del procedimento | 1.0 |  |  |  |  |
| SIUT | SIES | 20210622011.0 |  |  | 20210622011.0 | Annotazione ordinanza giudice dell’esecuzione |  | SIEP | SIEP - Annotazione ordinanza giudice dell’esecuzione | TF002.SIEP | Verifica corretta visualizzazione campi quantificazione pena per la funzione annotazione ordinanza GE |  |  |  | Verifica: verificare che la visualizzazione della quantificazione della pena relativa all'annotazione ordinanza del GE avvenga correttamente per le funzioni di Depenalizzazione, Incostituzionalità ed Amnistia/Indulto | 1.0 |  |  |  |  |
| SIUT | SIES | 202106220110.0 |  |  | 202106220110.0 | SIES - Errore in stampa decreto irreperibilità |  | SIEP | SIEP - SIES - Errore in stampa decreto irreperibilità | TF003.SIEP | Verifica corretta generazione decreto di irreperibilità |  |  |  | Verifica: verificare che venga generato correttamente il template SIEP_GDS_DECRIRR | 1.0 |  |  |  |  |
| SIUT | SIES | 20210624014.0 |  |  | 20210624014.0 | Errore in Emissione Misura Sicurezza |  | SIUS | SIUS - Errore in Emissione Misura Sicurezza | TF004.SIUS | Verifica corretta emissione di un'ordinanza con misura di sicurezza. |  |  |  | Verifica: verificare che l'inserimento di una misura di sicurezza nell'emissione di un'ordinanza non produca errore. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210709014.0 |  |  | 20210709014.0 | Anomalia stampa foglio complementare |  | SIEP | SIEP - Anomalia stampa foglio complementare | TF005.SIEP | Verifica stampa foglio complementare. |  |  |  | Verifica: verificare che la stampa del foglio complementare riporti le informazioni sull'espiazione della pena. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210709019.0 |  |  | 20210709019.0 | Tribunale dei Minorenni di Roma - impossibile definizioni del procedimento |  | SIUS | SIUS - Tribunale dei Minorenni di Roma - impossibile definizioni del procedimento | TF006.SIUS | Verifica abilitazione tasti modifica e cancellazione. |  |  |  | Verifica: verificare che nella pagina di dettaglio definizione procedimento siano visibili e attivi i tasti di Modifica e Cancellazione. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210715018.0 |  |  | 20210715018.0 | Mancata trascrizione quantitativo di  pena fungibile in stampa -template SIEP_AM_COMPU657_3 + altri |  | SIEP | SIEP - Mancata trascrizione quantitativo di  pena fungibile in stampa -template SIEP_AM_COMPU657_3 + altri | TF007.SIEP | Verifica trascrizione pena fungibile su stampa |  |  |  | Verifica: Verificare che la stampa Siep_am_compu657_3 riporti il quantitativo di pena fungibile. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.12.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210723-Allegato-al-piano-test_SIES_v.12.4.12.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica prossibilità di accedere al dettaglio del procedimento nella ricerca per soggetto. |  | Verifica: verificare che nella ricerca per soggetto si possa accedere al dettaglio del procedimento |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Cliccare sull 'icona Ricerca Procedimento per Soggetto |  | Visualizzazione pagina Ricerca Procedimento per Soggetto |  |  |  |  |
|  | 2 | Azione | Lasciare la selezione "nel distretto" ed indicare un cognome. Cliccare su Ricerca. |  | Visualizzazione pagina Elenco Soggetti con Procedimenti |  |  |  |  |
|  | 3 | Azione | Selezionare un link presente nella colonna "Cod. CUI" |  | Visualizzazione pagina  Elenco Soggetti con Procedimenti RICERCA CODICE CUI |  |  |  |  |
|  | 4 | Azione | Selezionare l'icona di dettaglio sull'ultima colonna in corrispondenza di un record che presenti un valore numerico nella colonna "procedimenti". |  | Visualizazzione pagina Elenco Procedimenti di |  |  |  |  |
|  | V | Verifica | Verificare che la lista presenti nell'ultima colonna una lente tramite la quale accedere al dettaglio del fascicolo. |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica corretta visualizzazione campi quantificazione pena per la funzione annotazione ordinanza GE |  | Verifica: verificare che la visualizzazione della quantificazione della pena relativa all'annotazione ordinanza del GE avvenga correttamente per le funzioni di Depenalizzazione, Incostituzionalità ed Amnistia/Indulto |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un Procedimento non Archiviato |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Navigazione | Rideterminazione Pena |  | Visualizzazione pagina Rideterminazione della pena |  |  |  |  |
|  | 3 | Azione | Cliccare su Depenalizzazione |  | Visualizzazione pagina Richiesta/Anticipazione Depenalizzazione |  |  |  |  |
|  | 4 | Azione | Nella form selezionare il check "Anticipazione degli Effetti" e il radio "Depenalizzazione" o "Illecito amministrativo". Indicare i quantun della richiesta con segno "meno" (es "Reclusione") (scegliere un valore basso per evitare di andare in negativo es 1 mese e 1 giorno). Cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Anticipazioni Depenalizzazione |  |  |  |  |
|  | 5 | Azione | Cliccare su Calcolo Pena |  | Visualizzazione pagina Calcolo Pena |  |  |  |  |
|  | 6 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina Provvedimenti e Stampe per Rideterminazione Pena |  |  |  |  |
|  | 7 | Azione | Selezionare la voce "Determinazione Pena per Revoca sent. e Incost.". |  | Visualizzazione pagina  Richiesta Nuovo Residuo Pena |  |  |  |  |
|  | 8 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Richiesta Nuovo Residuo Pena |  |  |  |  |
|  | 9 | Azione | Stampare e Validare. |  |  |  |  |  |  |
|  | 10 | Navigazione | Decisione del GE |  | Visualizzazione pagina Decisione del GE |  |  |  |  |
|  | 11 | Azione | Cliccare su Depenalizzazione |  | Visualizzazione pagina Depenalizzazione |  |  |  |  |
|  | 12 | Azione | Nella form selezionare il link "seleziona richieste" e dalla popup il link "seleziona" |  | Visualizzazione pagina Depenalizzazione |  |  |  |  |
|  | V | Verifica | Verifcare che i campi Fonte, Anno e numero vengano caricati correttamente. |  |  |  |  |  |  |
|  | 13 | Azione | Selezionare il radio "in conformità alla richiesta del PM" |  |  |  |  |  |  |
|  | V | Verifica | Verificare che i quantum della richiesta vengano caricati correttamente nei campi della form. |  |  |  |  |  |  |
|  | 14 | Navigazione | Rideterminazione Pena |  | Visualizzazione pagina Rideterminazione della pena |  |  |  |  |
|  | 15 | Azione | Cliccare su Incostituzionalità |  | Visualizzazione pagina Richiesta/Anticipazione Incostituzionalità |  |  |  |  |
|  | 16 | Azione | Dopo aver cliccato sull'icona "Inserisci", nella form selezionare il check "Anticipazione degli Effetti". Indicare  Anno/Numero e data della Sentenza CC,  indicare i quantum con segno "meno".  Cliccare su Conferma. |  | Visualizzazione pagina Richiesta/Anticipazione Incostituzionalità |  |  |  |  |
|  | 17 | Azione | Cliccare su Calcolo Pena |  | Visualizzazione pagina Calcolo Pena |  |  |  |  |
|  | 18 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina Provvedimenti e Stampe per Rideterminazione Pena |  |  |  |  |
|  | 19 | Azione | Selezionare la voce "Revoca sentenza e Incostituzionalità". |  | Visualizzazione pagina   Revoca sentenza ex art.673 c.p.p. |  |  |  |  |
|  | 20 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina Revoca sentenza ex art.673 c.p.p.- Depenalizzazione |  |  |  |  |
|  | 21 | Azione | Stampare e Validare. |  |  |  |  |  |  |
|  | 22 | Navigazione | Decisione del GE |  | Visualizzazione pagina Decisione del GE |  |  |  |  |
|  | 23 | Azione | Cliccare su Incostituzionalità |  | Visualizzazione pagina  Incostituzionalità |  |  |  |  |
|  | 24 | Azione | Nella form selezionare il link "seleziona richieste" e dalla popup il link "seleziona" |  | Visualizzazione pagina  Incostituzionalità |  |  |  |  |
|  | V | Verifica | Verifcare che i campi relativi alla "Sentenza Corte Costituzionale" vengano caricati correttamente. |  |  |  |  |  |  |
|  | 25 | Azione | Selezionare il radio "in conformità alla richiesta del PM" |  |  |  |  |  |  |
|  | V | Verifica | Verificare che i quantum della richiesta vengano caricati correttamente nei campi della form. |  |  |  |  |  |  |
|  | 26 | Navigazione | Rideterminazione Pena |  | Visualizzazione pagina Rideterminazione della pena |  |  |  |  |
|  | 27 | Azione | Cliccare su Amnistia/Indulto |  | Visualizzazione pagina Richiesta/Anticipazione Amnistia/Indulto |  |  |  |  |
|  | 28 | Azione | Selezionare il check "Anticipazione degli Effetti" ed indicare i quantum con segno "meno".  Cliccare su Conferma. |  | Visualizzazione pagina Richiesta/Anticipazione Amnistia/Indulto |  |  |  |  |
|  | 29 | Azione | Cliccare su Calcolo Pena |  | Visualizzazione pagina Calcolo Pena |  |  |  |  |
|  | 30 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina Provvedimenti e Stampe per Rideterminazione Pena |  |  |  |  |
|  | 31 | Azione | Selezionare la voce "Determinazione pena - ex artt. 671 c.p.p. e art. 174 c.p.". |  | Visualizzazione pagina   Determinazione pena - ex artt. 671 c.p.p. e art. 174 c.p. |  |  |  |  |
|  | 32 | Azione | Cliccare su Conferma. |  | Visualizzazione pagina   Determinazione pena - ex artt. 671 c.p.p. e art. 174 c.p. |  |  |  |  |
|  | 33 | Azione | Stampare e Validare. |  |  |  |  |  |  |
|  | 34 | Navigazione | Decisione del GE |  | Visualizzazione pagina Decisione del GE |  |  |  |  |
|  | 35 | Azione | Cliccare su Amnistia/Indulto |  | Visualizzazione pagina  Amnistia/Indulto |  |  |  |  |
|  | 36 | Azione | Nella form selezionare il link "seleziona richieste" e dalla popup il link "seleziona" |  | Visualizzazione pagina  Amnistia/Indulto |  |  |  |  |
|  | 37 | Azione | Selezionare il radio "in conformità alla richiesta del PM" |  |  |  |  |  |  |
|  | V | Verifica | Verificare che i quantum della richiesta vengano caricati correttamente nei campi della form. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica corretta generazione decreto di irreperibilità |  | Verifica: verificare che venga generato correttamente il template SIEP_GDS_DECRIRR |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Nella pagina di dettaglio, nel menù orizzontale a tendina, selezionare le seguenti voci :
Difensore,
Reati, 
Posizione Giuridica, 
Pena Complessiva, 
Assegnazione Magistrato.
Per ognuna di queste voci inserire le informazioni obbligatorie. In particolare la Posizione Giuridica deve essere "Libero". |  | Visualizzazione pagine delle singole voci selezionate |  |  |  |  |
|  | 3 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 4 | Azione | Indicare il procedimento da validare e cliccare su Conferma |  | Visualizzazione pagina Dettaglio Procedimento con stato procedimento a Validato |  |  |  |  |
|  | 5 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  | Visualizzazione pagina  Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO Libero |  |  |  |  |
|  | 6 | Azione | Compilare i dati in maschera e confermare |  | Visualizzazione pagina  Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO Libero |  |  |  |  |
|  | 7 | Azione | Stampare e validare. |  | Visualizzazione pagina Dettaglio Ordine esecuzione legge 165/98 - condannato libero |  |  |  |  |
|  | 8 | Navigazione | Verbali Arresto/Vane Ricerche Notifica Carcere » Verbale Vane Ricerche |  | Visualizzazione pagina Inserimento Verbale Vane Ricerche |  |  |  |  |
|  | 9 | Azione | Compilare i dati in maschera e confermare |  | Visualizazzione pagina  Dettaglio Verbale Vane Ricerche |  |  |  |  |
|  | 10 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Gestione Decreto di Sospensione |  | Visualizzazione pagina Gestione Decreto di Sospensione |  |  |  |  |
|  | 11 | Azione | Cliccare su Rinnovazione Notifica |  | Visualizazzione pagina Rinnovazione Notifica comma 8 bis |  |  |  |  |
|  | V | Verifica | Verificare che il sistema preveda come obbligatori i campi "Risposta Pervenuta in Data" ed "Autorità delegata alla notifica |  |  |  |  |  |  |
|  | 12 | Azione | Stampare e Validare |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la validazione non vada in errore. |  |  |  |  |  |  |
|  | 13 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Gestione Decreto di Sospensione |  | Visualizzazione pagina Gestione Decreto di Sospensione |  |  |  |  |
|  | 14 | Azione | Cliccare su Irreperibilità |  | Visualizzazione pagina  IRREPERIBILITA' |  |  |  |  |
|  | 15 | Azione | Cliccare su Decreto |  | Visualizazzione pagina Decreto di Irreperibilità |  |  |  |  |
|  | 16 | Azione | Cliccare su Conferma. |  | Visualizazione pagina Dettaglio Decreto |  |  |  |  |
|  | 17 | Azione | Stampare |  | Generazione stampa SIEP_GDS_DECRIRR |  |  |  |  |
|  | V | Verifica | Verificare che la Stampa non vada in errore. |  |  |  |  |  |  |
| TF004.SIUS | 01 | Verifica corretta emissione di un'ordinanza con misura di sicurezza. |  | Verifica: verificare che l'inserimento di una misura di sicurezza nell'emissione di un'ordinanza non produca errore. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Inserire i dati obbligatori e Confermare |  | Visualizzazione pagina Dettaglio Soggetto |  |  |  |  |
|  | 3 | Azione | Selezionare dalla combo la voce "Iscrizione Procedimento" |  | Visualizzazione pagina Iscrizione Procedimento da Soggetto |  |  |  |  |
|  | 4 | Azione | Completare i dati indicando:
Tipo atto = Fascicolo,
Contenuto = APPELLO CONTRO PROVVEDIMENTO SU MISURA DI SICUREZZA (ART. 680 CPP),
Oggetto = Appello Contro Sentenza Giudice di Merito,
Data arrivo in cancelleria
Magistrato. 
Confermare. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 5 | Navigazione | Udienza » Fissazione Udienza |  | Visualizzazione pagina Fissazione Udienza |  |  |  |  |
|  | 6 | Azione | Nella pagina di Inserimento Fissazione Udienza indicare il difensore (obbligatorio), procedere all'inserimento Udienza e completare con i dati obbligatori.
Confermare. |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 7 | Azione | Stampare e validare. |  |  |  |  |  |  |
|  | 8 | Azione | Tornare al dettaglio del procedimento cliccando sul link del procedimento SIUS. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 9 | Azione | Selezionare la funzione "Inserimento Riferimenti Altri Titoli Esecutivi" |  | Visualizzazione pagina  Inserimento Riferimenti Altri Titoli Esecutivi |  |  |  |  |
|  | 10 | Azione | Selezionare "Titoli non presenti su SIEP". 
NON INSERIRE ANNO e NUMERO
Lasciare selezionata la voce  ES. MIS. SIC. 
Completare gli altri dati indicando
Tipo Provvedimento = Sentenza. 
Indicare gli altri dati obbligatori..
Confermare. |  | Visualizzazione pagina Dettaglio Riferimento Altro Titolo Esecutivo |  |  |  |  |
|  | 11 | Navigazione | Ordinanze » Emissione Ordinanza |  | Visualizzazione pagina Fissazione Udienza |  |  |  |  |
|  | 12 | Azione | Sulla form di  Emissione Ordinanza indicare la data emissione e confermare. |  | Visualizzazione pagina  Emissione Ordinanza Appello Contro Provvedimento su Misura Sicurezza |  |  |  |  |
|  | 13 | Azione | Selezionare il link Dettaglio Misure Sicurezza e selezionare l'icona di inserimento in alto vicino al titolo. |  | Visualizzazione pagina Elenco Misure Sicurezza |  |  |  |  |
|  | 14 | Azione | Selezionare l'icona di inserimento misura di sicurezza. |  |  |  |  |  |  |
|  | V | Verifica | Verificare l'apertura della form di inserimento senza errori. |  |  |  |  |  |  |
| TF005.SIEP | 01 | Verifica stampa foglio complementare. |  | Verifica: verificare che la stampa del foglio complementare riporti le informazioni sull'espiazione della pena. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento con posizione giuridica ESECUZIONE PRESSO DOMICILIO DELLA PENA DETENTIVA |  |  |  |  |  |  |
|  | 2 | Navigazione | Definizione Procedimento >> Fine Espiazione |  | Visualizzazione pagina  Definizione Procedimento - Pena Espiata |  |  |  |  |
|  | 3 | Azione | Inserire Data Definizione e come Oggetto: "Archiviazione per pena espiata in regime carcerario".
...
|  | V | Verifica | Verificare che la stampa del foglio complementare riporti le informazioni sull'espiazione della pena. |  |  |  |  |  |  |
| TF006.SIUS | 01 | Verifica abilitazione tasti modifica e cancellazione. |  | Verifica: verificare che nella pagina di dettaglio definizione procedimento siano visibili e attivi i tasti di Modifica e Cancellazione. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIUS come Ufficio di Sorveglianza presso il Tribunale per minorenni | Vxxxxx (Ufficio di Sorveglianza presso il Tribunale per minorenni) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
...
|  | 2 | Azione | Selezionare il dettaglio di un fascicolo dall'elenco risultante dalla ricerca |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Dalla combo delle funzionalità selezionare Iscrizione Procedimento |  | Visualizzazione pagina Iscrizione Procedimento |  |  |  |  |
|  | 4 | Azione | In fase di iscrizione indicare
Tipo Atto = Istanza,
contenuto = Concessione Liberazione Anticipata, 
oggetto = Liberazione Anticipata.
Indicare "Data arrivo in cancelleria" e magistrato.
Infine confermare. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 5 | Azione | Sul dettaglio, dalla combo in alto selezionare la voce "Definizione Procedimento". |  | Visualizzazione pagina  Inserimento Definizione Procedimento |  |  |  |  |
|  | 6 | Azione | Lasciare invariati i dati e confermare. |  | Visualizazzione pagina Dettaglio Definizione Procedimento |  |  |  |  |
|  | V | Verifica | Verificare che nella pagina in alto siano visibili i tasti di Modifica e Cancellazione. |  |  |  |  |  |  |
| TF007.SIEP | 01 | Verifica trascrizione pena fungibile su stampa |  | Verifica: Verificare che la stampa Siep_am_compu657_3 riporti il quantitativo di pena fungibile. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento con soggetto detenuto |  |  |  |  |  |  |
|  | 2 | Navigazione | Rideterminazione Pena |  | Visualizzazione pagina  Rideterminazione della pena |  |  |  |  |
|  | 3 | Azione | Cliccare su  Computo misura cautelare stesso reato (presofferto) |  | Visualizzazione pagina  Computo misura cautelare stesso reato (presofferto) |  |  |  |  |
|  | 4 | Azione | Inserire il Periodo da Computare tale che il periodo di espiato superi la quantità di pena che deve ancora essere scontata. Cliccare su Conferma |  | Visualizzazione pagina  Computo misura cautelare stesso reato (presofferto) |  |  |  |  |
|  | 5 | Azione | Cliccare su Calcolo Pena |  | Visualizzazione pagina Calcolo Pena |  |  |  |  |
|  | 6 | Azione | Selezionare Data Odierna Con Fungibilità e cliccare su Conferma |  | Visualizzazione pagina Provvedimenti e Stampe per Rideterminazione Pena |  |  |  |  |
|  | 7 | Azione | Cliccare su Stesso reato |  | Visualizzazione pagina Decreto Computo C.C. art. 657 c.p.p. |  |  |  |  |
|  | 8 | Azione | Inserire i dati obbligatori e cliccare su Conferma |  | Visualizzazione pagina Decreto Computo C.C. art. 657 c.p.p. |  |  |  |  |
|  | 9 | Azione | Cliccare sull'icona di stampa |  | Generazione template Siep_am_compu657_3 |  |  |  |  |
|  | V | Verifica | Verificare che la stampa riporti nella sezione Comunica il periodo di presofferto. |  |  |  |  |  |  |
