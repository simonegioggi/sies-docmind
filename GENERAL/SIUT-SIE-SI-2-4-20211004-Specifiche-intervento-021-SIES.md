---
uniqueName: siut-sie-si-2-4-20211004-specifiche-intervento-021
displayName: "SIUT SIE SI 2 4 20211004 Specifiche intervento 021 SIES"
category: "GENERAL"
tags: []
---

# SIUT-SIE-SI-2.4-20211004-Specifiche-intervento-021-SIES

> **File originale:** `MEV/SCHEDA_021/Docs/SIUT-SIE-SI-2.4-20211004-Specifiche-intervento-021-SIES.docx`  
> **Tipo:** DOCX
...
2	Definizione dell’Obiettivo	17
3	Architettura del Sistema	18
3.1	Architettura	18
4	Specifiche dei requisiti	18
4.1	Premessa	18
4.2	Elenco Requisiti	19
5	Interfacce	19
6	Descrizione dell’Intervento	20
6.1	REQ-SIE-021-01_FN.01 -  Gestione Nuovi Fori (FORO di NAPOLI NORD)	20
6.1.1	Moduli sw	31
6.1.2	Architettura	35
6.1.3	Interfacce utente	35
6.1.4	Basi dati	38
6.1.4.1	Selezione Lista Fori SIES	38
6.1.4.2	Tabella Avvocati SIES	40
6.1.5	WEB services	40
6.1.6	XSD	40
6.1.7	Configurazione	40
6.1.8	Tutorial	40
6.2	REQ- SIE-021-02_FN.01 -  Ricerca su ReGIndE	40
6.2.1	Moduli sw	41
6.2.2	Architettura	43
6.2.3	Interfacce utente	43
6.2.3.1	Sottosistema SIEP	43
6.2.3.2	Sottosistema SIGE	57
6.2.3.3	Sottosistema SIUS	66
6.2.4	Basi dati	71
6.2.5	WEB services	72
6.2.5.1	Gestione delle fault	73
6.2.5.2	Altre specifiche per il servizio	74
6.2.6	XSD	74
6.2.7	Configurazione	74
6.2.8	Tutorial	75
6.3	REQ- SIE-021-03_FN.01 – Inserimento Manuale: Indisponibilità ReGIndE o Avvocato Non Presente	75
6.3.1	Moduli sw	75
6.3.2	Architettura	75
6.3.3	Interfacce utente	75
6.3.3.1	Inserimento manuale: Indisponibilità ReGIndE o Avvocato Non Presente	76
6.3.3.2	Inserimento manuale avvocato sul sistema SIES	80
6.3.4	Basi dati	82
6.3.5	WEB services	82
6.3.6	XSD	82
6.3.7	Configurazione	82
6.3.8	Tutorial	82
6.4	REQ- SIE-021-04_FN.01 – Interventi su Funzioni SIES di Gestione Avvocati	82
6.4.1	Moduli sw	83
6.4.2	Architettura	83
6.4.3	Interfacce utente	83
6.4.4	Basi dati	84
6.4.5	WEB services	84
6.4.6	XSD	84
6.4.7	Configurazione	85
6.4.8	Tutorial	85
6.5	REQ- SIE-021-05_FN.01 – Bonifica Anagrafica Avvocati SIES	85
6.5.1	Bonifica dei dati presenti nella tabella Avvocato	85
6.5.2	Moduli sw	86
6.5.3	Architettura	87
6.5.4	Interfacce utente	87
6.5.5	Basi dati	87
6.5.6	WEB services	88
6.5.7	XSD	88
6.5.8	Configurazione	88
6.5.9	Tutorial	88
6.6	REQ- SIE-021-06_FN.01 – Aggiornamento Tabelle COMUNE e CG_REF_CODES di SIES	88
6.6.1	Aggiornamento dei dati presenti nella tabella COMUNE di SIES	89
6.6.2	Aggiornamento dei dati presenti nella tabella CG_REF_CODES (domini PROVINCIA,REGIONE,NAZIONE)	91
6.6.2.1	Aggiornamento dominio PROVINCIA	91
6.6.2.2	Aggiornamento dominio REGIONE	92
6.6.2.3	Aggiornamento dominio NAZIONE	93
6.6.3	Moduli sw	95
6.6.4	Architettura	96
6.6.5	Interfacce utente	96
6.6.6	Basi dati	104
6.6.7	WEB services	104
6.6.8	XSD	104
6.6.9	Configurazione	104
6.6.10	Tutorial	104

Figura 1: Architettura del sistema SIES	18
Figura 2: Sezione notifica Difensore	22
Figura 3: Alert per Comune non Esistente	22
Figura 4: Form ricerca Difensori su ReGIndE	23
Figura 5: Combo-box dei fori	24
Figura 6: [Esempio Template 1]	24
Figura 7: [Esempio Template 2]	25
Figura 8 – Messaggio Alert su Dettaglio procedimento SIEP con presenza Avvocato non certificato	26
Figura 9 – Segnalazione su Dettaglio procedimento SIEP per Avvocato non certificato	26
Figura 10 – Alert su Form Rideterminazione pena per procedimento SIEP con Avvocato non certificato	27
Figura 11 – Messaggio Alert su Dettaglio procedimento SIUS con presenza Avvocato non certificato	27
Figura 12 – Segnalazione su Dettaglio procedimento SIUS per Avvocato non certificato	28
Figura 13 – Alert su Form Emissione Ordinanza per procedimento SIUS con Avvocato non certificato	29
Figura 14 – Messaggio Alert su Dettaglio procedimento SIGE con presenza Avvocato non certificato	29
Figura 15 – Segnalazione su Dettaglio procedimento SIGE per Avvocato non certificato	30
Figura 16 – Alert su Form Emissione Ordinanza per procedimento SIGE con Avvocato non certificato	31
Figura 17: Ordine di Esecuzione con Sezione destinatario Notifica difensore modificata	36
Figura 18: Fissazione Udienza con Sezione destinatario Notifica difensore modificata	37
Figura 19: Sezione destinatario Notifica - SIGE	38
Figura 20: Form inserimento difensore procedimento SIEP - attuale	44
Figura 21: Form inserimento difensore procedimento SIEP - nuova	45
Figura 22: Form di attivazione ricerca su ReGIndE	46
Figura 23: Form di ricerca su ReGIndE con segnalazione di eccessive occorrenze con criteri impostati	47
Figura 24: Form Elenco Avvocati ReGIndE	48
Figura 25: Form Inserimento Avvocato selezionato	50
Figura 26: Form dettaglio avvocato procedimento SIEP	52
Figura 27: Form sostituzione Difensore procedimento SIEP	53
Figura 28: Form Iscrizione Istanza da Soggetto - Attuale	54
Figura 29: Form Iscrizione Istanza da Soggetto - Nuova	55
Figura 30: Form Iscrizione Istanza da Titolo Esecutivo -Nuova	56
Figura 31: Form Iscrizione Istanza da Procedimento SIEP - Nuova	57
Figura 32: Form sostituzione Assegnazione Difensore procedimento SIGE - Attuale	58
Figura 33: Form sostituzione Assegnazione Difensore procedimento SIGE - Nuova	59
Figura 34: Form Dettaglio Difensore procedimento SIGE - Attuale	61
Figura 35: Form Dettaglio Difensore procedimento SIGE - Nuova	61
Figura 36: Form Sostituzione Difensore procedimento SIGE - Nuova	62
Figura 37: Form Inserimento Difensore procedimento SIGE – Parti in causa	63
Figura 38: Form Inserimento Difensore Parte	64
Figura 39: Form Dettaglio Fissazione Udienza procedimento SIGE	65
Figura 40: Form Inserimento Difensore procedimento SIGE Parti in casusa - Nuova	66
Figura 41: Form Assegnazione Difensore procedimento SIUS - Attuale	67
Figura 42: Form Assegnazione Difensore procedimento SIUS - Nuova	68
Figura 43: Form Dettaglio Difensore procedimento SIUS - Attuale	70
Figura 44: Form Dettaglio Difensore procedimento SIUS - Nuova	70
Figura 45: Form Sostituzione Difensore procedimento SIUS - Nuova	71
Figura 46: Form Ricerca Difensore su ReGIndE in caso di assenza collegamento	77
Figura 47: Form Ricerca Difensore su ReGIndE in caso nessun occorrenza trovata	78
Figura 48: Form Elenco Avvocati SIES	79
Figura 49: Form Esito Ricerca Difensori SIES in caso di nessun occorrenza trovata	80
Figura 50: Form Inserimento Difensore in SIES	81
Figura 51: Form Gestione Difensori - Attuale	83
Figura 52: Form Gestione Difensori - Nuova	83
Figura 53: Form Elenco Difensori - Attuale	84
Figura 54: Form Elenco Difensori - Nuova	84
...
Al momento il sistema è configurato per il funzionamento in TLS1.0, infatti nel file “standalone-full.xml” presente nel percorso “/home/SIES/jboss-eap-6.4.Alpha/standalone/configuration” nel paragrafo dedicato alle proprietà di sistema

<property name="jdk.tls.client.protocols" value="SSLv2Hello,SSLv3,TLSv1"/>

è impostato il parametro “TLSv1”, che abilita i protocolli TLSv1, TLSv1.1 e TLSv1.2.
