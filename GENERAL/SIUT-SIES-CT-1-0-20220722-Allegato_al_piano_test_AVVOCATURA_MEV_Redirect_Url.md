---
uniqueName: siut-sies-ct-1-0-20220722-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20220722 Allegato al piano test AVVOCATURA MEV Redirect Url"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_AVVOCATURA_MEV_Redirect_Url

> **File originale:** `Avvocatura-SIES/Rilascio 20220722-MEV_Redirect_Url/SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_AVVOCATURA_MEV_Redirect_Url.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_AVVOCATURA_MEV_Redirect_Url.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220722-Piano_dei_Test_AVVOCATURA_MEV_Redirect_Url.docx |
|  | Versione | 1.0 |
|  | Data | 44764.0 |
|  | Intervento | AVVOCATURA MEV_Redirect_Url |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA MEV_Redirect_Url |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_AVVOCATURA_MEV_Redirect_Url.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIUS-Avvocati | MEV_Redirect_Url |  |  | MEV_Redirect_Url | Nuova Redirect URL |  | SIUS-Avvocati | SIUS-Avvocati - Nuova Redirect URL | TF001.SIUS-Avvocati | Nuova redirect url in caso di logout dall'applicazione |  |  |  | Verifica: verificare che quando si effettua il logout dall'applicazione la URL contenga il valore "servizipst.giustizia.it" prelevato da un file di configurazione esterno all'applicazione | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA MEV_Redirect_Url |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220722-Allegato_al_piano_test_AVVOCATURA_MEV_Redirect_Url.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS-Avvocati | 01 | Nuova redirect url in caso di logout dall'applicazione |  | Verifica: verificare che quando si effettua il logout dall'applicazione la URL contenga il valore "servizipst.giustizia.it" prelevato da un file di configurazione esterno all'applicazione |  | 1.0 |  |  | OK |
...
|  | 1.0 | Azione | L'utente preme il pulsante "Disconnetti/Logout" |  | Uscita dall’applicazione |  |  |  |  |
|  | V | Verifica | Verificare che la pagina di re indirizzamento contenga la stringa "servizipst.giustizia.it" invece che "pst.giustizia.it" |  |  |  |  |  |  |
