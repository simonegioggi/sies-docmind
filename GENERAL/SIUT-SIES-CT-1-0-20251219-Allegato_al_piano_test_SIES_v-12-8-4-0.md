---
uniqueName: siut-sies-ct-1-0-20251219-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20251219 Allegato al piano test SIES v 12 8 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20251219-Allegato_al_piano_test_SIES_v.12.8.4.0

> **File originale:** `RILASCIO_12.8.4.0/SIUT-SIES-CT-1.0-20251219-Allegato_al_piano_test_SIES_v.12.8.4.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.8.4.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20251219-Allegato_al_piano_test_SIES_v.12.8.4.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202511270115 |  |  | 202511270115 | Errore nota accompagnamento notifica avvocati template Siep |  | SIEP | SIEP - Errore nota accompagnamento notifica avvocati template Siep | TF001.SIEP | Errore nell'impostazione di alcune frasi |  |  |  | Verifica: Verificare che le frasi all'interno del template siano corrette | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.8.4.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20251219-Allegato_al_piano_test_SIES_v.12.8.4.0.xlsx |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nell'impostazione di alcune frasi |  | Verifica: Verificare che le frasi all'interno del template siano corrette |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare un fascicolo in cui sia presente un Ordine Esecuzione di Ingiunzione al Pagamento della Pena Pecuniaria, un Provvedimento di Trasmissione Atti all'UDS per la Conversione Pena Pecuniaria, per un soggetto in "Espiazione Pena in Regime Carcerario" |  |  |  |  |  |
|  | 1 | Navigazione | Decisioni Sorveglianza >> Espulsione >> Accoglimento Opposizione |  | Visualizzazione pagina "ACCOGLIMENTO OPPOSIZIONE ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD." |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "DETTAGLIO ACCOGLIMENTO OPPOSIZIONE ESPULSIONE ART.16 COMMA 5 D.LO 286/1998 E SUCC.MOD." |  |  |  |  |
|  | 3 | Azione | L'utente preme il tasto "Generazione Stampa" |  | Produzione del template "SIEP_MA_ESPU_ACCOGLIE.rtf" |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template |  | Il risultato atteso è che le modifiche al template richieste siano state apportate correttamente |  |  |  |  |
