---
uniqueName: siut-sies-ct-1-0-20201127-allegato-al-piano-testsi
displayName: "SIUT SIES CT 1 0 20201127 Allegato al piano test SIES v 12 4 5 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20201127-Allegato-al-piano-test_SIES_v.12.4.5.0

> **File originale:** `RILASCIO_12.4.5.0/SIUT-SIES-CT-1.0-20201127-Allegato-al-piano-test_SIES_v.12.4.5.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20201127-Allegato-al-piano-test_SIES_v.12.4.5.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20201127-Piano_dei_Test_SIES_v.12.4.5.0.doc |
|  | Versione | 1.0 |
|  | Data | 44162.0 |
|  | Intervento | SIES v.12.4.5.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.5.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20201127-Allegato-al-piano-test_SIES_v.12.4.5.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202011040110.0 |  |  | 202011040110.0 | Formato carattere di scrittura errato |  | SIEP | SIEP -  Formato carattere di scrittura errato | TF001.SIEP | Verifica che la stampa prodotta presenti il formato dei caratteri corretto. |  |  |  | Verifica: verificare che la stampa SIEP_RINVIO_PROV_DET_SCARC.rtf abbia il formato dei caratteri corretto. | 1.0 |  |  |  |  |
| SIUT | SIES | 20201106019.0 |  |  | 20201106019.0 | DUE PROCURE/PROCURE GENERALI - CON I RISPETTIVI SIEP |  | SIUS | SIUS - DUE PROCURE/PROCURE GENERALI - CON I RISPETTIVI SIEP | TF002.SIUS | Verificare che se si modifica un fascicolo l'anno del fascicolo non venga aggiornato con l'anno corrente. |  |  |  | Verifica: verificare che non venga aggiornato l'anno di un fascicolo con quello corrente nel caso abbia uno  stato diverso da 01 - Archiviato/Definito, 05 - Unificato o 07 - Emesso Provvedimento. | 1.0 |  |  |  |  |
| SIUT | SIES | 202011180111.0 |  |  | 202011180111.0 | SIUS tribunale Sorveglianza Fasc. aggancia al momento del deposito ordinanza un altro titolo legato ad un Siep di altra sede |  | SIUS | SIUS - SIUS tribunale Sorveglianza Fasc. aggancia al momento del deposito ordinanza un altro titolo legato ad un Siep di altra sede |  |  |  |  |  |  |  |  |  |  |  |
| SIUT | SIES | 202011120110.0 |  |  | 202011120110.0 | note trasmissione cumulo |  | SIEP | SIEP - note trasmissione cumulo | TF003.SIUS | Verfica che la stampa riporti nella penultima pagina l'indicazione corretta del casellario e la data corretta del provvedimento. |  |  |  | Verifica: verificare che la stampa SIEP_CUMULO_OE_656_LIB riporti nella penultima pagina l'indicazione corretta del casellario e la data corretta del provvedimento. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.5.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20201127-Allegato-al-piano-test_SIES_v.12.4.5.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica che la stampa prodotta presenti il formato dei caratteri corretto. |  | Verifica: verificare che la stampa SIEP_RINVIO_PROV_DET_SCARC.rtf abbia il formato dei caratteri corretto. |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Ricercare un fascicolo con Soggetto detenuto. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Navigazione | Decisioni della Sorveglianza » Differimento » Differimento Provvisorio |  | Visualizzazione pagina  Differimento / Rinvio dell'esecuzione Provvisorio |  |  |  |  |
|  | 3 | Azione | Inserire i dati obbligatori. In particolare, nei Dati del Decreto di Differimento/Rinvio dell'Esecuzione  indicare "Già Scarcerato" e la data di scarcerazione.
Cliccare su Conferma. |  | Visualizzazione pagina  Differimento / Rinvio dell'esecuzione Provvisorio |  |  |  |  |
|  | 4 | Azione | Inserire un destinatario e cliccare su Conferma |  | Visualizzazione pagina  Differimento / Rinvio dell'esecuzione Provvisorio |  |  |  |  |
|  | 5 | Azione | procedere con la stampa tramite l'apposita icona |  | Viene prodotta la stampa SIEP_RINVIO_PROV_DET_SCARC.rtf |  |  |  |  |
|  | V | Verifica | Verificare che la stampa prodotta abbia il formato dei caratteri  corretto |  |  |  |  |  |  |
| TF002.SIUS | 01 | Verificare che se si modifica un fascicolo l'anno del fascicolo non venga aggiornato con l'anno corrente. |  | Verifica: verificare che non venga aggiornato l'anno di un fascicolo con quello corrente nel caso abbia uno  stato diverso da 01 - Archiviato/Definito, 05 - Unificato o 07 - Emesso Provvedimento. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Ricercare un fascicolo con anno 2000 e di tipo Concessione Misure Alternative |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 3 | Azione | Verificare se ha ordinanza depositata o comunque procedere al deposito dell'ordinanza attraverso la voce di menu Ordinanze. |  | Visualizzazione pagina Dettaglio Deposito Ordinanza |  |  |  |  |
|  | 4 | Azione | Cliccare sull'icona Trasferisci |  | Visualizzazione pagina Trasferimento Ordinanza |  |  |  |  |
|  | V | Verifica | Verificare che sia presente un solo Ufficio di esecuzione destinatario del provvedimento. |  |  |  |  |  |  |
|  | 5 | Navigazione | Ricerche e Visualizzazioni » Procedimento per n° SIUS |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 6 | Azione | Ricercare un fascicolo nello stato Iscritto con lo stesso numero di quello dello step 2 ma con anno minore e che risponda ai seguenti requisiti:
uno stato diverso da 01 - Archiviato/Definito, 05 - Unificato o 07 - Emesso Provvedimento. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 7 | Azione | Selezionare l'icona di Modifica |  | Visualizzazione pagina Modifica Procedimento |  |  |  |  |
|  | 8 | Azione | Cliccare su Conferma |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 9 | Navigazione | Ricerche e Visualizzazioni » Procedimento per n° SIUS |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 10 | Azione | Ricercare il fascicolo dello step 1 |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 11 | Azione | Selezionare il link "Provvedimenti" |  | Visualizzazione pagina Ricerca Provvedimenti |  |  |  |  |
|  | 12 | Azione | Accedere al dettaglio dell'ordinanza |  | Visualizzazione pagina Dettaglio Ordinanza |  |  |  |  |
|  | 13 | Azione | Selezionare il link in corrispondenza di Anno / Numero Ordinanza |  | Visualizzazione pagina Dettaglio Deposito Ordinanza |  |  |  |  |
|  | 14 | Azione | Selezionare l'icona Trasferisci |  | Visualizzazione pagina Trasferimento Ordinanza |  |  |  |  |
|  | V | Verifica | Verificare che sia presente ancora un solo Ufficio di esecuzione destinatario del provvedimento. |  |  |  |  |  |  |
| TF003.SIUS | 02 | Verfica che la stampa riporti nella penultima pagina l'indicazione corretta del casellario e la data corretta del provvedimento. |  | Verifica: verificare che la stampa SIEP_CUMULO_OE_656_LIB riporti nella penultima pagina l'indicazione corretta del casellario e la data corretta del provvedimento. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Sul menu di scelta rapida in alto selezionare l'icona con sigla IC |  | Visualizzazione pagina Ricerca Istruttoria Cumulo |  |  |  |  |
|  | 2 | Azione | Ricercare un' istruttoria in stato "aperta" |  | Visualizzazione pagina  Elenco Istruttorie |  |  |  |  |
|  | V | Verifica | Verificare che il condannatao non sia nato a roma |  |  |  |  |  |  |
|  | R1 | Riciclo Test | Se la verifica ha avuto esito negativo ricercare altro fascicolo partendo dallo step 1 altrimenti passare allo step successivo. |  |  |  |  |  |  |
|  | 3 | Azione | Cliccare sul link dell'istruttoria presente nella prima colonna dell'elenco Istruttotie |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 4 | Azione | Selezionare  Dati Finali Cumulo |  | Visualizazzione pagina  Dati Finali Cumulo |  |  |  |  |
|  | 5 | Azione | Completare se necessario:
 "Pene rideterminate", "Posizione Giuridica", "Calcolo Pena", "Emissione Provvedimento" |  | Visualizazione pagina  Dettaglio Provvedimento Determinazione Pene Concorrenti |  |  |  |  |
|  | 6 | Azione | procedere con la stampa tramite l'apposita icona |  | Produzione stampa SIEP_CUMULO_OE_656_LIB |  |  |  |  |
|  | V | Verifica | Verificare che  il template riporti nella penultima pagina l'indicazione corretta del casellario e la data corretta del provvedimento. |  | SIEP_CUMULO_OE_656_LIB |  |  |  |  |
