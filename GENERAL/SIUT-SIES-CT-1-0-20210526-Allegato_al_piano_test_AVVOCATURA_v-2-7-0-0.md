---
uniqueName: siut-sies-ct-1-0-20210526-allegatoalpianotestavvoc
displayName: "SIUT SIES CT 1 0 20210526 Allegato al piano test AVVOCATURA v 2 7 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210526-Allegato_al_piano_test_AVVOCATURA_v.2.7.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.7.0.0/SIUT-SIES-CT-1.0-20210526-Allegato_al_piano_test_AVVOCATURA_v.2.7.0.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210526-Allegato-al-piano-test_AVVOCATURA_v.2.7.0.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210526-Piano_dei_Test_AVVOCATURA_v.2.7.0.0.docx |
|  | Versione | 1.0 |
|  | Data | 44342.0 |
|  | Intervento | AVVOCATURA v.2.7.0.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | AVVOCATURA v.2.7.0.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210526-Allegato-al-piano-test_AVVOCATURA_v.2.7.0.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210525019.0 |  |  | 20210525019.0 | SIES 12.4.10.0 collegato a SIUS Avvocati ed al ticket 202105030111 - URGENTE |  | SIUS | SIUS - SIES 12.4.10.0 collegato a SIUS Avvocati ed al ticket 202105030111 - URGENTE | TF001.SIUS | Verifica visualizzazione coerente della Data Udienza in presenza di un decreto di fissazione udienza. |  |  |  | Verifica: verificare che solo in presenza di un decreto di fissazione udienza validato siano visualizzati la Data Udienza, Il decreto di Fissazione Udienza ed i Movimenti di Udienza. | 1.0 |  |  |  |  |
| SIUT | SIES | 202105250111.0 |  |  | 202105250111.0 | SIES 12.4.10.0 collegato a SIUS Avvocati ed al ticket 202105030111 - pre-fissazione udienza |  | SIUS | SIUS - SIES 12.4.10.0 collegato a SIUS Avvocati ed al ticket 202105030111 - pre-fissazione udienza | TF002.SIUS | Verifica non visualizzazione Data Udienza in presenza di una pre-fissazione di udienza. |  |  |  | Verifica: verificare che in presenza della pre-fissazione udienza non sia visualizzata la Data Udienza. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | AVVOCATURA v.2.7.0.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210526-Allegato-al-piano-test_AVVOCATURA_v.2.7.0.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIUS | 01 | Verifica visualizzazione coerente della Data Udienza in presenza di un decreto di fissazione udienza. |  | Verifica: verificare che solo in presenza di un decreto di fissazione udienza validato siano visualizzati la Data Udienza, Il decreto di Fissazione Udienza ed i Movimenti di Udienza. |  | 1.0 |  |  | OK |
...
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con un provvedimento di fissazione udienza non validato, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
...
|  | V | Verifica | Verificare che il fascicolo (con decreto di fissazione udienza non validato) non abbia valorizzata la colonna Data Udienza. |  |  |  |  |  |  |
|  | 4 | Azione | L'utente seleziona il link contenuto nella colonna N.SIUS |  | Visualizzazione Dettaglio Procedimento |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con decreto di fissazione udienza non validato) non abbia valorizzato il Decreto di Fissazione Udienza. |  |  |  |  |  |  |
|  | R1 | Riciclo Script | Rieseguire il test partendo dallo step 1 dopo aver validato il decreto di fissazione udienza. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con provvedimento di fissazione udienza validato) abbia valorizzata la Data Udienza nell'elenco dei Fascicoli e riporti il provvedimento di fissazione udienza ed il movimento di udienza nel dettaglio del procedimento. |  |  |  |  |  |  |
|  | 4 | Navigazione | Ricerche -> estremi procedimenti |  |  |  |  |  |  |
|  | 5 | Azione | L'utente ricerca un procedimento con un decreto di fissazione udienza non validato, imposta i criteri di ricerca per fascicolo e preme il pulsante "Cerca". |  | Visualizzazione Dettaglio Procedimento |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con decreto di fissazione udienza non validato) non abbia valorizzati la Data Udienza, il Decreto di Fissazione Udienza, i movimenti di udienza. |  |  |  |  |  |  |
|  | R1 | Riciclo Script | Rieseguire il test partendo dallo step 4 dopo aver validato il decreto di fissazione udienza. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con decreto di fissazione udienza validato) abbia valorizzata la Data Udienza e riporti il provvedimento di fissazione udienza ed i movimenti di udienza. |  |  |  |  |  |  |
| TF002.SIUS | 01 | Verifica non visualizzazione Data Udienza in presenza di una pre-fissazione di udienza. |  | Verifica: verificare che in presenza della pre-fissazione udienza non sia visualizzata la Data Udienza. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche -> Dati Soggetto |  |  |  |  |  |  |
|  | 2 | Azione | L'utente ricerca un soggetto che abbia almeno un fascicolo con una pre-fissazione udienza, imposta i criteri di ricerca per soggetto e preme il pulsante "Cerca". |  | Visualizzazione dati soggetto |  |  |  |  |
|  | 3 | Azione | L'utente seleziona il link contenuto nella colonna N. Fascicoli SIUS |  | Il sistema prospetta l'elenco dei Fascicoli associati al soggetto ricercato |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con pre-fissazione udienza) non abbia valorizzata la colonna Data Udienza. |  |  |  |  |  |  |
|  | 4 | Azione | L'utente seleziona il link contenuto nella colonna N.SIUS |  | Visualizzazione Dettaglio Procedimento |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con pre-fissazione udienza) non abbia valorizzata la Data Udienza. |  |  |  |  |  |  |
|  | 4 | Navigazione | Ricerche -> estremi procedimenti |  |  |  |  |  |  |
|  | 5 | Azione | L'utente ricerca un procedimento con una pre-fissazione udienza, imposta i criteri di ricerca per fascicolo e preme il pulsante "Cerca". |  | Visualizzazione Dettaglio Procedimento |  |  |  |  |
|  | V | Verifica | Verificare che il fascicolo (con pre-fissazione udienza) non abbia valorizzata la Data Udienza. |  |  |  |  |  |  |
