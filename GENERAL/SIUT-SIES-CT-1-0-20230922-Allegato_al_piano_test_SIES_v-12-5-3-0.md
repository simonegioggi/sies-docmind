---
uniqueName: siut-sies-ct-1-0-20230922-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20230922 Allegato al piano test SIES v 12 5 3 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20230922-Allegato_al_piano_test_SIES_v.12.5.3.0

> **File originale:** `RILASCIO_12.5.3.0/SIUT-SIES-CT-1.0-20230922-Allegato_al_piano_test_SIES_v.12.5.3.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20230922-Allegato_al_piano_test_SIES_v.12.5.3.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20230922-Piano_dei_Test_SIES_v.12.5.3.0.docx |
|  | Versione | 1.0 |
|  | Data | 45191.0 |
|  | Intervento | SIES v.12.5.3.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.5.3.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20230922-Allegato_al_piano_test_SIES_v.12.5.3.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202107150110.0 |  |  | 202107150110.0 | Rif TT 20210715018 - Template SIEP_AM_COMPU657_1 |  | SIEP | SIEP - Rif TT 20210715018 - Template SIEP_AM_COMPU657_1 | TF001.SIEP | Errore nella trascrizione pena fungibile nel template indicato |  |  |  | Verifica: Verificare che la stampa del template indicato riporti il quantitativo di pena fungibile | 1.0 |  |  |  |  |
| SIUT | SIES | 202107150111.0 |  |  | 202107150111.0 | Rif. TT 20210715018 - Template SIEP_AM_COMPU657_2 |  | SIEP | SIEP - Rif. TT 20210715018 - Template SIEP_AM_COMPU657_2 | TF002.SIEP | Errore nella trascrizione pena fungibile nel template indicato |  |  |  | Verifica: Verificare che la stampa del template indicato riporti il quantitativo di pena fungibile | 1.0 |  |  |  |  |
| SIUT | SIES | 202107150112.0 |  |  | 202107150112.0 | Rif. TT 20210715018 - Template SIEP_AM_COMPU657_MIS |  | SIEP | SIEP - Rif. TT 20210715018 - Template SIEP_AM_COMPU657_MIS | TF003.SIEP | Errore nella trascrizione pena fungibile nel template indicato |  |  |  | Verifica: Verificare che la stampa del template indicato riporti il quantitativo di pena fungibile | 1.0 |  |  |  |  |
| SIUT | SIES | 20230512014.0 |  |  | 20230512014.0 | Rif. Ticket 20230405011 - Apertura Ticket su Sies Tribunale Sorveglianza Roma per Sius Avvocati |  | SIES - Avvocatura | SIES - Avvocatura - Rif. Ticket 20230405011 - Apertura Ticket su Sies Tribunale Sorveglianza Roma per Sius Avvocati | TF001.SIES - Avvocatura | Errore nella visualizzazione del procedimento |  |  |  | Verifica: verificare che la ricerca del procedimento vada a buon fine | 1.0 |  |  |  |  |
| SIUT | SIES | 20230718019.0 |  |  | 20230718019.0 | SIEP Non si può dare corso alla misura alternativa |  | SIEP | SIEP - SIEP Non si può dare corso alla misura alternativa | TF004.SIEP | Errore nella cancellazione di un provvedimento |  |  |  | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine | 1.0 |  |  |  |  |
| SIUT | SIES | 202307240122.0 |  |  | 202307240122.0 | Visualizzazione maschera errata |  | SIEP | SIEP - Visualizzazione maschera errata | TF005.SIEP | Errore nella cancellazione di un provvedimento |  |  |  | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine | 1.0 |  |  |  |  |
| SIUT | SIES | 20230817015.0 |  |  | 20230817015.0 | Errore Modello SIES - SIUS |  | SIUS | SIUS - Errore Modello SIES - SIUS | TF001.SIUS | Errore nella stampa del decreto di fissazione udienza |  |  |  | Verifica: verificare che nella stampa del decreto di fissazione udienza per il contenuto "Remissione Debito" sia riportato il Magistrato Relatore | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.5.3.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20230922-Allegato_al_piano_test_SIES_v.12.5.3.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nella trascrizione pena fungibile nel template indicato | 23 | Verifica: Verificare che la stampa del template indicato riporti il quantitativo di pena fungibile |  | 1.0 |  |  | OK |
...
|  | 1.0 | Azione | Ricercare un procedimento con soggetto detenuto (o comunque con posizione giuridica consona a produrre il template indicato) |  |  |  |  |  |  |
|  | 2.0 | Navigazione | Rideterminazione Pena |  | Visualizzazione pagina "Rideterminazione della pena" |  |  |  |  |
|  | 3.0 | Azione | Cliccare su "Computo misura cautelare stesso reato (presofferto)" |  | Visualizzazione pagina "Computo misura cautelare stesso reato (presofferto)" |  |  |  |  |
|  | 4.0 | Azione | Inserire il Periodo da Computare tale che il periodo di espiato superi la quantità di pena che deve ancora essere scontata. Cliccare su "Conferma" |  | Visualizzazione pagina "Computo misura cautelare stesso reato (presofferto)" |  |  |  |  |
|  | 5.0 | Azione | Cliccare su "Calcolo Pena" |  | Visualizzazione pagina "Calcolo Pena" |  |  |  |  |
|  | 6.0 | Azione | Selezionare "Data Odierna Con Fungibilità" e cliccare su "Conferma" |  | Visualizzazione pagina "Provvedimenti e Stampe per Rideterminazione Pena" |  |  |  |  |
|  | 7.0 | Azione | Cliccare su "Stesso reato" |  | Visualizzazione pagina "Decreto Computo C.C. art. 657 c.p.p." |  |  |  |  |
|  | 8.0 | Azione | L'utente riempie i campi obbligatori e clicca su "Conferma" |  | Visualizzazione pagina "Decreto Computo C.C. art. 657 c.p.p." |  |  |  |  |
|  | 9.0 | Azione | Cliccare sull'icona di stampa |  | Generazione template "Siep_am_compu657_1" |  |  |  |  |
|  | V | Verifica | Verificare che la stampa riporti nella sezione Comunica il periodo di presofferto. |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella trascrizione pena fungibile nel template indicato |  | Verifica: Verificare che la stampa del template indicato riporti il quantitativo di pena fungibile |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 7.0 | Azione | Cliccare su "Stesso reato" |  | Visualizzazione pagina "Decreto Computo C.C. art. 657 c.p.p." |  |  |  |  |
|  | 8.0 | Azione | L'utente riempie i campi obbligatori e clicca su "Conferma" |  | Visualizzazione pagina "Decreto Computo C.C. art. 657 c.p.p." |  |  |  |  |
|  | 9.0 | Azione | Cliccare sull'icona di stampa |  | Generazione template "Siep_am_compu657_2" |  |  |  |  |
|  | V | Verifica | Verificare che la stampa riporti nella sezione Comunica il periodo di presofferto. |  |  |  |  |  |  |
| TF003.SIEP | SIEP | Errore nella trascrizione pena fungibile nel template indicato |  | Verifica: Verificare che la stampa del template indicato riporti il quantitativo di pena fungibile |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 7.0 | Azione | Cliccare su "Stesso reato" |  | Visualizzazione pagina "Decreto Computo C.C. art. 657 c.p.p." |  |  |  |  |
|  | 8.0 | Azione | L'utente riempie i campi obbligatori e clicca su "Conferma" |  | Visualizzazione pagina "Decreto Computo C.C. art. 657 c.p.p." |  |  |  |  |
|  | 9.0 | Azione | Cliccare sull'icona di stampa |  | Generazione template "Siep_am_compu657_MIS" |  |  |  |  |
|  | V | Verifica | Verificare che la stampa riporti nella sezione Comunica il periodo di presofferto. |  |  |  |  |  |  |
| TF001.SIES - Avvocatura | SIES - Avvocatura | Errore nella visualizzazione del procedimento |  | Verifica: verificare che la ricerca del procedimento vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare il fascicolo 2021/285 |  |  |  |  |  |
|  | 1.0 | Navigazione | Ricerche » Dati Soggetto |  | Visualizzazione pagina "Ricerca Soggetti con Procedimenti di Sorveglianza" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Cerca" | Il soggetto da ricercare è lo stesso del fascicolo di cui sopra | Visualizzazione pagina "Elenco Soggetti con Procedimenti" |  |  |  |  |
...
|  | 4.0 | Azione | L'utente clicca, nella sezione dei risultati trovati, colonna "N. SIUS", sul link "Anno/Numero" | Il fascicolo da ricercare è lo stesso di cui sopra |  |  |  |  |  |
...
|  | 6.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Cerca" | Il fascicolo da ricercare è lo stesso di cui sopra |  |  |  |  |  |
|  | V | Verifica | Verificare che la ricerca vada a buon fine ed il fascicolo sia visualizzato correttamente |  | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |
| TF004.SIEP | SIEP | Errore nella cancellazione di un provvedimento | 23 | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o ricercare un fascicolo, in stato validato, in cui sia stata assegnata la posizione giuridica LIBERO al soggetto |  |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni Sorveglianza » Misure Alternative - Affidamento in Prova al Servizio Sociale » Concessione/Ratifica |  | Visualizzazione pagina "Concessione Affidamento In Prova" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Concessione Affidamento In Prova" |  |  |  |  |
|  | 3.0 | Azione | L'utente clicca sull'icona "Generazione Stampa" |  | Visualizzazione documento "Documento.rtf" |  |  |  |  |
|  | 4.0 | Azione | L'utente clicca nel checkbox "Valida Documento" e preme il pulsante "Conferma" | Premere "OK" | Visualizzazione pagina "Dettaglio Concessione Affidamento In Prova " |  |  |  |  |
|  | 5.0 | Navigazione | Decisioni Sorveglianza » Registrazione data inizio misura |  | Visualizzazione pagina "Registrazione Data Inizio Misura" |  |  |  |  |
|  | 6.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Registrazione Data Inizio Misura" |  |  |  |  |
|  | 7.0 | Navigazione | Elenco Provvedimenti del PM |  | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 8.0 | Azione | L'utente, nella colonna "Azioni", clicca sull'icona "Cancella" relativa al "Verbale  sottoscrizione obblighi" | Premere prima "OK" e poi "Conferma" la motivazione dell'annullamento | Visualizzazione pagina "Elenco Provvedimenti PM" |  |  |  |  |
|  | 9.0 | Navigazione | Elenco Procedimenti Sorveglianza e GE |  | Visualizzazione pagina "Elenco Procedimenti Sorveglianza e GE" |  |  |  |  |
|  | V | Verifica | Verificare che l'Ordinanza di Concessione Misure Alternative Alla Detenzione NON sia stata cancellata |  | Possibilità di emettere nuovamente un Verbale di Sottoscrizione Obblighi |  |  |  |  |
| TF005.SIEP | SIEP | Errore nella cancellazione di un provvedimento | 23 | Verifica: verificare che la cancellazione di un "Ordine Esecuzione di Ingiunzione al Pagamento" vada a buon fine |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come "Procura della Repubblica Presso il Tribunale Ordinario" | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o ricercare un fascicolo in stato validato in cui sia presente la pena complessiva ed attivata la modalità di pagamento della pena pecuniaria e sia stata assegnata una posizione giuridica |  |  |  |  |  |
|  | 1.0 | Navigazione | Decisioni Sorveglianza » Misure Alternative - Affidamento in Prova al Servizio Sociale » Concessione/Ratifica |  | Visualizzazione pagina "Concessione Affidamento In Prova" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Concessione Affidamento In Prova" |  |  |  |  |
|  | 3.0 | Azione | L'utente clicca sull'icona "Generazione Stampa" |  | Visualizzazione documento "Documento.rtf" |  |  |  |  |
|  | 4.0 | Azione | L'utente clicca nel checkbox "Valida Documento" e preme il pulsante "Conferma" | Premere "OK" | Visualizzazione pagina "Dettaglio Concessione Affidamento In Prova " |  |  |  |  |
|  | 5.0 | Navigazione | Decisioni Sorveglianza » Registrazione data inizio misura |  | Visualizzazione pagina "Registrazione Data Inizio Misura" |  |  |  |  |
|  | 6.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Conferma" | Posizione Giuridica: Espiazione Pena in Regime di Affidamento in Prova | Visualizzazione pagina "Dettaglio Registrazione Data Inizio Misura" |  |  |  |  |
|  | 7.0 | Navigazione | Decisione della Sorveglianza » Affidamento in prova al Servizio Sociale » Cessazione / Cessazione su Reclamo 51 Bis |  | Visualizzazione pagina "Cessazione Affidamento in Prova" |  |  |  |  |
|  | 8.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Conferma" | Selezionare il Radio Button "Esecuzione contro soggetto detenuto dal" ed immettere una data valida | Visualizzazione pagina "Cessazione Affidamento in Prova" |  |  |  |  |
|  | V | Verifica | Verificare che, nella pagina, la sezione "Destinatari" sia presente ed editabile. Inoltre, verificare che se si cambia il valore del Radio Button in "Esecuzione contro soggetto non detenuto", la data venga cancellata, mentre se si seleziona nuovamente l'opzione precedente, la data sia nuovamente valorizzata. |  | Visualizzazione sezione "Destinatari" e data "Esecuzione contro soggetto detenuto Dal" |  |  |  |  |
| TF001.SIUS | SIUS | Errore nella stampa del decreto di fissazione udienza | 23 | Verifica: verificare che nella stampa del decreto di fissazione udienza per il contenuto "Remissione Debito" sia riportato il Magistrato Relatore |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Iscrivere o ricercare un fascicolo con Contenuto "Remissione Debito" ed Oggetto "Remissione Debito" in stato iscritto |  |  |  |  |  |
|  | 1.0 | Navigazione | Udienza » Fissazione Udienza |  | Visualizzazione pagina "Inserimento Fissazione Udienza" |  |  |  |  |
|  | 2.0 | Azione | L'utente riempie i campi obbligatori e preme il pulsante "Conferma" |  | Visualizzazione pagina "Dettaglio Fissazione Udienza" |  |  |  |  |
|  | 3.0 | Azione | L'utente clicca sull'icona "Generazione Stampa" |  | Visualizzazione documento "Documento.rtf" |  |  |  |  |
|  | V | Verifica | Verificare che nella stampa prodotta venga riportato correttamente il Magistrato Relatore |  | Visualizzazione Nome e Cognome del Magistrato Relatore |  |  |  |  |
