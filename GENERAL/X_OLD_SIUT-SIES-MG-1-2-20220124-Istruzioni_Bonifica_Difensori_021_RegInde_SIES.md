---
uniqueName: xoldsiut-sies-mg-1-2-20220124-istruzionibonificadi
displayName: "X OLD SIUT SIES MG 1 2 20220124 Istruzioni Bonifica Difensori 021 RegInde SIES"
category: "GENERAL"
tags: []
---

# X_OLD_SIUT-SIES-MG-1.2-20220124-Istruzioni_Bonifica_Difensori_021_RegInde_SIES

> **File originale:** `MEV/SCHEDA_021/Docs/consegna docx/20220422/X_OLD_SIUT-SIES-MG-1.2-20220124-Istruzioni_Bonifica_Difensori_021_RegInde_SIES.docx`  
> **Tipo:** DOCX
...
3.1 Importazione tabella Avvocati ReGIndE in SIES	9
3.2 Istruzioni per lancio eseguibili file.sh	10
3.2.1 Attività di installazione ed esecuzione procedura batch Bonifica Difensori	10
3.3 Procedura Bonifica Difensori SIES	11
3.3.1 STEP 1	11
3.3.2 STEP 2	15
3.3.3 STEP 3	19
3.3.4 STEP 4	23
...
Posizionarsi nel percorso /home/oracle//bonifica_db/bonifica/; lanciare il comando:
...
Posizionarsi nel percorso /home/oracle//bonifica_db/; lanciare sequenzialmente i comandi, indicati nel par. 3.3.



## 3.3 Procedura Bonifica Difensori SIES
...
SELECT * FROM USER_TABLES A WHERE A.TABLE_NAME= ‘PRE_XBA_ AVVOCATI_CON_PENDENZE’;
...
Verificare che nel file /home/oracle//bonifica_db/log/LOG_Bonifica_AVV_2.log non siano riportati errori oracle;
...
| Inizio XBA_CREA_AVV_CON_PENDENZE. La tabella XBA_AVVOCATI_CON_PENDENZE conterr�� i dati di transito per eseguire la bonifica AVVOCATO. |  | YYYY-MM-DD HH:MM:SS.m |
| --- | --- | --- |
...
è possibile selezionare, a campione, un avvocato, anche con più occorrenze, annotarsi Codice Fscale, il numero di pendenze (valore NUM_PENDENZE) per ciascun AMBIENTE e verificare che nella tabella PRE_XBA_AVVOCATI_CON_PENDENZE, eseguendo la seguente query (in cui va sostituito il parametro 'valore codice fiscale' con il codice fiscale annotato)
...
Verificare che nel file /home/oracle//bonifica_db/log/LOG_Bonifica_AVV_4.log non siano riportati errori oracle;
...
Select * from FROM XBA_VERIF_AVV_CERTIFICABILI 		individuare a campione un avvocato certificato ReGIndE (FLAG_REGINDE = ‘SI’), a cui risultano collegati altri avvocati non certificati (FLAG_REGINDE = ‘NO’, ID_AVVOCATO_CERT uguale a quello dell’avvocato certificato) e annotarsi il codice fiscale (es. BBTFBR50P30D810D)
...
SELECT * FROM user_tables a WHERE a.TABLE_NAME= ‘POST_XBA_ AVVOCATI_CON_PENDENZE’;
...
Verificare che nel file /home/oracle//bonifica_db/log/LOG_Bonifica_AVV_Restore.log non siano riportati errori oracle;
