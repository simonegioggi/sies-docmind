---
uniqueName: siut-sies-pr-1-0-20210309-pianodirilascioavvocatur
displayName: "SIUT SIES PR 1 0 20210309 Piano di Rilascio AVVOCATURA v 2 4 0 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20210309-Piano_di_Rilascio_AVVOCATURA_v.2.4.0.0

> **File originale:** `Avvocatura-SIES/RILASCIO_2.4.0.0/SIUT-SIES-PR-1.0-20210309-Piano_di_Rilascio_AVVOCATURA_v.2.4.0.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 09/03/2021 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 2.4.0.0 di AVVOCATURA.
...
# Generalità
Il presente documento descrive il piano di rilascio di AVVOCATURA 2.4.0.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- | --- |
| Portale Fornitura | 1 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.4.0.0 2021-03-09 > Documentazione > documentazione.zip | 2.4.0.0 | 09/03/2021 |
| Portale Fornitura | 2 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.4.0.0 2021-03-09 > Applicazione > avvocatura.war | 2.4.0.0 | 09/03/2021 |
| Portale Fornitura | 3 | SIUT > 06 - Rilasci Software > SIES > Rilascio AVVOCATURA 2.4.0.0 2021-03-09 > Sorgenti > sorgenti.zip | 2.4.0.0 | 09/03/2021 |
| Note-osservazioni |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 202103040111 | DGSIA - Referenti Applicativi | L’utente segnala che la versione 2.3.0.0 risolve il ticket 20210205017, ma non sembra adeguata alle richieste dell'amministrazione che aveva ritenuto di non rendere edotto l'avvocato dell'esito prima del deposito dell'ordinanza. In fase di primo collaudo fu chiesta esplicita modifica sul punto.
Con la soluzione al presente ticket, l'esito dell'ordinanza risulta visibile prima del deposito dell'ordinanza stessa, creando di fatto un comportamento incongruente nel sistema stesso. | Per la risoluzione della problematica si è intervenuti con la modifica della classe in cui viene popolato l’elenco degli esiti provvedimento impostando nella colonna “Esito Provvedimento” il valore dell’esito stesso solamente se il provvedimento è stato depositato | E’ stata modificata la classe:
“ProcedimentoPerSoggettoXmlUtil.java”
modificando la proprietà impostata per popolare la colonna “Esito Provvedimento”: viene valorizzata solamente in caso di deposito presente |  |
...
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20210309-Piano_di_Rilascio_AVVOCATURA_v.2.4.0.0.doc
SIUT-SIES-PT-1.0-20210309-Piano_dei_Test_AVVOCATURA _v.2.4.0.0.doc
SIUT-SIES-CT-1.0-20210309-Allegato_al_piano_test_AVVOCATURA_v.2.4.0.0.xls |
| Note-osservazioni |  |  |
