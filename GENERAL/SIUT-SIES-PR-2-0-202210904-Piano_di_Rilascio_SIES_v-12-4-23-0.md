---
uniqueName: siut-sies-pr-2-0-202210904-pianodirilasciosiesv-12
displayName: "SIUT SIES PR 2 0 202210904 Piano di Rilascio SIES v 12 4 23 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-2.0-202210904-Piano_di_Rilascio_SIES_v.12.4.23.0

> **File originale:** `RILASCIO_12.4.23.0/SIUT-SIES-PR-2.0-202210904-Piano_di_Rilascio_SIES_v.12.4.23.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 2.0 | 16/09/2022 | Prima Emissione |  |
| 2.0 | 04/10/2022 | Seconda Emissione | Aggiunto Ticket#202209260112 |
...
siap.sige.fascicolo.dao.FascicoloSigeSqlDAO.java |  |
| 202209260112 | Nessuna | L’ufficio segnala che in merito al ticket di cui all'oggetto si richiede il ripristino della funzione di "Trasferimento ordinanza" in quanto destinata a sviluppi futuri dell'applicativo. La richiesta dell'utente non era da considerare un mal funzionamento e necessitava solamente di istruzioni. | Per la risoluzione della problematica è stato ripristinato il comportamento precedente. | Il problema era legato alla assenza della icona per la funzione di trasmissione del deposito decreto e deposito ordinanza che è stata ripristinata.
Classe modificata:
siap/sige/provvedimento/DettaglioDepositoProvvedimentoSige.jsp |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20221004-Piano_di_Rilascio_SIES_v.12.4.23.0.docx
SIUT-SIES-PT-1.0-20221004-Piano_dei_Test_SIES_v.12.4.23.0.docx
SIUT-SIES-CT-1.0-20221004-Allegato_al_piano_test_SIES_v.12.4.23.0.xls |
