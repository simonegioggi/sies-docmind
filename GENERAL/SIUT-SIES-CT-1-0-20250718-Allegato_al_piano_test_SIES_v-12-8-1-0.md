---
uniqueName: siut-sies-ct-1-0-20250718-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20250718 Allegato al piano test SIES v 12 8 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20250718-Allegato_al_piano_test_SIES_v.12.8.1.0

> **File originale:** `RILASCIO_12.8.1.0/SIUT-SIES-CT-1.0-20250718-Allegato_al_piano_test_SIES_v.12.8.1.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.8.1.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20250718-Allegato_al_piano_test_SIES_v.12.8.1.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202506300126 |  |  | 202506300126 | fascicolo 20033_25_pm_gela |  | SIEP | SIEP - fascicolo 20033_25_pm_gela | TF001.SIEP | Errore nella valorizzazione dell'avvocato presentante |  |  |  | Verifica: Verificare che l'iscrizione di una istanza per Procedimento SIEP non vada in errore | 1.0 |  |  |  |  |
| SIUT | SIES | 202506300135 |  |  | 202506300135 | ordine esecuzione e ingiunzione pagamento ex art.660 cpp |  | SIEP | SIEP - ordine esecuzione e ingiunzione pagamento ex art.660 cpp | TF002.SIEP | Errore nel caricamento dello stato esecuzione nel template |  |  |  | Verifica: Verificare che nel template venga caricato lo stato esecuzione | 1.0 |  |  |  |  |
| SIUT | SIES | 20250707018 |  |  | 20250707018 | SIEP - reginde |  | SIEP | SIEP - SIEP - reginde | TF003.SIEP | Errore nel controllo dell'omocodia in un codice fiscale |  |  |  | Verifica: Verificare che l'inserimento di un avvocato con codice fiscale con omocodia non vada in errore | 1.0 |  |  |  |  |
| SIUT | SIES | 202507140139 |  |  | 202507140139 | SIES: Anomalia nomi comuni - BOLZANO |  | SIEP | SIEP - SIES: Anomalia nomi comuni - BOLZANO | TF004.SIEP | Errore nell'inserimento del valore "Bolzano/Bozen" nel campo "Sede" |  |  |  | Verifica: Verificare che l'inserimento di un ordine di esecuzione non vada in errore se il campo sede nella notifica al difensore comprende un carattere non alfabetico | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.8.1.0 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20250718-Allegato_al_piano_test_SIES_v.12.8.1.0.xlsx |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |  |  |  |  |  |  |  |  |
| TF001.SIEP | SIEP | Errore nella valorizzazione dell'avvocato presentante |  | Verifica: Verificare che l'iscrizione di una istanza per Procedimento SIEP non vada in errore |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Procura della Repubblica presso il Tribunale" | Axxxxx (Procura della Repubblica presso il Tribunale) |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 1 | Navigazione | Istanze » Iscrizione Istanza » Iscrizione Istanza per Procedimento SIEP |  | Visualizzazione pagina "Iscrizione Istanza per Procedimento SIEP" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e la sola sezione "Avvocato" e preme il tasto "Conferma" | ISTANZA = DEPOSITATA | Visualizzazione pagina "Dettaglio Procedimento" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha iscritto l'istanza |  | Il risultato atteso è che l'iscrizione sia andata a buon fine |  |  |  |  |  |  |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errore nel caricamento dello stato esecuzione nel template |  | Verifica: Verificare che nel template venga caricato lo stato esecuzione |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Procura Generale della Repubblica presso la Corte d’Appello" | Cxxxxx (Procura Generale della Repubblica presso la Corte d’Appello) |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare o creare 4 fascicoli di pena pecuniaria con modalità di pagamento in unica soluzione e con rateizzazione, con soggetto con posizione giuridica "Libero" o "Detenuto"; inoltre nel fascicolo deve essere presente un solo evento validato (per esempio un cumulo iniziale) | 1)   Pagamento con Rata Unica e Soggetto Libero;
2)   Pagamento con Rata Unica e Soggetto Detenuto;
3)   Pagamento con Rateizzazione e Soggetto Libero;
4)   Pagamento con Rateizzazione e Soggetto Detenuto; |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 1 | Navigazione | Gestione Altre Sanzioni » Riscossione Pene Pecuniarie » Ordine Ingiunzione / Altri Provvedimenti » Ordine Ingiunzione |  | Visualizzazione pagina "Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordine di Ingiunzione al Pagamento Pena Pecuniaria" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 3 | Azione | L'utente clicca sull'icona di "Generazione Stampa" |  | 1)   Produzione template "SIEP_PP_OI_PAGAMENTO_UN.rtf"
2)   Produzione template "SIEP_PP_OI_PAGAMENTO_UN_DET.rtf"
3)   Produzione template "SIEP_PP_OI_PAGAMENTO_RR.rtf"
4)   Produzione template "SIEP_PP_OI_PAGAMENTO_RR_DET.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha stampato il template interessato dall'evento |  | Il risultato atteso è che nel template prodotto sia presente lo stato di esecuzione |  |  |  |  |  |  |  |  |  |  |  |  |
| TF003.SIEP | SIEP | Errore nel controllo dell'omocodia in un codice fiscale |  | Verifica: Verificare che l'inserimento di un avvocato con codice fiscale con omocodia non vada in errore |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Procura della Repubblica presso il Tribunale" | Axxxxx (Procura della Repubblica presso il Tribunale) |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (o creare) un fascicolo in stato iscritto |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 1 | Navigazione | Assegnazione Difensore |  | Visualizzazione pagina "Assegnazione Difensore" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Navigazione | Assegnazione |  | Visualizzazione pagina "Inserimento Difensore" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 3 | Navigazione | Seleziona da RegInde |  | Visualizzazione pagina "Ricerca Difensore su ReGInde" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 4 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" | SIGNORELLI FRANCESCA del foro di Bergamo (SGNFNC80M51A7V4Y) | Visualizzazione pagina "Elenco Difensori certificati Reginde" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha ricercato l'avvocato con codice fiscale con omocodia |  | Il risultato atteso è l'avvocato venga trovato ed inserito correttamente |  |  |  |  |  |  |  |  |  |  |  |  |
| TF004.SIEP | SIEP | Errore nell'inserimento del valore "Bolzano/Bozen" nel campo "Sede" |  | Verifica: Verificare che l'inserimento di un ordine di esecuzione non vada in errore se il campo sede nella notifica al difensore comprende un carattere non alfabetico |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Procura della Repubblica presso il Tribunale" | Axxxxx (Procura della Repubblica presso il Tribunale) |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare (o creare) un fascicolo in stato iscritto con soggetto con posizione giuridica "Libero" |  |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 1 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  | Visualizzazione pagina "Ordine di Esecuzione con sospensione (LEGGE 165/98) - CONDANNATO Libero" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" | Nelle sezioni "Notifica Al Condannato" e "Notifica al Difensore" inserire nel campo "Sede" il valore "BOLZANO/BOZEN" | Visualizzazione pagina "Dettaglio Ordine esecuzione legge 165/98 - condannato libero" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente ha iscritto l'ordine di esecuzione |  | Il risultato atteso è che l'iscrizione sia andata a buon fine |  |  |  |  |  |  |  |  |  |  |  |  |
