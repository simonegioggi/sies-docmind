---
uniqueName: siut-sie-pt-1-0-20210730-pianodeitest021regindesie
displayName: "SIUT SIE PT 1 0 20210730 Piano dei Test 021 RegInde SIES"
category: "GENERAL"
tags: []
---
...
> **File originale:** `MEV/SCHEDA_021/Docs/consegna docx/ORIGINALS/Documentazione consegna Scheda-21/SIUT-SIE-PT-1.0-20210730-Piano_dei_Test_021_RegInde_SIES.pdf`  
> **Tipo:** PDF
...
previste nella scheda SIUT-SIE-SC-1.3-20200616 Scheda intervento Scheda_n.21_SIES_Reginde.pdf 
[RIF.1] e dalle successive specifiche di intervento SIUT-SIE-SI-2.3-20210730-Specifiche-intervento-
021-SIES – RegInde.pdf [RIF. 2]. 
. 
1.2. Riferimenti 
Riferimento 
Nome Documento 
...
RIF.1 
SIUT-SIE-SC-1.3-20200616 
Scheda 
intervento 
Scheda_n.21_SIES_Reginde.pdf 
Scheda di Intervento  
RIF.2 
SIUT-SIE-SI-2.3-20210730-Specifiche-intervento-
021-SIES – RegInde.pdf 
Specifiche di Intervento. 
RIF.3 
SIUT-SIE-PR-1.0-20210730-
Piano_di_Rilascio_021_RegInde_SIES.docx 
...
L'entità oggetto di verifica è l'applicativo SIES relativamente alle funzionalità oggetto delle Specifiche 
Funzionali [Rif.2].  
Poiché la Gestione dell'anagrafica di un avvocato è richiamata da più funzioni per i test si è fatto 
riferimento solo a qualcuna di queste in quanto portano tutte alla stessa pagina di gestione. 
...
documento 
SIUT-SIE-CT-1.0-20210730-
Allegato_al_piano_test_021_RegInde_SIES.xlsx [RIF.4].
...
documento SIUT-SIE-CT-1.0-20210730-Allegato_al_piano_test_021_RegInde_SIES.xlsx [RIF.4]. 
...
RegInde.pdf [RIF.2] e SIUT-SIE-PR-1.0-20210730-Piano_di_rilascio_021_RegInde_SIES.docx [RIF.3]. 
7.2. Sistemi esterni 
N.A. 
