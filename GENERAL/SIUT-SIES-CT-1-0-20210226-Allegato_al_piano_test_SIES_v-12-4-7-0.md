---
uniqueName: siut-sies-ct-1-0-20210226-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210226 Allegato al piano test SIES v 12 4 7 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210226-Allegato_al_piano_test_SIES_v.12.4.7.0

> **File originale:** `RILASCIO_12.4.7.0/SIUT-SIES-CT-1.0-20210226-Allegato_al_piano_test_SIES_v.12.4.7.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210226-Allegato-al-piano-test_SIES_v.12.4.7.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210226-Piano_dei_Test_SIES_v.12.4.7.0.doc |
|  | Versione | 1.0 |
|  | Data | 44253.0 |
|  | Intervento | SIES v.12.4.7.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.7.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210226-Allegato-al-piano-test_SIES_v.12.4.7.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210113013.0 |  |  | 20210113013.0 | DEFINIZIONE PER STATISTICA |  | SIEP | SIEP - DEFINIZIONE PER STATISTICA | TF001.SIEP | Verifica corretta classificazione eventi inseriti nello stesso giorno |  |  |  | Verifica: verificare che nel foglio excel prodotto del riepilogo Ispettivo, nella scheda Dettaglio, un fascicolo precedentemente creato deve essere classificato con la voce corretta | 1.0 |  |  |  |  |
| SIUT | SIES | 20210127015.0 |  |  | 20210127015.0 | SIUS - decreto irreperibilità già esistente |  | SIEP | SIEP - SIUS - decreto irreperibilità già esistente | TF002.SIEP | Verifica corretta visualizzazione del messaggio per una tipologia di provvedimento (da rigetto a inammissibilità) |  |  |  | Verifica: verificare che il sistema visualizzi il messaggio corretto e congruente con il tipo di provvedimento inserito. | 1.0 |  |  |  |  |
| SIUT | SIES | 202101270113.0 |  |  | 202101270113.0 | SIEP 136/2019 PG BARI |  | SIEP | SIEP - SIEP 136/2019 PG BARI | TF003.SIEP | Verifica che il numero di eventi visualizzati sia coerente. |  |  |  | Verifica: verificare che nell'elenco dei provvedimenti del PM ci sia ancora coerenza tra il numero di eventi visualizzabile e quello conteggiato e sia presente l'icona di cancellazione sull'ultimo evento. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210208018.0 |  |  | 20210208018.0 | Ricerca soggetto altre bdi |  | SIEP | SIEP - Ricerca soggetto altre bdi | TF004.SIEP | Verifica corretto caricamento descrizione nella combo altra BDI |  |  |  | Verifica: verificare che nella combo altra BDI vengano caricate correttamente le decrizioni delle singole BDI | 1.0 |  |  |  |  |
| SIUT | SIES | 20210212012.0 |  |  | 20210212012.0 | Elenco Provvedimenti Esecutivi Coinvolti |  | SIEP | SIEP -  Elenco Provvedimenti Esecutivi Coinvolti | TF005.SIEP | Verifica corretta visualizazzione della colonna Anno/Numero reg. Gen. con numero sentenza |  |  |  | Verifica: verificare che in elenco titoli coinvolti in corrispondenza della colonna Anno/Numero Reg. Gen. siano riportati anno e numero della sentenza del GUP | 1.0 |  |  |  |  |
| SIUT | SIES | 20210212019.0 |  |  | 20210212019.0 | versione 12.4.6.0 Risultato negativo test in pre-esercizio |  | SIEP | SIEP - versione 12.4.6.0 Risultato negativo test in pre-esercizio | TF006.SIEP | Verifica corretta visualizzazione dei dati relativi alla revoca della misura alternativa. |  |  |  | Verifica: verificare che nel Dettaglio Revoca Misura Alternativa vengano visualizzati correttamente i campi Data inizio e fine misura. | 1.0 |  |  |  |  |
|  |  |  |  |  |  |  |  |  |  |  | Verifica che il calcolo revoca benefici applicati con sentenza di condanna sia corretto. |  |  |  | Verifica: verificare che nel "Dettaglio della Pena" in fondo alla popup nella sezione "Totale Quantum" non vi siano quantum di arresto negativi pari alla Misura cautelare sofferta. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.7.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210226-Allegato-al-piano-test_SIES_v.12.4.7.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica corretta classificazione eventi inseriti nello stesso giorno |  | Verifica: verificare che nel foglio excel prodotto del riepilogo Ispettivo, nella scheda Dettaglio, un fascicolo precedentemente creato deve essere classificato con la voce corretta |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Iscrivere un fascicolo SIEP per soggetto con posizione giuridica iniziale Libero. |  |  |  |  |  |  |
|  | 2 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 3 | Azione | Validare il procedimento dello step 1 cliccando sul pulsante Conferma |  | Visualizazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 4 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizzazione pagina :  Emissione Ordine di Esecuzione - Libero |  |  |  |  |
|  | 5 | Azione | Inserire le informazioni richieste nella pagina. Cliccare su Conferma |  | Visualizzazione pagina  Dettaglio Ordine Esecuzione Condannato Libero |  |  |  |  |
|  | 6 | Azione | Stampare e validare. |  | Visualizzazione pagina  Dettaglio Ordine Esecuzione Condannato Libero |  |  |  |  |
|  | 7 | Navigazione | Verbali Arresto/Vane ricerche Notifica carcere » Verbale Vane Ricerche |  | Visualizzazione pagina   Inserimento Verbale Vane Ricerche |  |  |  |  |
|  | 8 | Azione | Inserire le informazioni richieste nella pagina e cliccare su Conferma |  | Visualizazzione pagina  Dettaglio Verbale Vane Ricerche |  |  |  |  |
|  | 9 | Navigazione | Istruttorie/Richieste » Richiesta/Comunicazione |  | Visualizzazione pagina  RICHIESTA/COMUNICAZIONE |  |  |  |  |
|  | 10 | Azione | Inserire i dati necessari. In particolare come  tipologia atto scegliere "Richiesta" ed Oggetto Atto "(generica)". |  | Visualizazione pagina Dettaglio Richiesta/Comunicazione |  |  |  |  |
|  | 11 | Azione | Procedere alla stampa e validazione |  | Visualizazione pagina Dettaglio Richiesta/Comunicazione |  |  |  |  |
|  | 12 | Navigazione | Menu Statistiche/Monitoraggio » Statistiche/Estrazione Dati. |  | Visualizzazione pagina  STATISTICHE - ESTRAZIONE DATI |  |  |  |  |
|  | 13 | Azione | Selezionare "classe I" e "Riepilogo Ispettivo". Cliccare su Conferma |  | Visualizazione pagina STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI - |  |  |  |  |
|  | 14 | Azione | Cliccare su Conferma |  | Visualizzazione pagina STATISTICHE UFFICIO - RIEPILOGO STATI PROCEDIMENTI |  |  |  |  |
|  | 15 | Azione | Premere il tasto "seleziona tutti" e quindi "Conferma". |  | Produzione foglio Excel |  |  |  |  |
|  | V | Verifica | Verificare che nel foglio excel prodotto, nella scheda Dettaglio, il fascicolo precedentemente creato deve essere classificato nella voce:
PROCEDIMENTI CON CONDANNATI IRREPERIBILI - Condannati Irreperibili con Verbale di Vane Ricerche |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica corretta visualizzazione del messaggio per una tipologia di provvedimento (da rigetto a inammissibilità) |  | Verifica: verificare che il sistema visualizzi il messaggio corretto e congruente con il tipo di provvedimento inserito. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche e Visualizzazioni » Ricerca Titolo Esecutivo per Numero SIEP |  | Visualizzazione pagina Ricerca Titolo Esecutivo |  |  |  |  |
|  | 2 | Azione | L'utente ricerca un procedimento SIEP a cui collegarsi |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Nella pagina di dettaglio procedimento selezionare dalla combo Iscrizione Procedimento e cliccare sulla lentina |  | Visualizzazione pagina Iscrizione Procedimento |  |  |  |  |
|  | 4 | Azione | Inscrivere il procedimento SIUS con:
Tipo Atto = Attività,
Contenuto = Applicazione Provvisoria di misura alternativa,
Oggetto = Ammissione provvisoria a Detenzione Domiciliare - Art. 47 ter co.1 quater O.P.
Infine Confermare. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 5 | Navigazione | Decreti » Emissione Decreto |  | Visualizzazione pagina Emissione Decreto |  |  |  |  |
|  | 6 | Azione | Inserire la Data di Emissione ed il Magistrato Relatore. Infine cliccare su Conferma |  | Visualizzazione pagina Emissione Decreto Applicazione Provvisoria di Misura Alternativa |  |  |  |  |
|  | 7 | Azione | Procedere all'emissione del decreto. Come esito indicare "Dichiara l'Inammissibilità". |  | Visualizzazione pagina Dettaglio Decreto Applicazione Provvisoria di Misura Alternativa |  |  |  |  |
|  | 8 | Azione | Stampare e validare |  | Visualizzazione pagina Dettaglio Decreto Applicazione Provvisoria di Misura Alternativa |  |  |  |  |
|  | 9 | Navigazione | Decreti » Deposito Decreto |  | Visualizzazione pagina Deposito Decreto |  |  |  |  |
|  | 10 | Azione | Procedere al deposito del decreto inserendo la Data Deposito in Cancelleria ed infine cliccando su Conferma |  | Visualizzazione pagina Dettaglio Deposito Decreto |  |  |  |  |
|  | 11 | Navigazione | Decreti » Irreperibilità |  | Visualizzazione pagina Emissione Decreto Irreperibilità |  |  |  |  |
|  | 12 | Azione | Provare ad inserire un decreto di irreperibilità. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga mostrato il messaggio: "Inserimento impossibile : Esiste un Decreto di Inammissibilita' " |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica che il numero di eventi visualizzati sia coerente. |  | Verifica: verificare che nell'elenco dei provvedimenti del PM ci sia ancora coerenza tra il numero di eventi visualizzabile e quello conteggiato e sia presente l'icona di cancellazione sull'ultimo evento. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Ricercare un fascicolo con almeno un provvedimento |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Andare tramite l'apposita icona posta in alto all' Elenco Provvedimenti PM |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | V | Verifica | Verificare che il numero totale di eventi indicato nell'intestazione della tabella sia uguale al numero di elementi effettivamente visualizzati e sia presente anche il tasto x di cancellazione sull'ultimo evento. |  |  |  |  |  |  |
|  | 4 | Azione | L'utente effettua l'accesso al sistema SIUS come Tribunale di Sorveglianza | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | 5 | Navigazione | Ricerche e Visualizzazioni » Ricerca Titolo Esecutivo per Numero SIEP |  | Visualizzazione pagina Ricerca Titolo Esecutivo |  |  |  |  |
|  | 6 | Azione | Ricercare il fascicolo SIEP precedentemente individuato nello step 2 |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 7 | Azione | Nella pagina di dettaglio procedimento selezionare dalla combo Iscrizione Procedimento e cliccare sulla lentina |  | Visualizzazione pagina Iscrizione Procedimento |  |  |  |  |
|  | 8 | Azione | Iscrivere un procedimento SIUS con:
Tipo Atto: Attività,
Contenuto: Concessione Misure Alternative alla Detenzione,
Oggetto: uno qualsiasi. 
Confermare. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 9 | Navigazione | Udienza » Fissazione Udienza |  | Visualizzazione pagina Fissazione Udienza |  |  |  |  |
|  | 10 | Azione | Fissare una udienza. Stampare e validare |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 11 | Navigazione | Udienza » Rinvio Udienza » Rinvio Udienza da Verbale |  | Visualizzazione pagina Rinvio Udienza |  |  |  |  |
|  | 12 | Azione | Inserire un rinvio udienze. Per semplicità selezionare Nuovo Ruolo. 
Confermare |  | Visualizzazione pagina Dettaglio Rinvio Udienza |  |  |  |  |
|  | 13 | Azione | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 14 | Azione | Aprire il fascicolo SIEP dello step 2 |  |  |  |  |  |  |
|  | 15 | Navigazione | Stato esecuzione » Gestione Stato Esecuzione |  | Visualizzazione pagina  Gestione Stato Esecuzione |  |  |  |  |
|  | 16 | Azione | Mettere il check sulla colonna "visualizza" dell'evento "Rinvio udienza da verbale" e cliccare su Aggiorna. |  | Visualizzazione messaggio Aggiornamento eseguito correttamente |  |  |  |  |
|  | 17 | Azione | Andare tramite l'apposita icona posta in alto all' Elenco Provvedimenti PM |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | V | Verifica | Verificare che il numero totale di eventi indicato nell'intestazione della tabella sia uguale al numero di elementi effettivamente visualizzati e sia presente anche il tasto x di cancellazione sull'ultimo evento. |  |  |  |  |  |  |
| TF004.SIEP | 01 | Verifica corretto caricamento descrizione nella combo altra BDI |  | Verifica: verificare che nella combo altra BDI vengano caricate correttamente le decrizioni delle singole BDI |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerche » Soggetto |  | Visualizzazione pagina  Ricerca Soggetto |  |  |  |  |
|  | 2 | Azione | Valorizzare nome e cognome. Cliccare su Ricerca |  | Visualizzazione pagina Elenco Soggetti |  |  |  |  |
|  | 3 | Azione | Sulla pagina Elenco Soggetti selezionare l'icona di dettaglio accanto ad uno dei risultati. |  | Visualizzazione pagina Dettaglio Soggetto |  |  |  |  |
|  | 4 | Azione | Sulla pagina di Dettaglio Soggetto selezionare il radio button "In altri distretti" presente nellaparte inferiore dello schermo |  | Viene visualizzata una combo |  |  |  |  |
|  | V | Verifica | Verificare che la combo che viene visualizzata contenga oltre all'etichetta "tutte" anche la descrizione delle singole BDI. |  |  |  |  |  |  |
| TF005.SIEP | 01 | Verifica corretta visualizazzione della colonna Anno/Numero reg. Gen. con numero sentenza |  | Verifica: verificare che in elenco titoli coinvolti in corrispondenza della colonna Anno/Numero Reg. Gen. siano riportati anno e numero della sentenza del GUP |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento validato ed accedere al dettaglio |  | Visualizzazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 2 | Navigazione | Funzioni Amministrative - Annulla validazione Procedimento |  | Visualizzazione pagina Annullamento Validazione Procedimento |  |  |  |  |
|  | 3 | Azione | Annullare la validazione del procedimento dello step 1 |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 4 | Azione | Dal dettaglio del fascicolo selezionare il link della sentenza. |  | Visualizzazione pagina Dettaglio Sentenza |  |  |  |  |
|  | 5 | Azione | Cliccare sull'icona di modifica |  | Visualizzazione pagina Modifica Sentenza |  |  |  |  |
|  | 6 | Azione | Nella prima riga in corrispondenza dei campi Anno/Numero Reg. Gen. selezionare GUP dalla combo e confermare. |  | Visualizzazione pagina Dettaglio Sentenza |  |  |  |  |
|  | 7 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 8 | Azione | Validare nuovamente il procedimento dello step 1 |  | Visualizzazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 9 | Azione | Cliccare sull'icona di Gestione Cumulo |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 10 | Azione | Cliccare su Apertura Istruttoria |  | Visualizzazione pagina Apertura Istruttoria Cumulo |  |  |  |  |
|  | 11 | Azione | Ritornare nella pagina di  Gestione Cumulo |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 12 | Azione | Cliccare sul link Elenco Titoli Coinvolti |  | Visualizzazione pagina  Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | V | Verifica | Verificare che in elenco titoli coinvolti in corrispondenza della colonna Anno/Numero Reg. Gen. siano riportati anno e numero della sentenza GUP dello step 6. |  |  |  |  |  |  |
| TF006.SIEP | 01 | Verifica corretta visualizzazione dei dati relativi alla revoca della misura alternativa. |  | Verifica: verificare che nel Dettaglio Revoca Misura Alternativa vengano visualizzati correttamente i campi Data inizio e fine misura. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un fascicolo con soggetto avente una Posizione Giuridica di Espiazione Pena in Regime di Affidamento in Prova |  |  |  |  |  |  |
|  | 2 | Navigazione | Decisioni della Sorveglianza >> Affidamento in Prova al servizio Sociale >> Revoca |  | Visualizzazione pagina Revoca Affidamento in Prova |  |  |  |  |
|  | 3 | Azione | Compilare i campi indicando in "Misura Alternativa Revocata dal" una data compresa tra Decorrenza pena e Fine Pena (presenti nella parte superiore della schermata). Procedere avanti fino alla validazione del provvedimento. |  | Visualizazione pagina  Dettaglio Revoca Affidamento in Prova |  |  |  |  |
|  | 4 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina :  Inserimento Sentenza |  |  |  |  |
|  | 5 | Azione | Inserire le informazioni richieste nella pagina. Cliccare su Conferma |  | Visualizzazione pagina dettaglio sentenza |  |  |  |  |
|  | 6 | Azione | Selezionare dalla combo delle funzioni Assegnazione N. SIEP e cliccare sulla lente |  | Visualizazzione pagina  Inserimento Procedimento |  |  |  |  |
|  | 7 | Azione | Inserire le informazioni richieste nella pagina e cliccare su Conferma |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 8 | Azione | Inserire tamite la Combo delle funzionalità le seguenti informazioni :
Assegnazione Difensore,
Iscrizione Posizione Giuridica,
Iscrizione Reati,
Iscrizione Pena Principale,
Assegnazione Procedimento al Magistrato |  |  |  |  |  |  |
|  | 9 | Azione | Procedere alla validazione del fascicolo |  |  |  |  |  |  |
|  | 10 | Azione | Cliccare sull'icona Gestione Cumulo |  | Visualizazione pagina Gestione Cumulo |  |  |  |  |
|  | 11 | Azione | Aprire l'istruttoria con l'apposito pulsante presente nella pagina Gestione Cumulo. Confermare ed infine ritornare in Gestione Cumulo. |  | Visualizazione pagina Gestione Cumulo |  |  |  |  |
|  | 12 | Azione | Selezionare Titoli coinvolti con l'apposito pulsante presente nella pagina Gestione Cumulo. |  | Visualizzazione pagina  Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 13 | Azione | Cliccare sul pulsante Iscrizione Proprio Procedimento |  | Visualizzazione pagina  Ricerca Procedimenti per Titolo e Soggetto |  |  |  |  |
|  | 14 | Azione | Selezionare nella lista il fascicolo dello step 1 e cliccare sul pulsante Iscrivi in Istruttoria |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 15 | Azione | selezionare l'icona Dettaglio Dati Analitici presente nella colonna Azioni per il fascicolo individuato allo step 1 |  | Visualizzazione pagina  Gestione Dati Analitici |  |  |  |  |
|  | 16 | Azione | Cliccare su Attività della Sorveglianza e successivamente sul pulsante Revoche Misure Alternative |  | Visualizzazione pagina Elenco Provvedimenti di Revoca Misura Alternativa |  |  |  |  |
|  | 17 | Azione | Nella lista selezionare l'icona di dettaglio o modifica presenti nella colonna Azioni |  |  |  |  |  |  |
|  | V | Verifica | Verificare che nella maschera di dettaglio o modifica siano visualizzati  i campi Data Inizio Misura e Data Fine Misura. |  |  |  |  |  |  |
|  | R1 | Riciclo Test | Eseguire il test dallo step 1 cambiando la tipologia di misura in 
Detenzione Domiciliare, 
Semilibertà, 
Arresti Domiciliare art 656 comma 10 |  |  |  |  |  |  |
| TF006.SIEP | 02 | Verifica che il calcolo revoca benefici applicati con sentenza di condanna sia corretto. |  | Verifica: verificare che nel "Dettaglio della Pena" in fondo alla popup nella sezione "Totale Quantum" non vi siano quantum di arresto negativi pari alla Misura cautelare sofferta. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | L'utente Ricerca/Inserisce un Soggetto |  |  |  |  |  |  |
|  | 2 | Navigazione | Iscrizione » Sentenza |  | Visualizzazione pagina :  Inserimento Sentenza |  |  |  |  |
|  | 3 | Azione | Inserire le informazioni richieste nella pagina. Cliccare su Conferma |  | Visualizzazione pagina dettaglio sentenza |  |  |  |  |
|  | 4 | Azione | Selezionare dalla combo delle funzioni Assegnazione N. SIEP e cliccare sulla lente |  | Visualizazzione pagina  Inserimento Procedimento |  |  |  |  |
|  | 5 | Azione | Inserire le informazioni richieste nella pagina e cliccare su Conferma |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 6 | Azione | Inserire tamite la Combo delle funzionalità le seguenti informazioni :
Assegnazione Difensore,
Iscrizione Posizione Giuridica,
Iscrizione Reati,
Assegnazione Procedimento al Magistrato |  |  |  |  |  |  |
|  | 7 | Azione | Inserire tamite la Combo delle funzionalità l'Iscrizione Pena Complessiva |  | Visualizzazione pagina Inserimento Pena Complessiva |  |  |  |  |
|  | 8 | Azione | Inserire una pena complessiva per esempio di due anni. Cliccare su Conferma |  | Visualizzazione pagina Dettaglio Pena Complessiva |  |  |  |  |
|  | 9 | Azione | Inserire tamite la Combo delle funzionalità l'Iscrizione Concessione Benefici |  | Visualizzazione pagina  Iscrizione concessione benefici |  |  |  |  |
|  | 10 | Azione | Cliccare sul pulsante Indulto |  | Visualizzazione pagina  Beneficio Indulto |  |  |  |  |
|  | 11 | Azione | Inserire il Beneficio dell'indulto in sentenza pari alla pena complessiva in modo da azzerare la pena da eseguire (Condono pena principale). 
Cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Beneficio Indulto |  |  |  |  |
|  | 12 | Azione | Inserire tamite la Combo delle funzionalità l'Iscrizione Misura Cautelare |  | Visualizzazione pagina  Misure Cautelari |  |  |  |  |
|  | 13 | Azione | Selezionare il pulsante Cessata al momento del passaggio in giudicato computabili |  | Visualizzazione pagina  Inserimento Misura Cautelare - COMPUTABILE |  |  |  |  |
|  | 14 | Azione | Inserire una misura cautelare. Cliccare su Conferma |  | Visualizazzione pagina   Elenco Misure Cautelari |  |  |  |  |
|  | 15 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina :  Inserimento Sentenza |  |  |  |  |
|  | 16 | Azione | Validare il procedimento |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 17 | Azione | Cliccare sull'icona Gestione Cumulo |  | Visualizazione pagina Gestione Cumulo |  |  |  |  |
|  | 18 | Azione | Aprire l'istruttoria con l'apposito pulsante presente nella pagina Gestione Cumulo. Confermare ed infine ritornare in Gestione Cumulo. |  | Visualizazione pagina Gestione Cumulo |  |  |  |  |
|  | 19 | Azione | Cliccare su Titoli Coinvolti |  | Visualizzazione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 20 | Azione | Cliccare su Iscrizione Manuale Titolo |  | Visualizzazione pagina  Inserimento Manuale Titolo Soggetto a Cumulo |  |  |  |  |
|  | 21 | Azione | Inserire solo i dati relativi alla Sentenza.
Cliccare su Conferma.
Ritornare in Gestione Cumulo. |  | Visualizazione pagina Gestione Cumulo |  |  |  |  |
|  | 22 | Azione | Cliccare su Richieste del PM |  | Visualizzazione pagina  Richieste del PM |  |  |  |  |
|  | 23 | Azione | Cliccare su Richieste al Giudice dell'Esecuzione |  | Visualizzazione pagina  Richieste del PM al GE |  |  |  |  |
|  | 24 | Azione | Cliccare su Richiesta Revoca Benefici |  | Visualizzazione pagina Richieste al G.E. Revoca Benefici |  |  |  |  |
|  | 25 | Azione | Selezionare dalla lista il titolo su cui è concesso il beneficio.
Cliccare su Conferma. |  | Visualizzazione pagina Inserimento Richiesta Revoca Beneficio |  |  |  |  |
|  | 26 | Azione | selezionare il link "Revocato in relazione al Titolo Esecutivo" |  | Visualizzazione popup Elenco Titoli associati all'Istruttoria |  |  |  |  |
|  | 27 | Azione | Nella colonna azioni fare click sull'icona per selezionare la sentenza |  | Visualizzazione pagina Inserimento Richiesta Revoca Beneficio |  |  |  |  |
|  | 28 | Azione | Nella form indicare i quantum di revoca con segno +  e valore pari ai quantum concessi con beneficio (nel nostro caso di test 2 anni). 
Selezionare il check "Anticipazione degli effetti".
Cliccare su Conferma. |  | Visualizazione pagina  Dettaglio Richiesta Revoca Benefici |  |  |  |  |
|  | 29 | Azione | Spostarsi su Gestione Cumulo >> Dati Finali Cumulo 
Inserire data e cliccare su Conferma |  | Visualizzazione pagina Dati Finali Cumulo |  |  |  |  |
|  | 30 | Azione | Cliccare su Pene Rideterminate |  | Visualizazzione pagina  Dati Finali Cumulo - Pene Determinate in cumulo |  |  |  |  |
|  | 31 | Azione | Selezionare il link "Dettaglio della pena" |  | Visualizzazione popup Riepilogo delle pene |  |  |  |  |
|  | V | Verifica | Il risultato atteso è che in fondo alla popup nella sezione "Totale Quantum" non vi siano quantum di arresto negativi pari alla Misura cautelare sofferta. Per il caso di test tale misura deve essere scalata dalla reclusione di 2 anni. |  |  |  |  |  |  |
