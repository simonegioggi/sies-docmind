---
uniqueName: siut-sies-ct-1-0-20201023-allegato-al-piano-testsi
displayName: "SIUT SIES CT 1 0 20201023 Allegato al piano test SIES v 12 4 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20201023-Allegato-al-piano-test_SIES_v.12.4.4.0

> **File originale:** `RILASCIO_12.4.4.0/SIUT-SIES-CT-1.0-20201023-Allegato-al-piano-test_SIES_v.12.4.4.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20201023-Allegato-al-piano-test_SIES_v.12.4.4.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20201023-Piano_dei_Test_SIES_v.12.4.4.0.doc |
|  | Versione | 1.0 |
|  | Data | 44127.0 |
|  | Intervento | SIES v.12.4.4.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.4.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20201023-Allegato-al-piano-test_SIES_v.12.4.4.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20200930012.0 |  |  | 20200930012.0 | Problemi di stampa richiesta di Accertamento Pericolosità Sociale |  | SIEP | SIEP - Problemi di stampa richiesta di Accertamento Pericolosità Sociale | TF001.SIEP | Verifica che la stampa richiesta di accertamento pericolosità sociale non vada in errore. |  |  |  | Verifica: verificare che nel caso in cui anno e numero ordinanza non siano valorizzati non vada in errore la stampa richiesta per Accertamento Pericolosità Sociale. | 1.0 |  |  |  |  |
| SIUT | SIES | 20201015014.0 |  |  | 20201015014.0 | Errore SIUS in "dettagli Richiesta Istruttoria Generica" |  | SIUS | SIUS - Errore SIUS in "dettagli Richiesta Istruttoria Generica" | TF002.SIUS | Verifica che la stampa richiesta istruttoria generica non vada in errore. |  |  |  | Verifica: verificare che nel caso in cui anno e numero ordinanza non siano valorizzati non vada in errore la stampa richiesta istruttoria generica. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.4.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20201023-Allegato-al-piano-test_SIES_v.12.4.4.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica che la stampa richiesta di accertamento pericolosità sociale non vada in errore. |  | Verifica: verificare che nel caso in cui anno e numero ordinanza non siano valorizzati non vada in errore la stampa richiesta per Accertamento Pericolosità Sociale. |  | 1.0 |  |  | OK |
...
|  | 2 | Azione | Ricercare un fascicolo SIEP di classe 4 selezionando Singolo Procedimento SIEP . Se si fosse selezionato Intervallo Procedimenti SIEP   occorreva inserire un intervallo di valori e dall' Elenco Titoli Esecutivi occorreva selezionare un fascicolo. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Accedere al dettaglio del fascicolo e selezionare dalla combo in alto la voce Iscrizione Procedimento |  | Visualizzazione pagina  Iscrizione Procedimento |  |  |  |  |
|  | 4 | Azione | Completare i campi indicando come
Tipo Atto: Ordinanza, 
Contenuto: Applicazione Misura Sicurezza. 
Oggetto: selezionare dalla popup Accertamento Pericolosità Sociale - Art. 679 c.p.p. - Art. 40 D.P.R. 448/88.
Infine cliccare su Conferma |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 5 | Navigazione | Udienza » Fissazione Udienza |  | Visualizzazione pagina Fissazione Udienza |  |  |  |  |
|  | 6 | Azione | Inserire il numero SIUS associato al fascicolo SIEP e Confermare |  | Visualizzazione pagina  Inserimento Fissazione Udienza |  |  |  |  |
|  | 7 | Azione | Inserire i dati dell'udienza e confermare. |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 8 | Azione | Stampare e Validare |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 9 | Navigazione | Udienza » Rinvio Udienza » Ordinanza Rinvio Udienza |  | Visualizzazione pagina Ordinanza Rinvio Udienza |  |  |  |  |
|  | 10 | Azione | Inserire il numero SIUS associato al fascicolo SIEP e Confermare |  | Visualizzazione pagina Ordinanza Rinvio Udienza |  |  |  |  |
|  | 11 | Azione | Selezionare dalla Lista Udienze una nuova data. (Attenzione se non sono presenti udienze già fissate bisogna inserirne una nuova utilizzando la funzione Funzioni Amministrative » Gestione Udienza » Inserimento Udienza UDS). |  | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza |  |  |  |  |
|  | 12 | Azione | Stampare e Validare |  | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza |  |  |  |  |
|  | 13 | Azione | Collegarsi come utente Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | 14 | Azione | Tramite l'icona della lente (Dettaglio Procedimento) ricercare il fascicolo di classe 4 collegato al procedimento SIUS precedentemente inserito. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 15 | Navigazione | Gestione Misure Sicurezza |  | Visualizzazione pagina  Misure Sicurezza |  |  |  |  |
|  | 16 | Azione | Cliccare su Richiesta Accertamento Pericolosità Sociale |  | Visualizzazione pagina Richiesta Accertamento Pericolosità Sociale |  |  |  |  |
|  | 17 | Azione | Inserire i dati obbligatori e Confermare |  | Visualizzazione pagina Dettaglio Richiesta Accertamento Pericolosità Sociale |  |  |  |  |
|  | 18 | Azione | Cliccare sull'icona di Stampa |  | Produzione stampa SIEP_MS_RICHAPPLMS |  |  |  |  |
|  | V | Verifica | Verificare che la stampa non vada in errore. |  |  |  |  |  |  |
| TF002.SIUS | 01 | Verifica che la stampa richiesta istruttoria generica non vada in errore. |  | Verifica: verificare che nel caso in cui anno e numero ordinanza non siano valorizzati non vada in errore la stampa richiesta istruttoria generica. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Ricercare un procedimento SIUS associato ad un fascicolo SIEP di classe 4. 
Il fascicolo SIEP deve avere:
Posizione Giuridica: Libero
Contenuto: Applicazione Misura Sicurezza. 
Oggetto:  Accertamento Pericolosità Sociale. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 3 | Navigazione | Udienza » Fissazione Udienza |  | Visualizzazione pagina Fissazione Udienza |  |  |  |  |
|  | 4 | Azione | Inserire il numero SIUS dello step 2 e Confermare |  | Visualizzazione pagina  Inserimento Fissazione Udienza. Se viene visualizzata la pagina Dettaglio Ordinanza Rinvio Udienza vuol dire che il caso di test ha già una data di fissazione udienza e si può passare direttamente allo step 7. |  |  |  |  |
|  | 5 | Azione | Inserire i dati dell'udienza e confermare. |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 6 | Azione | Stampare e Validare |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 7 | Navigazione | Udienza » Rinvio Udienza » Ordinanza Rinvio Udienza |  | Visualizzazione pagina Ordinanza Rinvio Udienza |  |  |  |  |
|  | 8 | Azione | Inserire il numero SIUS dello step 2 e Confermare |  | Visualizzazione pagina Ordinanza Rinvio Udienza |  |  |  |  |
|  | 9 | Azione | Selezionare dalla Lista Udienze una nuova data. (Attenzione se non sono presenti udienze già fissate bisogna inserirne una nuova utilizzando la funzione Funzioni Amministrative - Gestione Udienza - Inserimento Udienza UDS). |  | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza |  |  |  |  |
|  | 10 | Azione | Stampare e Validare |  | Visualizzazione pagina Dettaglio Ordinanza Rinvio Udienza |  |  |  |  |
|  | 11 | Navigazione | Fase istruttoria » Richiesta Atti |  | Visualizzazione pagina  Richiesta Atti |  |  |  |  |
|  | 12 | Azione | Inserire il numero SIUS dello step 2 e Confermare |  | Visualizzazione pagina Richiesta Documenti Istruttori |  |  |  |  |
|  | 13 | Azione | Cliccare su Altre Istruttorie |  | Visualizzazione pagina Altre Richieste Istruttorie |  |  |  |  |
|  | 14 | Azione | Inserire Data Emissione e Destinatario n. 3 e cliccare su Conferma |  | Visualizzazione pagina  DETTAGLIO Richiesta Istruttoria Generica |  |  |  |  |
|  | 15 | Azione | Cliccare sull'icona di Stampa |  | Produzione stampa SIUS_IS_UDSGENERICO1 |  |  |  |  |
|  | V | Verifica | Verificare che la stampa non vada in errore. |  |  |  |  |  |  |
