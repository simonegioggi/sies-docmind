---
uniqueName: siut-sies-ct-1-0-20250228-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20250228 Allegato al piano test SIES v 12 7 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20250228-Allegato_al_piano_test_SIES_v.12.7.1.0

> **File originale:** `RILASCIO_12.7.1.0/SIUT-SIES-CT-1.0-20250228-Allegato_al_piano_test_SIES_v.12.7.1.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.7.1.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20250228-Allegato_al_piano_test_SIES_v.12.7.1.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202501220131 |  |  | 202501220131 | Uffici |  | SIEP | SIEP - Uffici | TF001.SIEP | Errore nel caricamento della combo "Ufficio" |  |  |  | Verifica: Verificare che la combo "Ufficio" in Ricerca Utenti Per Ufficio sia caricata correttamente | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.7.1.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20250228-Allegato_al_piano_test_SIES_v.12.7.1.0.xlsx |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | SIEP | Errore nel caricamento della combo "Ufficio" |  | Verifica: Verificare che la combo "Ufficio" in Ricerca Utenti Per Ufficio sia caricata correttamente |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "GESTORE UTENTI E PROFILI" | ADMINXX (GESTORE UTENTI E PROFILI) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerca Utenti Per Ufficio |  | Visualizzazione pagina "Ricerca Utenti Per Ufficio" |  |  |  |  |
|  | V | Verifica | Verificare che nella combo "Ufficio" la presenza della voce "Ufficio di Sorveglianza presso il tribunale per minorenni" |  |  |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Cercare od inserire un fascicolo con un "Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione" | Visualizzazione pagina "Dettaglio Ordine Esecuzione Condannato ..." |  |  |  |  |
|  | 2 | Azione | L'utente clicca sull'icona di trasmissione "Trasmissione Provvedimento" |  | Visualizzazione pagina "Trasferimento Documento" |  |  |  |  |
|  | V | Verifica | Verificare che nella combo "Destinatario" la presenza della voce "Magistrato di Sorveglianza per i minorenni" |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "GESTORE UTENTI E PROFILI" | ADMINXX (GESTORE UTENTI E PROFILI) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione |  |  |  |  |  |  |
|  | 3 | Navigazione | Ricerca Utenti Per Ufficio |  | Visualizzazione pagina "Ricerca Utenti Per Ufficio" |  |  |  |  |
|  | V | Verifica | Verificare nella combo "Ufficio" la presenza della voce "Ufficio di Sorveglianza presso il tribunale per minorenni" e non quella di "Magistrato di Sorveglianza per i minorenni" |  |  |  |  |  |  |
