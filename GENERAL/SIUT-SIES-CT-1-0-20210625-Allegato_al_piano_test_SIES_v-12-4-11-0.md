---
uniqueName: siut-sies-ct-1-0-20210625-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210625 Allegato al piano test SIES v 12 4 11 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210625-Allegato_al_piano_test_SIES_v.12.4.11.0

> **File originale:** `RILASCIO_12.4.11.0/SIUT-SIES-CT-1.0-20210625-Allegato_al_piano_test_SIES_v.12.4.11.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210625-Allegato-al-piano-test_SIES_v.12.4.11.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210625-Piano_dei_Test_SIES_v.12.4.11.0.docx |
|  | Versione | 1.0 |
|  | Data | 44372.0 |
|  | Intervento | SIES v.12.4.11.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.11.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210625-Allegato-al-piano-test_SIES_v.12.4.11.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20210514015.0 |  |  | 20210514015.0 | Ricerca procedimento Sige per titolo esecutivo |  | SIGE | SIGE - Ricerca procedimento Sige per titolo esecutivo | TF001.SIGE | Verifica funzione Ricerca Procedimento SIGE per Titolo Esecutivo |  |  |  | Verifica: verificare che la Funzione Ricerca Procedimento SIGE per Titolo Esecutivo non vada in errore. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210514016.0 |  |  | 20210514016.0 | Fogli complementari Sige - visibilità oggetti |  | SIGE | SIGE - Fogli complementari Sige - visibilità oggetti | TF002.SIGE | Verifica visibilità oggetti su elenco fogli complementari |  |  |  | Verifica: verificare che l'elenco dei fogli complementari abbia visualizzato la descrizione degli oggetti. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210514018.0 |  |  | 20210514018.0 | Iscrizione soggetto sige |  | SIGE | SIGE - Iscrizione soggetto sige | TF003.SIGE | Verifica corretta visualizzazione campi Cognome e Nome Madre |  |  |  | Verifica: verificare che vengano visualizzati correttamente i campi cognome e nome madre nella form iscrizione soggetto. | 1.0 |  |  |  |  |
| SIUT | SIES | 202105200113.0 |  |  | 202105200113.0 | SIUS - Presa in carico altre BDI - Funzione Stato Esecuzione |  | SIUS | SIUS - SIUS - Presa in carico altre BDI - Funzione Stato Esecuzione | TF004.SIUS | Verifica visualizzazione provvedimento di cumulo da uffici della sorveglianza |  |  |  | Verifica: verificare che anche dagli uffici della Sorveglianza sia possibile visualizzare il dettaglio del provvedimento di cumulo. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210521012.0 |  |  | 20210521012.0 | Variazione data trasmissione provvedimento |  | SIEP | SIEP - Variazione data trasmissione provvedimento | TF005.SIEP | Verifica avvenuta variazione data emissione e trasmissione di un provvedimento |  |  |  | Verifica: verificare che la variazione della data di emissione e trasmissione di un provvedimento di Liberazione Anticipata venga recepita correttamente dal sistema. | 1.0 |  |  |  |  |
| SIUT | SIES | 202105240111.0 |  |  | 202105240111.0 | SIUS - Presa in carico altre BDI - Impossibile inserire Record Sospensione |  | SIUS | SIUS - SIUS - Presa in carico altre BDI - Impossibile inserire Record Sospensione | TF006.SIUS | Verifica presa in carico altra BDI di procedimento con sospensione pena |  |  |  | Verifica: verificare che nella presa in carico da altra BDI di un procedimento non vengano segnalati errori relativi alle sospensioni. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210526011.0 |  |  | 20210526011.0 | Anomalia SIES - Foglio Complementare |  | SIEP | SIEP - Anomalia SIES - Foglio Complementare | TF007.SIEP | Verifica stampa foglio complementare. |  |  |  | Verifica: verificare che la stampa del foglio complementare riporti le date di inizio e fine espiazione pena | 1.0 |  |  |  |  |
| SIUT | SIES | 20210531014.0 |  |  | 20210531014.0 | Erroe Statistiche SIEP |  | SIEP | SIEP - Erroe Statistiche SIEP | TF008.SIEP | Verifica elaborazione statistica per Classe IV |  |  |  | Verifica: verificare che il sistema produca correttamente l'elaborazione della statistica per procedimenti pendenti di classe IV | 1.0 |  |  |  |  |
| SIUT | SIES | 202106080116.0 |  |  | 202106080116.0 | Motivazione revoca sospensione condizionale |  | SIUS | SIUS - Motivazione revoca sospensione condizionale | TF009.SIUS | Verifica correzione frase su proposta prospetto cumulo |  |  |  | Verifica: verificare che la stampa Prospetto cumulo (proposta) riporti la correzione della parola "ordinata" riferita alla revoca | 1.0 |  |  |  |  |
| SIUT | SIES | 20210610017.0 |  |  | 20210610017.0 | CORREZIONE TEMPLATE - SIGE_OR_CONFLCOMPETENZA.rtf |  | SIGE | SIGE - CORREZIONE TEMPLATE - SIGE_OR_CONFLCOMPETENZA.rtf | TF010.SIGE | Verifica corretta emissione dell'ORDINANZA DI CONFLITTO DI COMPETENZA |  |  |  | Verifica: verificare che l'ORDINANZA DI CONFLITTO DI COMPETENZA riporti correttamente i componenti del collegio. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210615018.0 |  |  | 20210615018.0 | Provvedimento di Cumulo - presa in carico atti pervenuti |  | SIEP | SIEP - Provvedimento di Cumulo - presa in carico atti pervenuti | TF011.SIEP | Verifica presa in carico di atti pervenuta da altra base dati fuori distretto |  |  |  | Verificare che nella presa in carico di atti pervenuti da altra base dati fuori distretto la pagina non vada in errore. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210618011.0 |  |  | 20210618011.0 | Richiesta evolutiva SIUS (Riclassificato in MAC) |  | SIUS | SIUS - Richiesta evolutiva SIUS (Riclassificato in MAC) | TF012.SIUS | Verificare che nella ricerca udienza la colonna giudice relatore contenga le informazioni corrette |  |  |  | Verificare che nell'elenco delle udienze siano viasualizzati per ogni collegio i giudici relatori effettivi. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.11.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210625-Allegato-al-piano-test_SIES_v.12.4.11.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIGE | 01 | Verifica funzione Ricerca Procedimento SIGE per Titolo Esecutivo |  | Verifica: verificare che la Funzione Ricerca Procedimento SIGE per Titolo Esecutivo non vada in errore. |  | 1.0 |  |  | OK |
...
|  | 1 | Navigazione | Ricerche » Procedimento SIGE per Titolo Esecutivo |  | Visualizzazione pagina Ricerca Procedimento SIGE per Titolo Esecutivo |  |  |  |  |
|  | 2 | Azione | Selezionare:
Ricerca Sentenza/Decreto 
Solo Ufficio 
Cliccare su un tasto di Ricerca lasciando i campi di input vuoti |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la funzione non vada in errore e prospetti l'esito della ricerca. |  |  |  |  |  |  |
| TF002.SIGE | 01 | Verifica visibilità oggetti su elenco fogli complementari |  | Verifica: verificare che l'elenco dei fogli complementari abbia visualizzato la descrizione degli oggetti. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come Tribunale Ordinario | Txxxxx (Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Monitoraggio/Ricerche/Estrazione Dati » Ricerche Fogli Complementari |  | Visualizzazione pagina Statistiche Fogli Complementari |  |  |  |  |
|  | 2 | Azione | Selezionare la voce Tutti e cliccare su Ricerca |  | Visualizzazione pagina Elenco Fogli Complementari |  |  |  |  |
|  | V | Verifica | Verificare che nella colonna Provvedimento sia presente la descrizione dell'oggetto. |  |  |  |  |  |  |
|  | 3 | Azione | Effettuare la Stampa |  | Generadione documento di stampa |  |  |  |  |
|  | V | Verifica | Verificare che la stampa SIGE_ST_ELENCOSTATSFOGLICOMPL.rtf abbia la colonna Provvedimento valorizzata con la descrizione dell'oggetto. |  |  |  |  |  |  |
| TF003.SIGE | 01 | Verifica corretta visualizzazione campi Cognome e Nome Madre |  | Verifica: verificare che vengano visualizzati correttamente i campi cognome e nome madre nella form iscrizione soggetto. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIGE come Tribunale Ordinario | Txxxxx (Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Iscrizione manuale » Iscrizione Soggetto |  | Visualizzazione pagina  Inserimento Soggetto |  |  |  |  |
|  | 2 | Azione | Compilare i campi obbligatori e valorizzare anche Cognome Madre e Nome Madre.
Cliccare su Conferma |  | Visualizzazione pagina Dettaglio Soggetto |  |  |  |  |
|  | V | Verifica | Verificare che  i campi Cognome Madre e Nome Madre vengano riportati correttamente su due righe distinte. |  |  |  |  |  |  |
| TF004.SIUS | 01 | Verifica visualizzazione provvedimento di cumulo da uffici della sorveglianza |  | Verifica: verificare che anche dagli uffici della Sorveglianza sia possibile visualizzare il dettaglio del provvedimento di cumulo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento con istruttoria cumulo chiusa tramite la selezione dell'icona posta in alto ed avente il simbolo "IC". |  | Visualizzazione pagina Ricerca Istruttoria Cumulo |  |  |  |  |
|  | 2 | Azione | Selezionare un intervallo di istruttorie con Stato "chiusa" . Cliccare su Ricerca. |  | Visualizzazione pagina Elenco Istruttorie |  |  |  |  |
|  | 3 | Azione | Dai risultati della ricerca prendere nota del numero di fascicolo dalla colonna "Anno/Numero SIEP Cumulante". |  |  |  |  |  |  |
...
|  | 6 | Navigazione | Ricerche e Visualizzazioni » Ricerca Titolo Esecutivo per Numero SIEP |  | Visualizzazione pagina Ricerca Titolo Esecutivo |  |  |  |  |
|  | 7 | Azione | Indicare gli estremi del fascicolo individuato nello step 3 e cliccare su Ricerca. |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 8 | Azione | Selezionare dalla combo in alto la voce "Elenco provvedimenti del PM" e confermare con l'icona accanto. |  | Visualizzazione pagina  Elenco Provvedimenti PM |  |  |  |  |
|  | 9 | Azione | Dall'elenco selezionare l'icona di dettaglio del provvedimento di "Unificazione". |  |  |  |  |  |  |
|  | V | Verifica | Deve potersi visualizzare la pagina  di Dettaglio del provvedimento. |  |  |  |  |  |  |
| TF005.SIEP | 01 | Verifica avvenuta variazione data emissione e trasmissione di un provvedimento |  | Verifica: verificare che la variazione della data di emissione e trasmissione di un provvedimento di Liberazione Anticipata venga recepita correttamente dal sistema. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un fascicolo Validato con Posizione Giuridica espiazione pena in regime carcerario. |  |  |  |  |  |  |
|  | 2 | Navigazione | Decisioni Sorveglianza >> Liberazione Anticipata |  | Visualizzazione pagina Emissione Ordinanza di Liberazione Anticipata |  |  |  |  |
|  | 3 | Azione | Compilare i campi obbligatori e cliccare su Conferma |  | Visualizzazione pagina Dettaglio Liberazione Anticipata |  |  |  |  |
|  | 4 | Azione | Cliccare sulla lentina vicino alla voce Comunicazione |  | Visualizzazione pagina Comunicazione Concessione Liberazione Anticipata |  |  |  |  |
|  | 5 | Azione | Cambiare la data di Emissione e Trasmissione e Confermare |  | Visualizzazione pagina Dettaglio Comunicazione Concessione Liberazione Anticipata |  |  |  |  |
|  | 6 | Azione | Procedere alla stampa ma non alla validazione. |  |  |  |  |  |  |
|  | 7 | Azione | Selezionare Elenco provvedimenti del PM. |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | 8 | Azione | Selezionare l'icona "Modifica PM e Valida" relativa al provvedimento non validato appena inserito. |  | Visualizzazione pagina Modifica Magistrato Firmatario |  |  |  |  |
|  | V | Verifica | Verificare che la Data di Emissione e Trasmissione siano quelle modificate nello step 5 |  |  |  |  |  |  |
|  | 9 | Azione | Cambiare la data di Emissione e Trasmissione e Confermare |  | Viene visualizzato un messaggio che riporta le Date modificate e la richiesta di conferma |  |  |  |  |
|  | 10 | Azione | Cliccare sul pulsante OK del messaggio |  | Visualizzazione messaggio Aggiornamento Documento Avvenuto Correttamente! |  |  |  |  |
|  | 11 | Azione | Cliccare su OK |  | Visualizzazione pagina Elenco Provvedimenti PM |  |  |  |  |
|  | 12 | Azione | Selezionare l'icona "Dettagli" relativa al provvedimento ora validato appena inserito. |  | Visualizzazione pagina Dettaglio Comunicazione Concessione Liberazione Anticipata |  |  |  |  |
|  | V | Verifica | Verificare che la Data di Emissione e Trasmissione siano quelle modificate nello step 8 |  |  |  |  |  |  |
| TF006.SIUS | 01 | Verifica presa in carico altra BDI di procedimento con sospensione pena |  | Verifica: verificare che nella presa in carico da altra BDI di un procedimento non vengano segnalati errori relativi alle sospensioni. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Selezionare un fascicolo con soggetto in Affidamento in prova. |  |  |  |  |  |  |
|  | 2 | Navigazione | Decisioni della Sorveglianza >> Affidamento in Prova >> Revoca |  | Visualizzazione pagina  Revoca Affidamento in Prova |  |  |  |  |
|  | 3 | Azione | Compilare gli estremi dell'ordinanza di revoca. 
Non valorizzare il campo "Misura Alternativa Revocata dal".
Valorizzare il campo "Pena residua rideterminata" e selezionare "Esecuzione contro soggetto non detenuto".
Confermare. |  | Visualizzazione pagina Revoca Affidamento in Prova |  |  |  |  |
|  | 4 | Azione | Inserire i dati dei destinatari. Confermare. |  | Visualizzazione pagina Dettaglio Revoca Affidamento in Prova |  |  |  |  |
|  | 5 | Azione | L'utente effettua l'accesso al sistema SIUS come Tribunale di Sorveglianza di un altro distretto | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | 6 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 7 | Navigazione | Ricerche Altre BDI » Ricerca Fascicolo SIEP altre BDI |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 8 | Azione | Ricercare il fascicolo dello step 1 |  | Visualizzazione pagina Dettaglio Ricerca altre BDI |  |  |  |  |
|  | 9 | Azione | Procedere alla presa in carico. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema non segnali errori relativi alle sospensioni. |  |  |  |  |  |  |
| TF007.SIEP | 01 | Verifica stampa foglio complementare. |  | Verifica: verificare che la stampa del foglio complementare riporti le date di inizio e fine espiazione pena |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento con posizione giuridica Arresti Domiciliari ex art.656 comma 10 cpp |  |  |  |  |  |  |
|  | 2 | Navigazione | Definizione Procedimento >> Fine Espiazione |  | Visualizzazione pagina  Definizione Procedimento - Pena Espiata |  |  |  |  |
|  | 3 | Azione | Inserire Data Definizione e come Oggetto: "Archiviazione per pena espiata in regime di arresti Domiciliari ex art.656 comma 10 cpp".
Cliccare su Conferma. |  | Visualizzazione pagina  Dettaglio Definizione Procedimento - Pena Espiata |  |  |  |  |
|  | 4 | Azione | Cliccare sull'icona di Stampa |  | Generazione stampa Siep_arc_foglio_comp_esp |  |  |  |  |
|  | V | Verifica | Verificare che la stampa del foglio complementare riporti le date di inizio e fine espiazione pena |  |  |  |  |  |  |
| TF008.SIEP | 01 | Verifica elaborazione statistica per Classe IV |  | Verifica: verificare che il sistema produca correttamente l'elaborazione della statistica per procedimenti pendenti di classe IV |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. Devono essere presenti per uno stesso ufficio più di 400 fascicoli pendenti di classe IV. |  |  |  |  |  |  |
|  | 1 | Navigazione | Statistiche/Monitoraggio » Statistiche - Estrazione Dati |  | Visualizzazione pagina  STATISTICHE - ESTRAZIONE DATI |  |  |  |  |
|  | 2 | Azione | Selezionare:
- Classe IV
- Procedimenti Pendenti nel Periodo
Cliccare su Conferma |  | Visualizzazione pagina RICERCA PROCEDIMENTI CLASSE IV |  |  |  |  |
|  | 3 | Azione | Indicare il periodo e cliccare su Conferma |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema produca correttamente l'elaborazione della statistica. |  |  |  |  |  |  |
| TF009.SIUS | 01 | Verifica correzione frase su proposta prospetto cumulo |  | Verifica: verificare che la stampa Prospetto cumulo (proposta) riporti la correzione della parola "ordinata" riferita alla revoca |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerca Istruttorie Cumulo |  | Visualizzazione pagina Ricerca Istruttoria Cumulo |  |  |  |  |
|  | 2 | Azione | Ricercare una istruttoria di cumulo nello stato "Aperta" avente almento due Titoli coinvolti |  |  |  |  |  |  |
|  | 3 | Azione | Dall'elenco cliccare su link Anno e numero istruttoria della colonna N° Istruttoria |  | Visualizzazione pagina   Gestione Cumulo |  |  |  |  |
|  | 4 | Azione | Selezionare Titoli coinvolti |  | Visualizazzione pagina Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 5 | Azione | Per il Titolo cumulante o uno dei Titoli in elenco, selezionare l’icona ‘Dettaglio Dati Analitici’ |  | Visualizzazione pagina Gestione Dati Analitici |  |  |  |  |
|  | 6 | Azione | Selezionare ‘Dati Analitici’ e successivamente ‘Benefici (disposti in sentenza)’ |  | Visualizzazione pagina Elenco Benefici |  |  |  |  |
|  | 7 | Azione | - Se  è gia presente una sospensione della pena, cliccare su Anno e Numero Istruttoria.
'- Se non è presente un tale beneficio, selezionare il tasto ‘Inserisci Pena Sospesa – Non Menzione’ e nella successiva form procedere con l’inserimento della sola sospensione, non impostare ‘Non Menzione’. Cliccare su Conferma. Dalla successiva form di Dettaglio Beneficio, cliccare su Anno e Numero dell’Istruttoria. |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 8 | Azione | Selezionare Richieste del PM e poi Richieste al Giudice dell’Esecuzione |  | Visualizzazione pagina Richieste del PM |  |  |  |  |
|  | 9 | Azione | Selezionare Richieste al Giudice dell’Esecuzione |  | Visualizzazione pagina  Richieste del PM al GE |  |  |  |  |
|  | 10 | Azione | Selezionare ‘Richiesta Revoca Benefici’. |  | Visualizzazione pagina Richieste al G.E. Revoca Benefici |  |  |  |  |
|  | 11 | Azione | Selezionare il Titolo e cliccare su Conferma |  | Visualizzazione pagina Inserimento Richiesta Revoca Beneficio |  |  |  |  |
|  | 12 | Azione | Procedere con la Revoca del Beneficio selezionando il check box ‘Anticipazione degli effetti’ e cliccare su Conferma. |  | Visualizzazione pagina Dettaglio Richiesta Revoca Benefici |  |  |  |  |
|  | 13 | Azione | Cliccare sul link dell' Anno e Numero Istruttoria. |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 14 | Azione | Selezionare Prospetto cumulo (proposta) |  | Generazione documento SIEP_CUMULO_PROSPETTO_PROPOSTA |  |  |  |  |
|  | V | Verifica | Verificare nella stampa prodotta che dopo la sezione OSSERVA sia riportata la dicitura corretta: "Dispone, in via provvisoria, la revoca del beneficio, prima che sia definitivamente ordinata con provvedimento del giudice dell’esecuzione". |  |  |  |  |  |  |
| TF010.SIGE | 01 | Verifica corretta emissione dell'ORDINANZA DI CONFLITTO DI COMPETENZA |  | Verifica: verificare che l'ORDINANZA DI CONFLITTO DI COMPETENZA riporti correttamente i componenti del collegio. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Ricercare un procedimento nello stato iscritto |  |  |  |  |  |  |
|  | 2 | Navigazione | Udienze/Fissazione/Rinvio/Ruolo » Fissazione Udienza |  | Visualizzazione pagina  Inserimento Fissazione Udienza |  |  |  |  |
|  | 3 | Azione | Inserire fissazione udienza di tipo collegiale, nel caricare l'udienza inserire presidente e 2 consiglieri. Cliccare su Conferma |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 4 | Azione | Validare la Fissazione Udienza |  | Visualizzazione pagina Dettaglio Fissazione Udienza |  |  |  |  |
|  | 5 | Navigazione | Ordinanze/Deposito/Notifiche » Ordinanza Conflitto Competenza |  | Visualizzazione pagina Ordinanza Conflitto di Competenza |  |  |  |  |
|  | 6 | Azione | Inserire il procedimento dello step 1 e Confermare |  | Visualizzazione pagina Emissione Ordinanza Conflitto di Competenza |  |  |  |  |
|  | 7 | Azione | Inserire ordinanza e cliccare su Conferma |  | Visualizzazione pagina Dettaglio Ordinanza Conflitto di Competenza |  |  |  |  |
|  | 8 | Azione | Stampare |  | Generazione documento SIGE_OR_CONFLCOMPETENZA |  |  |  |  |
|  | V | Verifica | Verificare che in fondo al documento di stampa i componenti del collegio siano riportati correttamente. |  |  |  |  |  |  |
| TF011.SIEP | 01 | Verifica presa in carico di atti pervenuta da altra base dati fuori distretto |  | Verificare che nella presa in carico di atti pervenuti da altra base dati fuori distretto la pagina non vada in errore. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Ricerca Istruttorie Cumulo |  | Visualizzazione pagina Ricerca Istruttoria Cumulo |  |  |  |  |
|  | 2 | Azione | Ricercare una istruttoria di cumulo nello stato "Aperta" ed annotare anno e numero del fascicolo. |  | Visualizzazione pagina Elenco Istruttorie |  |  |  |  |
|  | 3 | Azione | Dall'elenco risultante scegliere una istruttoria e memorizzare l'anno ed il numero SIEP cumulante (terz'ultima colonna dell'elenco) |  | Visualizzazione pagina Elenco Istruttorie |  |  |  |  |
|  | 4 | Azione | Ricercare un procedimento validato |  | Visualizzazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 5 | Azione | Memorizzare l'anno ed il numero della sentenza la Data e chi l'ha emessa (contenuto terza riga della pagina visualizzata) |  | Visualizzazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 6 | Navigazione | Istruttorie/Richieste >> Trasmissione per Competenza/Seguito Atti |  | Visualizzazione pagina Trasmissione per Competenza |  |  |  |  |
|  | 7 | Azione | Cliccare su  Nel Distretto |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 8 | Azione | Indicare gli etremi del procedimento con istruttoria aperta  inizialmente ricercato nello step 3 e selezionare il tasto "Carica" |  | Visualizzazione pagina TRASMISSIONE PER COMPETENZA |  |  |  |  |
|  | 9 | Azione | Come Oggetto Atto selezionare "atti per competenza (per emissione provvedimento cumulo)". Premere Conferma. |  | Visualizzazione pagina Dettaglio Trasmissione Competenza |  |  |  |  |
|  | 10 | Azione | Stampare e validare |  | Visualizzazione pagina Dettaglio Trasmissione Competenza |  |  |  |  |
|  | 11 | Azione | Selezionare l'icona di trasmissione. |  | Visualizzazione pagina  Trasferimento Trasmissione per Competenza |  |  |  |  |
|  | 12 | Azione | Cliccare su Conferma. |  | Visualizazzione messaggioTrasmissione Provvedimento sottomessa al Sistema! |  |  |  |  |
|  | 13 | Azione | Cliccare su OK |  | Visualizzazione pagina Dettaglio Trasmissione Competenza |  |  |  |  |
|  | 14 | Azione | Ricercare il fascicolo con l'istruttoria aperta dello step 3 |  | Visualizzazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 15 | Azione | Entrare nell'istruttoria con l'apposito pulsante (Gestione Cumulo). |  | Visualizzazione pagina Gestione Cumulo |  |  |  |  |
|  | 16 | Azione | Cliccare sul link Elenco Titoli Coinvolti |  | Visualizzazione pagina   Elenco Provvedimenti Esecutivi Coinvolti |  |  |  |  |
|  | 17 | Azione | Cliccare su Iscrizione Manuale Titolo |  | Visualizzazione pagina   Inserimento Manuale Titolo Soggetto a Cumulo |  |  |  |  |
|  | 18 | Azione | Selezionare "Sentenza" nella combo Tipo Provvedimento. |  | Visualizzazione pagina  Inserimento Manuale Titolo Soggetto a Cumulo |  |  |  |  |
|  | 19 | Azione | Compilare i campi della sezione Sentenza riportando come Data Provvedimento, Anno/Numero Sentenza e Autorità e Luogo Emittente gli stessi valori della sentenza del fascicolo trasmesso e confermare. |  | Visualizazzione pagina Dettaglio Titolo Cumulato |  |  |  |  |
|  | 20 | Azione | Tornare sul dettaglio dell'istruttoria e selezionate Atti ricevuti per competenza |  | Visualizzazione pagina Lista Atti Ricevuti per Competenza |  |  |  |  |
|  | 21 | Azione | Selezionare l'icona di dettaglio |  | Visualizzazione pagina  Dettaglio Trasmissione Competenza Ricevuta |  |  |  |  |
|  | 22 | Azione | Cliccare su Presa In Carico. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che la pagina non vada in errore. |  |  |  |  |  |  |
| TF012.SIUS | 01 | Verificare che nella ricerca udienza la colonna giudice relatore contenga le informazioni corrette |  | Verificare che nell'elenco delle udienze siano viasualizzati per ogni collegio i giudici relatori effettivi. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Navigazione | Funzioni Amministrative » Gestione Udienza » Ricerca Udienza |  | Visualizzazione pagina  Ricerca Udienza |  |  |  |  |
|  | 2 | Azione | Ricercare un intervallo di udienze. Cliccare su Conferma |  | Visualizzazione pagina  Elenco Udienze |  |  |  |  |
|  | V | Verifica | Verificare che l'elenco delle udienze contenga nella colonna Giudice Relatore le informazioni congruenti con quanto riportato nel dettaglio dell'udienza |  |  |  |  |  |  |
|  | 3 | Azione | Cliccare sull'icona di stampa della videata |  | Generazione stampa videata |  |  |  |  |
|  | V | Verifica | Verificare che la stampa della videata contenga nella colonna Giudice Relatore le informazioni congruenti con quanto riportato nel dettaglio dell'udienza. |  |  |  |  |  |  |
