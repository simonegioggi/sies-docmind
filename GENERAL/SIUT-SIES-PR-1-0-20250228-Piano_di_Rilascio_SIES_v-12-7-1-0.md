---
uniqueName: siut-sies-pr-1-0-20250228-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20250228 Piano di Rilascio SIES v 12 7 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20250228-Piano_di_Rilascio_SIES_v.12.7.1.0

> **File originale:** `RILASCIO_12.7.1.0/SIUT-SIES-PR-1.0-20250228-Piano_di_Rilascio_SIES_v.12.7.1.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 28/02/2025 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.7.1.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.7.1.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.7.1.0 2025-02-28 | 12.7.1.0 | 28/02/2025 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 202501220131 | CISIA di Firenze | L’ufficio segnala delle differenze tra gli Uffici presenti nell'Elenco in fase di Ricerca Utente tra gli ambienti di Esercizio e Pre-Esercizio. Le differenze sono che nell'Esercizio risulta mancante "Ufficio di Sorveglianza presso il Tribunale dei Minorenni" ed è presente "Magistrato di Sorveglianza per i minorenni" | Per la risoluzione della problematica è stato corretto il caricamento della combo “Ufficio” | Il problema era legato al fatto che in particolari casi veniva manipolato il valore del campo UDSM.
Classi modificate:
siesWeb/src/siap/sico/evento/action/ActLoadTrasferisciDocumento.java
siesWeb/src/siap/siep/jms/action/ActLoadListaProvvedimentiTrasmessi.java
siesWeb/src/siap/siep/nuovaistanza/action/ActLoadTrasferisciNuovaIstanza.java
siesWeb/src/siap/siep/ordineesecuzione/action/ActLoadTrasferisciProvvedimentoL78del2013.java
siesWeb/src/siap/siep/richiesta/action/ActLoadTrasferisciRichiestaGenerica.java |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20250228-Piano_di_Rilascio_SIES_v.12.7.1.0.docx
SIUT-SIES-PT-1.0-20250228-Piano_dei_Test_SIES_v.12.7.1.0.docx
SIUT-SIES-CT-1.0-20250228-Allegato_al_piano_test_SIES_v.12.7.1.0.xlsx |
...
# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.7.0.0.
...
Creare sul server DB una cartella V_12_7_1_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_7_1_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_7_1_0 tramite il comando:
chmod 777 V_12_7_1_0
...
Nella cartella appena creata (V_12_7_1_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_7_1_0/log/ in cui si può constatare l’esito dell’esecuzione.
