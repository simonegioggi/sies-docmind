---
uniqueName: siut-sic-ct-1-0-20210924-allegatoalpianotestsippiv
displayName: "SIUT SIC CT 1 0 20210924 Allegato al piano test SIPPI v 9 8 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIC-CT-1.0-20210924-Allegato_al_piano_test_SIPPI_v.9.8.1.0

> **File originale:** `RILASCIO_9.8.1.0_SIPPI/ORIGINALI/SIUT-SIC-CT-1.0-20210924-Allegato_al_piano_test_SIPPI_v.9.8.1.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIC-PT-1.0-20210924-Piano_dei_Test_SIPPI_v.9.8.1.0 |
|  | Piano di test | SIUT-SIC-PT-1.0-20210924-Piano_dei_Test_SIPPI_v.9.8.1.0.docx |
|  | Versione | 1.0 |
|  | Data | 44463.0 |
|  | Intervento | SIPPI v. 9.8.1.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIPPI v. 9.8.1.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIC-PT-1.0-20210924-Piano_dei_Test_SIPPI_v.9.8.1.0 | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIC_SIPPI | 20210820011.0 |  |  | 20210820011.0 | Impossibilità registrazione scheda del casellario |  | SITMP | SITMP - Impossibilità registrazione scheda del casellario | TF001.SITMP | Verifica che in fase di 'Invio Scheda' da SitMP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. |  |  |  | Verifica che in fase di 'Invio Scheda' da SitMP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. | 1.0 |  |  |  |  |
| SIUT | SIC_SIPPI | 20210820011.0 |  |  | 20210820011.0 | Impossibilità registrazione scheda del casellario |  | SIES | SIES - Impossibilità registrazione scheda del casellario | TF002.SIES | Verifica che in fase di 'Richiesta Certificato' da SIEP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. |  |  |  | Verifica che in fase di 'Richiesta Certificato' da SIEP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIPPI v. 9.8.1.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIC-PT-1.0-20210924-Piano_dei_Test_SIPPI_v.9.8.1.0 |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SITMP | 01 | Verifica che in fase di 'Invio Scheda' da SitMP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. |  | Verifica che in fase di 'Invio Scheda' da SitMP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIT-MP  effettuando il login con la propria utenza (Cancelliere di Tribunale), è presente un procedimento in stato "GIUDIZIO DEFINITIVO" con misure di prevenzione  personali definitive per un soggetto nato all'estero (p.es. Marocco) |  |  |  |  |  |  |
|  | P | Stato Base | L'utente è autenticato e abilitato all'utilizzo della funzione |  |  |  |  |  |  |
|  | 1 | Navigazione | Login>>Ricerca procedimento di prevenzione con le caratteristiche indicate nelle pre-condizioni |  |  |  |  |  |  |
|  | 2 | Azione | L'utente seleziona il Procedimento di prevenzione e preme il bottone [Dettaglio] |  | Il sistema SIT-MP apre la copertina del procedimento selezionato |  |  |  |  |
|  | 3 | Azione | L'utente dal menù di spalla sinistra "Atti-Nuovo" seleziona Atto Esecutivo-Redazione Scheda e preme il bottone [Conferma] |  | Il sistema SIT-MP apre la pagina in cui selezionare il soggetto per cui redigere la Nuova schda Casellario |  |  |  |  |
|  | 4 | Azione | L'utente seleziona il soggetto straniero e preme il bottone [Nuova Scheda] |  | Il sistema SIT-MP apre la pagina per redigere la scheda |  |  |  |  |
|  | 5 | Azione | L'utente compila i dati della scheda casellario e preme il bottone [Salva] |  | Il sistema SIT-MP provvede al salvataggio dei dati immessi |  |  |  |  |
|  | 6 | Azione | L'utente preme il bottone [Invia] |  | Il sistema SIT-MP provvede all'invio dei dati ed il sistema Casellario |  |  |  |  |
|  | V | Verifica | Verificare che  non venga restituito più l'errore di "CODICE LUOGO NASCITA VUOTO" |  |  |  |  |  |  |
| TF002.SIES | 01 | Verifica che in fase di 'Richiesta Certificato' da SIEP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. |  | Verifica che in fase di 'Richiesta Certificato' da SIEP verso Casellario, per uno Straniero senza Luogo di Nascita e con Codice Fiscale valorizzato, il sistema SIC_SIPPI risponda con esito positivo. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 1 | Navigazione | Istruttorie/Richieste |  | Visualizzazione pagina  Istruttorie/Richieste |  |  |  |  |
|  | 2 | Azione | Cliccare su Richiesta Certificato Penale |  | Visualizzazione pagina  Ricerca Procedimento |  |  |  |  |
|  | 3 | Azione | Riocercare un procedimento con un soggetto straniero in possesso di codice fiscale. Confermare. |  | Visualizzazione pagina  Richiesta Certificato Penale |  |  |  |  |
|  | 4 | Azione | Cliccare su Richiesta Certificato |  | Richiesta certificato al sistema informativo del casellario. |  |  |  |  |
|  | V | Verifica | Verificare che la richiesta del certificato sia andata a buon fine. |  |  |  |  |  |  |
|  | 5 | Azione | L'utente effettua l'accesso al sistema SIUS come Tribunale di Sorveglianza | Dxxxxx (Tribunale di Sorveglianza) |  |  |  |  |  |
|  | 6 | Azione | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 7 | Navigazione | Ricerche e Visualizzazioni » Procedimento per n° SIUS |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 8 | Azione | Ricercare un procedimento con un soggetto straniero in possesso di codice fiscale. Cliccare su Ricerca. |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 9 | Azione | Dalla combo delle funzioni selezionare Richiesta Certificato Penale |  | Visualizzazione pagina  Richiesta Certificato Penale |  |  |  |  |
|  | 10 | Azione | Cliccare su Richiesta Certificato |  | Richiesta certificato al sistema informativo del casellario. |  |  |  |  |
|  | V | Verifica | Verificare che la richiesta del certificato sia andata a buon fine. |  |  |  |  |  |  |
