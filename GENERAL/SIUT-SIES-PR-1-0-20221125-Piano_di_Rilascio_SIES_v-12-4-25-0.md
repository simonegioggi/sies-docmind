---
uniqueName: siut-sies-pr-1-0-20221125-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20221125 Piano di Rilascio SIES v 12 4 25 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20221125-Piano_di_Rilascio_SIES_v.12.4.25.0

> **File originale:** `RILASCIO_12.4.25.0/SIUT-SIES-PR-1.0-20221125-Piano_di_Rilascio_SIES_v.12.4.25.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 25/11/2022 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.4.25.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.4.25.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.4.25.0 2022-11-25 | 12.4.25.0 | 25/11/2022 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 20221102013 | Centro di Competenza | L’ufficio segnala che il sistema non elimina il record dopo l’annotazione sul procedimento dell’avvenuto assorbimento in cumulo. | Per la risoluzione della problematica si è intervenuti sul codice, risolvendo l'errore, sostituendo, per il codice tipo messaggio, il valore “01” (richiesta) con “02” (esito). | Il problema era legato al fatto che il sistema non riconosceva la Comunicazione di Emissione Cumulo e non la marcava correttamente.
Classe modificata:
siap.siep.presaincarico.action.ActLoadInsAnnotaEsitoTrasmComp.java |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20221125-Piano_di_Rilascio_SIES_v.12.4.25.0.docx
SIUT-SIES-PT-1.0-20221125-Piano_dei_Test_SIES_v.12.4.25.0.docx
SIUT-SIES-CT-1.0-20221125-Allegato_al_piano_test_SIES_v.12.4.25.0.xls |
...
Creare sul server DB una cartella V_12_4_25_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_4_25_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_4_25_0 tramite il comando:
chmod 777 V_12_4_25_0
...
Nella cartella appena creata (V_12_4_25_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_4_25_0/log/ in cui si può constatare l’esito dell’esecuzione.
