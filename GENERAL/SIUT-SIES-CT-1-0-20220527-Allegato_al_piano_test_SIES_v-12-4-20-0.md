---
uniqueName: siut-sies-ct-1-0-20220527-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20220527 Allegato al piano test SIES v 12 4 20 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20220527-Allegato_al_piano_test_SIES_v.12.4.20.0

> **File originale:** `RILASCIO_12.4.20.0/SIUT-SIES-CT-1.0-20220527-Allegato_al_piano_test_SIES_v.12.4.20.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20220527-Allegato_al_piano_test_SIES_v.12.4.20.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20220527-Piano_dei_Test_SIES_v.12.4.20.0.docx |
|  | Versione | 1.0 |
|  | Data | 44708.0 |
|  | Intervento | SIES v.12.4.20.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.20.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20220527-Allegato_al_piano_test_SIES_v.12.4.20.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202204010111.0 |  |  | 202204010111.0 | Gup 2022/146 Trib. di Foggia |  | SIGE | SIGE - Gup 2022/146 Trib. di Foggia | TF001.SIGE | Errore nell'inserimento di una sentenza |  |  |  | Verifica: verificare che, nel caso di presenza di più di un titolo esecutivo con gli stessi dati nel database, il sistema consenta di inserire di un nuovo titolo con stessi dati | 1.0 |  |  |  |  |
| SIUT | SIES | 20220415019.0 |  |  | 20220415019.0 | cancellazione/pagina errore |  | SIUS | SIUS - cancellazione/pagina errore | TF001.SIUS | Errore nella cancellazione dell'ordinanza |  |  |  | Verifica: verificare che il sistema consenta di cancellare un'ordinanza di revoca delle misure alternative se inserita anche la data di decorrenza revoca | 1.0 |  |  |  |  |
| SIUT | SIES | 202205020111.0 |  |  | 202205020111.0 | Ordini di Esecuzione/Scarcerazione --> Sospensione Esecuzione ex art. 656 c.p.p. --> Ordine di Esecuzione |  | SIEP | SIEP - Ordini di Esecuzione/Scarcerazione --> Sospensione Esecuzione ex art. 656 c.p.p. --> Ordine di Esecuzione | TF001.SIEP | Errore nell'associazione del template di stampa relativamente ad una precisa posizione giuridica |  |  |  | Verifica: verificare che il sistema, per le posizioni giuridiche "Espiazione pena per Altra Causa in Misura Sicurezza Detentiva (Internato) (cod. 75)" e
"Espiazione pena per Altra Causa in Regime di Detenzione (cod. 74)", associ il documento di stampa "SIEP_LS_DACNI" | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.20.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20220527-Allegato_al_piano_test_SIES_v.12.4.20.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIGE | SIGE | Errore nell'inserimento di una sentenza |  | Verifica: verificare che, nel caso di presenza di più di un titolo esecutivo con gli stessi dati nel database, il sistema consenta di inserire di un nuovo titolo con stessi dati |  | 1.0 |  |  | OK |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare un fascicolo SIGE già esistente oppure iscriverne uno nuovo | Visualizzazione Pagina "Dettaglio Procedimento SIGE" |  |  |  |  |
|  | 1.0 | Navigazione | Dal menù orizzontale a tendina selezionare la voce "Iscrizione Sentenze / Decreto" |  | Visualizzazione pagina "Inserimento Sentenza, Decreto Penale, Sentenza Straniera Delibata" |  |  |  |  |
|  | 2.0 | Azione | Nella sezione "Dati Sentenza" inserire nei campi "Anno/Numero Sentenza", "Autorità Emittente" e "Luogo Emittente" uguali a quelli di almeno altre due sentenze già presenti in banca dati ed inserite dallo stesso ufficio e premere il tasto "Conferma" | Per esempio: almeno due sentenze 2022/1 del Gup Presso Tribunale Ordinario di Torino inserite dall'ufficio Tribunale Ordinario di Torino | Visualizzazione pagina "Elenco Titoli Esecutivi" |  |  |  |  |
|  | V | Verifica | Verificare che il sistema prospetti la pagina di "Elenco Titoli Esecutivi" e non una pagina di errore |  |  |  |  |  |  |
| TF001.SIUS | SIUS | Errore nella cancellazione dell'ordinanza |  | Verifica: verificare che il sistema consenta di cancellare un'ordinanza di revoca delle misure alternative se inserita anche la data di decorrenza revoca |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti con contenuto "Revoca Misure Alternative per Violazione Prescrizioni su Proposta del Magistrato" ed oggetto "Revoca Affidamento in prova art. 47 quater o.p." |  |  |  |  |  |
...
|  | 3.0 | Azione | Inserire l'esito "Accoglie Proposta e Revoca", valorizzare il campo "Data decorrenza Revoca" e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Ordinanza" |  |  |  |  |
|  | 4.0 | Azione | Premere il tasto "Cancella" e confermare l'operazione di eliminazione dell'ordinanza |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema elimini correttamente l'ordinanza |  |  |  |  |  |  |
| TF001.SIEP | SIEP | Errore nell'associazione del template di stampa relativamente ad una precisa posizione giuridica |  | Verifica: verificare che il sistema, per le posizioni giuridiche "Espiazione pena per Altra Causa in Misura Sicurezza Detentiva (Internato) (cod. 75)" e
"Espiazione pena per Altra Causa in Regime di Detenzione (cod. 74)", associ il documento di stampa "SIEP_LS_DACNI" |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Assicurarsi che, per l'uffico collegato, siano presenti od inserire procedimenti di Classe I validati indicando, per il soggetto, come posizione giuridica: "Libero + Detenuto per altra causa + Definitivo - in Istituto di Detenzione" e come "Tipo Misura": "Espiazione pena per Altra Causa in Misura Sicurezza Detentiva (Internato)" oppure "Espiazione per altra causa in regime di detenzione" |  |  |  |  |  |
|  | 1.0 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  | Visualizzazione pagina "Ordine di Esecuzione con sospensione (LEGGE 165/98) - DETENUTO PER ALTRA CAUSA" |  |  |  |  |
|  | 2.0 | Azione | Riempire i campi obbligatori e premere il tasto "Conferma" |  | Visualizzazione pagina "Dettaglio Legge 165/98 Detenuto Altra Causa" |  |  |  |  |
|  | 3.0 | Azione | Premere il tasto "Generazione Stampa" |  | Produzione template "SIEP_LS_DACNI" |  |  |  |  |
|  | V | Verifica | Verificare che non venga inserito il provvedimento indeterminato e venga prodotto il template "SIEP_LS_DACNI" |  |  |  |  |  |  |
