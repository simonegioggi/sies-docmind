---
uniqueName: siut-sies-ct-1-0-20240927-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20240927 Allegato al piano test SIES v 12 6 4 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20240927-Allegato_al_piano_test_SIES_v.12.6.4.0

> **File originale:** `RILASCIO_12.6.4.0/SIUT-SIES-CT-1.0-20240927-Allegato_al_piano_test_SIES_v.12.6.4.0.xlsx`  
> **Tipo:** XLSX
...
| Codice Area |  |  | SIES v.12.6.4.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20240927-Allegato_al_piano_test_SIES_v.12.6.4.0.xlsx | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202409020116 |  |  | 202409020116 | STATISTICA SIUS - SORVEGLIANZA DI CAMPOBASSO |  | SIUS | SIUS - STATISTICA SIUS - SORVEGLIANZA DI CAMPOBASSO | TF001.SIUS | Errore nella decodifica esito tenore |  |  |  | Verifica: Verificare che dopo l'elaborazione della statistica l'esito del tenore sia codificato correttamente | 1.0 |  |  |  |  |
| SIUT | SIES | 202409100121 |  |  | 202409100121 | siep Procura Generale di Napoli |  | SIEP | SIEP - siep Procura Generale di Napoli | TF001.SIEP | Errore sulla dimensione dei campi multa ed ammenda |  |  |  | Verifica: Verificare che per i campi multa ed ammenda nella rideterminazione pena del cumulo si possano inserire valori fino a 14 interi e 2 decimali | 1.0 |  |  |  |  |
| SIUT | SIES | 202409180152 |  |  | 202409180152 | SIEP - Nuova dicitura |  | SIEP | SIEP - SIEP - Nuova dicitura | TF002.SIEP | Errore nella decodifica del sesso del condannato/a |  |  |  | Verifica: Verificare che nella stampa del template sia diversificata la decodifica del sesso del condannato/a | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.6.4.0 |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20240927-Allegato_al_piano_test_SIES_v.12.6.4.0.xlsx |  |  |  |  |  |  |  |  |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |  |  |  |  |  |  |  |  |
| TF001.SIUS | SIUS | Errore nella decodifica esito tenore |  | Verifica: Verificare che dopo l'elaborazione della statistica l'esito del tenore sia codificato correttamente |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
...
|  | 1 | Navigazione | Statistiche/Monitoraggio » Monitoraggio Provvedimenti » Per intervalli temporali |  | Visualizzazione pagina "STATISTICHE - NUMERO PROVVEDIMENTI PER PRINCIPALI INTERVALLI" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Caricamento" |  | Visualizzazione pagina "STATISTICHE - NUMERO PROVVEDIMENTI PER PRINCIPALI INTERVALLI" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 3 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" |  | Produzione template "SIEP_PP_OI_PAGAMENTO_UN.rtf" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | Il sistema ha prodotto la statistica richiesta in formato Excel | Documento.xls | Il risultato atteso è che nella colonna "Esito" del foglio "ElencoProc.GG.Intercorsi" vi siano valori compatibili con quanto riportato nei provvedimenti |  |  |  |  |  |  |  |  |  |  |  |  |
| TF001.SIEP | SIEP | Errore sulla dimensione dei campi multa ed ammenda |  | Verifica: Verificare che per i campi multa ed ammenda nella rideterminazione pena del cumulo si possano inserire valori fino a 14 interi e 2 decimali |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare un fascicolo con cumulo aperto | Visualizzazione pagina "Ricerca Istruttoria Cumulo" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 1 | Navigazione | Dati Finali Cumulo |  | Visualizzazione pagina "Dati Finali Cumulo" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 2 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" | Tabulatore "Dati Finali" | Visualizzazione pagina "Dati Finali Cumulo" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | 3 | Azione | L'utente riempe i campi obbligatori e preme il tasto "Conferma" | Tabulatore "Pene Rideterminate" | Visualizzazione pagina "Dati Finali Cumulo - Pene Determinate in cumulo" |  |  |  |  |  |  |  |  |  |  |  |  |
|  | V | Verifica | L'utente riempie i campi "Multa" e "Ammenda" inserendo valori fino a 14 interi e 2 decimali, e preme il tasto "Conferma" | 12345678900000 | Il risultato atteso è che il sistema consente l'ìinserimento di importi fino a 14 cifre intere e 2 decimali |  |  |  |  |  |  |  |  |  |  |  |  |
| TF002.SIEP | SIEP | Errore nella decodifica del sesso del condannato/a |  | Verifica: Verificare che nella stampa del template sia diversificata la decodifica del sesso del condannato/a |  | 1.0 |  |  | OK |  |  |  |  |  |  |  |  |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIES come "Procura della Repubblica presso il Tribunale" | Axxxxx (Procura della Repubblica presso il Tribunale) | inserire un OI per ciascun provvedimento e stampare. Verificare che . |  |  |  |  |  |  |  |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione | Ricercare o creare 4 fascicoli di pena pecuniaria con modalità di pagamento in unica soluzione e con rateizzazione, con soggetto con posizione giuridica "Libero" o "Detenuto" | 1)   Pagamento con Rata Unica e Soggetto Libero;
