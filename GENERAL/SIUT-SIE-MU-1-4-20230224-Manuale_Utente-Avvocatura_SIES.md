---
uniqueName: siut-sie-mu-1-4-20230224-manualeutente-avvocaturas
displayName: "SIUT SIE MU 1 4 20230224 Manuale Utente Avvocatura SIES"
category: "GENERAL"
tags: []
---

# SIUT-SIE-MU-1.4-20230224-Manuale_Utente-Avvocatura_SIES

> **File originale:** `SIUT-SIE-MU-1.4-20230224-Manuale_Utente-Avvocatura_SIES.pdf`  
> **Tipo:** PDF
...
14/05/2020 
Revisione 
Revisione a seguito dei ticket n° 20200513012 e n° 
20200513016: 
 
Par. 1.1: Esplicitate le modalità di accesso al 
sistema tramite PST e come quest’ultimo è 
responsabile di tracciare il CF per passarlo 
in input al sistema di Consultazione; 
 
Par. 2.1: Eliminate le diciture in cui si 
specificava che l’utente autenticato sul PST 
fosse esclusivamente un avvocato. Ciò 
perché il PST, in fase di autenticazione non 
effettua 
nessun 
controllo 
sul 
ruolo 
dell’utente. Inoltre sono state specificate le 
regole 
di 
validità 
generale 
per 
la 
consultazione sul SIUS; 
 
Par. 3.1: Rettificati i pre-requisiti di accesso 
al sistema di Consultazione eleminando le 
diciture in cui si specificava che l’utente 
autenticato sul PST fosse esclusivamente 
un avvocato. 
Il 
documento 
è 
...
nella 
sua
completezza in considerazione del fatto che il PST non 
garantisce 
che 
l’utente 
autenticato 
sia 
necessariamente un avvocato. In tal senso, quindi,
dove utilizzato il riferimento ad utente avvocato è
stata effettuata la sostituzione con utente generico. 
1.4 
24/02/2023 
Revisione 
Revisione a seguito del Ticket#20230201017 - 
Anomalia Sies: 
 
Par. 2.1 nella sezione visibilità Avvisi, 
...
5.1.1. 
PAGINA DI RICERCA PER ESTREMI DEL PROCEDIMENTO ........................................................................... 14 
5.1.2. 
DETTAGLIO PROCEDIMENTO SORVEGLIANZA ....................................................................................... 15 
5.1.2.1. 
DETTAGLIO ORDINANZA .............................................................................................................. 19 
5.1.2.2. 
DETTAGLIO DECRETO .................................................................................................................. 21 
5.1.2.3. 
DETTAGLIO DECRETO DI CITAZIONE (FISSAZIONE UDIENZA) ................................................................. 22 
5.2. RICERCA DATI SOGGETTO ............................................................................................................ 24 
5.2.1. 
PAGINA DI RICERCA SOGGETTI CON PROCEDIMENTI DI SORVEGLIANZA ....................................................... 24 
5.2.2. 
ELENCO PROCEDIMENTO SOGGETTO ................................................................................................. 26 
6. 
CONSULTAZIONE ................................................................................................................... 28 
6.1. CONSULTAZIONE AVVISI .............................................................................................................. 28 
6.1.1. 
PAGINA DI RICERCA AVVISI .............................................................................................................. 28 
6.1.2. 
RISULTATO ELENCO AVVISI .............................................................................................................. 29
...
Questo documento illustra le modalità operative per l’utilizzo del sistema Avvocatura – SIES che 
espone le funzionalità per la consultazione dei procedimenti di Sorveglianza e degli Avvisi ad essi 
inerenti. 
L’accesso al sistema di Consultazione Avvocatura SIUS avviene tramite il Portale dei Servizi Telematici 
(PST) [ex artt.6 “Portale dei servizi telematici” e 34 “Specifiche tecniche” del Decreto del Ministro delle 
Giustizia 21 Febbraio 2011 n. 44], il quale, a seguito di un sistema di autenticazione ‘forte’ basato su 
token crittografico (esempio: Smart card, chiavetta USB,...), è responsabile di tracciare il Codice Fiscale 
dell’utente che ha effettuato l’accesso e di passarlo in input all’applicazione in oggetto. 
 
In base al Codice Fiscale, che è, pertanto, dato obbligatorio da acquisire in input dal sistema di 
...
E’ bene sottolineare che ad oggi non sussiste un controllo specifico per accertare l’identità del ruolo 
dell’utente che fa accesso al sistema di Consultazione Avvocatura SIES. Il sistema lavora 
esclusivamente sul valore del Codice Fiscale, il quale è utilizzato per le ‘interrogazioni’ al SIUS. Il 
sistema SIUS restituisce i dati ricercati dall’utente solo se l’utente è registrato al suo interno quale 
avvocato attivo ed è associato come difensore ad un procedimento SIUS. 
1.2. Glossario 
1.2.1. Definizioni 
...
Esso si presenta come Applicazione Web che sarà accessibile tramite la Login posta nella home page 
del PST (Portale Servizi Telematici).  
 
 
Figura 1: Accesso tramite PST 
 
A seguito della ‘Login’ su PST, eseguita secondo le modalità esplicitate al par. 1.1, il portale mostrerà 
un pulsante di accesso all’applicazione ‘Consultazione SIUS distrettuali’. 
 
L’utilizzo di tale pulsante determina l’apertura del sistema di Consultazione Avvisi, facendo transitare 
dal sistema PST verso il sistema di Consultazione il Codice Fiscale dell’utente autenticato. 
 
Il sistema di Consultazione utilizzerà l’informazione del Codice Fiscale quale discriminante per 
l’individuazione dei procedimenti del SIUS, pertanto il Codice Fiscale è un dato obbligatorio che il 
sistema di Consultazione si aspetta in input dal sistema di autenticazione PST. 
 
Il presente documento, descrive le funzionalità inerenti la consultazione dei procedimenti della 
sorveglianza per i quali, l’utente che ha effettuato l’accesso, risulti difensore. L’utente, inoltre, avrà la 
possibilità di consultare gli Avvisi che il sistema SIUS genera in fase di validazione di un decreto di 
citazione (fissazione udienza) oppure al momento del deposito dell'ordinanza o del decreto. 
...
Ver. 1.4 del 24/02/2023 
Pag. 10/30 
Si rammenda che la consultazione del SIUS distrettuale è soggetta alle seguenti regole di validità 
generale: 
 
 L’utente richiedente deve essere abbinato al fascicolo SIUS di interesse in qualità di avvocato 
attivo ed, in relazione a tale abbinamento, sul SIUS deve essere censito correttamente il suo 
codice fiscale; 
 
 Le informazioni visibili all’utente richiedente sono relative ai seguenti atti: 
 
- 
Procedimenti SIUS in cui l’utente risulta difensore assegnatario, indipendentemente dallo 
stato del fascicolo; 
- 
Provvedimenti legati al Procedimento SIUS in cui l’utente risulta difensore assegnatario: 
1. Decreto di fissazione udienza (se validato); 
2. Decreti il cui deposito sia stato validato; 
3. Ordinanze il cui deposito sia stato validato; 
4. Ordinanze di Rinvio Udienza il cui deposito sia stato validato; 
...
- 
Validazione del Deposito di un’Ordinanza di Rinvio Udienza; 
- 
...
In ogni caso, il risultato sarà un elenco di Soggetti che soddisfano i criteri di ricerca valorizzati. 
Dall’elenco dei soggetti poi sarà possibile accedere alla lista dei procedimenti per il soggetto 
selezionato e dalla lista dei procedimenti arrivare al dettaglio del decreto oppure al dettaglio 
dell’ordinanza. 
...
 L’utente censito su PST deve aver effettuato l’operazione di ‘Login’ sul PST (Portale dei Servizi 
telematici) secondo quanto specificato al par. 1.1; 
 Il sistema di autenticazione PST, in fase di accesso al Sistema di Consultazione, deve fornire, 
come informazione da passare nella request, il codice fiscale dell’utente loggato su PST. 
Verificate tali condizioni, l’utente avrà diretto accesso alla "Home Page" del sistema 
...
Nella barra del titolo sulla destra è indicata, tramite link, l’utenza ed il codice fiscale con cui è 
avvenuto l’accesso. Cliccando sul suddetto link è possibile effettuare la Disconnessione/Logout 
dall’applicazione: 
...
In Ricerche l’utente che accede all’applicazione avrà la possibilità di consultare in tempo reale, tutti i 
procedimenti del sistema SIUS in cui lui risulta difensore assegnatario. 
Con la Consultazione l’utente avrà la possibilità di consultare gli Avvisi che il sistema SIUS genera in 
...
Dopo essere stato autenticato sul PST, l’utente accede all’applicazione di Consultazione dei 
Procedimenti ed accede al menù di Ricerche Estremi Procedimento. 
5.1.1. Pagina di ricerca per estremi del procedimento 
La maschera delle ricerche consente di individuare i procedimenti di sorveglianza associati al codice 
Fiscale dell’utente che ha effettuato l’accesso all’applicazione web. L’utente richiedente deve essere 
abbinato al fascicolo SIUS di interesse in qualità di avvocato attivo. 
 
Figura 4 – Ricerca Procedimenti di Sorveglianza 
 
I campi presenti nella maschera sono: 
a) Anno Procedimento SIUS - Anno del Procedimento che si vuole ricercare; Obbligatorio; 
Numerico di 4 cifre 
...
Questa sezione riporta i dati che caratterizzano il procedimento di sorveglianza.  Così come previsto 
delle pagine del sistema SIUS, nella maschera di dettaglio saranno visualizzati di dati relativi a: 
...
Tramite questo pulsante, dalla pagina di dettaglio dell’ordinanza si torna 
alla pagina di dettaglio del procedimento.
...
La maschera delle ricerche consente di trovare i procedimenti di sorveglianza associati ad un soggetto 
il cui difensore è l’utente che ha effettuato l’accesso all’applicazione. L’utente richiedente deve essere 
abbinato al fascicolo SIUS di interesse in qualità di avvocato attivo. 
...
e) Cognome (Inserire almeno 3 caratteri) – Inserire le iniziali del cognome del soggetto da 
ricercare, Obbligatoria solo se non presente nessun dato nell’altra sezione. E’ necessario inserire 
almeno 3 caratteri; lunghezza massima consentita 100 caratteri. 
...
Il valore riportato in corrispondenza del campo ‘N. SIUS’ è un link che permette all’utente di 
visualizzare il dettaglio del procedimento (vedi par.5.1.2). 
...
associati a Procedimenti SIUS il cui difensore è l’utente che ha effettuato l’accesso all’applicazione di 
Consultazione. L’utente richiedente deve essere abbinato al fascicolo SIUS di interesse in qualità di 
avvocato attivo. 
...
Ver. 1.4 del 24/02/2023 
Pag. 30/30 
di un decreto di citazione (vd. par.5.1.2.3), al dettaglio di un decreto (vd. par.5.1.2.2) oppure al 
dettaglio di un’ordinanza (vd. par.5.1.2.1). 
