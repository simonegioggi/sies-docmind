---
uniqueName: siut-sies-ct-1-1-20210924-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 1 20210924 Allegato al piano test SIES v 12 4 13 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.1-20210924-Allegato_al_piano_test_SIES_v.12.4.13.0

> **File originale:** `RILASCIO_12.4.13.0/SIUT-SIES-CT-1.1-20210924-Allegato_al_piano_test_SIES_v.12.4.13.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.1-20210924-Allegato-al-piano-test_SIES_v.12.4.13.0.xls |  |
|  | Piano di test | SIUT-SIES-PT-1.0-20210924-Piano_dei_Test_SIES_v.12.4.13.0.docx |  |
|  | Versione | 1.1 | Modificato il test TF005.SIGE con l'aggiunta degli step dal 4 al 10 |
|  | Data | 44463.0 |  |
...
| Codice Area |  |  | SIES v.12.4.13.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.1-20210924-Allegato-al-piano-test_SIES_v.12.4.13.0.xls | Versione | 1.1 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.1-20210924-Allegato-al-piano-test_SIES_v.12.4.13.0.xls |  |  |  |  |  |  |
...
|  | 6 | Azione | Individuare dall'elenco il collegio di interesse e verificare che l'idcollegio (escludendo le ultime 6 cifre numeriche) sia maggiore di 2147. In caso affermativo passare allo step 11 altrimenti a quello successivo. |  |  |  |  |  |  |
|  | 7 | Azione | Disabilitare i constraint tramite il comando sql:
alter table  table_name
DISABLE constraint
   constraint_name; |  |  |  |  |  |  |
|  | 8 | Azione | Aggiornare l'id della tabella COLLEGIO con il nuovo valore [newIdCollegio]  che è la concatenzaione di un numero maggiore di 2147 + il numero distretto da cui si effettua il test +  l'Anno corrente |  |  |  |  |  |  |
|  | 9 | Azione | Aggiornare gli IDcollegio con il nuovo valore  [newIdCollegio] ricavato nello step precedente delle seguenti tabelle:
UPDATE COLLEGIO_ESPERTO SET COL_ID_COLLEGIO = [newIdCollegio] WHERE COL_ID_COLLEGIO = [oldIdCollegio];
UPDATE COLLEGIO_GIUDICE_POPOLARE SET COL_ID_COLLEGIO = [newIdCollegio] WHERE COL_ID_COLLEGIO = [oldIdCollegio];
UPDATE COLLEGIO_MAGISTRATO SET COL_ID_COLLEGIO = [newIdCollegio] WHERE COL_ID_COLLEGIO = [oldIdCollegio];
UPDATE PROVVEDIMENTO_SIGE SET COL_ID_COLLEGIO = [newIdCollegio] WHERE COL_ID_COLLEGIO = [oldIdCollegio];
UPDATE UDIENZA_SIGE SET COL_ID_COLLEGIO = [newIdCollegio] WHERE COL_ID_COLLEGIO = [oldIdCollegio].
[oldIdCollegio] è il valore della tabella COLLEGIO prima della modifica effettuata nello step precedente. |  |  |  |  |  |  |
|  | 10 | Azione | Abilitare i constraint tramite il comando sql:
alter table  table_name
ENABLE constraint
   constraint_name; |  |  |  |  |  |  |
|  | 11 | Navigazione | Ordinanze/Deposito/Notifiche » Emissione Ordinanza |  | Visualizzazione pagina Emissione Ordinanza |  |  |  |  |
|  | 12 | Azione | Cliccare sul link 'Inserimento Udienza - Visualizza Collegio' |  | Visualizzazione pop-up Dettaglio Udienza Collegiale |  |  |  |  |
|  | 13 | Azione | Cliccare sull'icona di Modifica |  | Visualizzazione pop-up Modifica Udienza Collegiale |  |  |  |  |
|  | 14 | Azione | Inserire i giudici del collegio. Cliccare su Conferma. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che non venga visualizzato l'errore segnalato. A fine test rimettere il valore OLD del collegio al posto di quello NEW per ripristinare il DB allo stato pre-test. |  |  |  |  |  |  |
