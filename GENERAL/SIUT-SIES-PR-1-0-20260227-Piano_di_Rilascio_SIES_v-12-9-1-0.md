---
uniqueName: siut-sies-pr-1-0-20260227-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20260227 Piano di Rilascio SIES v 12 9 1 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20260227-Piano_di_Rilascio_SIES_v.12.9.1.0

> **File originale:** `RILASCIO_12.9.1.0/SIUT-SIES-PR-1.0-20260227-Piano_di_Rilascio_SIES_v.12.9.1.0.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 27/02/2026 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.9.1.0 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.9.1.0 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- | --- | --- |
| 202602190150 | Tribunale di Sorveglianza di Trieste | L’ufficio segnala che è stata aggiornata le versione del SIES con l'ultima (12.9.0.0), e ogni volta che richiedo un certificato penale da un numero di SIUS mi si apre la schermata come da screen allegato.
Nonostante io inserisca nel campo la giusta password, alla successiva richiesta di certificato penale mi riappare nuovamente quella schermata | Per la risoluzione della problematica è stata modificata la gestione di aggiornamento della password | Il problema era legato al fatto che la form non decodificava la password quando la ricaricava a video.
Classi modificate:
/siap/siep/istruttoria/LoadRichiestaCertificatoPenale.jsp
/siap/sius/fascicolo/LoadRichiestaCertificatoPenale.jsp |  |
| 202602190169 | Procura Generale della Repubblica presso la Corte d’Appello di Napoli | L’ufficio segnala che la richiesta istruttoria di rilascio del Certificato penale da Utente abilitato, restituisce il seguente messaggio di errore:
F3BException --> Eccezione di sistema:
UtenteController.ExModificaUtenteDatiAccessoNSC: Non posso modificare utente: f3b.dao.DAOException: ORA-12899: valore troppo grande per la colonna "SIESNA"."UTENTE"."PWD_NSC" (corrente: 33, massimo: 30) 
il problema è comune a tutti gli utenti abilitati e si verifica dopo la prima richiesta formulata a seguito dell'installazione dell'aggiornamento SIES versione 12.9.0.0 avvenuta in data 18 febbraio u.s., nel senso che la prima richiesta viene esitata regolarmente ma dalla successiva si verifica l'errore | Per la risoluzione della problematica è stata modificata la gestione di aggiornamento della password | Il problema era legato al fatto che la form non decodificava la password quando la ricaricava a video.
Classi modificate:
/siap/siep/istruttoria/LoadRichiestaCertificatoPenale.jsp
/siap/sius/fascicolo/LoadRichiestaCertificatoPenale.jsp |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20260227-Piano_di_Rilascio_SIES_v.12.9.1.0.docx
SIUT-SIES-PT-1.0-20260227-Piano_dei_Test_SIES_v.12.9.1.0.docx
SIUT-SIES-CT-1.0-20260227-Allegato_al_piano_test_SIES_v.12.9.1.0.xlsx |
...
| template.zip | Template | siep\cumulo\SIEP_CUMULO_PROSPETTO_TITOLI.rtf
...
# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.9.0.0.
...
Creare sul server DB una cartella V_12_9_1_0 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_9_1_0/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_9_1_0 tramite il comando:
chmod 777 V_12_9_1_0
...
Nella cartella appena creata (V_12_9_1_0), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_9_1_0/log/ in cui si può constatare l’esito dell’esecuzione.
