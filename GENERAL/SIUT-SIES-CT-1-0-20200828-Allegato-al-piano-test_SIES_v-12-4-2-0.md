---
uniqueName: siut-sies-ct-1-0-20200828-allegato-al-piano-testsi
displayName: "SIUT SIES CT 1 0 20200828 Allegato al piano test SIES v 12 4 2 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20200828-Allegato-al-piano-test_SIES_v.12.4.2.0

> **File originale:** `RILASCIO_12.4.2.0/SIUT-SIES-CT-1.0-20200828-Allegato-al-piano-test_SIES_v.12.4.2.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20200828-Allegato-al-piano-test_SIES_v.12.4.2.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20200828-Piano_dei_Test_SIES_v.12.4.2.0.docx |
|  | Versione | 1.0 |
|  | Data | 44071.0 |
|  | Intervento | SIES v.12.4.2.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.2.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20200828-Allegato-al-piano-test_SIES_v.12.4.2.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 20200730015.0 |  |  | 20200730015.0 | Impossibile gestire atto pervenuto |  | SIEP | SIEP - Impossibile gestire atto pervenuto | TF001.SIEP | Verifica controllo su assenza fascicolo cumulante. |  |  |  | Verifica: verificare che nel caso di trasmissione di un fascicolo cumulante inesistente il sistema visualizzi un messaggio sulla mancanza del fascicolo stesso. | 1.0 |  |  |  |  |
| SIUT | SIES | 20200812012.0 |  |  | 20200812012.0 | Errore in inserimento Titolo Esecutivo |  | SIUS | SIUS - Errore in inserimento Titolo Esecutivo | TF001.SIUS | Verifica controllo su assenza anno e numero sentenza. |  |  |  | Verifica: verificare che nel caso di  "Iscrizione Procedimento" per l'ufficio di sorveglianza quando si vuole procedere alla "Iscrizione Procedimento Collegato", collegando un fascicolo SIEP di classe IV privo di anno e numero sentenza,  il risultato atteso sia il dettaglio del fascicolo piuttosto della pagina di errore segnalata. | 1.0 |  |  |  |  |
...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20200828-Allegato-al-piano-test_SIES_v.12.4.2.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica controllo su assenza fascicolo cumulante. |  | Verifica: verificare che nel caso di trasmissione di un fascicolo cumulante inesistente il sistema visualizzi un messaggio sulla mancanza del fascicolo stesso. |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Ricercare un fascicolo in stato diverso da "iscritto" di classe 1 |  |  |  |  |  |  |
|  | 2 | Navigazione | Istruttorie/Richieste |  |  |  |  |  |  |
|  | 3 | Azione | Cliccare su Trasmissione Per Competenza/Seguito Atti |  | Visualizzazione messaggio che il procedimento non è ancora stato trasmesso a NSC |  |  |  |  |
|  | 4 | Azione | Cliccare su  OK |  | Visualizzazione pagina Trasmissione per Competenza |  |  |  |  |
|  | 5 | Azione | Cliccare su Nel Distretto |  | Visualizzazione pagina Ricerca Procedimento |  |  |  |  |
|  | 6 | Azione | Cliccare su Inserisci Titolo |  | Visualizzazione pagina TRASMISSIONE PER COMPETENZA |  |  |  |  |
|  | 7 | Azione | Compilare i dati della maschera:
Come "Ufficio Competente all'emissione del Provvedimento" inserire un ufficio dello stesso distretto es la Procura Generale.
Come "Relativa al Procedimento numero" indicare in procedimento inesistente es 2020/9999.
Come "Oggetto Atto" selezionare "atti per competenza (per emissione provvedimento di cumulo)".
Cliccare su Conferma |  | Visualizzazione pagina Dettaglio Trasmissione Competenza |  |  |  |  |
|  | 8 | Azione | Effettuare la Stampa e successivamente validare |  | Visualizzazione pagina Dettaglio Trasmissione Competenza |  |  |  |  |
|  | 9 | Azione | Selezionare l'icona presente per procedere alla trasmissione |  | Visualizazione pagina  Trasferimento Trasmissione per Competenza |  |  |  |  |
|  | 10 | Azione | Cliccare su Conferma |  | Visualizzazione messaggio di avvenuta trasmissione |  |  |  |  |
|  | 11 | Azione | Collegarsi con utenza dell'ufficio a cui si sono trasmessi gli atti (es Procura Generale) | Cxxxxx (Procura Generale della Repubblica Presso la Corte D'Appello) |  |  |  |  |  |
|  | 12 | Navigazione | Presa in carico Provvedimenti » Atti Ricevuti per Competenza |  |  |  |  |  |  |
|  | 13 | Azione | Cliccare su Elenco Atti Ricevuti |  | Visualizzazione pagina Lista Atti Ricevuti per Competenza |  |  |  |  |
|  | 14 | Azione | Nell'elenco selezionare il fascicolo precedentemente trasmesso. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema visualizzi il dettaglio con un messaggio che informa che il procedimento 2020/9999 non è stato trovato. |  |  |  |  |  |  |
| TF001.SIUS | 01 | Verifica controllo su assenza anno e numero sentenza. |  | Verifica: verificare che nel caso di  "Iscrizione Procedimento" per l'ufficio di sorveglianza quando si vuole procedere alla "Iscrizione Procedimento Collegato", collegando un fascicolo SIEP di classe IV privo di anno e numero sentenza,  il risultato atteso sia il dettaglio del fascicolo piuttosto della pagina di errore segnalata. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
|  | P | Attività Preliminari e/o Precondizioni | L'utente effettua l'accesso al sistema SIEP come Procura della Repubblica Presso il Tribunale Ordinario | Axxxxx (Procura della Repubblica Presso il Tribunale Ordinario) |  |  |  |  |  |
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Iscrivere un fascicolo di esecuzione Misura di Sicurezza disposte con ordinanza del Mds |  |  |  |  |  |  |
|  | 2 | Navigazione | Gestione Misure Sicurezza |  |  |  |  |  |  |
|  | 3 | Azione | Cliccare su Iscrizione Procedimento per Misura di Sicurezza applicata con ordinanza dal Magistrato di Sorveglianza e/o in sede di impugnazione dal Tribunale di Sorveglianza |  | Visualizzazione pagina Iscrizione Procedimento Misura Sicurezza disposta fuori sentenza - Ricerca Provvedimento Sorveglianza |  |  |  |  |
|  | 4 | Azione | Cliccare su  Ricerca |  | Visualizzazione pagina Elenco Provvedimenti della Sorveglianza relativi a Misure Sicurezza Disposte fuori Sentenza |  |  |  |  |
|  | 5 | Azione | Cliccare su Avanti >>> |  | Visualizzazione pagina Iscrizione Procedimento Esecuzione Misura Sicurezza Fuori Sentenza |  |  |  |  |
|  | 6 | Azione | Compilare i dati obbligatori nella sezione Soggetto In fase di Iscrizione;
compilare  i dati obbligatori nella sezione Provvedimento della Sorveglianza (selezionando Ordinanza di Ufficio di Sorveglianza) ed
omettere di riempire i campi Anno/Numero Provvedimento;
compilare  i dati obbligatori nella sezione Misura Sicurezza;
compilare  i dati obbligatori nella sezione Provvedimento da Eseguire;
cliccare su Conferma |  | Visualizzazione pagina Dettaglio Procedimento |  |  |  |  |
|  | 7 | Azione | Nella pagina di dettaglio, nel menù orizzontale a tendina, selezionare la voce Assegnazione Procedimento al Magistrato, assegnare e successivamente validare il procedimento stesso |  | Visualizzazione pagina Dettaglio Procedimento con stato procedimento a Validato |  |  |  |  |
|  | 8 | Azione | Collegarsi con utenza dell'Ufficio di Sorveglianza di cui in precedenza abbiamo creato l'Ordinanza | Exxxxx (Ufficio di Sorveglianza) |  |  |  |  |  |
|  | 9 | Navigazione | Iscrizione Manuale » Iscrizione Soggetto |  |  |  |  |  |  |
|  | 10 | Azione | Compilare i dati obbligatori e premere Conferma |  | Visualizzazione pagina Dettaglio Soggetto |  |  |  |  |
|  | 11 | Azione | Nella pagina di dettaglio selezionare la voce Iscrizione Procedimento dal menù orizzontale a tendina |  | Visualizzazione pagina Iscrizione Procedimento da Soggetto |  |  |  |  |
|  | 12 | Azione | Compilare i dati obbligatori selezionando nel campo Contenuto la voce Esecuzione Misura Sicurezza, premere Conferma |  | Visualizzazione pagina Dettaglio Procedimento SIUS |  |  |  |  |
|  | 13 | Azione | Nella pagina di dettaglio selezionare la voce  Assegnazione Titolo Esecutivo Principale dal menù orizzontale a tendina |  | Visualizzazione pagina Assegnazione Titolo Esecutivo Principale |  |  |  |  |
|  | 14 | Azione | Nella sezione Estremi del Titolo Esecutivo Principale, riempire i campi obbligatori avendo cura di inserire gli stessi dati del procedimento SIEP creato negli step 1-7 e premere il tasto Conferma |  |  |  |  |  |  |
|  | V | Verifica | Verificare che il sistema visualizzi il dettaglio degli Estremi del Titolo Esecutivo Principale prescelto e dia la possibilità di confermare l'assegnazione definitivamante |  |  |  |  |  |  |
