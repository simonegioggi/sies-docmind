---
uniqueName: siut-sies-ct-1-0-20210326-allegatoalpianotestsiesv
displayName: "SIUT SIES CT 1 0 20210326 Allegato al piano test SIES v 12 4 8 0"
category: "GENERAL"
tags: []
---

# SIUT-SIES-CT-1.0-20210326-Allegato_al_piano_test_SIES_v.12.4.8.0

> **File originale:** `RILASCIO_12.4.8.0/SIUT-SIES-CT-1.0-20210326-Allegato_al_piano_test_SIES_v.12.4.8.0.xls`  
> **Tipo:** XLS
...
|  | Nome del file | SIUT-SIES-CT-1.0-20210326-Allegato-al-piano-test_SIES_v.12.4.8.0.xls |
|  | Piano di test | SIUT-SIES-PT-1.0-20210326-Piano_dei_Test_SIES_v.12.4.8.0.doc |
|  | Versione | 1.0 |
|  | Data | 44281.0 |
|  | Intervento | SIES v.12.4.8.0 |
|  | Area Applicativa | Penale |
|  | Allegato al Piano dei Test |  |

## TabellaTest

| Codice Area |  |  | SIES v.12.4.8.0 |  |  |  | Codifica  Piano di test |  | SIUT-SIES-CT-1.0-20210326-Allegato-al-piano-test_SIES_v.12.4.8.0.xls | Versione | 1.0 |  |  |  |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
...
| SIUT | SIES | 202102230121.0 |  |  | 202102230121.0 | Archiviazione pene pecuniarie |  | SIEP | SIEP - Archiviazione pene pecuniarie | TF001.SIEP | Verifica corretta modifica del template |  |  |  | Verifica: verificare che il template SIEP_OS_01.rtf venga visualizzato correttamente | 1.0 |  |  |  |  |
| SIUT | SIES | 20210224017.0 |  |  | 20210224017.0 | Template da correggere |  | SIEP | SIEP - Template da correggere | TF002.SIEP | Verifica corretta modifica del template |  |  |  | Verifica: verificare che i template SIEP_MA_ARDOM_REVO_DIRETTA.rtf venga visualizzato correttamente. | 1.0 |  |  |  |  |
| SIUT | SIES | 20210310014.0 |  |  | 20210310014.0 | rif ticket 202103020113 — ricerca per soggetto SIEP |  | SIEP | SIEP -  rif ticket 202103020113 — ricerca per soggetto SIEP | TF003.SIEP | Verifica che sia presente il controllo sull'anno nascita se inserito a 0. |  |  |  | Verifica: verificare che nell'inserimento del Soggetto sia presente il controllo sulla digitazione dell'anno di nascita nel caso si stia inserendo una data presunta. | 1.0 |  |  |  |  |
| SIUT | SIES | 202103160116.0 |  |  | 202103160116.0 | Errore SIUS su emissione provvedimento |  | SIUS | SIUS - Errore SIUS su emissione provvedimento | TF004.SIUS | Verifica corretta profilatura utenza TDS |  |  |  | Verifica: Verificare che l'utente del TDS sia profilato in lettura nella funzionalità Dettaglio Misura Sicurezza | 1.0 |  |  |  |  |
...
| Progetto / Obiettivo Software |  |  | SIES v.12.4.8.0 |  |  |  |  |  |  |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| Codifica Piano di test |  |  | SIUT-SIES-CT-1.0-20210326-Allegato-al-piano-test_SIES_v.12.4.8.0.xls |  |  |  |  |  |  |
| ID caso di test | Suffisso Caso di test | Nome Caso di test
Tipo Step |  | Descrizione |  | Versione | Stima tempo | N.cond. di test | Esito |
| TF001.SIEP | 01 | Verifica corretta modifica del template |  | Verifica: verificare che il template SIEP_OS_01.rtf venga visualizzato correttamente |  | 1.0 |  |  | OK |
...
|  | 1 | Azione | Iscrivere un fascicolo SIEP per soggetto con posizione giuridica iniziale Espiazione pena in Istituto di Detenzione - Custodia Cautelare per Questa Causa in regime di Detenzione. |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Completare i dati minimali (Difensore - Posizione Giuridica - Reati - Pena Complessiva - Assegnazione la magistrato). |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 3 | Azione | Iscrivere 2 misure di sicurezza tramite la funzione presente sempre nella combo: Iscrizione misura Sicurezza |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 4 | Navigazione | Validazione Procedimento |  | Visualizzazione pagina Validazione Procedimento |  |  |  |  |
|  | 5 | Azione | Validare il procedimento dello step 1 cliccando sul pulsante Conferma |  | Visualizazione pagina  Dettaglio Procedimento |  |  |  |  |
|  | 6 | Navigazione | Ordini di Esecuzione/Scarcerazione » Ordine di Esecuzione |  | Visualizzazione pagina :  Emissione Ordine di Esecuzione - Libero |  |  |  |  |
|  | 7 | Azione | Inserire le informazioni richieste nella pagina. Cliccare su Conferma |  | Visualizzazione pagina  Dettaglio Ordine Esecuzione Condannato Libero |  |  |  |  |
|  | 8 | Azione | Stampare. |  | Produzione stampa SIEP_OS_01.rtf |  |  |  |  |
|  | V | Verifica | Verificare che nella stampa esca la scritta " avra' termine il" senza "a" accentata e la data venga correttamente visualizzata. Inoltre nella sezione successiva che riporta "in pari data dovra' inoltre trovare applicazione la misura di sicurezza" le 2 misure inserite devono andare su 2 righe distinte. |  |  |  |  |  |  |
| TF002.SIEP | 01 | Verifica corretta modifica del template |  | Verifica: verificare che i template SIEP_MA_ARDOM_REVO_DIRETTA.rtf venga visualizzato correttamente. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | P | Stato Base | L'utente si trova nella pagina principale dell'applicazione. |  |  |  |  |  |  |
|  | 1 | Azione | Iscrivere un fascicolo SIEP per soggetto con posizione giuridica iniziale Espiazione pena in altro Luogo - Custodia Cautelare per Questa Causa in regime di Arresti Domiciliari. |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
|  | 2 | Azione | Completare i dati minimali (Difensore - Posizione Giuridica - Reati - Pena Complessiva - Assegnazione la magistrato). |  | Visualizazzione pagina Dettaglio Procedimento |  |  |  |  |
...
|  | 5 | Navigazione | Ordini di Esecuzione/Scarcerazione » Sospensione Esecuzione ex art. 656 c.p.p. » Ordine di Esecuzione |  | Visualizzazione pagina Ordine di Esecuzione con sospensione (LEGGE 165/98) - CUST. CAUT. PER QUESTA CAUSA IN REGIME DI ARRESTI DOMICILIARI |  |  |  |  |
|  | 6 | Azione | Inserire le informazioni richieste nella pagina. Cliccare su Conferma |  | Visualizzazione pagina  Dettaglio Legge 165/98 Arresti Domiciliari |  |  |  |  |
|  | 7 | Azione | Stampare e validare. |  | Visualizzazione pagina  Trasferimento Ordine Esecuzione |  |  |  |  |
|  | 8 | Navigazione | Decisioni della Sorveglianza » Gestione arresti Domiciliari 656 comma 10 » Revoca Arresti Domiciliari e Rigetta applicazione della misura alternativa. |  | Visualizzazione pagina Revoca Arresti Domiciliari e Rigetta applicazione misura alternativa |  |  |  |  |
|  | 9 | Azione | Inserire le informazioni richieste nella pagina. Cliccare su Conferma |  | Visualizzazione pagina Revoca Arresti Domiciliari ex art. 656 comma 10 |  |  |  |  |
|  | 10 | Azione | Stampare. |  | Produzione stampa SIEP_MA_ARDOM_REVO_DIRETTA.rt |  |  |  |  |
|  | V | Verifica | Verificare che nella stampa siano stati eliminati i doppi spazi e sia stata eliminata doppia riga a capo nell'elenco dei destinatari. |  |  |  |  |  |  |
| TF003.SIEP | 01 | Verifica che sia presente il controllo sull'anno nascita se inserito a 0. |  | Verifica: verificare che nell'inserimento del Soggetto sia presente il controllo sulla digitazione dell'anno di nascita nel caso si stia inserendo una data presunta. |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Inserire i dati del soggetto selezionando dalla combo Data Presunta il valore S ed indicando nell'anno di nascita il valore 0. |  |  |  |  |  |  |
|  | V | Verifica | Verificare che venga visualizzato il messaggio:"Inserire almeno il campo anni della data di nascita se non è stato impostato il campo Età presunta. Valore 0 non consentito." |  |  |  |  |  |  |
| TF004.SIUS | 01 | Verifica corretta profilatura utenza TDS |  | Verifica: Verificare che l'utente del TDS sia profilato in lettura nella funzionalità Dettaglio Misura Sicurezza |  | 1.0 |  |  | OK |
|  | Step | Tipo | Istruzioni
(test) | Dati di input
(Associated Data) | Risultati attesi
(Expected Result) |  |  |  |  |
...
|  | 2 | Azione | Inserire estremi di un fascicolo SIUS che abbia come contenuto "APPELLO CONTRO PROVVEDIMENTO SU MISURA DI SICUREZZA(ART. 680 CPP)" . Cliccare su Conferma |  | Visualizzazione pagina   Emissione Ordinanza |  |  |  |  |
|  | 3 | Azione | Inserire i dati obbligatori e cliccare su Conferma. |  | Visualizzazione pagina Emissione Ordinanza Appello Contro Provvedimento su Misura Sicurezza |  |  |  |  |
|  | 4 | Azione | Cliccare sul link Dettaglio Misura Sicurezza |  |  |  |  |  |  |
|  | V | Verifica | Verificare che si acceda alla pagina Elenco Misure Sicurezza |  |  |  |  |  |  |
