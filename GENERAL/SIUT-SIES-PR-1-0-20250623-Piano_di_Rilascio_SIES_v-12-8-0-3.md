---
uniqueName: siut-sies-pr-1-0-20250623-pianodirilasciosiesv-12-
displayName: "SIUT SIES PR 1 0 20250623 Piano di Rilascio SIES v 12 8 0 3"
category: "GENERAL"
tags: []
---

# SIUT-SIES-PR-1.0-20250623-Piano_di_Rilascio_SIES_v.12.8.0.3

> **File originale:** `RILASCIO_12.8.0.3/SIUT-SIES-PR-1.0-20250623-Piano_di_Rilascio_SIES_v.12.8.0.3.docx`  
> **Tipo:** DOCX
...
| --- | --- | --- | --- |
| 1.0 | 26/03/2025 | Prima Emissione |  |
...
Gli interventi in oggetto sono rilasciati nell’ambito della release 12.8.0.3 di SIES.
...
# Generalità
Il presente documento descrive il piano di rilascio di SIES 12.8.0.3 contenente gli interventi di natura correttiva, eseguiti a fronte di segnalazioni pervenute mediante il sistema di trouble ticketing OTRS.
...
| --- | --- | --- | --- |
| Portale fornitura | SIUT > 06 - Rilasci Software > SIES > Rilascio SIES 12.8.0.3 2025-06-23 | 12.8.0.3 | 26/03/2025 |
| Note-osservazioni |  |  |  |
...
| --- | --- | --- | --- | --- | --- |
| 202506200112 |  | errore inserimento parere |  |  |  |
| 202506190164 |  | errore in fase di iscrizione per carattere non consentito |  |  |  |
| 202506200116 |  | SIUS |  |  |  |
| 202506190140 |  | SIES - Siep - Problema emissione AVVISO MANCATO PAGAMENTO |  |  |  |
| Note-osservazioni |  |  |  |  |  |
...
| --- | --- | --- |
| documentazione.zip | Documentazione | SIUT-SIES-PR-1.0-20250623-Piano_di_Rilascio_SIES_v.12.8.0.3.docx |
...
| template.zip | Template | siep\altri\test.rtf |
| Note-osservazioni |  |  |

# Installazione
## Prerequisiti
Per l’installazione della release SIES oggetto del presente rilascio è necessario aver installato la precedente release 12.8.0.2.
...
Creare sul server DB una cartella V_12_8_0_3 sotto la directory /home/oracle/;
Copiare il contenuto della cartella aggiorna_db nella cartella /home/oracle/V_12_8_0_3/;
Dare i permessi di lettura, scrittura ed esecuzione a tutti i file della cartella V_12_8_0_3 tramite il comando:
chmod 777 V_12_8_0_3
...
Nella cartella appena creata (V_12_8_0_3), lanciare il comando:
./aggiorna_db.sh
Durante l’esecuzione verrà creato un file di log nella cartella /home/oracle/V_12_8_0_3/log/ in cui si può constatare l’esito dell’esecuzione.
